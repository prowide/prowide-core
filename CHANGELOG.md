...
#### 10.3.20 - SNAPSHOT
  * Feat: new `IsoCountry` enum with the ISO 3166-1 catalog of officially assigned countries (alpha-2, alpha-3 and numeric codes, and the English short names) with `IsoCountry.find(code)` to look up a country by any of the three codes
