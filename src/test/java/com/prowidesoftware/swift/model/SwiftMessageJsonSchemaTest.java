...
import com.prowidesoftware.swift.model.mt.mt3xx.MT380;
...
import com.prowidesoftware.swift.model.mt.mt7xx.MT720;
...
public class SwiftMessageJsonSchemaTest {
    ...
    public static boolean validateSchema(String jsonMsg) throws Exception {
        ...
        try (InputStream in = SwiftMessageJsonSchemaTest.class.getResourceAsStream("/SwiftMessageJsonSchema.json")) {
            if (in == null) {
    ...
    public void test_103_input() throws Exception {
        ...
        final MT103 mt = MT103.parse(m);
        final String json = mt.getSwiftMessage().toJson();
