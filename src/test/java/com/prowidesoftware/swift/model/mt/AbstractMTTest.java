...
public class AbstractMTTest {
    ...
    public void testGetSequence() {
        SwiftMessage m = new MT102()
                .append(MT102.SequenceA.newInstance(Field32A.tag("foo")))
                .getSwiftMessage();
    ...
    */
    ...
    public void testGetFieldsInvalidBlockBrackets() throws IOException {
        final String msg =
                "{1:F01OMFNCIABAXXX6368087500}{2:O1031542151104BCAOSNDPAXXX22438129121511041542N}{3:{108:210323165210}{4:\n"
                        + ":20:1234567890\n"
                        + ":23B:CRED\n"
                        + ":23E:SDVA\n"
                        + "-}";
    ...
    public void testMTClassParse() {
        MT940 mt = MT940.parse(
                "{1:F01ANASCH20AXXX0000000000}{2:I940BSCHGB2LXEQUN}{3:{108:FOOB3926BE868XXX}}{4:\n" + ":20:123456\n"
                        + ":25:123-304958\n"
                        + ":28C:123/1\n"
    ...
    @Test
    public void testAbstractMt() {
        int type = 9;

        try {
            AbstractMT.create(type);
        } catch (Exception e) {
