...
public class MT540Test {
    ...
    public static final String MT_540_CANC =
            "{1:F01SOGEFRPPAGSS0000000000}{2:O5401445211216SOGEFRPPAHCM5C3E1000002112161445N}{3:{108:5 C3E10}}{4:\n"+
                ":16R:GENL\n"+
                    ":20C::SEME//TFH5436259-B00\n"+
                    ":23G:CANC\n"+
                    ":98C::PREP//20211216144402\n"+
                    ":16R:LINK\n"+
                        ":20C::PREV//TFH5436259-A00\n"+
                    ":16S:LINK\n"+
                ":16S:GENL\n"+
                ":16R:TRADDET\n"+
                    ":98A::SETT//20211216\n"+
                    ":98A::TRAD//20211216\n"+
                    ":35B:ISIN FR0014001N46\n"+
                    "FRTR 0 25 02 24 EUR\n"+
                ":16S:TRADDET\n"+
                ":16R:FIAC\n"+
                    ":36B::SETT//FAMT/31000000,\n"+
                    ":97A::SAFE//0528808067001043\n"+
                ":16S:FIAC\n"+
                ":16R:SETDET\n"+
                    ":22F::SETR//TRAD\n"+
                    ":16R:SETPRTY\n"+
                        ":95P::DEAG//MGTCBEBEECL\n"+
                        ":97A::SAFE//94840\n"+
                    ":16S:SETPRTY\n"+
                    ":16R:SETPRTY\n"+
                        ":95P::SELL//SOGEFRPPHCM\n"+
                        ":97A::SAFE//94840\n"+
                    ":16S:SETPRTY\n"+
                    ":16R:SETPRTY\n"+
    ...
    void field20C_should_be_returned_by_MT540_CANC() {
        ...
        try {
            ...
            assertThat(mt540.getField20C().get(0).getReference()).isEqualTo("TFH5436259-B00");
            ...
            assertThat(fieldByName.getComponent(2)).isEqualTo("TFH5436259-B00");
