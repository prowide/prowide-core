 ...
 */
public class MT360Test {

    private static final String ALL_SEQUENCES = "{1:F01AAAAUS30AXXX0000123450}{2:I360BBBBGB44AXXXN}{4:\n" + ":15A:\n"
            + ":20:REF11111\n"
            + ":15B:\n"
            + ":18A:B1-COUNT\n"
            + ":22B:B1-END\n"
    ...
    public void testSequenceB1IsScopedToSequenceB() {
        final MT360 mt = new MT360(ALL_SEQUENCES);
    ...
    /** sequence E is absent, so E1 must be empty instead of returning B1 content */
    @Test
    public void testSequenceE1IsEmptyWhenSequenceEIsAbsent() {
        final MT360 mt = new MT360("{1:F01AAAAUS30AXXX0000123450}{2:I360BBBBGB44AXXXN}{4:\n" + ":15A:\n"
                + ":20:REF11111\n"
                + ":15B:\n"
                + ":18A:B1-COUNT\n"
                + ":22B:B1-END\n"
                + "-}");
        assertThat(mt.getSequenceE1()).isEmpty();
        assertThat(mt.getSequenceB1().getTags()).extracting("value").containsExactly("B1-COUNT", "B1-END");
    }
}
