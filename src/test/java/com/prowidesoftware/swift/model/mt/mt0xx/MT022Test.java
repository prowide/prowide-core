...
public class MT022Test {
    ...
    private final String sample1 = "{1:F01VNDZBET2AXXX0000000000}{2:I022DYDYXXXXXXXXN}{4:"
            + "{102:VNDZBET2AXXX}"
            + "{251:010605VNDZBET2AXXX0017000375}}";

    private final String sample2 = "{1:F01VNDZBET2AXXX0000000000}{2:I022DYDYXXXXXXXXN}{4:"
            + "{102:VNDZBET2AXXX}"
            + "{251:050822VNDZBET2AXXX0529001624}}";

    private final String sample3 = "{1:F01VNDZBET2AXXX0000000000}{2:I022DYDYXXXXXXXXN}{4:"
            + "{102:VNDZBET2AXXX}"
            + "{252:050822VNDZBET2AXXX0294001093050822VNDZBET2AXXX0294001096}}";

    private final String sample4 = "{1:F01VNDZBET2AXXX0000000000}{2:I022DYDYXXXXXXXXN}{4:"
            + "{102:VNDZBET2AXXX}"
            + "{253:050823VNDZBET2AXXX0042000211}}";

    private final String sample5 = "{1:F01VNDZBET2AXXX0000000000}{2:I022DYDYXXXXXXXXN}{4:"
            + "{102:VNDZBET2AXXX}"
            + "{254:050822VNDZBET2AXXX0025000093050822VNDZBET2AXXX002500009714501454}}";

    private final String sample6 = "{1:F01VNDZBET2AXXX0000000000}{2:I022DYDYXXXXXXXXN}{4:"
            + "{102:VNDZBET2AXXX}"
            + "{258:VNDZBET2AXXX002599905082214501454}}";

    private final String sample7 = "{1:F01VNDZBET2AXXX0000000000}{2:I022DYDYXXXXXXXXN}{4:"
            + "{102:VNDZBET2AXXX}"
            + "{259:VNDZBET2AXXX0025905082214501454}}";

    private final String sample8 = "{1:F01VNDZBET2AXXX0000000000}{2:I022DYDYXXXXXXXXN}{4:"
            + "{102:VNDZBET2AXXX}"
