...
public class MT103Test extends BaseMessageTestcase {
	...
	public void test103_1() {
		messageToParse = "{1:F01BICFOOYYAXXX1234123456}{2:O1030803051028AAPBESMMAXXX54237368560510280803N}{3:{113:NOMF}{108:0510280086100057}{119:STP}}{4:\n" + 
						":20:D051026EUR100057\n" + 
	...
	public void test103_2() {
		messageToParse = "{1:F01MYBICBICAXXX1234123456}{2:O1031041060411AAABESMMAXXX55944670160604111041N}{3:{113:ROMF}{108:0604113641000001}{119:STP}}{4:\n" + 
					":20:1234123421340001\n" + 
		...
		//check b1
		assertEquals("F01MYBICBICAXXX1234123456", b1.getBlockValue());
		...
		assertEquals("MYBICBICXXX", b4.getTagValue("57A"));
	...
	public void test103_3() {
		messageToParse = "{1:F01BICFOOYYAXXX1234123456}{2:O1030954060228RRRRESMMAXXX55549966520602280954N}{3:{113:NOMT}{108:2006022800940029}{119:STP}}{4:\n" + 
					":20:B185008345547244\n" + 
	...
	public void test103_4() {
		messageToParse = "{1:F01BICFOOYYAXXX1234123456}{2:O1031101051102UUUUESMMAXXX54267818770511021101N}{3:{113:ROMF}{108:0511029000000056}}{4:\n" + 
					":20:0511029000000056\n" + 
	...
	public void test103_5() {
		messageToParse = "{1:F01BICFOOYYAXXX1234123456}{2:O1031101051102KKKKESMMAXXX54267818770511021101N}{3:{113:ROMF}{108:0511029000000056}}{4:\n" + 
					":20:0511029000000056\n" + 
		...
		assertEquals("BICFOOMMXXX", b4.getTagValue("53A"));
		assertEquals("BICFOOYYXXX", b4.getTagValue("57A"));
