...
public class SystemMessageTest extends BaseMessageTestcase {
    ...
    public void testPostedFengw2_01() {
        String msg =
                "{1:F21FOOBARXXAXXX1234567890}{4:{177:0703281337}{451:1}{405:E66013}}{1:F01FOOBARXXAXXX3219604112}{2:I535FOOBARXXXXXXN}{4:\n"
                        + ":16R:GENL\n"
                        + ":28E:1/ONLY\n"
                        + ":13A::STAT//086\n"
    ...
    public void testPostedFengw2_02() {
        String msg =
                "{1:F21FOOBARXXAXXX1234567890}{4:{177:0704032320}{451:0}}{1:F01FOOBARXXAXXX3227607589}{2:I950FOOBARXXXXXXN}{4:\n"
                        + ":20:12345678070403\n"
                        + ":25:12345678\n"
                        + ":28C:93/1\n"
                        + ":60F:C070403USD0,\n"
    ...
    public void testPostedDonreda_01() {
        String msg =
                "{1:F21MTGSUS6SAXXX3206837054}{4:{177:0703161035}{451:0}}{1:F01MTGSUS6SAXXX3206837054}{2:O5641435070316CHASGB2LDGST07128160300703160735N}{3:{108:000255CQ8272245}}{4:\n"
                        + ":16R:GENL\n"
                        + ":20C::CORP//D455103\n"
                        + ":20C::SEME//029206016\n"
                        + ":23G:NEWM\n"
