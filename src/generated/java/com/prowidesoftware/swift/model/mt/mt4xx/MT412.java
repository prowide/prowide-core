...
public class MT412 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT412.class.getName());
	 ...
	 */
	public MT412(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT412(String)
	 */
	public MT412(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT412 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT412(m);
	...
	* @since 7.10.3
	*/
	public static MT412 fromJson(final String json) {
	...
	/**
	 * Class to model Sequence "Loop1" in MT 412.
	 */
