...
public class MT991 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT991.class.getName());
	 ...
	 */
	public MT991(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT991(String)
	 */
	public MT991(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT991 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT991(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "991")) {
	...
	* @since 7.10.3
	*/
	public static MT991 fromJson(final String json) {
