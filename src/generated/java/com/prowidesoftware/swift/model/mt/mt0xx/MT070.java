...
public class MT070 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT070.class.getName());
	 ...
	 */
	public MT070(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT070(String)
	 */
	public MT070(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT070 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT070(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "070")) {
	...
	* @since 7.10.3
	*/
	public static MT070 fromJson(final String json) {
