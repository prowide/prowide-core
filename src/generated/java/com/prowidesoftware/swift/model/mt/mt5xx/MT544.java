...
/**
 * <h1>MT 544 - Receive Free Confirmation</h1>
 * <h3>SWIFT MT544 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
<li class="sequence">
...
// end qualifiers constants	
	...
	*/
	...
	public MT544(final int messageType, final String sender, final String receiver) {
		super(544, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT544(int, String, String)", "Use the constructor MT544(sender, receiver) instead.");
	}
