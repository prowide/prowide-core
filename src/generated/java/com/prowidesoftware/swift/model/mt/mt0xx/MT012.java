...
public class MT012 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT012.class.getName());
	 ...
	 */
	public MT012(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT012(String)
	 */
	public MT012(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT012 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT012(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "012")) {
	...
	* @since 7.10.3
	*/
	public static MT012 fromJson(final String json) {
