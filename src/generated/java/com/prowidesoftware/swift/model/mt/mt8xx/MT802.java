...
public class MT802 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT802.class.getName());
	 ...
	 */
	public MT802(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT802(String)
	 */
	public MT802(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT802 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT802(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "802")) {
	...
	* @since 7.10.3
	*/
	public static MT802 fromJson(final String json) {
