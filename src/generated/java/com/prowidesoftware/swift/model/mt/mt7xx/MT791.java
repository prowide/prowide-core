...
public class MT791 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT791.class.getName());
	 ...
	 */
	public MT791(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT791(String)
	 */
	public MT791(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT791 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT791(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "791")) {
	...
	* @since 7.10.3
	*/
	public static MT791 fromJson(final String json) {
