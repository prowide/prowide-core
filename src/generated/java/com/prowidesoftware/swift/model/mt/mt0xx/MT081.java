...
public class MT081 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT081.class.getName());
	 ...
	 */
	public MT081(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT081(String)
	 */
	public MT081(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT081 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT081(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "081")) {
	...
	* @since 7.10.3
	*/
	public static MT081 fromJson(final String json) {
