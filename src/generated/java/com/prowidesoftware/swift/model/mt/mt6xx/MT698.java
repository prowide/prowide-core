...
public class MT698 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT698.class.getName());
	 ...
	 */
	public MT698(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT698(String)
	 */
	public MT698(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT698 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT698(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "698")) {
	...
	* @since 7.10.3
	*/
	public static MT698 fromJson(final String json) {
