...
public class MT795 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT795.class.getName());
	 ...
	 */
	public MT795(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT795(String)
	 */
	public MT795(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT795 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT795(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "795")) {
	...
	* @since 7.10.3
	*/
	public static MT795 fromJson(final String json) {
