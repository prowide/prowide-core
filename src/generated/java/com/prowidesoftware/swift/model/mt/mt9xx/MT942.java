...
public class MT942 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT942.class.getName());
	 ...
	 */
	public MT942(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT942(String)
	 */
	public MT942(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT942 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT942(m);
	...
	* @since 7.10.3
	*/
	public static MT942 fromJson(final String json) {
