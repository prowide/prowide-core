...
public class MT025 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT025.class.getName());
	 ...
	 */
	public MT025(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT025(String)
	 */
	public MT025(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT025 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT025(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "025")) {
	...
	* @since 7.10.3
	*/
	public static MT025 fromJson(final String json) {
