...
public class MT105 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT105.class.getName());
	 ...
	 */
	public MT105(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT105(String)
	 */
	public MT105(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT105 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT105(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "105")) {
	...
	* @since 7.10.3
	*/
	public static MT105 fromJson(final String json) {
