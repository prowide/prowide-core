...
public class MT498 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT498.class.getName());
	 ...
	 */
	public MT498(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT498(String)
	 */
	public MT498(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT498 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT498(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "498")) {
	...
	* @since 7.10.3
	*/
	public static MT498 fromJson(final String json) {
