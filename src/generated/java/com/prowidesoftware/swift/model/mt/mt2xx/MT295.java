...
public class MT295 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT295.class.getName());
	 ...
	 */
	public MT295(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT295(String)
	 */
	public MT295(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT295 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT295(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "295")) {
	...
	* @since 7.10.3
	*/
	public static MT295 fromJson(final String json) {
