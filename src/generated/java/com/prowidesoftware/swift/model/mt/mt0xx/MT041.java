...
public class MT041 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT041.class.getName());
	 ...
	 */
	public MT041(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT041(String)
	 */
	public MT041(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT041 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT041(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "041")) {
	...
	* @since 7.10.3
	*/
	public static MT041 fromJson(final String json) {
