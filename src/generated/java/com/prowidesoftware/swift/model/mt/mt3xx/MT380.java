...
public class MT380 extends AbstractMT implements Serializable {
	 ...
	 */
	public MT380(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT380(String)
	 */
	public MT380(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT380 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT380(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "380")) {
	...
	* @since 7.10.3
	*/
	public static MT380 fromJson(final String json) {
	 ...
	 * @since 9.2.18
	 */
	public static SequenceB getSequenceFXORDER(SwiftTagListBlock parentSequence) {
	 ...
	 * @since 9.2.18
	 */
	public static SequenceB1 getSequenceORDRPRTY(SwiftTagListBlock parentSequence) {
	 ...
	 * @since 9.2.18
	 */
	public static SequenceB2 getSequenceREAS(SwiftTagListBlock parentSequence) {
	 ...
	 * @since 9.2.18
	 */
	public static SequenceC getSequenceUNDE(SwiftTagListBlock parentSequence) {
