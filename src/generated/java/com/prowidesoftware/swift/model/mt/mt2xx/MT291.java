...
public class MT291 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT291.class.getName());
	 ...
	 */
	public MT291(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT291(String)
	 */
	public MT291(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT291 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT291(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "291")) {
	...
	* @since 7.10.3
	*/
	public static MT291 fromJson(final String json) {
