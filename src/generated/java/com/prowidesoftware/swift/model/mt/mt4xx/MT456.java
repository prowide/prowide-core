...
public class MT456 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT456.class.getName());
	 ...
	 */
	public MT456(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT456(String)
	 */
	public MT456(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT456 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT456(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "456")) {
	...
	* @since 7.10.3
	*/
	public static MT456 fromJson(final String json) {
	...
	/**
	 * Class to model Sequence "Loop1" in MT 456.
	 */
	public static class Loop1 extends SwiftTagListBlock {
		...
		/**
		 * Last mandatory tag name of the sequence: <em>"77D"  </em>
		 * Array format is for cases when more than one letter options is allowed
		 */
		protected static final String[] END = { "77D"   };
