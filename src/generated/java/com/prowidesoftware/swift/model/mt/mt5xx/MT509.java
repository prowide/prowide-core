...
<li class="fieldset">
Fieldset 36
 (O) (repetitive)<ul><li>FieldsetItem 36 B,D (O)</li><li>FieldsetItem 36 B,D (O)</li><li>FieldsetItem 36 B,D (O) (repetitive)</li><li>FieldsetItem 36 B,D (O)</li><li>FieldsetItem 36 B,D (O)</li><li>FieldsetItem 36 B,D (O)</li></ul></li><li class="field">Field 35 B (M)</li>
<li class="field">Field 16 S (M)</li>
</ul></li>
<li class="sequence">
...
public class MT509 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT509.class.getName());
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!Strings.CS.equals(param.getType(), "509")) {
	...
	*/
     ...
     * @since 9.2.18
     */
    public SequenceB getSequenceTRADE() {
        return getSequenceB();
    }
	 ...
	 * @since 9.2.18
	 */
	public static SequenceB getSequenceTRADE(SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
     public List<SequenceB1> getSequenceTRADPRTYList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceB1> getSequenceTRADPRTYList(final SwiftTagListBlock parentSequence) {
