...
public class MT732 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT732.class.getName());
	 ...
	 */
	public MT732(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT732(String)
	 */
	public MT732(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT732 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT732(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "732")) {
	...
	* @since 7.10.3
	*/
	public static MT732 fromJson(final String json) {
