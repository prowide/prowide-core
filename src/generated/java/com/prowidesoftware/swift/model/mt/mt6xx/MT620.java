...
public class MT620 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT620.class.getName());
	 ...
	 */
	public MT620(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT620(String)
	 */
	public MT620(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT620 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT620(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "620")) {
	...
	* @since 7.10.3
	*/
	public static MT620 fromJson(final String json) {
	 ...
	 *
	 * @see SwiftTagListBlock#getSubBlockDelimitedWithOptionalTail(String[], String[], String[])
	 * @param parentSequence a not null parent sequence to find SequenceG1 within it
