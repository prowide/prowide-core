...
public class MT790 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT790.class.getName());
	 ...
	 */
	public MT790(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT790(String)
	 */
	public MT790(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT790 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT790(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "790")) {
	...
	* @since 7.10.3
	*/
	public static MT790 fromJson(final String json) {
