...
/**
 * <h1>MT 601 - Commodity Option Confirmation</h1>
 * <h3>SWIFT MT601 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
<li class="sequence">
...
// end qualifiers constants	
	...
	*/
	...
	public MT601(final int messageType, final String sender, final String receiver) {
		super(601, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT601(int, String, String)", "Use the constructor MT601(sender, receiver) instead.");
	}
