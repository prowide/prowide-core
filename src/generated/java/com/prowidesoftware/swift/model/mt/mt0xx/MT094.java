...
public class MT094 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT094.class.getName());
	 ...
	 */
	public MT094(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT094(String)
	 */
	public MT094(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT094 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT094(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "094")) {
	...
	* @since 7.10.3
	*/
	public static MT094 fromJson(final String json) {
