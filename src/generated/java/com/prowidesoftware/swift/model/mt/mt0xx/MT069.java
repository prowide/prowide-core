...
public class MT069 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT069.class.getName());
	 ...
	 */
	public MT069(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT069(String)
	 */
	public MT069(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT069 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT069(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "069")) {
	...
	* @since 7.10.3
	*/
	public static MT069 fromJson(final String json) {
