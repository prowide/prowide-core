...
/**
 * <h1>MT 542 - Deliver Free</h1>
 * <h3>SWIFT MT542 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
<li class="sequence">
...
// end qualifiers constants	
	...
	*/
	...
	public MT542(final int messageType, final String sender, final String receiver) {
		super(542, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT542(int, String, String)", "Use the constructor MT542(sender, receiver) instead.");
	}
