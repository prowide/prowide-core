...
Fieldset 97
 (M) (repetitive)<ul><li>FieldsetItem 97 A,B,D (M)</li><li>FieldsetItem 97 A,E (O)</li><li>FieldsetItem 97 D (O)</li><li>FieldsetItem 97 A,B (O)</li></ul></li><li class="field">Field 94 B,C,F,L,T (O) (repetitive)</li>
<li class="sequence">
...
Fieldset 19
 (M) (repetitive)<ul><li>FieldsetItem 19 A (M)</li><li>FieldsetItem 19 A (O)</li><li>FieldsetItem 19 A (O)</li><li>FieldsetItem 19 A (O)</li></ul></li><li class="field">Field 92 B (O)</li>
<li class="field">Field 16 S (M)</li>
</ul></li>
<li class="sequence">
...
<li class="fieldset">
Fieldset 95
 (M) (repetitive)<ul><li>FieldsetItem 95 C,P,Q,R (M) (repetitive)</li><li>FieldsetItem 95 S,L (O) (repetitive)</li></ul></li><li class="field">Field 97 A,D (O)</li>
<li class="fieldset">
Fieldset 70
...
public class MT542 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT542.class.getName());
	 ...
	 */
	public MT542(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT542(String)
	 */
	public MT542(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT542 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT542(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "542")) {
	...
	* @since 7.10.3
	*/
	public static MT542 fromJson(final String json) {
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 99C at MT542 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 20U at MT542 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 20N at MT542 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 36D at MT542 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 97D at MT542 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 94T at MT542 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 95D at MT542 are expected at one sequence or across several sequences.
	 * 
	...
	/**
	 * Class to model Sequence "E4" in MT 542.
	 */
	@SequenceStyle(Type.GENERATED_16RS)
