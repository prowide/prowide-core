...
public class MT671 extends AbstractMT implements Serializable {
	 ...
	 */
	public MT671(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT671(String)
	 */
	public MT671(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT671 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT671(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "671")) {
	...
	* @since 7.10.3
	*/
	public static MT671 fromJson(final String json) {
	...
	public List<SequenceB2> getSequenceB2List() {
		...
		return com.prowidesoftware.swift.model.mt.SequenceUtils.resolveMT671GetSequenceB2List_sru2024(this);
	}
	...
	public SequenceC getSequenceC() {
		...
		return com.prowidesoftware.swift.model.mt.SequenceUtils.resolveMT671GetSequenceC_sru2024(this);
	}
