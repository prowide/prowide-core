...
Fieldset 94
 (O) (repetitive)<ul><li>FieldsetItem 94 B,L (O) (repetitive)</li><li>FieldsetItem 94 B,C,F,L,T (O) (repetitive)</li></ul></li><li class="fieldset">
Fieldset 19
...
<li class="sequence">
Sequence B2 - Confirmation Parties (M) (repetitive)<ul><li class="field">Field 16 R (M)</li>
<li class="fieldset">
Fieldset 95
...
<li class="fieldset">
Fieldset 36
 (M) (repetitive)<ul><li>FieldsetItem 36 B,D (M)</li><li>FieldsetItem 36 B,D (O)</li></ul></li><li class="field">Field 35 B (M)</li>
<li class="sequence">
...
<li class="sequence">
Sequence C4 - Digital Payment Settlement Details (O)<ul><li class="field">Field 16 R (M)</li>
<li class="field">Field 35 B (M)</li>
<li class="field">Field 36 D (M)</li>
<li class="field">Field 94 F,L,T (O)</li>
<li class="field">Field 16 S (M)</li>
...
public class MT514 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT514.class.getName());
	 ...
	 */
	public MT514(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT514(String)
	 */
	public MT514(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT514 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT514(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!Strings.CS.equals(param.getType(), "514")) {
	...
	* @since 7.10.3
	*/
	public static MT514 fromJson(final String json) {
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 20U at MT514 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 94T at MT514 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 97D at MT514 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 36D at MT514 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 95D at MT514 are expected at one sequence or across several sequences.
	 * 
     ...
     * @since 9.2.18
     */
    public SequenceB getSequenceCONFDET() {
        return getSequenceB();
    }
	 ...
	 * @since 9.2.18
	 */
	public static SequenceB getSequenceCONFDET(SwiftTagListBlock parentSequence) {
	...
	public SequenceB1 getSequenceB1() {
		...
		return com.prowidesoftware.swift.model.mt.SequenceUtils.resolveMT514GetSequenceB1_sru2026(this);
	}
     ...
     * @since 9.2.18
     */
     public List<SequenceB2> getSequenceCONFPRTYList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceB2> getSequenceCONFPRTYList(final SwiftTagListBlock parentSequence) {
        return getSequenceB2List(parentSequence);
    }
 

	/**
	 * Class to model Sequence "B3" in MT 514.
	 */
	@SequenceStyle(Type.GENERATED_16RS)
     ...
     * @see SequenceB3#getSequenceB3()
     * @return the found sequence or an empty sequence if none is found, <em>never returns null</em>
     * @since 9.2.18
     */
    public SequenceB3 getSequenceFIA() {
    ...
    /**
	 * Same as getSequenceB3 using the sequence delimiter field qualifier
	 * @see SequenceB3#getSequenceB3(SwiftTagListBlock)
	 * @param parentSequence a not null parent sequence to find SequenceB3 within it
	 * @return the found sequence or an empty sequence if none is found, <em>never returns null</em>
	 * @since 9.2.18
	 */
	public static SequenceB3 getSequenceFIA(SwiftTagListBlock parentSequence) {
		return getSequenceB3(parentSequence);
	}
     ...
     * @since 9.2.18
     */
    public SequenceC getSequenceSETDET() {
        return getSequenceC();
    }
	 ...
	 * @since 9.2.18
	 */
	public static SequenceC getSequenceSETDET(SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
     public List<SequenceC1> getSequenceSETPRTYList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceC1> getSequenceSETPRTYList(final SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
     public List<SequenceC2> getSequenceCSHPRTYList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceC2> getSequenceCSHPRTYList(final SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
     public List<SequenceC3> getSequenceAMTList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceC3> getSequenceAMTList(final SwiftTagListBlock parentSequence) {
        return getSequenceC3List(parentSequence);
    }
 

	/**
	 * Class to model Sequence "C4" in MT 514.
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	@NonUniqueSeparator
	...
	public SequenceC4 getSequenceC4() {
		...
		return com.prowidesoftware.swift.model.mt.SequenceUtils.resolveMT514GetSequenceC4_sru2026(this);
	}
     ...
     * @since 9.2.18
     */
     public List<SequenceD> getSequenceOTHRPRTYList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceD> getSequenceOTHRPRTYList(final SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
    public SequenceE getSequenceREPO() {
        return getSequenceE();
    }
	 ...
	 * @since 9.2.18
	 */
	public static SequenceE getSequenceREPO(SwiftTagListBlock parentSequence) {
