...
/**
 * <h1>MT 107 - General Direct Debit Message</h1>
 * <h3>SWIFT MT107 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
<li class="sequence">
...
// end qualifiers constants	
	...
	*/
	...
	public MT107(final int messageType, final String sender, final String receiver) {
		super(107, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT107(int, String, String)", "Use the constructor MT107(sender, receiver) instead.");
	}
