...
public class MT196 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT196.class.getName());
	 ...
	 */
	public MT196(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT196(String)
	 */
	public MT196(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT196 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT196(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "196")) {
	...
	* @since 7.10.3
	*/
	public static MT196 fromJson(final String json) {
