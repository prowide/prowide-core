...
/**
 * <h1>MT 592 - Request for Cancellation</h1>
 * <h3>SWIFT MT592 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT592 content, the parameter can not be <code>null</code>
	 * @see #MT592(String)
	 */
	...
	*/
	...
	public MT592(final int messageType, final String sender, final String receiver) {
		super(592, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT592(int, String, String)", "Use the constructor MT592(sender, receiver) instead.");
	}
