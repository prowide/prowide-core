...
public class MT592 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT592.class.getName());
	 ...
	 */
	public MT592(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT592(String)
	 */
	public MT592(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT592 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT592(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "592")) {
	...
	* @since 7.10.3
	*/
	public static MT592 fromJson(final String json) {
