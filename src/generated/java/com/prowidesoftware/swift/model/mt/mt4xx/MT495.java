...
public class MT495 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT495.class.getName());
	 ...
	 */
	public MT495(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT495(String)
	 */
	public MT495(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT495 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT495(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "495")) {
	...
	* @since 7.10.3
	*/
	public static MT495 fromJson(final String json) {
