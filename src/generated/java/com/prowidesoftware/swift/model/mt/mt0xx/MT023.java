...
public class MT023 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT023.class.getName());
	 ...
	 */
	public MT023(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT023(String)
	 */
	public MT023(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT023 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT023(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "023")) {
	...
	* @since 7.10.3
	*/
	public static MT023 fromJson(final String json) {
