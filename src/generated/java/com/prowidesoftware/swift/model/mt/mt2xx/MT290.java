...
public class MT290 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT290.class.getName());
	 ...
	 */
	public MT290(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT290(String)
	 */
	public MT290(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT290 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT290(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "290")) {
	...
	* @since 7.10.3
	*/
	public static MT290 fromJson(final String json) {
