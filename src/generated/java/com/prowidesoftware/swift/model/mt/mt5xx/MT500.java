...
public class MT500 extends AbstractMT implements Serializable {
	 ...
	 */
	public MT500(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT500(String)
	 */
	public MT500(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT500 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT500(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "500")) {
	...
	* @since 7.10.3
	*/
	public static MT500 fromJson(final String json) {
	 ...
	 * or null if none is found.
	 * The first occurrence of field 97D at MT500 is expected to be the only one.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 36D at MT500 are expected at one sequence or across several sequences.
	 * 
