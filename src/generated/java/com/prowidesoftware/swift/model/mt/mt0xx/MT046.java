...
public class MT046 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT046.class.getName());
	 ...
	 */
	public MT046(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT046(String)
	 */
	public MT046(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT046 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT046(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "046")) {
	...
	* @since 7.10.3
	*/
	public static MT046 fromJson(final String json) {
