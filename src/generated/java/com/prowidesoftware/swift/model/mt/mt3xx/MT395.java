...
public class MT395 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT395.class.getName());
	 ...
	 */
	public MT395(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT395(String)
	 */
	public MT395(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT395 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT395(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "395")) {
	...
	* @since 7.10.3
	*/
	public static MT395 fromJson(final String json) {
