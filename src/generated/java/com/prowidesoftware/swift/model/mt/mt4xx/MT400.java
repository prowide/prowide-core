...
public class MT400 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT400.class.getName());
	 ...
	 */
	public MT400(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT400(String)
	 */
	public MT400(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT400 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT400(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "400")) {
	...
	* @since 7.10.3
	*/
	public static MT400 fromJson(final String json) {
