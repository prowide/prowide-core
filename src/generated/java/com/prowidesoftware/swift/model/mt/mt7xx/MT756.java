...
/**
 * <h1>MT 756 - Advice of Reimbursement or Payment</h1>
 * <h3>SWIFT MT756 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT756 content, the parameter can not be <code>null</code>
	 * @see #MT756(String)
	 */
	...
	*/
	...
	public MT756(final int messageType, final String sender, final String receiver) {
		super(756, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT756(int, String, String)", "Use the constructor MT756(sender, receiver) instead.");
	}
