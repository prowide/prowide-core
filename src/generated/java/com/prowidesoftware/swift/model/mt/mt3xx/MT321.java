...
public class MT321 extends AbstractMT implements Serializable {
	 ...
	 */
	public MT321(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT321(String)
	 */
	public MT321(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT321 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT321(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "321")) {
	...
	* @since 7.10.3
	*/
	public static MT321 fromJson(final String json) {
	 ...
	 * @since 9.2.18
	 */
	public static SequenceB getSequenceLDDET(SwiftTagListBlock parentSequence) {
	 ...
	 * @since 9.2.18
	 */
	public static SequenceB1 getSequenceLDPRTY1(SwiftTagListBlock parentSequence) {
	 ...
	 * @since 9.2.18
	 */
	public static SequenceB2 getSequenceLDPRTY2(SwiftTagListBlock parentSequence) {
	 ...
	 * @since 9.2.18
	 */
	public static SequenceB3 getSequenceOTHRPRTY(SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
     public List<SequenceC> getSequenceSETDETList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceC> getSequenceSETDETList(final SwiftTagListBlock parentSequence) {
