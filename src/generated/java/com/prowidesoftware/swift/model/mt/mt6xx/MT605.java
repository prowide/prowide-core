...
public class MT605 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT605.class.getName());
	 ...
	 */
	public MT605(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT605(String)
	 */
	public MT605(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT605 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT605(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "605")) {
	...
	* @since 7.10.3
	*/
	public static MT605 fromJson(final String json) {
	...
	/**
	 * Class to model Sequence "Loop1" in MT 605.
	 */
	public static class Loop1 extends SwiftTagListBlock {
		...
		/**
		 * Last mandatory tag name of the sequence: <em>"87A", "87B", "87D"  </em>
		 * Array format is for cases when more than one letter options is allowed
		 */
		protected static final String[] END = { "87A", "87B", "87D"   };

		/**
		 * List of optional tags after the last mandatory tag.
		 */
		protected static final String[] TAIL = new String[]{ "88A", "88B", "88D", "72"   };
