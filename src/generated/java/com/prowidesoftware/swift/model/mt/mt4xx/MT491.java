...
public class MT491 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT491.class.getName());
	 ...
	 */
	public MT491(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT491(String)
	 */
	public MT491(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT491 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT491(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "491")) {
	...
	* @since 7.10.3
	*/
	public static MT491 fromJson(final String json) {
