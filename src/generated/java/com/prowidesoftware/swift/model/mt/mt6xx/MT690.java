...
public class MT690 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT690.class.getName());
	 ...
	 */
	public MT690(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT690(String)
	 */
	public MT690(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT690 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT690(m);
	...
	* @since 7.10.3
	*/
	public static MT690 fromJson(final String json) {
