...
public class MT102 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT102.class.getName());
	 ...
	 */
	public MT102(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT102(String)
	 */
	public MT102(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT102 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT102(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "102")) {
	...
	* @since 7.10.3
	*/
	public static MT102 fromJson(final String json) {
