...
public class MT029 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT029.class.getName());
	 ...
	 */
	public MT029(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT029(String)
	 */
	public MT029(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT029 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT029(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "029")) {
	...
	* @since 7.10.3
	*/
	public static MT029 fromJson(final String json) {
	...
	public List<Field106> getField106() {
		final List<Field106> result = new ArrayList<>();
