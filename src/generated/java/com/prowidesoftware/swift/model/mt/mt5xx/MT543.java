...
/**
 * <h1>MT 543 - Deliver Against Payment Instruction</h1>
 * <h3>SWIFT MT543 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
<li class="sequence">
...
// end qualifiers constants	
	...
	*/
	...
	public MT543(final int messageType, final String sender, final String receiver) {
		super(543, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT543(int, String, String)", "Use the constructor MT543(sender, receiver) instead.");
	}
