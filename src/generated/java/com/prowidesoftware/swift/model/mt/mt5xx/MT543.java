...
<li class="fieldset">
Fieldset 95
 (M) (repetitive)<ul><li>FieldsetItem 95 P,Q,R,C,D (M)</li><li>FieldsetItem 95 L,S (O)</li></ul></li><li class="field">Field 97 A,B,D (O)</li>
...
<li class="sequence">
Sequence E4 - Digital Payment Settlement Details (O) (repetitive)<ul><li class="field">Field 16 R (M)</li>
<li class="field">Field 35 B (M)</li>
...
<li class="fieldset">
Fieldset 95
 (M) (repetitive)<ul><li>FieldsetItem 95 C,P,Q,R (M) (repetitive)</li><li>FieldsetItem 95 L,S (O) (repetitive)</li></ul></li><li class="field">Field 97 A,B (O)</li>
<li class="fieldset">
Fieldset 70
...
public class MT543 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT543.class.getName());
	 ...
	 */
	public MT543(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT543(String)
	 */
	public MT543(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT543 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT543(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!Strings.CS.equals(param.getType(), "543")) {
	...
	* @since 7.10.3
	*/
	public static MT543 fromJson(final String json) {
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 99C at MT543 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 20U at MT543 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 20N at MT543 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 36D at MT543 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 97D at MT543 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 94T at MT543 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 95D at MT543 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * @since 9.2.18
	 */
	public static SequenceB getSequenceTRADDET(SwiftTagListBlock parentSequence) {
	 ...
	 * @since 9.2.18
	 */
	public static SequenceC getSequenceFIAC(SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
     public List<SequenceC1> getSequenceBREAKList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceC1> getSequenceBREAKList(final SwiftTagListBlock parentSequence) {
	 ...
	 * @since 9.2.18
	 */
	public static SequenceD getSequenceREPO(SwiftTagListBlock parentSequence) {
	 ...
	 * @since 9.2.18
	 */
	public static SequenceE getSequenceSETDET(SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
     public List<SequenceE1> getSequenceSETPRTYList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceE1> getSequenceSETPRTYList(final SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
     public List<SequenceE2> getSequenceCSHPRTYList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceE2> getSequenceCSHPRTYList(final SwiftTagListBlock parentSequence) {
    ...
    /**
     * Same as getSequenceE3List using the sequence delimiter field qualifier
     * @see SequenceE3#getSequenceE3List()
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public List<SequenceE3> getSequenceAMTList() {
        return getSequenceE3List();
     }
    ...
    /**
     * Same as getSequenceE3List using the sequence delimiter field qualifier
     * @see SequenceE3#getSequenceE3List(SwiftTagListBlock)
     * @param parentSequence a not null parent sequence to find SequenceE3 within it
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
	...
	/**
	 * Class to model Sequence "E4" in MT 543.
	 */
	@SequenceStyle(Type.GENERATED_16RS)
     ...
     * @since 9.2.18
     */
     public List<SequenceE4> getSequenceDIGPAYSETTList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceE4> getSequenceDIGPAYSETTList(final SwiftTagListBlock parentSequence) {
    ...
    /**
     * Same as getSequenceFList using the sequence delimiter field qualifier
     * @see SequenceF#getSequenceFList()
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public List<SequenceF> getSequenceOTHRPRTYList() {
        return getSequenceFList();
     }
    ...
    /**
     * Same as getSequenceFList using the sequence delimiter field qualifier
     * @see SequenceF#getSequenceFList(SwiftTagListBlock)
     * @param parentSequence a not null parent sequence to find SequenceF within it
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public static List<SequenceF> getSequenceOTHRPRTYList(final SwiftTagListBlock parentSequence) {
        return getSequenceFList(parentSequence);
    }
