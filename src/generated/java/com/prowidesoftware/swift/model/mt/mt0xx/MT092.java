...
public class MT092 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT092.class.getName());
	 ...
	 */
	public MT092(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT092(String)
	 */
	public MT092(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT092 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT092(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "092")) {
	...
	* @since 7.10.3
	*/
	public static MT092 fromJson(final String json) {
