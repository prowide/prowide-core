...
public class MT205COV extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT205COV.class.getName());
	 ...
	 */
	public MT205COV(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT205COV(String)
	 */
	public MT205COV(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT205COV parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "205")) {
	...
	* @since 7.10.3
	*/
	public static MT205COV fromJson(final String json) {
