...
public class MT190 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT190.class.getName());
	 ...
	 */
	public MT190(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT190(String)
	 */
	public MT190(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT190 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT190(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "190")) {
	...
	* @since 7.10.3
	*/
	public static MT190 fromJson(final String json) {
