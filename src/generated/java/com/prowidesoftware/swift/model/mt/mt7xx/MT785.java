 ...
 *
 * <p>
 * SWIFT MT785 (ISO 15022) message structure:
 *
 <div class="scheme"><ul>
 ...
 */
@Generated
public class MT785 extends AbstractMT implements Serializable {
	/**
	 * Constant identifying the SRU to which this class belongs to.
	 */
	public static final int SRU = 2026;
	private static final long serialVersionUID = 1L;
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT785.class.getName());
	...
	/**
	 * Creates an MT785 initialized with the parameter SwiftMessage.
	 * @param m swift message with the MT785 content
	 */
	public MT785(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}

	/**
	 * Creates an MT785 initialized with the parameter MtSwiftMessage.
	 * @param m swift message with the MT785 content, the parameter can not be null
	 * @see #MT785(String)
	 */
	public MT785(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT785 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT785(m);
	...
	/**
	 * Creates and initializes a new MT785 input message setting TEST BICS as sender and receiver.
	...
	/**
	 * Creates and initializes a new MT785 input message from sender to receiver.
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.7
	 */
	public MT785(final String sender, final String receiver) {
		super(785, sender, receiver);
	}
	
	/**
	 * Creates a new MT785 by parsing a String with the message content in its swift FIN format.
    ...
    private void sanityCheck(final SwiftMessage param) {
    	if (param.isServiceMessage()) {
			log.warning("Creating an MT785 object from FIN content with a Service Message. Check if the MT785 you are intended to read is prepended with and ACK.");
		} else if (!Strings.CS.equals(param.getType(), "785")) {
			log.warning("Creating an MT785 object from FIN content with message type "+param.getType());
		}
    }
	
	/**
	 * Creates a new MT785 by parsing a String with the message content in its swift FIN format.
	 * If the fin parameter cannot be parsed, the returned MT785 will have its internal message object
	 * initialized (blocks will be created) but empty.
	 * If the string contains multiple messages, only the first one will be parsed. 
	 *
	 * @param fin a string with the MT message in its FIN swift format. <em>fin may be null in which case this method returns null</em>
	 * @return a new instance of MT785 or null if fin is null 
	 * @since 7.7
	 */
	public static MT785 parse(final String fin) {
		if (fin == null) {
			return null;
		}
		return new MT785(fin);
    }
    
    /**
	 * Creates a new MT785 by parsing a input stream with the message content in its swift FIN format, using "UTF-8" as encoding.
	 ...
	 * @since 7.7
	 */
	public MT785(final InputStream stream) throws IOException {
	 ...
	 *
	 * @param stream an input stream in UTF-8 encoding with the MT message in its FIN swift format.
	 * @return a new instance of MT785 or null if stream is null or the message cannot be parsed 
	 * @throws IOException if the stream data cannot be read
	 * @since 7.7
	 */
	public static MT785 parse(final InputStream stream) throws IOException {
		if (stream == null) {
			return null;
		}
		return new MT785(stream);
    }
    
    /**
	 * Creates a new MT785 by parsing a file with the message content in its swift FIN format.
	 ...
	 * @since 7.7
	 */
	public MT785(final File file) throws IOException {
	 ...
	 *
	 * @param file a file with the MT message in its FIN swift format.
	 * @return a new instance of MT785 or null if; file is null, does not exist, can't be read, is not a file or the message cannot be parsed
	 * @throws IOException if the file content cannot be read
	 * @since 7.7
	 */
	public static MT785 parse(final File file) throws IOException {
		if (file == null) {
			return null;
		}
		return new MT785(file);
    }
	 ...
	 */
	@Override
	public MT785 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT785 append(final Tag... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT785 append(final Field... fields) {
		super.append(fields);
		return this;
	}

   /**
	* Creates an MT785 messages from its JSON representation.
	* <p>
	* For generic conversion of JSON into the corresponding MT instance
	* see {@link AbstractMT#fromJson(String)}
	*
	* @param json a JSON representation of an MT785 message
	* @return a new instance of MT785
	* @since 7.10.3
	*/
	public static MT785 fromJson(final String json) {
		return (MT785) AbstractMT.fromJson(json);
	}

	/**
	 * Iterates through block4 fields and return the first one whose name matches 20, 
	 * or null if none is found.
	 * The first occurrence of field 20 at MT785 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 21 at MT785 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 52A at MT785 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 52D at MT785 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 31C at MT785 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 59N at MT785 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 59S at MT785 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 59T at MT785 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 59P at MT785 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 59R at MT785 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 56A at MT785 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 56D at MT785 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 57A at MT785 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 57D at MT785 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 31E at MT785 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 72Z at MT785 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 23X at MT785 is expected to be the only one.
	 * 
	...
	/**
	 * Class to model Sequence "A" in MT 785.
	 */
