...
public class MT696 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT696.class.getName());
	 ...
	 */
	public MT696(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT696(String)
	 */
	public MT696(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT696 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT696(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "696")) {
	...
	* @since 7.10.3
	*/
	public static MT696 fromJson(final String json) {
