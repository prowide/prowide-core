...
/**
 * <h1>MT 696 - Answers</h1>
 * <h3>SWIFT MT696 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	...
	*/
	...
	public MT696(final int messageType, final String sender, final String receiver) {
		super(696, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT696(int, String, String)", "Use the constructor MT696(sender, receiver) instead.");
	}
