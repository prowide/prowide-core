...
public class MT410 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT410.class.getName());
	 ...
	 */
	public MT410(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT410(String)
	 */
	public MT410(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT410 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT410(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "410")) {
	...
	* @since 7.10.3
	*/
	public static MT410 fromJson(final String json) {
	...
	/**
	 * Class to model Sequence "Loop1" in MT 410.
	 */
