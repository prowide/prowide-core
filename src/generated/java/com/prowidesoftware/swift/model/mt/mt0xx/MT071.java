...
public class MT071 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT071.class.getName());
	 ...
	 */
	public MT071(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT071(String)
	 */
	public MT071(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT071 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT071(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "071")) {
	...
	* @since 7.10.3
	*/
	public static MT071 fromJson(final String json) {
	...
	public List<Field102> getField102() {
		final List<Field102> result = new ArrayList<>();
