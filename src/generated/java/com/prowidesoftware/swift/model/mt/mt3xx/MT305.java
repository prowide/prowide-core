...
public class MT305 extends AbstractMT implements Serializable {
	 ...
	 */
	public MT305(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT305(String)
	 */
	public MT305(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT305 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT305(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "305")) {
	...
	* @since 7.10.3
	*/
	public static MT305 fromJson(final String json) {
	 ...
	 * or null if none is found.
	 * The first occurrence of field 35C at MT305 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 53J at MT305 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 56J at MT305 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 57J at MT305 is expected to be the only one.
	 * 
