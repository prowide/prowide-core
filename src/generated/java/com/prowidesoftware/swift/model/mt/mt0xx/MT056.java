...
/**
 * <h1>MT 056 - Logical Terminal History Report</h1>
 * <h3>SWIFT MT056 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT056 content, the parameter can not be <code>null</code>
	 * @see #MT056(String)
	 */
	...
	*/
	...
	public MT056(final int messageType, final String sender, final String receiver) {
		super(56, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT056(int, String, String)", "Use the constructor MT056(sender, receiver) instead.");
	}
	...
	public List<Field270> getField270() {
		...
		for (int i=0; i<tags.length; i++) {
			result.add(new Field270(tags[i].getValue()));
		}
		return result;
	}
