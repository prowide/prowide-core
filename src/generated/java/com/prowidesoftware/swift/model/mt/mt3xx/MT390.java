...
public class MT390 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT390.class.getName());
	 ...
	 */
	public MT390(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT390(String)
	 */
	public MT390(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT390 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT390(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "390")) {
	...
	* @since 7.10.3
	*/
	public static MT390 fromJson(final String json) {
