...
public class MT340 extends AbstractMT implements Serializable {
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!Strings.CS.equals(param.getType(), "340")) {
	...
	*/
	 ...
	 * or null if none is found.
	 * The first occurrence of field 82J at MT340 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 87J at MT340 is expected to be the only one.
	 * 
