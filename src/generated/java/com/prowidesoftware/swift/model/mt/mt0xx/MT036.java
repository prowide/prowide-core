...
public class MT036 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT036.class.getName());
	 ...
	 */
	public MT036(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT036(String)
	 */
	public MT036(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT036 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT036(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "036")) {
	...
	* @since 7.10.3
	*/
	public static MT036 fromJson(final String json) {
