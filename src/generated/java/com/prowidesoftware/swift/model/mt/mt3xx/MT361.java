...
public class MT361 extends AbstractMT implements Serializable {
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!Strings.CS.equals(param.getType(), "361")) {
	...
	*/
	 ...
	 * or null if none is found.
	 * The first occurrence of field 82J at MT361 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 87J at MT361 is expected to be the only one.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 53J at MT361 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 56J at MT361 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 86J at MT361 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 57J at MT361 are expected at one sequence or across several sequences.
	 * 
	...
	public SequenceE1 getSequenceE1() {
		...
		final SequenceE1 result = getSequenceE1(getSequenceE());
		return result != null ? result : new SequenceE1();
	}
	...
	public SequenceF1 getSequenceF1() {
		...
		final SequenceF1 result = getSequenceF1(getSequenceF());
		return result != null ? result : new SequenceF1();
	}
	...
	public SequenceF2 getSequenceF2() {
		...
		final SequenceF2 result = getSequenceF2(getSequenceF());
		return result != null ? result : new SequenceF2();
	}
	...
	public static List<SequenceP1a> getSequenceP1aList(final SwiftTagListBlock parentSequence) {
	    if (parentSequence != null) {
            final List<SwiftTagListBlock> blocks = parentSequence.getSubBlocksDelimitedWithOptionalTail(SequenceP1a.START, SequenceP1a.END, SequenceP1a.TAIL);
            if (blocks != null && !blocks.isEmpty()) {
                final List<SequenceP1a> result = new ArrayList<>(blocks.size());
	...
	public static List<SequenceP1a1> getSequenceP1a1List(final SwiftTagListBlock parentSequence) {
	    if (parentSequence != null) {
            final List<SwiftTagListBlock> blocks = parentSequence.getSubBlocksDelimitedWithOptionalTail(SequenceP1a1.START, SequenceP1a1.END, SequenceP1a1.TAIL);
            if (blocks != null && !blocks.isEmpty()) {
                final List<SequenceP1a1> result = new ArrayList<>(blocks.size());
                for (final SwiftTagListBlock b : blocks) {
