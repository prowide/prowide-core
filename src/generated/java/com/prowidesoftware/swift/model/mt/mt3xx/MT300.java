...
public class MT300 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT300.class.getName());
	 ...
	 */
	public MT300(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT300(String)
	 */
	public MT300(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT300 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT300(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "300")) {
	...
	* @since 7.10.3
	*/
	public static MT300 fromJson(final String json) {
	 ...
	 * or null if none is found.
	 * The first occurrence of field 35C at MT300 is expected to be the only one.
	 * 
