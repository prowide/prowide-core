...
public class MT365 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT365.class.getName());
	 ...
	 */
	public MT365(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT365(String)
	 */
	public MT365(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT365 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT365(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!Strings.CS.equals(param.getType(), "365")) {
	...
	* @since 7.10.3
	*/
	public static MT365 fromJson(final String json) {
	 ...
	 * or null if none is found.
	 * The first occurrence of field 82J at MT365 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 87J at MT365 is expected to be the only one.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 53J at MT365 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 56J at MT365 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 86J at MT365 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 57J at MT365 are expected at one sequence or across several sequences.
	 * 
