...
/**
 * <h1>MT 995 - Queries</h1>
 * <h3>SWIFT MT995 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT995 content, the parameter can not be <code>null</code>
	 * @see #MT995(String)
	 */
	...
	*/
	...
	public MT995(final int messageType, final String sender, final String receiver) {
		super(995, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT995(int, String, String)", "Use the constructor MT995(sender, receiver) instead.");
	}
