...
public class MT042 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT042.class.getName());
	 ...
	 */
	public MT042(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT042(String)
	 */
	public MT042(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT042 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT042(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "042")) {
	...
	* @since 7.10.3
	*/
	public static MT042 fromJson(final String json) {
