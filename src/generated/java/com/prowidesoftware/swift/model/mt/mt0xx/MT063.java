...
public class MT063 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT063.class.getName());
	 ...
	 */
	public MT063(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT063(String)
	 */
	public MT063(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT063 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT063(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "063")) {
	...
	* @since 7.10.3
	*/
	public static MT063 fromJson(final String json) {
