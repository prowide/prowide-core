...
/**
 * <h1>MT 505 - Collateral Substitution</h1>
 * <h3>SWIFT MT505 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
<li class="sequence">
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT505 content, the parameter can not be <code>null</code>
	 * @see #MT505(String)
	 */
	...
	*/
	...
	public MT505(final int messageType, final String sender, final String receiver) {
		super(505, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT505(int, String, String)", "Use the constructor MT505(sender, receiver) instead.");
	}
