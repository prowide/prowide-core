...
public class MT097 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT097.class.getName());
	 ...
	 */
	public MT097(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT097(String)
	 */
	public MT097(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT097 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT097(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "097")) {
	...
	* @since 7.10.3
	*/
	public static MT097 fromJson(final String json) {
