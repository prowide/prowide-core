...
public class MT077 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT077.class.getName());
	 ...
	 */
	public MT077(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT077(String)
	 */
	public MT077(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT077 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT077(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "077")) {
	...
	* @since 7.10.3
	*/
	public static MT077 fromJson(final String json) {
