...
public class MT508 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT508.class.getName());
	 ...
	 */
	public MT508(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT508(String)
	 */
	public MT508(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT508 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT508(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "508")) {
	...
	* @since 7.10.3
	*/
	public static MT508 fromJson(final String json) {
	 ...
	 * or null if none is found.
	 * The first occurrence of field 97D at MT508 is expected to be the only one.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 36D at MT508 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 35B at MT508 are expected at one sequence or across several sequences.
	 * 
     ...
     * @since 9.2.18
     */
    public SequenceB getSequenceINPOSDET() {
        return getSequenceB();
    }
	 ...
	 * @since 9.2.18
	 */
	public static SequenceB getSequenceINPOSDET(SwiftTagListBlock parentSequence) {
