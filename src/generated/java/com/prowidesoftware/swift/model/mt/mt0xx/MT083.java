...
public class MT083 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT083.class.getName());
	 ...
	 */
	public MT083(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT083(String)
	 */
	public MT083(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT083 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT083(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "083")) {
	...
	* @since 7.10.3
	*/
	public static MT083 fromJson(final String json) {
