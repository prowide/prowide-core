...
public class MT490 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT490.class.getName());
	 ...
	 */
	public MT490(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT490(String)
	 */
	public MT490(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT490 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT490(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "490")) {
	...
	* @since 7.10.3
	*/
	public static MT490 fromJson(final String json) {
