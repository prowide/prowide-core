...
<li class="fieldset">
Fieldset 36
 (M) (repetitive)<ul><li>FieldsetItem 36 B,D (M)</li><li>FieldsetItem 36 B,D (M)</li><li>FieldsetItem 36 B,D (M)</li><li>FieldsetItem 36 B,D (O)</li></ul></li><li class="field">Field 16 S (M)</li>
</ul></li>
<li class="sequence">
...
<li class="sequence">
Sequence C2 - Digital Payment Settlement Details (O)<ul><li class="field">Field 16 R (M)</li>
...
<li class="sequence">
Sequence C3 - Confirmation Parties (M) (repetitive)<ul><li class="field">Field 16 R (M)</li>
<li class="fieldset">
Fieldset 95
...
<li class="field">Field 35 B (M)</li>
<li class="sequence">
Sequence C4 - Financial Instrument Attributes (O)<ul><li class="field">Field 16 R (M)</li>
...
Fieldset 36
 (O)<ul><li>FieldsetItem 36 B,D (O)</li><li>FieldsetItem 36 B,D (O)</li><li>FieldsetItem 36 B,D (O)</li></ul></li><li class="field">Field 35 B (O) (repetitive)</li>
...
Fieldset 95
 (M) (repetitive)<ul><li>FieldsetItem 95 P,Q,R (M)</li><li>FieldsetItem 95 L,S (O) (repetitive)</li></ul></li><li class="fieldset">
Fieldset 97
 (O) (repetitive)<ul><li>FieldsetItem 97 A,D,E (O)</li><li>FieldsetItem 97 A,E (O)</li><li>FieldsetItem 97 A,E (O)</li><li>FieldsetItem 97 A,E (O)</li></ul></li><li class="field">Field 98 A,C (O)</li>
<li class="field">Field 20 C (O)</li>
...
public class MT513 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT513.class.getName());
	 ...
	 */
	public MT513(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT513(String)
	 */
	public MT513(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT513 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT513(m);
	...
	* @since 7.10.3
	*/
	public static MT513 fromJson(final String json) {
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 20U at MT513 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 36D at MT513 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 94S at MT513 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 94T at MT513 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 97D at MT513 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 95D at MT513 are expected at one sequence or across several sequences.
	 * 
     ...
     * @since 9.2.18
     */
    public SequenceB getSequenceRCAP() {
        return getSequenceB();
    }
	 ...
	 * @since 9.2.18
	 */
	public static SequenceB getSequenceRCAP(SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
    public SequenceC getSequenceORDRDET() {
        return getSequenceC();
    }
	 ...
	 * @since 9.2.18
	 */
	public static SequenceC getSequenceORDRDET(SwiftTagListBlock parentSequence) {
	...
	public SequenceC2 getSequenceC2() {
		...
		return com.prowidesoftware.swift.model.mt.SequenceUtils.resolveMT513GetSequenceC2_sru2026(this);
	}
    ...
    /**
     * Same as getSequenceC3List using the sequence delimiter field qualifier
     * @see SequenceC3#getSequenceC3List()
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public List<SequenceC3> getSequenceCONFPRTYList() {
        return getSequenceC3List();
     }
    ...
    /**
     * Same as getSequenceC3List using the sequence delimiter field qualifier
     * @see SequenceC3#getSequenceC3List(SwiftTagListBlock)
     * @param parentSequence a not null parent sequence to find SequenceC3 within it
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public static List<SequenceC3> getSequenceCONFPRTYList(final SwiftTagListBlock parentSequence) {
        return getSequenceC3List(parentSequence);
    }
 

	/**
	 * Class to model Sequence "C4" in MT 513.
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public static class SequenceC4 extends SwiftTagListBlock {
		private static final long serialVersionUID = 1L;
		 ...
		 * @see SwiftTagListBlock
		 */
		private SequenceC4(final SwiftTagListBlock content) {
			super(content.getTags());
		}
		 ...
		 */
		@SequenceStyle(Type.GENERATED_16RS)
		public static SequenceC4 newInstance(final Tag... tags) {
			final SequenceC4 result = new SequenceC4();
			result.append(START_TAG);
			if (tags != null && tags.length > 0) {
				for (final Tag t : tags) {
					result.append(t);
		 ...
		 * @since 7.6
		 */
		public static SequenceC4 newInstance() {
			final SequenceC4 result = new SequenceC4();
			result.append(START_TAG);
			result.append(END_TAG);
			return result;
		 ...
		 * @since 7.6
		 */
		public static SequenceC4 newInstance(final SwiftTagListBlock... sequences) {
			final SequenceC4 result = new SequenceC4();
			result.append(START_TAG);
			if (sequences != null && sequences.length > 0) {
				for (final SwiftTagListBlock s : sequences) {
		...
		@SequenceStyle(Type.GENERATED_16RS)
		private SequenceC4(final SwiftMessage m) {
			super();
			if (m.getBlock4() != null) {
				setTags(m.getBlock4().getSubBlock(START_END_16RS).getTags());
			}
	...
	/**
	 * Get the single occurrence of SequenceC4 delimited by 16R/16S the value of SequenceC4#START_END_16RS.
	 * The presence of this method indicates that this sequence can occur only once according to the Standard.
	 * @return the found sequence or an empty sequence if none is found
	...
	public SequenceC4 getSequenceC4() {
		return new SequenceC4(super.getSwiftMessageNotNullOrException());
	}

    /**
     * Same as getSequenceC4 using the sequence delimiter field qualifier
     * @see SequenceC4#getSequenceC4()
     * @return the found sequence or an empty sequence if none is found, <em>never returns null</em>
     * @since 9.2.18
     */
    public SequenceC4 getSequenceFIA() {
        return getSequenceC4();
    }
	 ...
	 * The presence of this method indicates that this sequence can occur only once according to the Standard.
	 * @see SequenceC4#START_END_16RS
	 * @param parentSequence a not null parent sequence to find SequenceC4 within it
	 * @return the found sequence or an empty sequence if none is found, <em>never returns null</em>
	 * @since 7.7
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public static SequenceC4 getSequenceC4(SwiftTagListBlock parentSequence) {
		final SequenceC4 s = new SequenceC4();
		if (parentSequence != null) {
		    s.setTags(parentSequence.getSubBlock(SequenceC4.START_END_16RS).getTags());
		}
		return s;
	}
    ...
    /**
	 * Same as getSequenceC4 using the sequence delimiter field qualifier
	 * @see SequenceC4#getSequenceC4(SwiftTagListBlock)
	 * @param parentSequence a not null parent sequence to find SequenceC4 within it
	 * @return the found sequence or an empty sequence if none is found, <em>never returns null</em>
	 * @since 9.2.18
	 */
	public static SequenceC4 getSequenceFIA(SwiftTagListBlock parentSequence) {
		return getSequenceC4(parentSequence);
	}
	 ...
	 * @since 9.2.18
	 */
	public static SequenceD getSequenceSETDET(SwiftTagListBlock parentSequence) {
	...
	/**
	 * Get the list of SequenceD3 delimited by 16R/16S with value specified in {@link SequenceD3#START_END_16RS}.
	 *
	 * <p>The presence of this method indicates that this sequence can occur more than once according to the Standard.
     * @return the found sequences or an empty list if none is found
    ...
    /**
     * Same as getSequenceD3List using the sequence delimiter field qualifier
     * @see SequenceD3#getSequenceD3List()
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
	 ...
	 * <p>The presence of this method indicates that this sequence can occur more than once according to the Standard.
	 * @see SequenceD3#START_END_16RS
	 * @param parentSequence a not null parent sequence to find SequenceD3 within it
	 * @return the found sequences or an empty list if none is found or parent sequence is null
	 * @since 7.7
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public static List<SequenceD3> getSequenceD3List(final SwiftTagListBlock parentSequence) {
	    if (parentSequence != null) {
            ...
            if (blocks != null && !blocks.isEmpty()) {
                final List<SequenceD3> result = new ArrayList<>(blocks.size());
                for (final SwiftTagListBlock b : blocks) {
    ...
    /**
     * Same as getSequenceD3List using the sequence delimiter field qualifier
     * @see SequenceD3#getSequenceD3List(SwiftTagListBlock)
     * @param parentSequence a not null parent sequence to find SequenceD3 within it
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
	...
	/**
	 * Class to model Sequence "D4" in MT 513.
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	@NonUniqueSeparator
	...
	public SequenceD4 getSequenceD4() {
		...
		return com.prowidesoftware.swift.model.mt.SequenceUtils.resolveMT513GetSequenceD4_sru2026(this);
	}
	 ...
	 * @since 9.2.18
	 */
	public static SequenceF getSequenceREPO(SwiftTagListBlock parentSequence) {
