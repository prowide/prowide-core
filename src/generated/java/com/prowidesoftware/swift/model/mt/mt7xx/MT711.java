...
public class MT711 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT711.class.getName());
	 ...
	 */
	public MT711(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT711(String)
	 */
	public MT711(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT711 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT711(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "711")) {
	...
	* @since 7.10.3
	*/
	public static MT711 fromJson(final String json) {
