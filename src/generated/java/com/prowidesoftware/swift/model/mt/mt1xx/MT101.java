...
public class MT101 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT101.class.getName());
	 ...
	 */
	public MT101(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT101(String)
	 */
	public MT101(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT101 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT101(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "101")) {
	...
	* @since 7.10.3
	*/
	public static MT101 fromJson(final String json) {
