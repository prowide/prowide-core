...
/**
 * <h1>MT 578 - Settlement Allegement</h1>
 * <h3>SWIFT MT578 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
<li class="sequence">
...
// end qualifiers constants	
	...
	*/
	...
	public MT578(final int messageType, final String sender, final String receiver) {
		super(578, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT578(int, String, String)", "Use the constructor MT578(sender, receiver) instead.");
	}
