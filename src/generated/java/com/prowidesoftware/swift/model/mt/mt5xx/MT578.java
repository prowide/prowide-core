...
public class MT578 extends AbstractMT implements Serializable {
	 ...
	 */
	public MT578(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT578(String)
	 */
	public MT578(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT578 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT578(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "578")) {
	...
	* @since 7.10.3
	*/
	public static MT578 fromJson(final String json) {
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 20U at MT578 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 36D at MT578 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 97D at MT578 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 94T at MT578 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 95D at MT578 are expected at one sequence or across several sequences.
	 * 
     ...
     * @since 9.2.18
     */
     public List<SequenceF> getSequenceADDINFOList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceF> getSequenceADDINFOList(final SwiftTagListBlock parentSequence) {
