...
public class MT019 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT019.class.getName());
	 ...
	 */
	public MT019(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT019(String)
	 */
	public MT019(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT019 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT019(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "019")) {
	...
	* @since 7.10.3
	*/
	public static MT019 fromJson(final String json) {
