...
public class MT202 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT202.class.getName());
	 ...
	 */
	public MT202(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT202(String)
	 */
	public MT202(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT202 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT202(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!Strings.CS.equals(param.getType(), "202")) {
	...
	* @since 7.10.3
	*/
	public static MT202 fromJson(final String json) {
