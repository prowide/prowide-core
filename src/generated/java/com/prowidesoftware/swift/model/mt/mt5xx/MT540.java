...
/**
 * <h1>MT 540 - Receive Free</h1>
 * <h3>SWIFT MT540 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
<li class="sequence">
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT540 content, the parameter can not be <code>null</code>
	 * @see #MT540(String)
	 */
	...
	*/
	...
	public MT540(final int messageType, final String sender, final String receiver) {
		super(540, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT540(int, String, String)", "Use the constructor MT540(sender, receiver) instead.");
	}
