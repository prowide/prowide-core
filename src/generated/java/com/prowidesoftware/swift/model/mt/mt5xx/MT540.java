...
Fieldset 97
 (O)<ul><li>FieldsetItem 97 A,D,E (O)</li></ul></li><li class="fieldset">
Fieldset 70
...
public class MT540 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT540.class.getName());
	 ...
	 */
	public MT540(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT540(String)
	 */
	public MT540(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT540 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT540(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!Strings.CS.equals(param.getType(), "540")) {
	...
	* @since 7.10.3
	*/
	public static MT540 fromJson(final String json) {
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 20U at MT540 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 20N at MT540 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 36D at MT540 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 97D at MT540 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 94T at MT540 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 95D at MT540 are expected at one sequence or across several sequences.
	 * 
	...
	/**
	 * Class to model Sequence "E4" in MT 540.
	 */
	@SequenceStyle(Type.GENERATED_16RS)
