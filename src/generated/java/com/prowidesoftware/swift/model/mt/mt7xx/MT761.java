...
/**
 * <strong>MT 761 - Issue of a Demand Guarantee / Standby Letter of Credit</strong>
 *
 * <p>
...
public class MT761 extends AbstractMT implements Serializable {
	...
	*/
	...
	/**
	 * Creates and initializes a new MT761 input message setting TEST BICS as sender and receiver.<br>
	...
	/**
	 * Creates and initializes a new MT761 input message from sender to receiver.<br>
	 * All mandatory header attributes are completed with default values. 
	...
	/**
	 * Creates a new MT761 by parsing a String with the message content in its swift FIN format.<br>
    ...
    /**
	 * Creates a new MT761 by parsing a input stream with the message content in its swift FIN format, using "UTF-8" as encoding.<br>
    ...
    /**
	 * Creates a new MT761 by parsing a file with the message content in its swift FIN format.<br>
	 ...
	 * @since 7.10.3
	 */
	public final static MT761 fromJson(String json) {
