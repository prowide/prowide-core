...
/**
 * <h1>MT 535 - Statement of Holdings</h1>
 * <h3>SWIFT MT535 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
<li class="sequence">
...
// end qualifiers constants	
	...
	*/
	...
	public MT535(final int messageType, final String sender, final String receiver) {
		super(535, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT535(int, String, String)", "Use the constructor MT535(sender, receiver) instead.");
	}
...
// BaseSequenceCodeGenerator [seq=B1b1]
	...
	*/
	...
	public List<SequenceB1b1> getSequenceB1b1List() {
		...
		*/
		...
		return com.prowidesoftware.swift.model.mt.SequenceUtils.resolveMT535GetSequenceB1b1List_sru2017(this);
	}
	/**
	* Get the list of SequenceB1b1 delimited by 16R/16S with value specified in SequenceB1b1#START_END_16RS 
	* The presence of this methods indicates that this sequence can occur more than once according to the Standard.
	...
	*/
	...
	public static List<SequenceB1b1> getSequenceB1b1List(final SwiftTagListBlock parentSequence) {
		...
		*
		*/
		return com.prowidesoftware.swift.model.mt.SequenceUtils.resolveMT535GetSequenceB1b1List_sru2017(new MT535().append(parentSequence));
...
// BaseSequenceCodeGenerator [seq=B1c]
	...
	*/
	...
	public List<SequenceB1c> getSequenceB1cList() {
		...
		*/
		...
		return com.prowidesoftware.swift.model.mt.SequenceUtils.resolveMT535GetSequenceB1cList_sru2017(this);
	}
	/**
	* Get the list of SequenceB1c delimited by 16R/16S with value specified in SequenceB1c#START_END_16RS 
	* The presence of this methods indicates that this sequence can occur more than once according to the Standard.
	...
	*/
	...
	public static List<SequenceB1c> getSequenceB1cList(final SwiftTagListBlock parentSequence) {
		...
		*
		*/
		return com.prowidesoftware.swift.model.mt.SequenceUtils.resolveMT535GetSequenceB1cList_sru2017(new MT535().append(parentSequence));
