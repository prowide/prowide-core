...
<li class="fieldset">
Fieldset 93
 (M) (repetitive)<ul><li>FieldsetItem 93 B,F (M) (repetitive)</li><li>FieldsetItem 93 B,F (O)</li><li>FieldsetItem 93 B,F (O)</li></ul></li><li class="sequence">
...
public class MT535 extends AbstractMT implements Serializable {
	 ...
	 */
	public MT535(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT535(String)
	 */
	public MT535(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT535 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT535(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!Strings.CS.equals(param.getType(), "535")) {
	...
	* @since 7.10.3
	*/
	public static MT535 fromJson(final String json) {
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 97D at MT535 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 36D at MT535 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 93F at MT535 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 93E at MT535 are expected at one sequence or across several sequences.
	 * 
     ...
     * @since 9.2.18
     */
     public List<SequenceB1a> getSequenceFIAList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceB1a> getSequenceFIAList(final SwiftTagListBlock parentSequence) {
    ...
    /**
     * Same as getSequenceB1bList using the sequence delimiter field qualifier
     * @see SequenceB1b#getSequenceB1bList()
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public List<SequenceB1b> getSequenceSUBBALList() {
        return getSequenceB1bList();
     }
    ...
    /**
     * Same as getSequenceB1bList using the sequence delimiter field qualifier
     * @see SequenceB1b#getSequenceB1bList(SwiftTagListBlock)
     * @param parentSequence a not null parent sequence to find SequenceB1b within it
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public static List<SequenceB1b> getSequenceSUBBALList(final SwiftTagListBlock parentSequence) {
        return getSequenceB1bList(parentSequence);
    }
	...
	public List<SequenceB1b1> getSequenceB1b1List() {
		/*
		 * The delimiter BREAK is not unique across all sequences, so the sequences are resolved
		 * within every occurrence of their parent SequenceB1b instead of over the whole block 4
		 */
		if (this.getSwiftMessage() == null) {
			return null;
		}
		final List<SequenceB1b1> result = new ArrayList<>();
		for (final SequenceB1b parent : getSequenceB1bList()) {
			result.addAll(getSequenceB1b1List(parent));
		}
		return result;
	}
	...
	public List<SequenceB1c> getSequenceB1cList() {
		/*
		 * The delimiter BREAK is not unique across all sequences, so the sequences are resolved
		 * within every occurrence of their parent SequenceB1 instead of over the whole block 4
		 */
		if (this.getSwiftMessage() == null) {
			return null;
		}
		final List<SequenceB1c> result = new ArrayList<>();
		for (final SequenceB1 parent : getSequenceB1List()) {
			result.addAll(getSequenceB1cList(parent));
		}
		return result;
	}
