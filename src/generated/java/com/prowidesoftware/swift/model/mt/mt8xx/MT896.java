...
public class MT896 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT896.class.getName());
	 ...
	 */
	public MT896(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT896(String)
	 */
	public MT896(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT896 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT896(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "896")) {
	...
	* @since 7.10.3
	*/
	public static MT896 fromJson(final String json) {
