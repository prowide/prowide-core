...
public class MT064 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT064.class.getName());
	 ...
	 */
	public MT064(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT064(String)
	 */
	public MT064(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT064 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT064(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "064")) {
	...
	* @since 7.10.3
	*/
	public static MT064 fromJson(final String json) {
