...
/**
 * <h1>MT 900 - Confirmation of Debit</h1>
 * <h3>SWIFT MT900 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT900 content, the parameter can not be <code>null</code>
	 * @see #MT900(String)
	 */
	...
	*/
	...
	public MT900(final int messageType, final String sender, final String receiver) {
		super(900, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT900(int, String, String)", "Use the constructor MT900(sender, receiver) instead.");
	}
