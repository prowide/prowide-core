...
public class MT900 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT900.class.getName());
	 ...
	 */
	public MT900(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT900(String)
	 */
	public MT900(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT900 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT900(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "900")) {
	...
	* @since 7.10.3
	*/
	public static MT900 fromJson(final String json) {
