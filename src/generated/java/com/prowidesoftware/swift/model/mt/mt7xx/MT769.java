...
/**
 * <h1>MT 769 - Advice of Reduction or Release</h1>
 * <h3>SWIFT MT769 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT769 content, the parameter can not be <code>null</code>
	 * @see #MT769(String)
	 */
	...
	*/
	...
	public MT769(final int messageType, final String sender, final String receiver) {
		super(769, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT769(int, String, String)", "Use the constructor MT769(sender, receiver) instead.");
	}
