...
public class MT769 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT769.class.getName());
	 ...
	 */
	public MT769(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT769(String)
	 */
	public MT769(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT769 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT769(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "769")) {
	...
	* @since 7.10.3
	*/
	public static MT769 fromJson(final String json) {
