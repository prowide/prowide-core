...
/**
 * <h1>MT 503 - Collateral Claim</h1>
 * <h3>SWIFT MT503 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
<li class="sequence">
...
// begin qualifiers constants	
	...
	* @deprecated use instead com.prowidesoftware.swift.SchemeConstantsC.CRET
	* @see com.prowidesoftware.swift.SchemeConstantsC#CRET
	*/
	@Deprecated
	@com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2018)
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT503 content, the parameter can not be <code>null</code>
	 * @see #MT503(String)
	 */
	...
	*/
	...
	public MT503(final int messageType, final String sender, final String receiver) {
		super(503, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT503(int, String, String)", "Use the constructor MT503(sender, receiver) instead.");
	}
