...
public class MT503 extends AbstractMT implements Serializable {
	 ...
	 */
	public MT503(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT503(String)
	 */
	public MT503(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT503 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT503(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "503")) {
	...
	* @since 7.10.3
	*/
	public static MT503 fromJson(final String json) {
