...
/**
 * <h1>MT 499 - Free Format Message</h1>
 * <h3>SWIFT MT499 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT499 content, the parameter can not be <code>null</code>
	 * @see #MT499(String)
	 */
	...
	*/
	...
	public MT499(final int messageType, final String sender, final String receiver) {
		super(499, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT499(int, String, String)", "Use the constructor MT499(sender, receiver) instead.");
	}
