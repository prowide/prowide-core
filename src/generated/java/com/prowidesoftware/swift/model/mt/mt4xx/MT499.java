...
public class MT499 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT499.class.getName());
	 ...
	 */
	public MT499(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT499(String)
	 */
	public MT499(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT499 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT499(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "499")) {
	...
	* @since 7.10.3
	*/
	public static MT499 fromJson(final String json) {
