...
/**
 * <h1>MT 510 - Registration Status and Processing Advice</h1>
 * <h3>SWIFT MT510 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
<li class="sequence">
...
// begin qualifiers constants	
	...
	* @deprecated use instead com.prowidesoftware.swift.SchemeConstantsQ.QREG
	* @see com.prowidesoftware.swift.SchemeConstantsQ#QREG
	*/
	@Deprecated
	@com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2018)
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT510 content, the parameter can not be <code>null</code>
	 * @see #MT510(String)
	 */
	...
	*/
	...
	public MT510(final int messageType, final String sender, final String receiver) {
		super(510, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT510(int, String, String)", "Use the constructor MT510(sender, receiver) instead.");
	}
