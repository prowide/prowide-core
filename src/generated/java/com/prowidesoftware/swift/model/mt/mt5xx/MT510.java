...
public class MT510 extends AbstractMT implements Serializable {
	 ...
	 */
	public MT510(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT510(String)
	 */
	public MT510(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT510 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT510(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "510")) {
	...
	* @since 7.10.3
	*/
	public static MT510 fromJson(final String json) {
