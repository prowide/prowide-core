...
public class MT972 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT972.class.getName());
	 ...
	 */
	public MT972(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT972(String)
	 */
	public MT972(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT972 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT972(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "972")) {
	...
	* @since 7.10.3
	*/
	public static MT972 fromJson(final String json) {
