...
/**
 * <h1>MT 972 - Netting Interim Statement</h1>
 * <h3>SWIFT MT972 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT972 content, the parameter can not be <code>null</code>
	 * @see #MT972(String)
	 */
	...
	*/
	...
	public MT972(final int messageType, final String sender, final String receiver) {
		super(972, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT972(int, String, String)", "Use the constructor MT972(sender, receiver) instead.");
	}
