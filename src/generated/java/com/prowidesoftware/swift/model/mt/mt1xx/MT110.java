...
/**
 * <h1>MT 110 - Advice of Cheque(s)</h1>
 * <h3>SWIFT MT110 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT110 content, the parameter can not be <code>null</code>
	 * @see #MT110(String)
	 */
	...
	*/
	...
	public MT110(final int messageType, final String sender, final String receiver) {
		super(110, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT110(int, String, String)", "Use the constructor MT110(sender, receiver) instead.");
	}
