...
/**
 * <h1>MT 541 - Receive Against Payment Instruction</h1>
 * <h3>SWIFT MT541 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
<li class="sequence">
...
// end qualifiers constants	
	...
	*/
	...
	public MT541(final int messageType, final String sender, final String receiver) {
		super(541, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT541(int, String, String)", "Use the constructor MT541(sender, receiver) instead.");
	}
