...
public class MT195 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT195.class.getName());
	 ...
	 */
	public MT195(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT195(String)
	 */
	public MT195(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT195 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT195(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "195")) {
	...
	* @since 7.10.3
	*/
	public static MT195 fromJson(final String json) {
