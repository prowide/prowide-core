...
public class MT740 extends AbstractMT implements Serializable {
	 ...
	 */
	public MT740(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT740(String)
	 */
	public MT740(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT740 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT740(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!Strings.CS.equals(param.getType(), "740")) {
	...
	* @since 7.10.3
	*/
	public static MT740 fromJson(final String json) {
	 ...
	 * or null if none is found.
	 * The first occurrence of field 59N at MT740 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 59S at MT740 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 59T at MT740 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 59P at MT740 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 59R at MT740 is expected to be the only one.
	 * 
	...
	/**
	 * Class to model Sequence "A" in MT 740.
	 */
