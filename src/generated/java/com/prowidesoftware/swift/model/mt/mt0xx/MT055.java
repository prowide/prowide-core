...
/**
 * <h1>MT 055 - Delivery Instructions Report</h1>
 * <h3>SWIFT MT055 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT055 content, the parameter can not be <code>null</code>
	 * @see #MT055(String)
	 */
	...
	*/
	...
	public MT055(final int messageType, final String sender, final String receiver) {
		super(55, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT055(int, String, String)", "Use the constructor MT055(sender, receiver) instead.");
	}
