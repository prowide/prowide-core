...
public class MT055 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT055.class.getName());
	 ...
	 */
	public MT055(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT055(String)
	 */
	public MT055(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT055 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT055(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "055")) {
	...
	* @since 7.10.3
	*/
	public static MT055 fromJson(final String json) {
