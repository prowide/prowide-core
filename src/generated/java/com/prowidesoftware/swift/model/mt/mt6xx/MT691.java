...
public class MT691 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT691.class.getName());
	 ...
	 */
	public MT691(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT691(String)
	 */
	public MT691(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT691 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT691(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "691")) {
	...
	* @since 7.10.3
	*/
	public static MT691 fromJson(final String json) {
