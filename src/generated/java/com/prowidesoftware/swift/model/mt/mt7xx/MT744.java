...
public class MT744 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT744.class.getName());
	 ...
	 */
	public MT744(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT744(String)
	 */
	public MT744(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT744 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT744(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "744")) {
	...
	* @since 7.10.3
	*/
	public static MT744 fromJson(final String json) {
