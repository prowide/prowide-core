...
public class MT701 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT701.class.getName());
	 ...
	 */
	public MT701(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT701(String)
	 */
	public MT701(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT701 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT701(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "701")) {
	...
	* @since 7.10.3
	*/
	public static MT701 fromJson(final String json) {
