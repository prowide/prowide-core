...
public class MT037 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT037.class.getName());
	 ...
	 */
	public MT037(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT037(String)
	 */
	public MT037(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT037 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT037(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "037")) {
	...
	* @since 7.10.3
	*/
	public static MT037 fromJson(final String json) {
