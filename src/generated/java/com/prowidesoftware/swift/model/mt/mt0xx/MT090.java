...
/**
 * <h1>MT 090 - User-to-SWIFT Message</h1>
 * <h3>SWIFT MT090 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT090 content, the parameter can not be <code>null</code>
	 * @see #MT090(String)
	 */
	...
	*/
	...
	public MT090(final int messageType, final String sender, final String receiver) {
		super(90, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT090(int, String, String)", "Use the constructor MT090(sender, receiver) instead.");
	}
