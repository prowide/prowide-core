...
public class MT027 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT027.class.getName());
	 ...
	 */
	public MT027(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT027(String)
	 */
	public MT027(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT027 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT027(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "027")) {
	...
	* @since 7.10.3
	*/
	public static MT027 fromJson(final String json) {
