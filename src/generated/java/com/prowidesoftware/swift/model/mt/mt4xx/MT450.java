...
public class MT450 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT450.class.getName());
	 ...
	 */
	public MT450(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT450(String)
	 */
	public MT450(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT450 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT450(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "450")) {
	...
	* @since 7.10.3
	*/
	public static MT450 fromJson(final String json) {
	...
	/**
	 * Class to model Sequence "Loop1" in MT 450.
	 */
