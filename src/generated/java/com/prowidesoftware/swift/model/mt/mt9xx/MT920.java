...
public class MT920 extends AbstractMT implements Serializable {
	 ...
	 */
	public MT920(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT920(String)
	 */
	public MT920(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT920 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT920(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "920")) {
	...
	* @since 7.10.3
	*/
	public static MT920 fromJson(final String json) {
