...
/**
 * <h1>MT 455 - Cash Letter Credit Adjustment Advice</h1>
 * <h3>SWIFT MT455 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	...
	*/
	...
	public MT455(final int messageType, final String sender, final String receiver) {
		super(455, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT455(int, String, String)", "Use the constructor MT455(sender, receiver) instead.");
	}
