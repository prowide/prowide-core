...
public class MT455 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT455.class.getName());
	 ...
	 */
	public MT455(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT455(String)
	 */
	public MT455(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT455 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT455(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "455")) {
	...
	* @since 7.10.3
	*/
	public static MT455 fromJson(final String json) {
