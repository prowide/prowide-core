...
public class MT986 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT986.class.getName());
	 ...
	 */
	public MT986(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT986(String)
	 */
	public MT986(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT986 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT986(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "986")) {
	...
	* @since 7.10.3
	*/
	public static MT986 fromJson(final String json) {
