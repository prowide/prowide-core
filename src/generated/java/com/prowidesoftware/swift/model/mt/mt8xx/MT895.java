...
public class MT895 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT895.class.getName());
	 ...
	 */
	public MT895(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT895(String)
	 */
	public MT895(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT895 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT895(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "895")) {
	...
	* @since 7.10.3
	*/
	public static MT895 fromJson(final String json) {
