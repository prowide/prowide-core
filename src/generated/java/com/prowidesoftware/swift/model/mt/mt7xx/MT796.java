...
public class MT796 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT796.class.getName());
	 ...
	 */
	public MT796(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT796(String)
	 */
	public MT796(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT796 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT796(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "796")) {
	...
	* @since 7.10.3
	*/
	public static MT796 fromJson(final String json) {
