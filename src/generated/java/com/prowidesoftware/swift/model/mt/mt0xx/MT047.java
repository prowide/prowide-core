...
public class MT047 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT047.class.getName());
	 ...
	 */
	public MT047(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT047(String)
	 */
	public MT047(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT047 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT047(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "047")) {
	...
	* @since 7.10.3
	*/
	public static MT047 fromJson(final String json) {
