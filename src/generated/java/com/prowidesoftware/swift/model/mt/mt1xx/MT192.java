...
public class MT192 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT192.class.getName());
	 ...
	 */
	public MT192(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT192(String)
	 */
	public MT192(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT192 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT192(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "192")) {
	...
	* @since 7.10.3
	*/
	public static MT192 fromJson(final String json) {
