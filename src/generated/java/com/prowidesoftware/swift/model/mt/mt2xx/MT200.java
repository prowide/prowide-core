...
public class MT200 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT200.class.getName());
	 ...
	 */
	public MT200(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT200(String)
	 */
	public MT200(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT200 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT200(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "200")) {
	...
	* @since 7.10.3
	*/
	public static MT200 fromJson(final String json) {
