...
public class MT799 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT799.class.getName());
	 ...
	 */
	public MT799(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT799(String)
	 */
	public MT799(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT799 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT799(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "799")) {
	...
	* @since 7.10.3
	*/
	public static MT799 fromJson(final String json) {
