...
public class MT035 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT035.class.getName());
	 ...
	 */
	public MT035(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT035(String)
	 */
	public MT035(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT035 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT035(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "035")) {
	...
	* @since 7.10.3
	*/
	public static MT035 fromJson(final String json) {
