...
public class MT021 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT021.class.getName());
	 ...
	 */
	public MT021(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT021(String)
	 */
	public MT021(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT021 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT021(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "021")) {
	...
	* @since 7.10.3
	*/
	public static MT021 fromJson(final String json) {
