...
public class MT112 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT112.class.getName());
	 ...
	 */
	public MT112(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT112(String)
	 */
	public MT112(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT112 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT112(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "112")) {
	...
	* @since 7.10.3
	*/
	public static MT112 fromJson(final String json) {
