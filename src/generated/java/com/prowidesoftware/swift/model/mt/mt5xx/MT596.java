...
public class MT596 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT596.class.getName());
	 ...
	 */
	public MT596(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT596(String)
	 */
	public MT596(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT596 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT596(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "596")) {
	...
	* @since 7.10.3
	*/
	public static MT596 fromJson(final String json) {
