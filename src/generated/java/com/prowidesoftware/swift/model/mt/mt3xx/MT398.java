...
public class MT398 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT398.class.getName());
	 ...
	 */
	public MT398(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT398(String)
	 */
	public MT398(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT398 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT398(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "398")) {
	...
	* @since 7.10.3
	*/
	public static MT398 fromJson(final String json) {
