...
public class MT420 extends AbstractMT implements Serializable {
	 ...
	 */
	public MT420(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT420(String)
	 */
	public MT420(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT420 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT420(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "420")) {
	...
	* @since 7.10.3
	*/
	public static MT420 fromJson(final String json) {
