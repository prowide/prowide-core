...
/**
 * <h1>MT 568 - Corporate Action Narrative</h1>
 * <h3>SWIFT MT568 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
<li class="sequence">
...
// end qualifiers constants	
	...
	*/
	...
	public MT568(final int messageType, final String sender, final String receiver) {
		super(568, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT568(int, String, String)", "Use the constructor MT568(sender, receiver) instead.");
	}
