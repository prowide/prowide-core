...
public class MT568 extends AbstractMT implements Serializable {
	 ...
	 */
	public MT568(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT568(String)
	 */
	public MT568(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT568 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT568(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "568")) {
	...
	* @since 7.10.3
	*/
	public static MT568 fromJson(final String json) {
	 ...
	 * or null if none is found.
	 * The first occurrence of field 98E at MT568 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 94T at MT568 is expected to be the only one.
	 * 
	...
	public List<Field70F> getField70F() {
		final List<Field70F> result = new ArrayList<>();
