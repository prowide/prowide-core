...
public class MT350 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT350.class.getName());
	 ...
	 */
	public MT350(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT350(String)
	 */
	public MT350(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT350 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT350(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "350")) {
	...
	* @since 7.10.3
	*/
	public static MT350 fromJson(final String json) {
