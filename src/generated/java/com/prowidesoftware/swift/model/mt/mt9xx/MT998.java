...
public class MT998 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT998.class.getName());
	 ...
	 */
	public MT998(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT998(String)
	 */
	public MT998(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT998 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT998(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "998")) {
	...
	* @since 7.10.3
	*/
	public static MT998 fromJson(final String json) {
