...
public class MT752 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT752.class.getName());
	 ...
	 */
	public MT752(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT752(String)
	 */
	public MT752(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT752 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT752(m);
	...
	* @since 7.10.3
	*/
	public static MT752 fromJson(final String json) {
