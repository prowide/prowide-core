...
/**
 * <h1>MT 022 - Retrieval Request (History)</h1>
 * <h3>SWIFT MT022 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT022 content, the parameter can not be <code>null</code>
	 * @see #MT022(String)
	 */
	...
	*/
	...
	public MT022(final int messageType, final String sender, final String receiver) {
		super(22, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT022(int, String, String)", "Use the constructor MT022(sender, receiver) instead.");
	}
	 ...
	 * 
	 * @return a Field253 object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	 ...
	 * 
	 * @return a Field263 object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	 ...
	 * 
	 * @return a Field264 object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
