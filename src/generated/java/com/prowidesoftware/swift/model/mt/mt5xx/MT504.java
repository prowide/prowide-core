...
public class MT504 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT504.class.getName());
	 ...
	 */
	public MT504(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT504(String)
	 */
	public MT504(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT504 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT504(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "504")) {
	...
	* @since 7.10.3
	*/
	public static MT504 fromJson(final String json) {
     ...
     * @since 9.2.18
     */
     public List<SequenceA1> getSequenceListAGRE() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceA1> getSequenceListAGRE(final SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
     public List<SequenceA2> getSequenceListLINK() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceA2> getSequenceListLINK(final SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
    public SequenceB getSequenceSUMM() {
        return getSequenceB();
    }
	 ...
	 * @since 9.2.18
	 */
	public static SequenceB getSequenceSUMM(SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
    public SequenceB1 getSequenceSUMD() {
	 ...
	 * @since 9.2.18
	 */
	public static SequenceB1 getSequenceSUMD(SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
     public List<SequenceC> getSequenceListCOLD() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceC> getSequenceListCOLD(final SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
     public List<SequenceC1> getSequenceListSCOL() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceC1> getSequenceListSCOL(final SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
     public List<SequenceC1a> getSequenceListSETDET() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceC1a> getSequenceListSETDET(final SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
     public List<SequenceC1a1> getSequenceListSETPRTY() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceC1a1> getSequenceListSETPRTY(final SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
     public List<SequenceC2> getSequenceListCCOL() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceC2> getSequenceListCCOL(final SwiftTagListBlock parentSequence) {
    ...
    /**
     * Same as getSequenceC2aList using the sequence delimiter field qualifier
     * @see SequenceC2a#getSequenceC2aList()
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public List<SequenceC2a> getSequenceListCASHSET() {
        return getSequenceC2aList();
     }
    ...
    /**
     * Same as getSequenceC2aList using the sequence delimiter field qualifier
     * @see SequenceC2a#getSequenceC2aList(SwiftTagListBlock)
     * @param parentSequence a not null parent sequence to find SequenceC2a within it
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public static List<SequenceC2a> getSequenceListCASHSET(final SwiftTagListBlock parentSequence) {
        return getSequenceC2aList(parentSequence);
    }
	...
	/**
	 * Get the list of SequenceC2a1 delimited by 16R/16S with value specified in {@link SequenceC2a1#START_END_16RS}.
	 *
	 * <p>The presence of this method indicates that this sequence can occur more than once according to the Standard.
     * @return the found sequences or an empty list if none is found
    ...
    /**
     * Same as getSequenceC2a1List using the sequence delimiter field qualifier
     * @see SequenceC2a1#getSequenceC2a1List()
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public List<SequenceC2a1> getSequenceListCSHPRTY() {
        return getSequenceC2a1List();
     }
	 ...
	 * <p>The presence of this method indicates that this sequence can occur more than once according to the Standard.
	 * @see SequenceC2a1#START_END_16RS
	 * @param parentSequence a not null parent sequence to find SequenceC2a1 within it
	 * @return the found sequences or an empty list if none is found or parent sequence is null
	 * @since 7.7
	 */
	@SequenceStyle(Type.GENERATED_16RS)
    ...
    /**
     * Same as getSequenceC2a1List using the sequence delimiter field qualifier
     * @see SequenceC2a1#getSequenceC2a1List(SwiftTagListBlock)
     * @param parentSequence a not null parent sequence to find SequenceC2a1 within it
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public static List<SequenceC2a1> getSequenceListCSHPRTY(final SwiftTagListBlock parentSequence) {
        return getSequenceC2a1List(parentSequence);
    }
     ...
     * @since 9.2.18
     */
     public List<SequenceC3> getSequenceListBCOL() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceC3> getSequenceListBCOL(final SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
    public SequenceD getSequenceSETDET1() {
        return getSequenceD();
    }
	 ...
	 * @since 9.2.18
	 */
	public static SequenceD getSequenceSETDET1(SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
     public List<SequenceD1> getSequenceListSETPRTY1() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceD1> getSequenceListSETPRTY1(final SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
    public SequenceE getSequenceCASHSET1() {
        return getSequenceE();
    }
	 ...
	 * @since 9.2.18
	 */
	public static SequenceE getSequenceCASHSET1(SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
     public List<SequenceE1> getSequenceListCSHPRTY1() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceE1> getSequenceListCSHPRTY1(final SwiftTagListBlock parentSequence) {
