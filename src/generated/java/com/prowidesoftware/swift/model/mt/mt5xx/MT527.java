...
<li class="fieldset">
Fieldset 95
 (M) (repetitive)<ul><li>FieldsetItem 95 P,Q,R (M)</li><li>FieldsetItem 95 P,Q,R (O)</li><li>FieldsetItem 95 L (O)</li><li>FieldsetItem 95 L (O)</li></ul></li><li class="field">Field 97 A,B (O)</li>
...
<li class="fieldset">
Fieldset 19
 (O)<ul><li>FieldsetItem 19 A (O)</li><li>FieldsetItem 19 A (O)</li><li>FieldsetItem 19 A (O)</li><li>FieldsetItem 19 A (O)</li></ul></li><li class="sequence">
...
<li class="fieldset">
Fieldset 95
 (O) (repetitive)<ul><li>FieldsetItem 95 P,Q,R (O)</li><li>FieldsetItem 95 P,Q,R (O)</li><li>FieldsetItem 95 P,Q,R (O)</li><li>FieldsetItem 95 C,P,Q,R (O)</li><li>FieldsetItem 95 L (O)</li></ul></li><li class="field">Field 16 S (M)</li>
</ul></li>
</ul></div>
...
public class MT527 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT527.class.getName());
	 ...
	 */
	public MT527(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT527(String)
	 */
	public MT527(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT527 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT527(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "527")) {
	...
	* @since 7.10.3
	*/
	public static MT527 fromJson(final String json) {
	 ...
	 * or null if none is found.
	 * The first occurrence of field 94L at MT527 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 11A at MT527 is expected to be the only one.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 95L at MT527 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 20U at MT527 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 99B at MT527 are expected at one sequence or across several sequences.
	 * 
	...
	/**
	 * Class to model Sequence "B1" in MT 527.
	 */
	@SequenceStyle(Type.GENERATED_16RS)
     ...
     * @since 9.2.18
     */
     public List<SequenceB1> getSequenceListBREAK() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceB1> getSequenceListBREAK(final SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
     public List<SequenceC> getSequenceListSECMOVE() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceC> getSequenceListSECMOVE(final SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
     public List<SequenceD> getSequenceListCASHMOVE() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceD> getSequenceListCASHMOVE(final SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
     public List<SequenceE> getSequenceListADDINFO() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceE> getSequenceListADDINFO(final SwiftTagListBlock parentSequence) {
