...
public class MT695 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT695.class.getName());
	 ...
	 */
	public MT695(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT695(String)
	 */
	public MT695(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT695 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT695(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "695")) {
	...
	* @since 7.10.3
	*/
	public static MT695 fromJson(final String json) {
