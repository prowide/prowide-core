...
/**
 * <h1>MT 576 - Statement of Open Orders</h1>
 * <h3>SWIFT MT576 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
<li class="sequence">
...
// end qualifiers constants	
	...
	*/
	...
	public MT576(final int messageType, final String sender, final String receiver) {
		super(576, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT576(int, String, String)", "Use the constructor MT576(sender, receiver) instead.");
	}
