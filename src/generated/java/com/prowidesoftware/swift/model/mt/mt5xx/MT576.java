...
Fieldset 36
 (O)<ul><li>FieldsetItem 36 B,D (O)</li><li>FieldsetItem 36 B,D (O)</li><li>FieldsetItem 36 B,D (O)</li></ul></li><li class="field">Field 70 E (O)</li>
<li class="field">Field 16 S (M)</li>
</ul></li>
<li class="sequence">
...
<li class="fieldset">
Fieldset 36
 (O)<ul><li>FieldsetItem 36 B,D (O)</li><li>FieldsetItem 36 B,D (O)</li></ul></li><li class="fieldset">
Fieldset 19
...
<li class="fieldset">
Fieldset 95
 (M) (repetitive)<ul><li>FieldsetItem 95 P,Q,R (M)</li><li>FieldsetItem 95 L,S (O) (repetitive)</li></ul></li><li class="field">Field 97 A,B,D (O)</li>
<li class="field">Field 98 A,C (O)</li>
...
public class MT576 extends AbstractMT implements Serializable {
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!Strings.CS.equals(param.getType(), "576")) {
	...
	*/
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 36D at MT576 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 97D at MT576 are expected at one sequence or across several sequences.
	 * 
     ...
     * @since 9.2.18
     */
     public List<SequenceB> getSequenceFINList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceB> getSequenceFINList(final SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
     public List<SequenceB2> getSequenceORDERList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceB2> getSequenceORDERList(final SwiftTagListBlock parentSequence) {
    ...
    /**
     * Same as getSequenceB2bList using the sequence delimiter field qualifier
     * @see SequenceB2b#getSequenceB2bList()
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public List<SequenceB2b> getSequencePRICList() {
        return getSequenceB2bList();
     }
    ...
    /**
     * Same as getSequenceB2bList using the sequence delimiter field qualifier
     * @see SequenceB2b#getSequenceB2bList(SwiftTagListBlock)
     * @param parentSequence a not null parent sequence to find SequenceB2b within it
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public static List<SequenceB2b> getSequencePRICList(final SwiftTagListBlock parentSequence) {
        return getSequenceB2bList(parentSequence);
    }
    ...
    /**
     * Same as getSequenceB2cList using the sequence delimiter field qualifier
     * @see SequenceB2c#getSequenceB2cList()
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public List<SequenceB2c> getSequenceTRADPRTYList() {
        return getSequenceB2cList();
     }
    ...
    /**
     * Same as getSequenceB2cList using the sequence delimiter field qualifier
     * @see SequenceB2c#getSequenceB2cList(SwiftTagListBlock)
     * @param parentSequence a not null parent sequence to find SequenceB2c within it
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public static List<SequenceB2c> getSequenceTRADPRTYList(final SwiftTagListBlock parentSequence) {
        return getSequenceB2cList(parentSequence);
    }
