...
public class MT604 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT604.class.getName());
	 ...
	 */
	public MT604(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT604(String)
	 */
	public MT604(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT604 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT604(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "604")) {
	...
	* @since 7.10.3
	*/
	public static MT604 fromJson(final String json) {
	...
	/**
	 * Class to model Sequence "Loop1" in MT 604.
	 */
	public static class Loop1 extends SwiftTagListBlock {
		...
		/**
		 * Last mandatory tag name of the sequence: <em>"88A", "88B", "88D"  </em>
		 * Array format is for cases when more than one letter options is allowed
		 */
		protected static final String[] END = { "88A", "88B", "88D"   };
