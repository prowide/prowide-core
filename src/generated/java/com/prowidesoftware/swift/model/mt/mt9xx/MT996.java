...
public class MT996 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT996.class.getName());
	 ...
	 */
	public MT996(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT996(String)
	 */
	public MT996(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT996 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT996(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "996")) {
	...
	* @since 7.10.3
	*/
	public static MT996 fromJson(final String json) {
