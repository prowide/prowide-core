...
/**
 * <h1>MT 524 - Intra-Position Instruction</h1>
 * <h3>SWIFT MT524 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
<li class="sequence">
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT524 content, the parameter can not be <code>null</code>
	 * @see #MT524(String)
	 */
	...
	*/
	...
	public MT524(final int messageType, final String sender, final String receiver) {
		super(524, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT524(int, String, String)", "Use the constructor MT524(sender, receiver) instead.");
	}
