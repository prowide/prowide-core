...
public class MT524 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT524.class.getName());
	 ...
	 */
	public MT524(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT524(String)
	 */
	public MT524(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT524 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT524(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "524")) {
	...
	* @since 7.10.3
	*/
	public static MT524 fromJson(final String json) {
	 ...
	 * or null if none is found.
	 * The first occurrence of field 97D at MT524 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 94T at MT524 is expected to be the only one.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 36D at MT524 are expected at one sequence or across several sequences.
	 * 
