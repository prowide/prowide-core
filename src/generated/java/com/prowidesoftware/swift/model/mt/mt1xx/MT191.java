...
public class MT191 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT191.class.getName());
	 ...
	 */
	public MT191(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT191(String)
	 */
	public MT191(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT191 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT191(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "191")) {
	...
	* @since 7.10.3
	*/
	public static MT191 fromJson(final String json) {
