...
public class MT940 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT940.class.getName());
	 ...
	 */
	public MT940(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT940(String)
	 */
	public MT940(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT940 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT940(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "940")) {
	...
	* @since 7.10.3
	*/
	public static MT940 fromJson(final String json) {
