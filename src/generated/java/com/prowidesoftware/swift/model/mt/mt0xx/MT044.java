...
public class MT044 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT044.class.getName());
	 ...
	 */
	public MT044(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT044(String)
	 */
	public MT044(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT044 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT044(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "044")) {
	...
	* @since 7.10.3
	*/
	public static MT044 fromJson(final String json) {
