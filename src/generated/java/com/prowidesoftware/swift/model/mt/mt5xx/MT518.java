...
public class MT518 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT518.class.getName());
	 ...
	 */
	public MT518(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT518(String)
	 */
	public MT518(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT518 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT518(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!Strings.CS.equals(param.getType(), "518")) {
	...
	* @since 7.10.3
	*/
	public static MT518 fromJson(final String json) {
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 20U at MT518 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 94T at MT518 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 97D at MT518 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 36D at MT518 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 95D at MT518 are expected at one sequence or across several sequences.
	 * 
	...
	/**
	 * Class to model Sequence "B3" in MT 518.
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	...
	/**
	 * Class to model Sequence "C4" in MT 518.
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	@NonUniqueSeparator
