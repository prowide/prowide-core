...
public class MT971 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT971.class.getName());
	 ...
	 */
	public MT971(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT971(String)
	 */
	public MT971(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT971 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT971(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "971")) {
	...
	* @since 7.10.3
	*/
	public static MT971 fromJson(final String json) {
	...
	public List<Field62F> getField62F() {
		final List<Field62F> result = new ArrayList<>();
