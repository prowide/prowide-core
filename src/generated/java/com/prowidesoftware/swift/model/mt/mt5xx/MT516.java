 ...
 *
 * @deprecated MT516 was retired from the SWIFT standard in SRU after 2025. This class is kept for backward compatibility only and will not be updated.
 */
@Generated
@Deprecated
public class MT516 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT516.class.getName());
	 ...
	 */
	public MT516(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT516(String)
	 */
	public MT516(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT516 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT516(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!Strings.CS.equals(param.getType(), "516")) {
	...
	* @since 7.10.3
	*/
	public static MT516 fromJson(final String json) {
