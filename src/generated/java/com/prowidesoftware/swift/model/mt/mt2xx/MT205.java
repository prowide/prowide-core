...
public class MT205 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT205.class.getName());
	 ...
	 */
	public MT205(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT205(String)
	 */
	public MT205(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT205 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT205(m);
	...
	* @since 7.10.3
	*/
	public static MT205 fromJson(final String json) {
