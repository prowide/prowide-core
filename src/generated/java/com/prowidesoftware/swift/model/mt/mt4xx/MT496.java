...
public class MT496 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT496.class.getName());
	 ...
	 */
	public MT496(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT496(String)
	 */
	public MT496(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT496 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT496(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "496")) {
	...
	* @since 7.10.3
	*/
	public static MT496 fromJson(final String json) {
