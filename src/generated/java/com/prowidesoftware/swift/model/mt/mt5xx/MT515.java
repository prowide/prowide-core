...
public class MT515 extends AbstractMT implements Serializable {
	 ...
	 */
	public MT515(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT515(String)
	 */
	public MT515(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT515 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT515(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!Strings.CS.equals(param.getType(), "515")) {
	...
	* @since 7.10.3
	*/
	public static MT515 fromJson(final String json) {
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 20U at MT515 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 36D at MT515 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 94T at MT515 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 97D at MT515 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 95D at MT515 are expected at one sequence or across several sequences.
	 * 
     ...
     * @since 9.2.18
     */
     public List<SequenceB> getSequencePAFILLList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceB> getSequencePAFILLList(final SwiftTagListBlock parentSequence) {
	 ...
	 * @since 9.2.18
	 */
	public static SequenceC getSequenceCONFDET(SwiftTagListBlock parentSequence) {
	...
	public SequenceC1 getSequenceC1() {
		...
		return getSequenceC1(getSequenceC());
	}
