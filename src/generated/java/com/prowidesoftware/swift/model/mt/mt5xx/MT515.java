...
/**
 * <h1>MT 515 - Client Confirmation of Purchase or Sale</h1>
 * <h3>SWIFT MT515 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
<li class="sequence">
...
// end qualifiers constants	
	...
	*/
	...
	public MT515(final int messageType, final String sender, final String receiver) {
		super(515, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT515(int, String, String)", "Use the constructor MT515(sender, receiver) instead.");
	}
