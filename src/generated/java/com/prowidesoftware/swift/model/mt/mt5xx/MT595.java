...
public class MT595 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT595.class.getName());
	 ...
	 */
	public MT595(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT595(String)
	 */
	public MT595(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT595 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT595(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "595")) {
	...
	* @since 7.10.3
	*/
	public static MT595 fromJson(final String json) {
