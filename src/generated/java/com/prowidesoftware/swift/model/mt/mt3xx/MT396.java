...
public class MT396 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT396.class.getName());
	 ...
	 */
	public MT396(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT396(String)
	 */
	public MT396(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT396 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT396(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "396")) {
	...
	* @since 7.10.3
	*/
	public static MT396 fromJson(final String json) {
