...
public class MT692 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT692.class.getName());
	 ...
	 */
	public MT692(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT692(String)
	 */
	public MT692(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT692 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT692(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "692")) {
	...
	* @since 7.10.3
	*/
	public static MT692 fromJson(final String json) {
