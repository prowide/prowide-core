...
public class MT970 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT970.class.getName());
	 ...
	 */
	public MT970(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT970(String)
	 */
	public MT970(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT970 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT970(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "970")) {
	...
	* @since 7.10.3
	*/
	public static MT970 fromJson(final String json) {
