...
/**
 * <h1>MT 990 - Advice of Charges, Interest and Other Adjustments</h1>
 * <h3>SWIFT MT990 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT990 content, the parameter can not be <code>null</code>
	 * @see #MT990(String)
	 */
	...
	*/
	...
	public MT990(final int messageType, final String sender, final String receiver) {
		super(990, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT990(int, String, String)", "Use the constructor MT990(sender, receiver) instead.");
	}
