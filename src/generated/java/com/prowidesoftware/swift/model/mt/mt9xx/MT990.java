...
public class MT990 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT990.class.getName());
	 ...
	 */
	public MT990(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT990(String)
	 */
	public MT990(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT990 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT990(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "990")) {
	...
	* @since 7.10.3
	*/
	public static MT990 fromJson(final String json) {
