...
/**
 * <h1>MT 068 - Undelivered Report Rules</h1>
 * <h3>SWIFT MT068 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT068 content, the parameter can not be <code>null</code>
	 * @see #MT068(String)
	 */
	...
	*/
	...
	public MT068(final int messageType, final String sender, final String receiver) {
		super(68, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT068(int, String, String)", "Use the constructor MT068(sender, receiver) instead.");
	}
