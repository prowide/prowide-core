...
public class MT068 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT068.class.getName());
	 ...
	 */
	public MT068(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT068(String)
	 */
	public MT068(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT068 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT068(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "068")) {
	...
	* @since 7.10.3
	*/
	public static MT068 fromJson(final String json) {
