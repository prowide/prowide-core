...
public class MT051 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT051.class.getName());
	 ...
	 */
	public MT051(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT051(String)
	 */
	public MT051(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT051 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT051(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "051")) {
	...
	* @since 7.10.3
	*/
	public static MT051 fromJson(final String json) {
