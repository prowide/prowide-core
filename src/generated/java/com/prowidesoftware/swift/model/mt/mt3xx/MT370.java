...
public class MT370 extends AbstractMT implements Serializable {
	 ...
	 */
	public MT370(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT370(String)
	 */
	public MT370(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT370 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT370(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "370")) {
	...
	* @since 7.10.3
	*/
	public static MT370 fromJson(final String json) {
	 ...
	 * @since 9.2.18
	 */
	public static SequenceA2 getSequenceORDRPRTY(SwiftTagListBlock parentSequence) {
	 ...
	 * @since 9.2.18
	 */
	public static SequenceB getSequenceNETPOS(SwiftTagListBlock parentSequence) {
