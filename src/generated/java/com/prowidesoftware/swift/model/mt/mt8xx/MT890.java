...
public class MT890 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT890.class.getName());
	 ...
	 */
	public MT890(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT890(String)
	 */
	public MT890(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT890 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT890(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "890")) {
	...
	* @since 7.10.3
	*/
	public static MT890 fromJson(final String json) {
