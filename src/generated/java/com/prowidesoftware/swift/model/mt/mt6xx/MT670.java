...
/**
 * <h1>MT 670 - Standing Settlement Instruction Update Notification Request</h1>
 * <h3>SWIFT MT670 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
<li class="sequence">
...
// end qualifiers constants	
	...
	*/
	...
	public MT670(final int messageType, final String sender, final String receiver) {
		super(670, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT670(int, String, String)", "Use the constructor MT670(sender, receiver) instead.");
	}
