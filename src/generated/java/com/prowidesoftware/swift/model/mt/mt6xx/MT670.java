...
public class MT670 extends AbstractMT implements Serializable {
	 ...
	 */
	public MT670(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT670(String)
	 */
	public MT670(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT670 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT670(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "670")) {
	...
	* @since 7.10.3
	*/
	public static MT670 fromJson(final String json) {
	 ...
	 * @since 9.2.18
	 */
	public static SequenceA2 getSequenceDISPAR(SwiftTagListBlock parentSequence) {
	...
	public List<SequenceB2> getSequenceB2List() {
		...
		return com.prowidesoftware.swift.model.mt.SequenceUtils.resolveMT670GetSequenceB2List_sru2024(this);
	}
	...
	public SequenceC getSequenceC() {
		...
		return com.prowidesoftware.swift.model.mt.SequenceUtils.resolveMT670GetSequenceC_sru2024(this);
	}
