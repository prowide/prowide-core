...
public class MT391 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT391.class.getName());
	 ...
	 */
	public MT391(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT391(String)
	 */
	public MT391(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT391 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT391(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "391")) {
	...
	* @since 7.10.3
	*/
	public static MT391 fromJson(final String json) {
