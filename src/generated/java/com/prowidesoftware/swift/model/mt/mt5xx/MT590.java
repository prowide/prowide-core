...
public class MT590 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT590.class.getName());
	 ...
	 */
	public MT590(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT590(String)
	 */
	public MT590(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT590 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT590(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "590")) {
	...
	* @since 7.10.3
	*/
	public static MT590 fromJson(final String json) {
