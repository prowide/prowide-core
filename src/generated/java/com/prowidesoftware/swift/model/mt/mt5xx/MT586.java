...
<li class="fieldset">
Fieldset 95
 (O)<ul><li>FieldsetItem 95 P,Q,R (O)</li><li>FieldsetItem 95 L (O)</li></ul></li><li class="field">Field 97 A,B,D (M)</li>
...
<li class="sequence">
Sequence B2 - Reason (O) (repetitive)<ul><li class="field">Field 16 R (M)</li>
...
Sequence B4 - Financial Instrument/Account (M)<ul><li class="field">Field 16 R (M)</li>
...
<li class="sequence">
Sequence B5 - Two Leg Transaction Details (O)<ul><li class="field">Field 16 R (M)</li>
...
<li class="sequence">
Sequence B6 - Settlement Details (M)<ul><li class="field">Field 16 R (M)</li>
<li class="fieldset">
Fieldset 22
...
Sequence B6a - Settlement Parties (M) (repetitive)<ul><li class="field">Field 16 R (M)</li>
<li class="fieldset">
Fieldset 95
...
<li class="sequence">
Sequence B6b - Amounts (O) (repetitive)<ul><li class="field">Field 16 R (M)</li>
<li class="fieldset">
Fieldset 19
...
<li class="sequence">
Sequence B6c - Digital Payment Settlement Details (O)<ul><li class="field">Field 16 R (M)</li>
<li class="field">Field 35 B (M)</li>
...
public class MT586 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT586.class.getName());
	 ...
	 */
	public MT586(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT586(String)
	 */
	public MT586(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT586 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT586(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!Strings.CS.equals(param.getType(), "586")) {
	...
	* @since 7.10.3
	*/
	public static MT586 fromJson(final String json) {
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 24B at MT586 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 36D at MT586 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 97E at MT586 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 94T at MT586 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 95D at MT586 are expected at one sequence or across several sequences.
	 * 
	...
	public List<SequenceA1> getSequenceA1List() {
		...
		return com.prowidesoftware.swift.model.mt.SequenceUtils.resolveMT586GetSequenceA1List_sru2026(this);
	}
     ...
     * @since 9.2.18
     */
     public List<SequenceB> getSequenceALLDETList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceB> getSequenceALLDETList(final SwiftTagListBlock parentSequence) {
	...
	public List<SequenceB1> getSequenceB1List() {
		...
		return com.prowidesoftware.swift.model.mt.SequenceUtils.resolveMT586GetSequenceB1List_sru2026(this);
	}
     ...
     * @since 9.2.18
     */
     public List<SequenceB2> getSequenceREASList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceB2> getSequenceREASList(final SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
     public List<SequenceB3> getSequenceFIAList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceB3> getSequenceFIAList(final SwiftTagListBlock parentSequence) {
    ...
    /**
     * Same as getSequenceB4List using the sequence delimiter field qualifier
     * @see SequenceB4#getSequenceB4List()
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public List<SequenceB4> getSequenceFIACList() {
        return getSequenceB4List();
     }
    ...
    /**
     * Same as getSequenceB4List using the sequence delimiter field qualifier
     * @see SequenceB4#getSequenceB4List(SwiftTagListBlock)
     * @param parentSequence a not null parent sequence to find SequenceB4 within it
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public static List<SequenceB4> getSequenceFIACList(final SwiftTagListBlock parentSequence) {
        return getSequenceB4List(parentSequence);
    }
 

	/**
	 * Class to model Sequence "B4a" in MT 586.
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public static class SequenceB4a extends SwiftTagListBlock {
		private static final long serialVersionUID = 1L;
		 ...
		 * @see SwiftTagListBlock
		 */
		private SequenceB4a(final SwiftTagListBlock content) {
			super(content.getTags());
		}
		 ...
		 */
		@SequenceStyle(Type.GENERATED_16RS)
		public static SequenceB4a newInstance(final Tag... tags) {
			final SequenceB4a result = new SequenceB4a();
			result.append(START_TAG);
			if (tags != null && tags.length > 0) {
				for (final Tag t : tags) {
					result.append(t);
		 ...
		 * @since 7.6
		 */
		public static SequenceB4a newInstance() {
			final SequenceB4a result = new SequenceB4a();
			result.append(START_TAG);
			result.append(END_TAG);
			return result;
		 ...
		 * @since 7.6
		 */
		public static SequenceB4a newInstance(final SwiftTagListBlock... sequences) {
			final SequenceB4a result = new SequenceB4a();
			result.append(START_TAG);
			if (sequences != null && sequences.length > 0) {
				for (final SwiftTagListBlock s : sequences) {
		...
		@SequenceStyle(Type.GENERATED_16RS)
		private SequenceB4a(final SwiftMessage m) {
			super();
			if (m.getBlock4() != null) {
				setTags(m.getBlock4().getSubBlock(START_END_16RS).getTags());
			}
	...
	/**
	 * Get the list of SequenceB4a delimited by 16R/16S with value specified in {@link SequenceB4a#START_END_16RS}.
	 *
	 * <p>The presence of this method indicates that this sequence can occur more than once according to the Standard.
     * @return the found sequences or an empty list if none is found
	 * @see SequenceB4a#START_END_16RS
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public List<SequenceB4a> getSequenceB4aList() {
		return getSequenceB4aList(super.getSwiftMessageNotNullOrException().getBlock4());
	}

    /**
     * Same as getSequenceB4aList using the sequence delimiter field qualifier
     * @see SequenceB4a#getSequenceB4aList()
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public List<SequenceB4a> getSequenceBREAKList() {
        return getSequenceB4aList();
     }
	 ...
	 * <p>The presence of this method indicates that this sequence can occur more than once according to the Standard.
	 * @see SequenceB4a#START_END_16RS
	 * @param parentSequence a not null parent sequence to find SequenceB4a within it
	 * @return the found sequences or an empty list if none is found or parent sequence is null
	 * @since 7.7
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public static List<SequenceB4a> getSequenceB4aList(final SwiftTagListBlock parentSequence) {
	    if (parentSequence != null) {
            final List<SwiftTagListBlock> blocks = parentSequence.getSubBlocks(SequenceB4a.START_END_16RS);
            if (blocks != null && !blocks.isEmpty()) {
                final List<SequenceB4a> result = new ArrayList<>(blocks.size());
                for (final SwiftTagListBlock b : blocks) {
                    final SequenceB4a s = new SequenceB4a();
                    s.setTags(b.getSubBlock(SequenceB4a.START_END_16RS).getTags());
                    result.add(s);
                }
                return result;
            }
    ...
    /**
     * Same as getSequenceB4aList using the sequence delimiter field qualifier
     * @see SequenceB4a#getSequenceB4aList(SwiftTagListBlock)
     * @param parentSequence a not null parent sequence to find SequenceB4a within it
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public static List<SequenceB4a> getSequenceBREAKList(final SwiftTagListBlock parentSequence) {
        return getSequenceB4aList(parentSequence);
    }
    ...
    /**
     * Same as getSequenceB5List using the sequence delimiter field qualifier
     * @see SequenceB5#getSequenceB5List()
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public List<SequenceB5> getSequenceREPOList() {
        return getSequenceB5List();
     }
    ...
    /**
     * Same as getSequenceB5List using the sequence delimiter field qualifier
     * @see SequenceB5#getSequenceB5List(SwiftTagListBlock)
     * @param parentSequence a not null parent sequence to find SequenceB5 within it
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public static List<SequenceB5> getSequenceREPOList(final SwiftTagListBlock parentSequence) {
        return getSequenceB5List(parentSequence);
    }
 

	/**
	 * Class to model Sequence "B6" in MT 586.
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public static class SequenceB6 extends SwiftTagListBlock {
		private static final long serialVersionUID = 1L;
		 ...
		 * @see SwiftTagListBlock
		 */
		private SequenceB6(final SwiftTagListBlock content) {
			super(content.getTags());
		}
		 ...
		 */
		@SequenceStyle(Type.GENERATED_16RS)
		public static SequenceB6 newInstance(final Tag... tags) {
			final SequenceB6 result = new SequenceB6();
			result.append(START_TAG);
			if (tags != null && tags.length > 0) {
				for (final Tag t : tags) {
					result.append(t);
		 ...
		 * @since 7.6
		 */
		public static SequenceB6 newInstance() {
			final SequenceB6 result = new SequenceB6();
			result.append(START_TAG);
			result.append(END_TAG);
			return result;
		 ...
		 * @since 7.6
		 */
		public static SequenceB6 newInstance(final SwiftTagListBlock... sequences) {
			final SequenceB6 result = new SequenceB6();
			result.append(START_TAG);
			if (sequences != null && sequences.length > 0) {
				for (final SwiftTagListBlock s : sequences) {
		...
		@SequenceStyle(Type.GENERATED_16RS)
		private SequenceB6(final SwiftMessage m) {
			super();
			if (m.getBlock4() != null) {
				setTags(m.getBlock4().getSubBlock(START_END_16RS).getTags());
			}
	...
	/**
	 * Get the list of SequenceB6 delimited by 16R/16S with value specified in {@link SequenceB6#START_END_16RS}.
	 *
	 * <p>The presence of this method indicates that this sequence can occur more than once according to the Standard.
     * @return the found sequences or an empty list if none is found
	 * @see SequenceB6#START_END_16RS
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public List<SequenceB6> getSequenceB6List() {
		return getSequenceB6List(super.getSwiftMessageNotNullOrException().getBlock4());
	}

    /**
     * Same as getSequenceB6List using the sequence delimiter field qualifier
     * @see SequenceB6#getSequenceB6List()
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public List<SequenceB6> getSequenceSETDETList() {
        return getSequenceB6List();
     }
	 ...
	 * <p>The presence of this method indicates that this sequence can occur more than once according to the Standard.
	 * @see SequenceB6#START_END_16RS
	 * @param parentSequence a not null parent sequence to find SequenceB6 within it
	 * @return the found sequences or an empty list if none is found or parent sequence is null
	 * @since 7.7
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public static List<SequenceB6> getSequenceB6List(final SwiftTagListBlock parentSequence) {
	    if (parentSequence != null) {
            final List<SwiftTagListBlock> blocks = parentSequence.getSubBlocks(SequenceB6.START_END_16RS);
            if (blocks != null && !blocks.isEmpty()) {
                final List<SequenceB6> result = new ArrayList<>(blocks.size());
                for (final SwiftTagListBlock b : blocks) {
                    final SequenceB6 s = new SequenceB6();
                    s.setTags(b.getSubBlock(SequenceB6.START_END_16RS).getTags());
                    result.add(s);
                }
                return result;
            }
    ...
    /**
     * Same as getSequenceB6List using the sequence delimiter field qualifier
     * @see SequenceB6#getSequenceB6List(SwiftTagListBlock)
     * @param parentSequence a not null parent sequence to find SequenceB6 within it
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public static List<SequenceB6> getSequenceSETDETList(final SwiftTagListBlock parentSequence) {
        return getSequenceB6List(parentSequence);
    }
 

	/**
	 * Class to model Sequence "B6a" in MT 586.
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public static class SequenceB6a extends SwiftTagListBlock {
		private static final long serialVersionUID = 1L;
		 ...
		 * @see SwiftTagListBlock
		 */
		private SequenceB6a(final SwiftTagListBlock content) {
			super(content.getTags());
		}
		 ...
		 */
		@SequenceStyle(Type.GENERATED_16RS)
		public static SequenceB6a newInstance(final Tag... tags) {
			final SequenceB6a result = new SequenceB6a();
			result.append(START_TAG);
			if (tags != null && tags.length > 0) {
				for (final Tag t : tags) {
					result.append(t);
		 ...
		 * @since 7.6
		 */
		public static SequenceB6a newInstance() {
			final SequenceB6a result = new SequenceB6a();
			result.append(START_TAG);
			result.append(END_TAG);
			return result;
		 ...
		 * @since 7.6
		 */
		public static SequenceB6a newInstance(final SwiftTagListBlock... sequences) {
			final SequenceB6a result = new SequenceB6a();
			result.append(START_TAG);
			if (sequences != null && sequences.length > 0) {
				for (final SwiftTagListBlock s : sequences) {
		...
		@SequenceStyle(Type.GENERATED_16RS)
		private SequenceB6a(final SwiftMessage m) {
			super();
			if (m.getBlock4() != null) {
				setTags(m.getBlock4().getSubBlock(START_END_16RS).getTags());
			}
	...
	/**
	 * Get the list of SequenceB6a delimited by 16R/16S with value specified in {@link SequenceB6a#START_END_16RS}.
	 *
	 * <p>The presence of this method indicates that this sequence can occur more than once according to the Standard.
     * @return the found sequences or an empty list if none is found
	 * @see SequenceB6a#START_END_16RS
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public List<SequenceB6a> getSequenceB6aList() {
		return getSequenceB6aList(super.getSwiftMessageNotNullOrException().getBlock4());
	}

    /**
     * Same as getSequenceB6aList using the sequence delimiter field qualifier
     * @see SequenceB6a#getSequenceB6aList()
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public List<SequenceB6a> getSequenceSETPRTYList() {
        return getSequenceB6aList();
     }
	 ...
	 * <p>The presence of this method indicates that this sequence can occur more than once according to the Standard.
	 * @see SequenceB6a#START_END_16RS
	 * @param parentSequence a not null parent sequence to find SequenceB6a within it
	 * @return the found sequences or an empty list if none is found or parent sequence is null
	 * @since 7.7
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public static List<SequenceB6a> getSequenceB6aList(final SwiftTagListBlock parentSequence) {
	    if (parentSequence != null) {
            final List<SwiftTagListBlock> blocks = parentSequence.getSubBlocks(SequenceB6a.START_END_16RS);
            if (blocks != null && !blocks.isEmpty()) {
                final List<SequenceB6a> result = new ArrayList<>(blocks.size());
                for (final SwiftTagListBlock b : blocks) {
                    final SequenceB6a s = new SequenceB6a();
                    s.setTags(b.getSubBlock(SequenceB6a.START_END_16RS).getTags());
                    result.add(s);
                }
                return result;
            }
    ...
    /**
     * Same as getSequenceB6aList using the sequence delimiter field qualifier
     * @see SequenceB6a#getSequenceB6aList(SwiftTagListBlock)
     * @param parentSequence a not null parent sequence to find SequenceB6a within it
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public static List<SequenceB6a> getSequenceSETPRTYList(final SwiftTagListBlock parentSequence) {
        return getSequenceB6aList(parentSequence);
    }
 

	/**
	 * Class to model Sequence "B6b" in MT 586.
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public static class SequenceB6b extends SwiftTagListBlock {
		private static final long serialVersionUID = 1L;
		 ...
		 * @see SwiftTagListBlock
		 */
		private SequenceB6b(final SwiftTagListBlock content) {
			super(content.getTags());
		}
		 ...
		 */
		@SequenceStyle(Type.GENERATED_16RS)
		public static SequenceB6b newInstance(final Tag... tags) {
			final SequenceB6b result = new SequenceB6b();
			result.append(START_TAG);
			if (tags != null && tags.length > 0) {
				for (final Tag t : tags) {
					result.append(t);
		 ...
		 * @since 7.6
		 */
		public static SequenceB6b newInstance() {
			final SequenceB6b result = new SequenceB6b();
			result.append(START_TAG);
			result.append(END_TAG);
			return result;
		 ...
		 * @since 7.6
		 */
		public static SequenceB6b newInstance(final SwiftTagListBlock... sequences) {
			final SequenceB6b result = new SequenceB6b();
			result.append(START_TAG);
			if (sequences != null && sequences.length > 0) {
				for (final SwiftTagListBlock s : sequences) {
		...
		@SequenceStyle(Type.GENERATED_16RS)
		private SequenceB6b(final SwiftMessage m) {
			super();
			if (m.getBlock4() != null) {
				setTags(m.getBlock4().getSubBlock(START_END_16RS).getTags());
			}
	...
	/**
	 * Get the list of SequenceB6b delimited by 16R/16S with value specified in {@link SequenceB6b#START_END_16RS}.
	 *
	 * <p>The presence of this method indicates that this sequence can occur more than once according to the Standard.
     * @return the found sequences or an empty list if none is found
	 * @see SequenceB6b#START_END_16RS
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public List<SequenceB6b> getSequenceB6bList() {
		return getSequenceB6bList(super.getSwiftMessageNotNullOrException().getBlock4());
	}

    /**
     * Same as getSequenceB6bList using the sequence delimiter field qualifier
     * @see SequenceB6b#getSequenceB6bList()
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public List<SequenceB6b> getSequenceAMTList() {
        return getSequenceB6bList();
     }
	 ...
	 * <p>The presence of this method indicates that this sequence can occur more than once according to the Standard.
	 * @see SequenceB6b#START_END_16RS
	 * @param parentSequence a not null parent sequence to find SequenceB6b within it
	 * @return the found sequences or an empty list if none is found or parent sequence is null
	 * @since 7.7
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public static List<SequenceB6b> getSequenceB6bList(final SwiftTagListBlock parentSequence) {
	    if (parentSequence != null) {
            final List<SwiftTagListBlock> blocks = parentSequence.getSubBlocks(SequenceB6b.START_END_16RS);
            if (blocks != null && !blocks.isEmpty()) {
                final List<SequenceB6b> result = new ArrayList<>(blocks.size());
                for (final SwiftTagListBlock b : blocks) {
                    final SequenceB6b s = new SequenceB6b();
                    s.setTags(b.getSubBlock(SequenceB6b.START_END_16RS).getTags());
                    result.add(s);
                }
                return result;
            }
    ...
    /**
     * Same as getSequenceB6bList using the sequence delimiter field qualifier
     * @see SequenceB6b#getSequenceB6bList(SwiftTagListBlock)
     * @param parentSequence a not null parent sequence to find SequenceB6b within it
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public static List<SequenceB6b> getSequenceAMTList(final SwiftTagListBlock parentSequence) {
        return getSequenceB6bList(parentSequence);
    }
 

	/**
	 * Class to model Sequence "B6c" in MT 586.
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public static class SequenceB6c extends SwiftTagListBlock {
		private static final long serialVersionUID = 1L;
		 ...
		 * @see SwiftTagListBlock
		 */
		private SequenceB6c(final SwiftTagListBlock content) {
			super(content.getTags());
		}
		 ...
		 */
		@SequenceStyle(Type.GENERATED_16RS)
		public static SequenceB6c newInstance(final Tag... tags) {
			final SequenceB6c result = new SequenceB6c();
			result.append(START_TAG);
			if (tags != null && tags.length > 0) {
				for (final Tag t : tags) {
					result.append(t);
		 ...
		 * @since 7.6
		 */
		public static SequenceB6c newInstance() {
			final SequenceB6c result = new SequenceB6c();
			result.append(START_TAG);
			result.append(END_TAG);
			return result;
		 ...
		 * @since 7.6
		 */
		public static SequenceB6c newInstance(final SwiftTagListBlock... sequences) {
			final SequenceB6c result = new SequenceB6c();
			result.append(START_TAG);
			if (sequences != null && sequences.length > 0) {
				for (final SwiftTagListBlock s : sequences) {
		...
		@SequenceStyle(Type.GENERATED_16RS)
		private SequenceB6c(final SwiftMessage m) {
			super();
			if (m.getBlock4() != null) {
				setTags(m.getBlock4().getSubBlock(START_END_16RS).getTags());
			}
	...
	/**
	 * Get the list of SequenceB6c delimited by 16R/16S with value specified in {@link SequenceB6c#START_END_16RS}.
	 *
	 * <p>The presence of this method indicates that this sequence can occur more than once according to the Standard.
     * @return the found sequences or an empty list if none is found
	 * @see SequenceB6c#START_END_16RS
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public List<SequenceB6c> getSequenceB6cList() {
		return getSequenceB6cList(super.getSwiftMessageNotNullOrException().getBlock4());
	}

    /**
     * Same as getSequenceB6cList using the sequence delimiter field qualifier
     * @see SequenceB6c#getSequenceB6cList()
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public List<SequenceB6c> getSequenceDIGPAYSETTList() {
        return getSequenceB6cList();
     }
	 ...
	 * <p>The presence of this method indicates that this sequence can occur more than once according to the Standard.
	 * @see SequenceB6c#START_END_16RS
	 * @param parentSequence a not null parent sequence to find SequenceB6c within it
	 * @return the found sequences or an empty list if none is found or parent sequence is null
	 * @since 7.7
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public static List<SequenceB6c> getSequenceB6cList(final SwiftTagListBlock parentSequence) {
	    if (parentSequence != null) {
            final List<SwiftTagListBlock> blocks = parentSequence.getSubBlocks(SequenceB6c.START_END_16RS);
            if (blocks != null && !blocks.isEmpty()) {
                final List<SequenceB6c> result = new ArrayList<>(blocks.size());
                for (final SwiftTagListBlock b : blocks) {
                    final SequenceB6c s = new SequenceB6c();
                    s.setTags(b.getSubBlock(SequenceB6c.START_END_16RS).getTags());
                    result.add(s);
                }
                return result;
            }
    ...
    /**
     * Same as getSequenceB6cList using the sequence delimiter field qualifier
     * @see SequenceB6c#getSequenceB6cList(SwiftTagListBlock)
     * @param parentSequence a not null parent sequence to find SequenceB6c within it
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public static List<SequenceB6c> getSequenceDIGPAYSETTList(final SwiftTagListBlock parentSequence) {
        return getSequenceB6cList(parentSequence);
    }
