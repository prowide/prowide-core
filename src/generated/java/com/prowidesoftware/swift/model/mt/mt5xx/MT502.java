...
/**
 * <h1>MT 502 - Order to Buy or Sell</h1>
 * <h3>SWIFT MT502 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
<li class="sequence">
...
// end qualifiers constants	
	...
	*/
	...
	public MT502(final int messageType, final String sender, final String receiver) {
		super(502, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT502(int, String, String)", "Use the constructor MT502(sender, receiver) instead.");
	}
