...
<li class="fieldset">
Fieldset 94
 (O) (repetitive)<ul><li>FieldsetItem 94 H,L (O) (repetitive)</li><li>FieldsetItem 94 B,L (O) (repetitive)</li><li>FieldsetItem 94 B,C,F,L,T (O) (repetitive)</li></ul></li><li class="field">Field 35 B (M)</li>
<li class="fieldset">
Fieldset 36
 (M) (repetitive)<ul><li>FieldsetItem 36 B,D (M) (repetitive)</li><li>FieldsetItem 36 B,D (O)</li></ul></li><li class="fieldset">
Fieldset 19
 (O)<ul><li>FieldsetItem 19 A (O)</li><li>FieldsetItem 19 A (O)</li></ul></li><li class="sequence">
Sequence B1 - Digital Payment Settlement Details (O)<ul><li class="field">Field 16 R (M)</li>
...
<li class="sequence">
Sequence C - Penalties (O)<ul><li class="field">Field 16 R (M)</li>
...
Fieldset 22
 (M) (repetitive)<ul><li>FieldsetItem 22 H (M)</li><li>FieldsetItem 22 H (M)</li></ul></li><li class="field">Field 17 B (O)</li>
...
<li class="sequence">
Sequence C1a1A - Calculation Details (O) (repetitive)<ul><li class="field">Field 16 R (M)</li>
<li class="field">Field 98 A,C,E (M)</li>
<li class="field">Field 17 B (O)</li>
<li class="sequence">
Sequence C1a1A1 - Financial Instrument Attributes (O)<ul><li class="field">Field 16 R (M)</li>
<li class="field">Field 35 B (M)</li>
...
<li class="fieldset">
Fieldset 94
 (O) (repetitive)<ul><li>FieldsetItem 94 B,S (O)</li><li>FieldsetItem 94 B,L (O) (repetitive)</li></ul></li><li class="fieldset">
Fieldset 98
...
<li class="field">Field 25 D (M)</li>
<li class="sequence">
Sequence C1a1B1a1 - Reason (O) (repetitive)<ul><li class="field">Field 16 R (M)</li>
<li class="field">Field 24 B (M)</li>
<li class="field">Field 70 D (O)</li>
<li class="field">Field 16 S (M)</li>
</ul></li>
...
public class MT548 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT548.class.getName());
	 ...
	 */
	public MT548(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT548(String)
	 */
	public MT548(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT548 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT548(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!Strings.CS.equals(param.getType(), "548")) {
	...
	* @since 7.10.3
	*/
	public static MT548 fromJson(final String json) {
	 ...
	 * or null if none is found.
	 * The first occurrence of field 69A at MT548 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 69B at MT548 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 12A at MT548 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 12C at MT548 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 90A at MT548 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 90B at MT548 is expected to be the only one.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 20U at MT548 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 20N at MT548 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 94T at MT548 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 36D at MT548 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 35B at MT548 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 95D at MT548 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 97D at MT548 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 94S at MT548 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 92A at MT548 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 92B at MT548 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 70E at MT548 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 97E at MT548 are expected at one sequence or across several sequences.
	 * 
	...
	public List<SequenceA2> getSequenceA2List() {
		/*
		 * The delimiter STAT is not unique across all sequences, so the sequences are resolved
		 * within their parent SequenceA instead of over the whole block 4
		 */
		if (this.getSwiftMessage() == null) {
			return null;
		}
		return getSequenceA2List(getSequenceA());
	}
	...
	public List<SequenceA2a> getSequenceA2aList() {
		/*
		 * The delimiter REAS is not unique across all sequences, so the sequences are resolved
		 * within every occurrence of their parent SequenceA2 instead of over the whole block 4
		 */
		if (this.getSwiftMessage() == null) {
			return null;
		}
		final List<SequenceA2a> result = new ArrayList<>();
		for (final SequenceA2 parent : getSequenceA2List()) {
			result.addAll(getSequenceA2aList(parent));
		}
		return result;
	}
     ...
     * @since 9.2.18
     */
    public SequenceB getSequenceSETTRAN() {
        return getSequenceB();
    }
	 ...
	 * @since 9.2.18
	 */
	public static SequenceB getSequenceSETTRAN(SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
    public SequenceB1 getSequenceDIGPAYSETT() {
	 ...
	 * @since 9.2.18
	 */
	public static SequenceB1 getSequenceDIGPAYSETT(SwiftTagListBlock parentSequence) {
		return getSequenceB1(parentSequence);
	}
 

	/**
	 * Class to model Sequence "B2" in MT 548.
	 */
	@SequenceStyle(Type.GENERATED_16RS)
     ...
     * @since 9.2.18
     */
     public List<SequenceB2> getSequenceSETPRTYList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceB2> getSequenceSETPRTYList(final SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
    public SequenceC getSequencePENA() {
        return getSequenceC();
    }
	 ...
	 * @since 9.2.18
	 */
	public static SequenceC getSequencePENA(SwiftTagListBlock parentSequence) {
		return getSequenceC(parentSequence);
	}
 

	/**
	 * Class to model Sequence "C1" in MT 548.
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	...
	/**
	 * Class to model Sequence "C1a" in MT 548.
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	...
	/**
	 * Class to model Sequence "C1a1" in MT 548.
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	...
	/**
	 * Get the list of SequenceC1a1 delimited by 16R/16S with value specified in {@link SequenceC1a1#START_END_16RS}.
	 *
	 * <p>The presence of this method indicates that this sequence can occur more than once according to the Standard.
     * @return the found sequences or an empty list if none is found
    ...
    /**
     * Same as getSequenceC1a1List using the sequence delimiter field qualifier
     * @see SequenceC1a1#getSequenceC1a1List()
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public List<SequenceC1a1> getSequencePENDETList() {
        return getSequenceC1a1List();
     }
	 ...
	 * <p>The presence of this method indicates that this sequence can occur more than once according to the Standard.
	 * @see SequenceC1a1#START_END_16RS
	 * @param parentSequence a not null parent sequence to find SequenceC1a1 within it
	 * @return the found sequences or an empty list if none is found or parent sequence is null
	 * @since 7.7
	 */
	@SequenceStyle(Type.GENERATED_16RS)
    ...
    /**
     * Same as getSequenceC1a1List using the sequence delimiter field qualifier
     * @see SequenceC1a1#getSequenceC1a1List(SwiftTagListBlock)
     * @param parentSequence a not null parent sequence to find SequenceC1a1 within it
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public static List<SequenceC1a1> getSequencePENDETList(final SwiftTagListBlock parentSequence) {
        return getSequenceC1a1List(parentSequence);
    }
 

	/**
	 * Class to model Sequence "C1a1A" in MT 548.
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	...
	/**
	 * Get the list of SequenceC1a1A delimited by 16R/16S with value specified in {@link SequenceC1a1A#START_END_16RS}.
	 *
	 * <p>The presence of this method indicates that this sequence can occur more than once according to the Standard.
     * @return the found sequences or an empty list if none is found
    ...
    /**
     * Same as getSequenceC1a1AList using the sequence delimiter field qualifier
     * @see SequenceC1a1A#getSequenceC1a1AList()
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public List<SequenceC1a1A> getSequenceCALDETList() {
        return getSequenceC1a1AList();
     }
	 ...
	 * <p>The presence of this method indicates that this sequence can occur more than once according to the Standard.
	 * @see SequenceC1a1A#START_END_16RS
	 * @param parentSequence a not null parent sequence to find SequenceC1a1A within it
	 * @return the found sequences or an empty list if none is found or parent sequence is null
	 * @since 7.7
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public static List<SequenceC1a1A> getSequenceC1a1AList(final SwiftTagListBlock parentSequence) {
	    if (parentSequence != null) {
            ...
            if (blocks != null && !blocks.isEmpty()) {
                final List<SequenceC1a1A> result = new ArrayList<>(blocks.size());
                for (final SwiftTagListBlock b : blocks) {
    ...
    /**
     * Same as getSequenceC1a1AList using the sequence delimiter field qualifier
     * @see SequenceC1a1A#getSequenceC1a1AList(SwiftTagListBlock)
     * @param parentSequence a not null parent sequence to find SequenceC1a1A within it
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public static List<SequenceC1a1A> getSequenceCALDETList(final SwiftTagListBlock parentSequence) {
        return getSequenceC1a1AList(parentSequence);
    }
 

	/**
	 * Class to model Sequence "C1a1A1" in MT 548.
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public static class SequenceC1a1A1 extends SwiftTagListBlock {
		private static final long serialVersionUID = 1L;
		
		/**
		 * Constructs an empty sequence.
		 */
	    private SequenceC1a1A1() {
			super(new ArrayList<>());
		}
		 ...
		 * @see SwiftTagListBlock
		 */
		private SequenceC1a1A1(final SwiftTagListBlock content) {
			super(content.getTags());
		}
		 ...
		 */
		@SequenceStyle(Type.GENERATED_16RS)
		public static SequenceC1a1A1 newInstance(final Tag... tags) {
			final SequenceC1a1A1 result = new SequenceC1a1A1();
			result.append(START_TAG);
			if (tags != null && tags.length > 0) {
				for (final Tag t : tags) {
					result.append(t);
		 ...
		 * @since 7.6
		 */
		public static SequenceC1a1A1 newInstance() {
			final SequenceC1a1A1 result = new SequenceC1a1A1();
			result.append(START_TAG);
			result.append(END_TAG);
			return result;
		 ...
		 * @since 7.6
		 */
		public static SequenceC1a1A1 newInstance(final SwiftTagListBlock... sequences) {
			final SequenceC1a1A1 result = new SequenceC1a1A1();
			result.append(START_TAG);
			if (sequences != null && sequences.length > 0) {
				for (final SwiftTagListBlock s : sequences) {
		...
		@SequenceStyle(Type.GENERATED_16RS)
		private SequenceC1a1A1(final SwiftMessage m) {
			super();
			if (m.getBlock4() != null) {
				setTags(m.getBlock4().getSubBlock(START_END_16RS).getTags());
			}
	...
	/**
	 * Get the list of SequenceC1a1A1 delimited by 16R/16S with value specified in {@link SequenceC1a1A1#START_END_16RS}.
	 *
	 * <p>The presence of this method indicates that this sequence can occur more than once according to the Standard.
     * @return the found sequences or an empty list if none is found
	 * @see SequenceC1a1A1#START_END_16RS
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public List<SequenceC1a1A1> getSequenceC1a1A1List() {
		return getSequenceC1a1A1List(super.getSwiftMessageNotNullOrException().getBlock4());
	}

    /**
     * Same as getSequenceC1a1A1List using the sequence delimiter field qualifier
     * @see SequenceC1a1A1#getSequenceC1a1A1List()
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public List<SequenceC1a1A1> getSequenceFIAList() {
        return getSequenceC1a1A1List();
     }
	 ...
	 * <p>The presence of this method indicates that this sequence can occur more than once according to the Standard.
	 * @see SequenceC1a1A1#START_END_16RS
	 * @param parentSequence a not null parent sequence to find SequenceC1a1A1 within it
	 * @return the found sequences or an empty list if none is found or parent sequence is null
	 * @since 7.7
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public static List<SequenceC1a1A1> getSequenceC1a1A1List(final SwiftTagListBlock parentSequence) {
	    if (parentSequence != null) {
            final List<SwiftTagListBlock> blocks = parentSequence.getSubBlocks(SequenceC1a1A1.START_END_16RS);
            if (blocks != null && !blocks.isEmpty()) {
                final List<SequenceC1a1A1> result = new ArrayList<>(blocks.size());
                for (final SwiftTagListBlock b : blocks) {
                    final SequenceC1a1A1 s = new SequenceC1a1A1();
                    s.setTags(b.getSubBlock(SequenceC1a1A1.START_END_16RS).getTags());
                    result.add(s);
                }
                return result;
            }
    ...
    /**
     * Same as getSequenceC1a1A1List using the sequence delimiter field qualifier
     * @see SequenceC1a1A1#getSequenceC1a1A1List(SwiftTagListBlock)
     * @param parentSequence a not null parent sequence to find SequenceC1a1A1 within it
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public static List<SequenceC1a1A1> getSequenceFIAList(final SwiftTagListBlock parentSequence) {
        return getSequenceC1a1A1List(parentSequence);
    }
 

	/**
	 * Class to model Sequence "C1a1B" in MT 548.
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public static class SequenceC1a1B extends SwiftTagListBlock {
		private static final long serialVersionUID = 1L;
		
		/**
		 * Constructs an empty sequence.
		 */
	    private SequenceC1a1B() {
			super(new ArrayList<>());
		}
		 ...
		 * @see SwiftTagListBlock
		 */
		private SequenceC1a1B(final SwiftTagListBlock content) {
			super(content.getTags());
		}
		 ...
		 */
		@SequenceStyle(Type.GENERATED_16RS)
		public static SequenceC1a1B newInstance(final Tag... tags) {
			final SequenceC1a1B result = new SequenceC1a1B();
			result.append(START_TAG);
			if (tags != null && tags.length > 0) {
				for (final Tag t : tags) {
					result.append(t);
		 ...
		 * @since 7.6
		 */
		public static SequenceC1a1B newInstance() {
			final SequenceC1a1B result = new SequenceC1a1B();
			result.append(START_TAG);
			result.append(END_TAG);
			return result;
		 ...
		 * @since 7.6
		 */
		public static SequenceC1a1B newInstance(final SwiftTagListBlock... sequences) {
			final SequenceC1a1B result = new SequenceC1a1B();
			result.append(START_TAG);
			if (sequences != null && sequences.length > 0) {
				for (final SwiftTagListBlock s : sequences) {
		...
		@SequenceStyle(Type.GENERATED_16RS)
		private SequenceC1a1B(final SwiftMessage m) {
			super();
			if (m.getBlock4() != null) {
				setTags(m.getBlock4().getSubBlock(START_END_16RS).getTags());
			}
	...
	/**
	 * Get the list of SequenceC1a1B delimited by 16R/16S with value specified in {@link SequenceC1a1B#START_END_16RS}.
	 *
	 * <p>The presence of this method indicates that this sequence can occur more than once according to the Standard.
     * @return the found sequences or an empty list if none is found
	 * @see SequenceC1a1B#START_END_16RS
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public List<SequenceC1a1B> getSequenceC1a1BList() {
		return getSequenceC1a1BList(super.getSwiftMessageNotNullOrException().getBlock4());
	}

    /**
     * Same as getSequenceC1a1BList using the sequence delimiter field qualifier
     * @see SequenceC1a1B#getSequenceC1a1BList()
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public List<SequenceC1a1B> getSequenceRELTRANList() {
        return getSequenceC1a1BList();
     }
	 ...
	 * <p>The presence of this method indicates that this sequence can occur more than once according to the Standard.
	 * @see SequenceC1a1B#START_END_16RS
	 * @param parentSequence a not null parent sequence to find SequenceC1a1B within it
	 * @return the found sequences or an empty list if none is found or parent sequence is null
	 * @since 7.7
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public static List<SequenceC1a1B> getSequenceC1a1BList(final SwiftTagListBlock parentSequence) {
	    if (parentSequence != null) {
            final List<SwiftTagListBlock> blocks = parentSequence.getSubBlocks(SequenceC1a1B.START_END_16RS);
            if (blocks != null && !blocks.isEmpty()) {
                final List<SequenceC1a1B> result = new ArrayList<>(blocks.size());
                for (final SwiftTagListBlock b : blocks) {
                    final SequenceC1a1B s = new SequenceC1a1B();
                    s.setTags(b.getSubBlock(SequenceC1a1B.START_END_16RS).getTags());
                    result.add(s);
                }
                return result;
            }
    ...
    /**
     * Same as getSequenceC1a1BList using the sequence delimiter field qualifier
     * @see SequenceC1a1B#getSequenceC1a1BList(SwiftTagListBlock)
     * @param parentSequence a not null parent sequence to find SequenceC1a1B within it
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public static List<SequenceC1a1B> getSequenceRELTRANList(final SwiftTagListBlock parentSequence) {
        return getSequenceC1a1BList(parentSequence);
    }
 

	/**
	 * Class to model Sequence "C1a1B1" in MT 548.
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public static class SequenceC1a1B1 extends SwiftTagListBlock {
		private static final long serialVersionUID = 1L;
		
		/**
		 * Constructs an empty sequence.
		 */
	    private SequenceC1a1B1() {
			super(new ArrayList<>());
		}
		 ...
		 * @see SwiftTagListBlock
		 */
		private SequenceC1a1B1(final SwiftTagListBlock content) {
			super(content.getTags());
		}
		 ...
		 */
		@SequenceStyle(Type.GENERATED_16RS)
		public static SequenceC1a1B1 newInstance(final Tag... tags) {
			final SequenceC1a1B1 result = new SequenceC1a1B1();
			result.append(START_TAG);
			if (tags != null && tags.length > 0) {
				for (final Tag t : tags) {
					result.append(t);
		 ...
		 * @since 7.6
		 */
		public static SequenceC1a1B1 newInstance() {
			final SequenceC1a1B1 result = new SequenceC1a1B1();
			result.append(START_TAG);
			result.append(END_TAG);
			return result;
		 ...
		 * @since 7.6
		 */
		public static SequenceC1a1B1 newInstance(final SwiftTagListBlock... sequences) {
			final SequenceC1a1B1 result = new SequenceC1a1B1();
			result.append(START_TAG);
			if (sequences != null && sequences.length > 0) {
				for (final SwiftTagListBlock s : sequences) {
		...
		@SequenceStyle(Type.GENERATED_16RS)
		private SequenceC1a1B1(final SwiftMessage m) {
			super();
			if (m.getBlock4() != null) {
				setTags(m.getBlock4().getSubBlock(START_END_16RS).getTags());
			}
	...
	/**
	 * Get the list of SequenceC1a1B1 delimited by 16R/16S with value specified in {@link SequenceC1a1B1#START_END_16RS}.
	 *
	 * <p>The presence of this method indicates that this sequence can occur more than once according to the Standard.
     * @return the found sequences or an empty list if none is found
	 * @see SequenceC1a1B1#START_END_16RS
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public List<SequenceC1a1B1> getSequenceC1a1B1List() {
		return getSequenceC1a1B1List(super.getSwiftMessageNotNullOrException().getBlock4());
	}

    /**
     * Same as getSequenceC1a1B1List using the sequence delimiter field qualifier
     * @see SequenceC1a1B1#getSequenceC1a1B1List()
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public List<SequenceC1a1B1> getSequenceTRANList() {
        return getSequenceC1a1B1List();
     }
	 ...
	 * <p>The presence of this method indicates that this sequence can occur more than once according to the Standard.
	 * @see SequenceC1a1B1#START_END_16RS
	 * @param parentSequence a not null parent sequence to find SequenceC1a1B1 within it
	 * @return the found sequences or an empty list if none is found or parent sequence is null
	 * @since 7.7
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public static List<SequenceC1a1B1> getSequenceC1a1B1List(final SwiftTagListBlock parentSequence) {
	    if (parentSequence != null) {
            final List<SwiftTagListBlock> blocks = parentSequence.getSubBlocks(SequenceC1a1B1.START_END_16RS);
            if (blocks != null && !blocks.isEmpty()) {
                final List<SequenceC1a1B1> result = new ArrayList<>(blocks.size());
                for (final SwiftTagListBlock b : blocks) {
                    final SequenceC1a1B1 s = new SequenceC1a1B1();
                    s.setTags(b.getSubBlock(SequenceC1a1B1.START_END_16RS).getTags());
                    result.add(s);
                }
                return result;
            }
    ...
    /**
     * Same as getSequenceC1a1B1List using the sequence delimiter field qualifier
     * @see SequenceC1a1B1#getSequenceC1a1B1List(SwiftTagListBlock)
     * @param parentSequence a not null parent sequence to find SequenceC1a1B1 within it
     * @return the found sequences or an empty list if none is found
     * @since 9.2.18
     */
     public static List<SequenceC1a1B1> getSequenceTRANList(final SwiftTagListBlock parentSequence) {
        return getSequenceC1a1B1List(parentSequence);
    }
 

	/**
	 * Class to model Sequence "C1a1B1a" in MT 548.
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	@NonUniqueSeparator
	public static class SequenceC1a1B1a extends SwiftTagListBlock {
		private static final long serialVersionUID = 1L;
		
		/**
		 * Constructs an empty sequence.
		 */
	    private SequenceC1a1B1a() {
			super(new ArrayList<>());
		}
		 ...
		 * @see SwiftTagListBlock
		 */
		private SequenceC1a1B1a(final SwiftTagListBlock content) {
			super(content.getTags());
		}
	    ...
	    @NonUniqueSeparator
		@SequenceStyle(Type.GENERATED_16RS)
		public static SequenceC1a1B1a newInstance(final Tag... tags) {
			final SequenceC1a1B1a result = new SequenceC1a1B1a();
			result.append(START_TAG);
			if (tags != null && tags.length > 0) {
				for (final Tag t : tags) {
					result.append(t);
		 ...
		 * @since 7.6
		 */
		public static SequenceC1a1B1a newInstance() {
			final SequenceC1a1B1a result = new SequenceC1a1B1a();
			result.append(START_TAG);
			result.append(END_TAG);
			return result;
		 ...
		 * @since 7.6
		 */
		public static SequenceC1a1B1a newInstance(final SwiftTagListBlock... sequences) {
			final SequenceC1a1B1a result = new SequenceC1a1B1a();
			result.append(START_TAG);
			if (sequences != null && sequences.length > 0) {
				for (final SwiftTagListBlock s : sequences) {
		...
		@SequenceStyle(Type.GENERATED_16RS)
		private SequenceC1a1B1a(final SwiftMessage m) {
			super();
			if (m.getBlock4() != null) {
				setTags(m.getBlock4().getSubBlock(START_END_16RS).getTags());
			}
	...
	/**
	 * Get the list of SequenceC1a1B1a delimited by 16R/16S with value specified in {@link SequenceC1a1B1a#START_END_16RS}.
	 *
	 * <p>The presence of this method indicates that this sequence can occur more than once according to the Standard.
     *
     * <p>This sequence does not have a unique 16R/S delimiter, it is shared with another sequence in this
     ...
     *
     * @return the found sequences or an empty list if none is found
	 * @see SequenceC1a1B1a#START_END_16RS
	 */
	@NonUniqueSeparator
	@SequenceStyle(Type.GENERATED_16RS)
	public List<SequenceC1a1B1a> getSequenceC1a1B1aList() {
		/*
		 * The delimiter STAT is not unique across all sequences, so the sequences are resolved
		 * within every occurrence of their parent SequenceC1a1B1 instead of over the whole block 4
		 */
		if (this.getSwiftMessage() == null) {
			return null;
		}
		final List<SequenceC1a1B1a> result = new ArrayList<>();
		for (final SequenceC1a1B1 parent : getSequenceC1a1B1List()) {
			result.addAll(getSequenceC1a1B1aList(parent));
		}
		return result;
	}
     ...
     *
	 * @see SequenceC1a1B1a#START_END_16RS
	 * @param parentSequence a not null parent sequence to find SequenceC1a1B1a within it
	 * @return the found sequences or an empty list if none is found or parent sequence is null
	 * @since 7.7
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public static List<SequenceC1a1B1a> getSequenceC1a1B1aList(final SwiftTagListBlock parentSequence) {
	    if (parentSequence != null) {
            final List<SwiftTagListBlock> blocks = parentSequence.getSubBlocks(SequenceC1a1B1a.START_END_16RS);
            if (blocks != null && !blocks.isEmpty()) {
                final List<SequenceC1a1B1a> result = new ArrayList<>(blocks.size());
                for (final SwiftTagListBlock b : blocks) {
                    final SequenceC1a1B1a s = new SequenceC1a1B1a();
                    s.setTags(b.getSubBlock(SequenceC1a1B1a.START_END_16RS).getTags());
                    result.add(s);
                }
                return result;
            }
	...
	/**
	 * Class to model Sequence "C1a1B1a1" in MT 548.
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	@NonUniqueSeparator
	public static class SequenceC1a1B1a1 extends SwiftTagListBlock {
		private static final long serialVersionUID = 1L;
		
		/**
		 * Constructs an empty sequence.
		 */
	    private SequenceC1a1B1a1() {
			super(new ArrayList<>());
		}
		 ...
		 * @see SwiftTagListBlock
		 */
		private SequenceC1a1B1a1(final SwiftTagListBlock content) {
			super(content.getTags());
		}
	    ...
	    @NonUniqueSeparator
		@SequenceStyle(Type.GENERATED_16RS)
		public static SequenceC1a1B1a1 newInstance(final Tag... tags) {
			final SequenceC1a1B1a1 result = new SequenceC1a1B1a1();
			result.append(START_TAG);
			if (tags != null && tags.length > 0) {
				for (final Tag t : tags) {
					result.append(t);
		 ...
		 * @since 7.6
		 */
		public static SequenceC1a1B1a1 newInstance() {
			final SequenceC1a1B1a1 result = new SequenceC1a1B1a1();
			result.append(START_TAG);
			result.append(END_TAG);
			return result;
		 ...
		 * @since 7.6
		 */
		public static SequenceC1a1B1a1 newInstance(final SwiftTagListBlock... sequences) {
			final SequenceC1a1B1a1 result = new SequenceC1a1B1a1();
			result.append(START_TAG);
			if (sequences != null && sequences.length > 0) {
				for (final SwiftTagListBlock s : sequences) {
		...
		@SequenceStyle(Type.GENERATED_16RS)
		private SequenceC1a1B1a1(final SwiftMessage m) {
			super();
			if (m.getBlock4() != null) {
				setTags(m.getBlock4().getSubBlock(START_END_16RS).getTags());
			}
	...
	/**
	 * Get the list of SequenceC1a1B1a1 delimited by 16R/16S with value specified in {@link SequenceC1a1B1a1#START_END_16RS}.
	 *
	 * <p>The presence of this method indicates that this sequence can occur more than once according to the Standard.
     *
     * <p>This sequence does not have a unique 16R/S delimiter, it is shared with another sequence in this
     ...
     *
     * @return the found sequences or an empty list if none is found
	 * @see SequenceC1a1B1a1#START_END_16RS
	 */
	@NonUniqueSeparator
	@SequenceStyle(Type.GENERATED_16RS)
	public List<SequenceC1a1B1a1> getSequenceC1a1B1a1List() {
		/*
		 * The delimiter REAS is not unique across all sequences, so the sequences are resolved
		 * within every occurrence of their parent SequenceC1a1B1a instead of over the whole block 4
		 */
		if (this.getSwiftMessage() == null) {
			return null;
		}
		final List<SequenceC1a1B1a1> result = new ArrayList<>();
		for (final SequenceC1a1B1a parent : getSequenceC1a1B1aList()) {
			result.addAll(getSequenceC1a1B1a1List(parent));
		}
		return result;
	}
     ...
     *
	 * @see SequenceC1a1B1a1#START_END_16RS
	 * @param parentSequence a not null parent sequence to find SequenceC1a1B1a1 within it
	 * @return the found sequences or an empty list if none is found or parent sequence is null
	 * @since 7.7
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	public static List<SequenceC1a1B1a1> getSequenceC1a1B1a1List(final SwiftTagListBlock parentSequence) {
	    if (parentSequence != null) {
            final List<SwiftTagListBlock> blocks = parentSequence.getSubBlocks(SequenceC1a1B1a1.START_END_16RS);
            if (blocks != null && !blocks.isEmpty()) {
                final List<SequenceC1a1B1a1> result = new ArrayList<>(blocks.size());
                for (final SwiftTagListBlock b : blocks) {
                    final SequenceC1a1B1a1 s = new SequenceC1a1B1a1();
                    s.setTags(b.getSubBlock(SequenceC1a1B1a1.START_END_16RS).getTags());
                    result.add(s);
                }
                return result;
            }
	...
	/**
	 * Class to model Sequence "D" in MT 548.
	 */
	@SequenceStyle(Type.GENERATED_16RS)
     ...
     * @since 9.2.18
     */
     public List<SequenceD> getSequenceADDINFOList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceD> getSequenceADDINFOList(final SwiftTagListBlock parentSequence) {
