...
public class MT606 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT606.class.getName());
	 ...
	 */
	public MT606(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT606(String)
	 */
	public MT606(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT606 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT606(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "606")) {
	...
	* @since 7.10.3
	*/
	public static MT606 fromJson(final String json) {
