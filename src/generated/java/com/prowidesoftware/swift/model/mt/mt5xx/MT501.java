...
<li class="field">Field 93 B,F (M)</li>
...
public class MT501 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT501.class.getName());
	 ...
	 */
	public MT501(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT501(String)
	 */
	public MT501(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT501 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT501(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "501")) {
	...
	* @since 7.10.3
	*/
	public static MT501 fromJson(final String json) {
	...
	/**
	 * Iterates through block4 fields and return the first one whose name matches 93F, 
	 * or null if none is found.
	 * The first occurrence of field 93F at MT501 is expected to be the only one.
	 * 
	 * @return a Field93F object or null if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	public Field93F getField93F() {
		final Tag t = tag("93F");
		if (t != null) {
			return new Field93F(t.getValue());
		} else {
			return null;
		}
	}
	 ...
	 * or null if none is found.
	 * The first occurrence of field 97D at MT501 is expected to be the only one.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 36D at MT501 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * @since 9.2.18
	 */
	public static SequenceB getSequenceREGDET(SwiftTagListBlock parentSequence) {
	 ...
	 * @since 9.2.18
	 */
	public static SequenceB2 getSequenceFIAC(SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
     public List<SequenceC> getSequenceCLTDETList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceC> getSequenceCLTDETList(final SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
     public List<SequenceC1> getSequenceADDRESSList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceC1> getSequenceADDRESSList(final SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
     public List<SequenceC2> getSequencePERSDETList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceC2> getSequencePERSDETList(final SwiftTagListBlock parentSequence) {
