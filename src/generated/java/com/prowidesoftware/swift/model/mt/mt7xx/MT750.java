...
public class MT750 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT750.class.getName());
	 ...
	 */
	public MT750(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT750(String)
	 */
	public MT750(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT750 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT750(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "750")) {
	...
	* @since 7.10.3
	*/
	public static MT750 fromJson(final String json) {
