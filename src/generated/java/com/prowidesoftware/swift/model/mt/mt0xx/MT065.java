...
public class MT065 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT065.class.getName());
	 ...
	 */
	public MT065(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT065(String)
	 */
	public MT065(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT065 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT065(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "065")) {
	...
	* @since 7.10.3
	*/
	public static MT065 fromJson(final String json) {
