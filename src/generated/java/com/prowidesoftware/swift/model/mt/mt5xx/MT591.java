...
public class MT591 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT591.class.getName());
	 ...
	 */
	public MT591(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT591(String)
	 */
	public MT591(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT591 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT591(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "591")) {
	...
	* @since 7.10.3
	*/
	public static MT591 fromJson(final String json) {
