...
public class MT754 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT754.class.getName());
	 ...
	 */
	public MT754(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT754(String)
	 */
	public MT754(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT754 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT754(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "754")) {
	...
	* @since 7.10.3
	*/
	public static MT754 fromJson(final String json) {
