...
/**
 * <h1>MT 754 - Advice of Payment/Acceptance/Negotiation</h1>
 * <h3>SWIFT MT754 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT754 content, the parameter can not be <code>null</code>
	 * @see #MT754(String)
	 */
	...
	*/
	...
	public MT754(final int messageType, final String sender, final String receiver) {
		super(754, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT754(int, String, String)", "Use the constructor MT754(sender, receiver) instead.");
	}
