...
/**
 * <h1>MT 575 - Report of Combined Activity</h1>
 * <h3>SWIFT MT575 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
<li class="sequence">
...
// end qualifiers constants	
	...
	*/
	...
	public MT575(final int messageType, final String sender, final String receiver) {
		super(575, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT575(int, String, String)", "Use the constructor MT575(sender, receiver) instead.");
	}
