...
<li class="field">Field 20 C,U (M) (repetitive)</li>
<li class="field">Field 16 S (M)</li>
</ul></li>
<li class="sequence">
...
public class MT549 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT549.class.getName());
	 ...
	 */
	public MT549(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT549(String)
	 */
	public MT549(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT549 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT549(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "549")) {
	...
	* @since 7.10.3
	*/
	public static MT549 fromJson(final String json) {
	 ...
	 * or null if none is found.
	 * The first occurrence of field 97D at MT549 is expected to be the only one.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 20U at MT549 are expected at one sequence or across several sequences.
	 * 
