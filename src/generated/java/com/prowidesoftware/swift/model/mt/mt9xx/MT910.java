...
public class MT910 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT910.class.getName());
	 ...
	 */
	public MT910(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT910(String)
	 */
	public MT910(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT910 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT910(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "910")) {
	...
	* @since 7.10.3
	*/
	public static MT910 fromJson(final String json) {
