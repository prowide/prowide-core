...
public class MT526 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT526.class.getName());
	 ...
	 */
	public MT526(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT526(String)
	 */
	public MT526(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT526 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT526(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "526")) {
	...
	* @since 7.10.3
	*/
	public static MT526 fromJson(final String json) {
