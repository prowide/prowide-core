...
public class MT891 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT891.class.getName());
	 ...
	 */
	public MT891(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT891(String)
	 */
	public MT891(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT891 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT891(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "891")) {
	...
	* @since 7.10.3
	*/
	public static MT891 fromJson(final String json) {
