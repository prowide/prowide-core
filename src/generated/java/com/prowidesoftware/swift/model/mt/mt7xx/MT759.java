...
/**
 * MT 759 - Ancilliary Trade Structured Message.
 *
 * <p>
...
public class MT759 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT759.class.getName());
	 ...
	 */
	public MT759(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT759(String)
	 */
	public MT759(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT759 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT759(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "759")) {
	...
	* @since 7.10.3
	*/
	public static MT759 fromJson(final String json) {
