...
public class MT950 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT950.class.getName());
	 ...
	 */
	public MT950(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT950(String)
	 */
	public MT950(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT950 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT950(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "950")) {
	...
	* @since 7.10.3
	*/
	public static MT950 fromJson(final String json) {
