...
/**
 * <h1>MT 950 - Statement Message</h1>
 * <h3>SWIFT MT950 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	...
	*/
	...
	public MT950(final int messageType, final String sender, final String receiver) {
		super(950, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT950(int, String, String)", "Use the constructor MT950(sender, receiver) instead.");
	}
