...
<li class="fieldset">
Fieldset 95
 (M) (repetitive)<ul><li>FieldsetItem 95 P,Q,R (M)</li><li>FieldsetItem 95 L (O)</li></ul></li><li class="field">Field 97 A,B,D (O)</li>
...
<li class="fieldset">
Fieldset 20
 (M) (repetitive)<ul><li>FieldsetItem 20 C (M)</li><li>FieldsetItem 20 C,U (O)</li><li>FieldsetItem 20 C (O)</li><li>FieldsetItem 20 C (O)</li></ul></li><li class="field">Field 94 B,L (O)</li>
<li class="fieldset">
Fieldset 98
...
<li class="fieldset">
Fieldset 95
 (O)<ul><li>FieldsetItem 95 P,Q,R (O)</li><li>FieldsetItem 95 L (O)</li></ul></li><li class="field">Field 97 A,B,D (O)</li>
<li class="field">Field 25 D (O)</li>
...
public class MT569 extends AbstractMT implements Serializable {
	 ...
	 */
	public MT569(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT569(String)
	 */
	public MT569(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT569 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT569(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "569")) {
	...
	* @since 7.10.3
	*/
	public static MT569 fromJson(final String json) {
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 97D at MT569 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 20U at MT569 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 94L at MT569 are expected at one sequence or across several sequences.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 36D at MT569 are expected at one sequence or across several sequences.
	 * 
     ...
     * @since 9.2.18
     */
     public List<SequenceC> getSequenceSUMEList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceC> getSequenceSUMEList(final SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
     public List<SequenceC1> getSequenceSUMCList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceC1> getSequenceSUMCList(final SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
     public List<SequenceC1a> getSequenceTRANSDETList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceC1a> getSequenceTRANSDETList(final SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
     public List<SequenceC1a1> getSequenceVALDETList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceC1a1> getSequenceVALDETList(final SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
     public List<SequenceC1a1A> getSequenceSECDETList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceC1a1A> getSequenceSECDETList(final SwiftTagListBlock parentSequence) {
