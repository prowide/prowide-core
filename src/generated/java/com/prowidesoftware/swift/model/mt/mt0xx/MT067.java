...
public class MT067 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT067.class.getName());
	 ...
	 */
	public MT067(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT067(String)
	 */
	public MT067(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT067 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT067(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "067")) {
	...
	* @since 7.10.3
	*/
	public static MT067 fromJson(final String json) {
