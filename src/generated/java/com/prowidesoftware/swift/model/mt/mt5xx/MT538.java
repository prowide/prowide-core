...
public class MT538 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT538.class.getName());
	 ...
	 */
	public MT538(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT538(String)
	 */
	public MT538(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT538 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT538(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!Strings.CS.equals(param.getType(), "538")) {
	...
	* @since 7.10.3
	*/
	public static MT538 fromJson(final String json) {
	...
	public List<Field93A> getField93A() {
		final List<Field93A> result = new ArrayList<>();
     ...
     * @since 9.2.18
     */
     public List<SequenceB2> getSequenceSUBBALList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceB2> getSequenceSUBBALList(final SwiftTagListBlock parentSequence) {
     ...
     * @since 9.2.18
     */
     public List<SequenceB2a> getSequenceINPOSList() {
     ...
     * @since 9.2.18
     */
     public static List<SequenceB2a> getSequenceINPOSList(final SwiftTagListBlock parentSequence) {
	...
	public List<SequenceB2a1> getSequenceB2a1List() {
		/*
		 * The delimiter LINK is not unique across all sequences, so the sequences are resolved
		 * within every occurrence of their parent SequenceB2a instead of over the whole block 4
		 */
		if (this.getSwiftMessage() == null) {
			return null;
		}
		final List<SequenceB2a1> result = new ArrayList<>();
		for (final SequenceB2a parent : getSequenceB2aList()) {
			result.addAll(getSequenceB2a1List(parent));
		}
		return result;
	}
