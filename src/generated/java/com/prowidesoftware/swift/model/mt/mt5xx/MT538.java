...
/**
 * <h1>MT 538 - Statement of Intra-Position Advices</h1>
 * <h3>SWIFT MT538 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
<li class="sequence">
...
// end qualifiers constants	
	...
	*/
	...
	public MT538(final int messageType, final String sender, final String receiver) {
		super(538, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT538(int, String, String)", "Use the constructor MT538(sender, receiver) instead.");
	}
...
// BaseSequenceCodeGenerator [seq=A1]
	...
	*/
	...
	public List<SequenceA1> getSequenceA1List() {
		...
		*/
		...
		return com.prowidesoftware.swift.model.mt.SequenceUtils.resolveMT538GetSequenceA1List_sru2017(this);
	}
	/**
	* Get the list of SequenceA1 delimited by 16R/16S with value specified in SequenceA1#START_END_16RS 
	* The presence of this methods indicates that this sequence can occur more than once according to the Standard.
	...
	*/
	...
	public static List<SequenceA1> getSequenceA1List(final SwiftTagListBlock parentSequence) {
		...
		*
		*/
		return com.prowidesoftware.swift.model.mt.SequenceUtils.resolveMT538GetSequenceA1List_sru2017(new MT538().append(parentSequence));
...
// BaseSequenceCodeGenerator [seq=B2a1]
	...
	*/
	...
	public List<SequenceB2a1> getSequenceB2a1List() {
		...
		*/
		...
		return com.prowidesoftware.swift.model.mt.SequenceUtils.resolveMT538GetSequenceB2a1List_sru2017(this);
	}
	/**
	* Get the list of SequenceB2a1 delimited by 16R/16S with value specified in SequenceB2a1#START_END_16RS 
	* The presence of this methods indicates that this sequence can occur more than once according to the Standard.
	...
	*/
	...
	public static List<SequenceB2a1> getSequenceB2a1List(final SwiftTagListBlock parentSequence) {
		...
		*
		*/
		return com.prowidesoftware.swift.model.mt.SequenceUtils.resolveMT538GetSequenceB2a1List_sru2017(new MT538().append(parentSequence));
