...
public class MT768 extends AbstractMT implements Serializable {
	 ...
	 */
	public MT768(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT768(String)
	 */
	public MT768(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT768 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT768(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "768")) {
	...
	* @since 7.10.3
	*/
	public static MT768 fromJson(final String json) {
	 ...
	 * or null if none is found.
	 * The first occurrence of field 71D at MT768 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 72Z at MT768 is expected to be the only one.
	 * 
	 ...
	 * or null if none is found.
	 * The first occurrence of field 23X at MT768 is expected to be the only one.
	 * 
