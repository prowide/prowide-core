...
public class MT296 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT296.class.getName());
	 ...
	 */
	public MT296(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT296(String)
	 */
	public MT296(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT296 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT296(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "296")) {
	...
	* @since 7.10.3
	*/
	public static MT296 fromJson(final String json) {
