...
public class MT519 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT519.class.getName());
	 ...
	 */
	public MT519(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT519(String)
	 */
	public MT519(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT519 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT519(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "519")) {
	...
	* @since 7.10.3
	*/
	public static MT519 fromJson(final String json) {
	 ...
	 * or null if none is found.
	 * The first occurrence of field 97D at MT519 is expected to be the only one.
	 * 
	 ...
	 * or <code>Collections.emptyList()</code> if none is found.
	 * Multiple occurrences of field 36D at MT519 are expected at one sequence or across several sequences.
	 * 
