...
public class MT010 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT010.class.getName());
	 ...
	 */
	public MT010(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT010(String)
	 */
	public MT010(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT010 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT010(m);
	...
	* @since 7.10.3
	*/
	public static MT010 fromJson(final String json) {
