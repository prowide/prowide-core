...
public class MT011 extends AbstractMT implements Serializable {
	...
	private static final java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT011.class.getName());
	 ...
	 */
	public MT011(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT011(String)
	 */
	public MT011(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT011 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT011(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "011")) {
	...
	* @since 7.10.3
	*/
	public static MT011 fromJson(final String json) {
	...
	public List<Field175> getField175() {
		final List<Field175> result = new ArrayList<>();
