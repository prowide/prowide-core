...
<li class="sequence">
Sequence Loop1 - Returned Transaction (M) (repetitive)<ul><li class="field">Field 20  (M)</li>
...
public class MT203 extends AbstractMT implements Serializable {
	 ...
	 */
	public MT203(final SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @see #MT203(String)
	 */
	public MT203(final MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT203 parse(final MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT203(m);
    ...
    private void sanityCheck(final SwiftMessage param) {
		...
		} else if (!StringUtils.equals(param.getType(), "203")) {
	...
	* @since 7.10.3
	*/
	public static MT203 fromJson(final String json) {
	...
	/**
	 * Class to model Sequence "Loop1" in MT 203.
	 */
