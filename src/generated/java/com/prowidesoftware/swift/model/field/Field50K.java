...
@Generated
public class Field50K extends OptionKPartyField implements Serializable, MultiLineField {
	/**
    ...
    public Field50K(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "50K")) {
    ...
    public static Field50K fromJson(final String json) {
        ...
        final Field50K field = new Field50K();
