...
public class Field38J extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field38J.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field38J.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field38J setComponent2(java.lang.Long component2) {
     ...
     * @since 9.2.7
     */
    public Field38J setNumber(java.lang.Long component2) {
        return setComponent2(component2);
    }
    ...
    public static List<Field38J> getAll(final SwiftTagListBlock block) {
        final List<Field38J> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field38J fromJson(final String json) {
        ...
        final Field38J field = new Field38J();
