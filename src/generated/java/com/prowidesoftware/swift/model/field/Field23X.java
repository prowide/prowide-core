 ...
 * 		<li>Component 2: FileNameOrReference: <code>String</code></li>
 * </ol>
 *
...
public class Field23X extends Field implements Serializable {
    ...
    public Field23X(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "23X")) {
    ...
    protected Map<String, Integer> getLabelMap() {
        ...
        super.labelMap.put("filenameorreference", 2);
        return super.labelMap;
    }
    ...
    /**
     * Gets the component 2 (File Name Or Reference).
    ...
    /**
     * Gets the File Name Or Reference (component 2).
     * @return the File Name Or Reference from component 2
     */
    ...
    /**
     * Set the component 2 (File Name Or Reference).
     *
    ...
    /**
     * Set the File Name Or Reference (component 2).
     *
     * @param component2 the File Name Or Reference to set
     * @return the field object to enable build pattern
     */
    ...
    public static List<Field23X> getAll(final SwiftTagListBlock block) {
        final List<Field23X> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field23X fromJson(final String json) {
        ...
        final Field23X field = new Field23X();
        ...
        // **** COMPONENT 2 - File Name Or Reference
