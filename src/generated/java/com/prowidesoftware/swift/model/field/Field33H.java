...
public class Field33H extends Field implements Serializable, CurrencyContainer, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field33H.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field33H.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field33H setComponent2(java.math.BigDecimal component2) {
     ...
     * @since 9.2.7
     */
    public Field33H setAmount(java.math.BigDecimal component2) {
        return setComponent2(component2);
    }
    ...
    public static List<Field33H> getAll(final SwiftTagListBlock block) {
        final List<Field33H> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field33H fromJson(final String json) {
        ...
        final Field33H field = new Field33H();
