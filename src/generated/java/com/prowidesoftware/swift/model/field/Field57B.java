...
@Generated
public class Field57B extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field57B> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field57B> result = new ArrayList<Field57B>(arr.length);
			for (final Tag f : arr) {
