...
@Generated
public class Field53D extends OptionDPartyField implements Serializable, MultiLineField {
	/**
    ...
    public Field53D(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "53D")) {
    ...
    public static Field53D fromJson(final String json) {
        ...
        final Field53D field = new Field53D();
