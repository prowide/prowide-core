...
public class Field431 extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field431.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field431.PARSER_PATTERN
     */
    @Override
    ...
    /**
     * Gets the component 1 (Status Code).
    ...
    /**
     * Get the Status Code (component 1) as Long
     * @return the Status Code from component 1 converted to Long or null if cannot be converted
     * @since 9.2.7
     */
    public java.lang.Long getStatusCodeAsLong() {
     ...
     * @return the field object to enable build pattern
     */
    public Field431 setComponent1(java.lang.Long component1) {
        setComponent(1, SwiftFormatUtils.getLong(component1));
        return this;
    }

    /**
     * Alternative method setter for field's Status Code (component 1) as as Number
     *
    ...
    /**
     * Set the Status Code (component 1).
     *
     * @param component1 the Status Code to set
     * @return the field object to enable build pattern
     */
     ...
     * @since 9.2.7
     */
    public Field431 setStatusCode(java.lang.Long component1) {
        return setComponent1(component1);
    }
    ...
    public static List<Field431> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field431> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
