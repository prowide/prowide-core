...
public class Field14H extends Field implements Serializable {
    ...
    public Field14H(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "14H")) {
     ...
     */
    public Field14H setComponent1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field14H setConvention(String component1) {
     ...
     * @return the static value of Field14H.NAME
     */
    @Override
     ...
     */
    public static Field14H get(final SwiftTagListBlock block) {
        ...
        return new Field14H(t);
    }

    /**
     * Gets the first instance of Field14H in the given message.
     * @param msg may be empty or null
     * @return null if not found or msg is empty or null
     * @see #get(SwiftTagListBlock)
     */
    public static Field14H get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field14H in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field14H> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty()) {
    ...
    /**
     * Gets a list of all occurrences of the field Field14H from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field14H> getAll(final SwiftTagListBlock block) {
        final List<Field14H> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    /**
     * This method deserializes the JSON data into a Field14H object.
     * @param json JSON structure including tuples with label and value for all field components
     * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
     * @since 7.10.3
     * @see Field#fromJson(String)
     */
    public static Field14H fromJson(final String json) {

        final Field14H field = new Field14H();
