 ...
 * SWIFT MT Field 94S.
 * <p>
 * Model and parser for field 94S of a SWIFT MT message.
 *
 ...
 * <ul>
 * 		<li>validation pattern: <code>:4!c/[8c]/4!c[/140x]</code></li>
...
@Generated
public class Field94S extends Field implements Serializable, GenericField {
	/**
	...
	/**
	 * Constant with the field name 94S.
	 */
     ...
     */
    public Field94S(final String value) {
        super(value);
    }
     ...
     * @since 7.8
     */
    public Field94S(final Tag tag) {
        this();
        if (tag == null) {
            throw new IllegalArgumentException("tag cannot be null.");
        }
        if (!StringUtils.equals(tag.getName(), "94S")) {
     ...
     * @return the static value of Field94S.NAME
     */
    @Override
     ...
     */
    public static Field94S get(final SwiftTagListBlock block) {
    ...
    /**
     * Gets the first instance of Field94S in the given message.
     * @param msg may be empty or null
     * @return null if not found or msg is empty or null
     * @see #get(SwiftTagListBlock)
     */
    public static Field94S get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field94S in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field94S> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty()) {
    ...
    /**
     * Gets a list of all occurrences of the field Field94S from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field94S> getAll(final SwiftTagListBlock block) {
    ...
    /**
     * This method deserializes the JSON data into a Field94S object.
     * @param json JSON structure including tuples with label and value for all field components
     * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
     * @since 7.10.3
     * @see Field#fromJson(String)
     */
    public static Field94S fromJson(final String json) {

        final Field94S field = new Field94S();
