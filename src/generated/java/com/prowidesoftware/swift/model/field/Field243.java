...
public class Field243 extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field243.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field243.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field243 setComponent1(java.lang.Long component1) {
     ...
     * @since 9.2.7
     */
    public Field243 setType(java.lang.Long component1) {
        return setComponent1(component1);
    }
    ...
    public static List<Field243> getAll(final SwiftTagListBlock block) {
        final List<Field243> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field243 fromJson(final String json) {
        ...
        final Field243 field = new Field243();
