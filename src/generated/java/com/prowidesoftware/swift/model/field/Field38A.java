...
public class Field38A extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field38A.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field38A.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field38A setComponent1(java.lang.Long component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field38A setPeriod(String component1) {
     ...
     * @since 9.2.7
     */
    public Field38A setPeriod(java.lang.Long component1) {
        return setComponent1(component1);
    }
    ...
    public static List<Field38A> getAll(final SwiftTagListBlock block) {
        final List<Field38A> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field38A fromJson(final String json) {
        ...
        final Field38A field = new Field38A();
