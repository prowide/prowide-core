...
public class Field37G extends Field implements Serializable, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field37G.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field37G.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field37G setComponent2(java.math.BigDecimal component2) {
     ...
     * @since 9.2.7
     */
    public Field37G setRate(java.math.BigDecimal component2) {
        return setComponent2(component2);
    }
    ...
    public static List<Field37G> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field37G> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
