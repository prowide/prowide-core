...
public class Field126 extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field126.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field126.PARSER_PATTERN
     */
    @Override
    ...
    /**
     * Get the Seed (component 1) as Long
     * @return the Seed from component 1 converted to Long or null if cannot be converted
     * @since 9.2.7
     */
    public java.lang.Long getSeedAsLong() {
    ...
    public static List<Field126> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field126> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
