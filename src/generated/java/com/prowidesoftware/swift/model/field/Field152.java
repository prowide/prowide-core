...
public class Field152 extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field152.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field152.PARSER_PATTERN
     */
    @Override
    ...
    /**
     * Gets the component 1 (Sequence Number).
    ...
    /**
     * Get the Sequence Number (component 1) as Long
     * @return the Sequence Number from component 1 converted to Long or null if cannot be converted
     * @since 9.2.7
     */
    ...
    /**
     * Alternative method setter for field's Sequence Number (component 1) as as Number
     *
    ...
    /**
     * Set the Sequence Number (component 1).
     *
     * @param component1 the Sequence Number to set
     * @return the field object to enable build pattern
     */
    ...
    public static List<Field152> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field152> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
