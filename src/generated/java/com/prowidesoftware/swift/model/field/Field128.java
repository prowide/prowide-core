...
public class Field128 extends Field implements Serializable, BICContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field128.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field128.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field128> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field128> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
