...
/**
 * <strong>SWIFT MT Field 51</strong>
 * <p>
 * Model and parser for field 51 of a SWIFT MT message.
 *
...
@Generated
public class Field51 extends Field implements Serializable, MultiLineField {
	/**
	...
	/**
	 * Constant with the field name 51
	 */
    public static final String NAME = "51";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_51 = "51";
     ...
     */
    public Field51(final String value) {
        super(value);
    }
     ...
     * @since 7.8
     */
    public Field51(final Tag tag) {
        this();
        if (tag == null) {
            throw new IllegalArgumentException("tag cannot be null.");
        }
        if (!StringUtils.equals(tag.getName(), "51")) {
            throw new IllegalArgumentException("cannot create field 51 from tag "+tag.getName()+", tagname must match the name of the field.");
        }
        parse(tag.getValue());
    }
     ...
     * @since 7.7
     */
    public static Field51 newInstance(Field51 source) {
        Field51 cp = new Field51();
    ...
    public String getValueDisplay(int component, Locale locale) {
        if (component < 1 || component > 4) {
            throw new IllegalArgumentException("invalid component number " + component + " for field 51");
        }
        if (component == 1) {
     ...
     * @see #typesPattern()
     * @return the static value of Field51.COMPONENTS_PATTERN
     */
    @Override
    @Deprecated
    @ProwideDeprecated(phase2=TargetYear.SRU2022)
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field51.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field51.PARSER_PATTERN
     */
    @Override
     ...
     */
    public Field51 setComponent1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field51 setNameAndAddressLine1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field51 setNameAndAddress(String value) {
        List<String> lines = SwiftParseUtils.getLines(value);
     ...
     * @return the field object to enable build pattern
     */
    public Field51 setComponent2(String component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field51 setNameAndAddressLine2(String component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field51 setComponent3(String component3) {
     ...
     * @return the field object to enable build pattern
     */
    public Field51 setNameAndAddressLine3(String component3) {
     ...
     * @return the field object to enable build pattern
     */
    public Field51 setComponent4(String component4) {
     ...
     * @return the field object to enable build pattern
     */
    public Field51 setNameAndAddressLine4(String component4) {
     ...
     * @return the static value of Field51.NAME
     */
    @Override
     ...
     */
    public static Field51 get(final SwiftTagListBlock block) {
        ...
        return new Field51(t) ;
    }

    /**
     * Gets the first instance of Field51 in the given message.
     * @param msg may be empty or null
     * @return null if not found or msg is empty or null
     * @see #get(SwiftTagListBlock)
     */
    public static Field51 get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field51 in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field51> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty())
    ...
    /**
     * Gets a list of all occurrences of the field Field51 from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field51> getAll(final SwiftTagListBlock block) {
        if (block == null || block.isEmpty()) {
            return java.util.Collections.emptyList();
        }
        final Tag[] arr = block.getTagsByName(NAME);
        if (arr != null && arr.length > 0) {
            final List<Field51> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
                result.add( new Field51(f));
            }
            return result;
        }
        return java.util.Collections.emptyList();
    ...
    /**
     * This method deserializes the JSON data into a Field51 object.
     * @param json JSON structure including tuples with label and value for all field components
     * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
     * @since 7.10.3
     * @see Field#fromJson(String)
     */
    public static Field51 fromJson(final String json) {
