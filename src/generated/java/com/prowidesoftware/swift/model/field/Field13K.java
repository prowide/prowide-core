...
public class Field13K extends Field implements Serializable, AmountContainer, GenericField {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field13K.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field13K.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field13K> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field13K> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
