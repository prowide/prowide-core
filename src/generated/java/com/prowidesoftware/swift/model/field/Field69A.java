...
@Generated
public class Field69A extends Field implements Serializable, DateContainer, com.prowidesoftware.swift.model.field.GenericField {
	/**
	...
	*/
	...
	/**
	 * Gets the Date1 (component2) as Calendar
	 * @return the Date1 from component2 converted to Calendar or <code>null</code> if cannot be converted
	 */
	...
	/**
	 * Gets the Date2 (component3) as Calendar
	 * @return the Date2 from component3 converted to Calendar or <code>null</code> if cannot be converted
	 */
   ...
   public String parserPattern() {
	...
	public static List<Field69A> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field69A> result = new ArrayList<Field69A>(arr.length);
			for (final Tag f : arr) {
