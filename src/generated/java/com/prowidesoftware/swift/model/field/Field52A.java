...
@Generated
public class Field52A extends Field implements Serializable, BICContainer, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field52A> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field52A> result = new ArrayList<Field52A>(arr.length);
			for (final Tag f : arr) {
