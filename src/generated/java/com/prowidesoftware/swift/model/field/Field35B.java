...
@Generated
public class Field35B extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field35B> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field35B> result = new ArrayList<Field35B>(arr.length);
			for (final Tag f : arr) {
