...
public class Field99C extends Field implements Serializable, GenericField {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field99C.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field99C.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field99C setComponent2(java.lang.Long component2) {
     ...
     * @since 9.2.7
     */
    public Field99C setNumber(java.lang.Long component2) {
        return setComponent2(component2);
    }
    ...
    public static List<Field99C> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field99C> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
