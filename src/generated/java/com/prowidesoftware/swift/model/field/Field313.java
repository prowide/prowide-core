...
public class Field313 extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field313.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field313.PARSER_PATTERN
     */
    @Override
    ...
    /**
     * Get the Count (component 1) as Long
     * @return the Count from component 1 converted to Long or null if cannot be converted
     * @since 9.2.7
     */
    public java.lang.Long getCountAsLong() {
     ...
     * @since 9.2.7
     *
     * @param component1 the Long with the Count content to set
     * @return the field object to enable build pattern
     */
    public Field313 setComponent1(java.lang.Long component1) {
        setComponent(1, SwiftFormatUtils.getLong(component1));
        return this;
    }

    /**
     * Alternative method setter for field's Count (component 1) as as Number
     *
     * This method supports java constant value boxing for simpler coding styles (ex: 10 becomes an Integer)
     *
     * @param component1 the Number with the Count content to set
     * @return the field object to enable build pattern
    ...
    /**
     * Set the Count (component 1) from a Long object.
     *
     * @see #setComponent1(java.lang.Long)
     *
     * @param component1 Long with the Count content to set
     * @return the field object to enable build pattern
     * @since 9.2.7
     */
    public Field313 setCount(java.lang.Long component1) {
        return setComponent1(component1);
    }
    ...
    public static Field313 fromJson(final String json) {
        ...
        final Field313 field = new Field313();
