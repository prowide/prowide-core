...
@Generated
public class Field93D extends Field implements Serializable, AmountContainer, com.prowidesoftware.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field93D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field93D> result = new ArrayList<Field93D>(arr.length);
			for (final Tag f : arr) {
