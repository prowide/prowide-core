...
/**
 * <strong>SWIFT MT Field 21T</strong>
 * <p>
...
public class Field21T extends Field implements Serializable {
    ...
    public Field21T(final Tag tag) {
        ...
        if (!StringUtils.equals(tag.getName(), "21T")) {
            throw new IllegalArgumentException("cannot create field 21T from tag "+tag.getName()+", tagname must match the name of the field.");
        }
        parse(tag.getValue());
    }
     ...
     * @see #typesPattern()
     * @return the static value of Field21T.COMPONENTS_PATTERN
     */
    @Override
    @Deprecated
    @ProwideDeprecated(phase2=TargetYear.SRU2022)
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field21T.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field21T.PARSER_PATTERN
     */
    @Override
     ...
     */
    public static List<Field21T> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty())
     ...
     */
    public static List<Field21T> getAll(final SwiftTagListBlock block) {
        if (block == null || block.isEmpty()) {
            return java.util.Collections.emptyList();
        }
        final Tag[] arr = block.getTagsByName(NAME);
        if (arr != null && arr.length > 0) {
            final List<Field21T> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
