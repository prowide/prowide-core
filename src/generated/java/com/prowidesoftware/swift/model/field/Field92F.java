...
public class Field92F extends Field implements Serializable, CurrencyContainer, AmountContainer, GenericField {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field92F.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field92F.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field92F setCurrencyCode(java.util.Currency component2) {
        return setComponent2(component2);
    }
     ...
     * @return the field object to enable build pattern
     */
    public Field92F setComponent3(java.math.BigDecimal component3) {
     ...
     * @since 9.2.7
     */
    public Field92F setAmount(java.math.BigDecimal component3) {
        return setComponent3(component3);
    }
    ...
    public static List<Field92F> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field92F> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
