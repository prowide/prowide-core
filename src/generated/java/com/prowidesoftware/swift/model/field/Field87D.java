...
@Generated
public class Field87D extends OptionDPartyField implements Serializable, MultiLineField {
	/**
    ...
    public Field87D(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "87D")) {
    ...
    public static Field87D fromJson(final String json) {
        ...
        final Field87D field = new Field87D();
