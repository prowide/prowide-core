...
@Generated
public class Field90K extends Field implements Serializable, AmountContainer, com.prowidesoftware.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field90K> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field90K> result = new ArrayList<Field90K>(arr.length);
			for (final Tag f : arr) {
