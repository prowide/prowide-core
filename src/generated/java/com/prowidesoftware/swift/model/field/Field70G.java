...
public class Field70G extends Field implements Serializable, GenericField, MultiLineField {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field70G.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field70G.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field70G> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field70G> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
