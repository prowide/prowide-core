...
public class Field33F extends Field implements Serializable, CurrencyContainer, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field33F.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field33F.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field33F setComponent2(java.math.BigDecimal component2) {
     ...
     * @since 9.2.7
     */
    public Field33F setAmount(java.math.BigDecimal component2) {
        return setComponent2(component2);
    }
    ...
    public static List<Field33F> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field33F> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
