 ...
 * 		<li>Component 2: Dates: <code>String</code></li>
 * </ol>
 *
...
public class Field340 extends Field implements Serializable {
    ...
    public Field340(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "340")) {
    ...
    public static List<Field340> getAll(final SwiftTagListBlock block) {
        final List<Field340> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field340 fromJson(final String json) {
        ...
        final Field340 field = new Field340();
