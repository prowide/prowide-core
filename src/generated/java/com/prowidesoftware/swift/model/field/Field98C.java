...
@Generated
public class Field98C extends Field implements Serializable, DateContainer, com.prowidesoftware.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field98C> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field98C> result = new ArrayList<Field98C>(arr.length);
			for (final Tag f : arr) {
