...
public class Field401 extends Field implements Serializable {
     ...
     * @return the static value of Field401.PARSER_PATTERN
     */
	@Override
	...
	/**
	 * Get the Code (component 1) as Number
	 * @return the Code from component 1 converted to Number or null if cannot be converted
	 */
	...
	public static List<Field401> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field401> result = new ArrayList<>(arr.length);
			for (final Tag f : arr) {
