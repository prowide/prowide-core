...
/**
 * <strong>SWIFT MT Field 34X</strong>
 * <p>
 * Model and parser for field 34X of a SWIFT MT message.
 *
...
public class Field34X extends Field implements Serializable, AmountContainer {
     ...
     */
    public static final String F_34X = "34X";
     ...
     */
    public Field34X(final String value) {
        super(value);
    }
     ...
     * @since 7.7
     */
    public static Field34X newInstance(Field34X source) {
        Field34X cp = new Field34X();
     ...
     * @see #typesPattern()
     * @return the static value of Field34X.COMPONENTS_PATTERN
     */
    @Override
    @Deprecated
    @ProwideDeprecated(phase2=TargetYear.SRU2022)
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field34X.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field34X.PARSER_PATTERN
     */
    @Override
     ...
     */
    public Field34X setComponent1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field34X setCurrency(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field34X setComponent2(String component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field34X setComponent2(java.math.BigDecimal component2) {
     ...
     */
    public Field34X setComponent2(java.lang.Number component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field34X setAmount(String component2) {
     ...
     * @since 9.2.7
     */
    public Field34X setAmount(java.math.BigDecimal component2) {
        return setComponent2(component2);
    }
     ...
     * @see #setAmount(java.math.BigDecimal)
     */
    public Field34X setAmount(java.lang.Number component2) {
        return setComponent2(component2);
    }
     ...
     * @return the static value of Field34X.NAME
     */
    @Override
     ...
     */
    public static Field34X get(final SwiftTagListBlock block) {
        ...
        return new Field34X(t) ;
    }

    /**
     * Gets the first instance of Field34X in the given message.
     * @param msg may be empty or null
     * @return null if not found or msg is empty or null
     * @see #get(SwiftTagListBlock)
     */
    public static Field34X get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field34X in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field34X> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty())
    ...
    /**
     * Gets a list of all occurrences of the field Field34X from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field34X> getAll(final SwiftTagListBlock block) {
        if (block == null || block.isEmpty()) {
            return java.util.Collections.emptyList();
        }
        final Tag[] arr = block.getTagsByName(NAME);
        if (arr != null && arr.length > 0) {
            final List<Field34X> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
                result.add( new Field34X(f));
            }
            return result;
        }
        return java.util.Collections.emptyList();
    ...
    /**
     * This method deserializes the JSON data into a Field34X object.
     * @param json JSON structure including tuples with label and value for all field components
     * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
     * @since 7.10.3
     * @see Field#fromJson(String)
     */
    public static Field34X fromJson(final String json) {

        Field34X field = new Field34X();
