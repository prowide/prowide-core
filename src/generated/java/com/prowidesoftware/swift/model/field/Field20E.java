...
/**
 * <strong>SWIFT MT Field 20E</strong>
 * <p>
...
public class Field20E extends Field implements Serializable {
     ...
     * @see #typesPattern()
     * @return the static value of Field20E.COMPONENTS_PATTERN
     */
    @Override
    @Deprecated
    @ProwideDeprecated(phase2=TargetYear.SRU2022)
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field20E.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field20E.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field20E> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field20E> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
