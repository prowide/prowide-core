...
public class Field263 extends Field implements Serializable, DateContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field263.TYPES_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field263 setComponent5(java.lang.Long component5) {
     ...
     * @since 9.2.7
     */
    public Field263 setSessionNumber(java.lang.Long component5) {
        return setComponent5(component5);
    }
    ...
    public static List<Field263> getAll(final SwiftTagListBlock block) {
        final List<Field263> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field263 fromJson(final String json) {
        ...
        final Field263 field = new Field263();
