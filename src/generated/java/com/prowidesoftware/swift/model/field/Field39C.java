...
@Generated
public class Field39C extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field39C> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field39C> result = new ArrayList<Field39C>(arr.length);
			for (final Tag f : arr) {
