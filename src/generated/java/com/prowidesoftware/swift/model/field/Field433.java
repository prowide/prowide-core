 ...
 * <ol>
 * 		<li>Component 1: ScreeningResults: <code>String</code></li>
...
public class Field433 extends Field implements Serializable {
    ...
    public Field433(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "433")) {
    ...
    protected Map<String, Integer> getLabelMap() {
        ...
        super.labelMap.put("screeningresults", 1);
    ...
    /**
     * Set the component 1 (Screening Results).
     *
    ...
    /**
     * Set the Screening Results (component 1).
     *
     * @param component1 the Screening Results to set
     * @return the field object to enable build pattern
     */
    ...
    public static List<Field433> getAll(final SwiftTagListBlock block) {
        final List<Field433> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field433 fromJson(final String json) {
        ...
        final Field433 field = new Field433();

        final JsonObject jsonObject = JsonParser.parseString(json).getAsJsonObject();

        // **** COMPONENT 1 - Screening Results
