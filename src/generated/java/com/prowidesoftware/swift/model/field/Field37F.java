...
@Generated
public class Field37F extends Field implements Serializable, AmountContainer, DateContainer {
	/**
    ...
    public Field37F(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "37F")) {
     ...
     * @return the field object to enable build pattern
     */
    public Field37F setEndDate(String component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field37F setEndDate(java.util.Calendar component2) {
        return setComponent2(component2);
    }
     ...
     * @return the field object to enable build pattern
     */
    public Field37F setPeriod(String component3) {
     ...
     * @return the field object to enable build pattern
     */
    public Field37F setNumber(String component4) {
    ...
    public static List<Field37F> getAll(final SwiftTagListBlock block) {
        final List<Field37F> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
