...
public class Field31C extends Field implements Serializable, DateContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field31C.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field31C.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field31C> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field31C> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
