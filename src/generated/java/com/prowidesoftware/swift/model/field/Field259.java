...
public class Field259 extends Field implements Serializable, DateContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field259.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field259.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field259 setComponent2(java.lang.Long component2) {
     ...
     * @since 9.2.7
     */
    public Field259 setSessionNumber(java.lang.Long component2) {
        return setComponent2(component2);
    }
     ...
     * @return the field object to enable build pattern
     */
    public Field259 setComponent3(java.lang.Long component3) {
     ...
     * @since 9.2.7
     */
    public Field259 setMessageCategory(java.lang.Long component3) {
        return setComponent3(component3);
    }
    ...
    public static List<Field259> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field259> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
