...
@Generated
public class Field58A extends OptionAPartyField implements Serializable, BICContainer, MultiLineField {
	/**
    ...
    public Field58A(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "58A")) {
     ...
     * @return the field object to enable build pattern
     */
    public Field58A setIdentifierCode(String component3) {
     ...
     * @return the field object to enable build pattern
     */
    public Field58A setIdentifierCode(com.prowidesoftware.swift.model.BIC component3) {
        return setComponent3(component3);
    }
    ...
    public static Field58A fromJson(final String json) {
        ...
        final Field58A field = new Field58A();
