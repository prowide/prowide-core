...
@Generated
public class Field50E extends Field implements Serializable, MultiLineField {
	/**
	...
	/**
	 * Constant with the field name 50E.
	 */
    public static final String NAME = "50E";
    /**
     * Same as NAME, intended to be clear when using static imports.
     */
    public static final String F_50E = "50E";
     ...
     */
    public Field50E(final String value) {
        super(value);
    }
     ...
     * @since 7.8
     */
    public Field50E(final Tag tag) {
        this();
        if (tag == null) {
            throw new IllegalArgumentException("tag cannot be null.");
        }
        if (!Strings.CS.equals(tag.getName(), "50E")) {
            throw new IllegalArgumentException("cannot create field 50E from tag "+tag.getName()+", tagname must match the name of the field.");
        }
        parse(tag.getValue());
    }
     ...
     * @since 7.7
     */
    public static Field50E newInstance(Field50E source) {
        Field50E cp = new Field50E();
    ...
    public String getValueDisplay(int component, Locale locale) {
        if (component < 1 || component > 4) {
            throw new IllegalArgumentException("invalid component number " + component + " for field 50E");
        }
        if (component == 1) {
     ...
     */
    public Field50E setComponent1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field50E setNarrativeLine1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field50E setNarrative(String value) {
        List<String> lines = SwiftParseUtils.getLines(value);
     ...
     * @return the field object to enable build pattern
     */
    public Field50E setComponent2(String component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field50E setNarrativeLine2(String component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field50E setComponent3(String component3) {
     ...
     * @return the field object to enable build pattern
     */
    public Field50E setNarrativeLine3(String component3) {
     ...
     * @return the field object to enable build pattern
     */
    public Field50E setComponent4(String component4) {
     ...
     * @return the field object to enable build pattern
     */
    public Field50E setNarrativeLine4(String component4) {
     ...
     * @return the static value of Field50E.NAME
     */
    @Override
     ...
     */
    public static Field50E get(final SwiftTagListBlock block) {
        ...
        return new Field50E(t);
    }

    /**
     * Gets the first instance of Field50E in the given message.
     * @param msg may be empty or null
     * @return null if not found or msg is empty or null
     * @see #get(SwiftTagListBlock)
     */
    public static Field50E get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field50E in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field50E> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty()) {
    ...
    /**
     * Gets a list of all occurrences of the field Field50E from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field50E> getAll(final SwiftTagListBlock block) {
        final List<Field50E> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    /**
     * This method deserializes the JSON data into a Field50E object.
     * @param json JSON structure including tuples with label and value for all field components
     * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
     * @since 7.10.3
     * @see Field#fromJson(String)
     */
    public static Field50E fromJson(final String json) {

        final Field50E field = new Field50E();
