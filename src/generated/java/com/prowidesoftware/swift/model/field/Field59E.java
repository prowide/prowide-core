...
public class Field59E extends Field implements Serializable, MultiLineField {
	...
	/**
	 * Constant with the field name 59E.
	 */
    public static final String NAME = "59E";
    /**
     ...
     */
    public Field59E(final String value) {
        super(value);
    }
     ...
     * @since 7.8
     */
    public Field59E(final Tag tag) {
        this();
        if (tag == null) {
            throw new IllegalArgumentException("tag cannot be null.");
        }
        if (!Strings.CS.equals(tag.getName(), "59E")) {
            throw new IllegalArgumentException("cannot create field 59E from tag "+tag.getName()+", tagname must match the name of the field.");
        }
        parse(tag.getValue());
    }
     ...
     * @since 7.7
     */
    public static Field59E newInstance(Field59E source) {
        Field59E cp = new Field59E();
     ...
     * @return the static value of Field59E.NAME
     */
    @Override
     ...
     */
    public static Field59E get(final SwiftTagListBlock block) {
        ...
        return new Field59E(t);
    }

    /**
     * Gets the first instance of Field59E in the given message.
     * @param msg may be empty or null
     * @return null if not found or msg is empty or null
     * @see #get(SwiftTagListBlock)
     */
    public static Field59E get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field59E in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field59E> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty()) {
    ...
    /**
     * Gets a list of all occurrences of the field Field59E from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field59E> getAll(final SwiftTagListBlock block) {
        final List<Field59E> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
     ...
     */
    public static Field59E fromJson(final String json) {

        final Field59E field = new Field59E();
