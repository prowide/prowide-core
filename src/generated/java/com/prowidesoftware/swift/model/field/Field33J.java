...
public class Field33J extends Field implements Serializable, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field33J.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field33J.PARSER_PATTERN
     */
    @Override
    ...
    /**
     * Gets the Unit (component 1).
     * @return the Unit from component 1
     */
    ...
    /**
     * Set the Unit (component 1).
     *
     * @param component1 the Unit to set
     * @return the field object to enable build pattern
     */
    public Field33J setUnit(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field33J setComponent2(java.math.BigDecimal component2) {
     ...
     * @since 9.2.7
     */
    public Field33J setAmount(java.math.BigDecimal component2) {
        return setComponent2(component2);
    }
    ...
    public static List<Field33J> getAll(final SwiftTagListBlock block) {
        final List<Field33J> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field33J fromJson(final String json) {
        ...
        final Field33J field = new Field33J();
