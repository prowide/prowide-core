...
public class Field94H extends Field implements Serializable, GenericField {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field94H.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field94H.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field94H> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field94H> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
