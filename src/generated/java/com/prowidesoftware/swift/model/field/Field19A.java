...
public class Field19A extends Field implements Serializable, CurrencyContainer, AmountContainer, GenericField {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field19A.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field19A.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field19A setCurrencyCode(java.util.Currency component3) {
        return setComponent3(component3);
    }
     ...
     * @return the field object to enable build pattern
     */
    public Field19A setComponent4(java.math.BigDecimal component4) {
     ...
     * @since 9.2.7
     */
    public Field19A setAmount(java.math.BigDecimal component4) {
        return setComponent4(component4);
    }
    ...
    public static Field19A fromJson(final String json) {
        ...
        final Field19A field = new Field19A();
