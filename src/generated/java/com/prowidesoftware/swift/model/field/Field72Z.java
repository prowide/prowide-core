...
@Generated
public class Field72Z extends StructuredNarrativeField implements Serializable, NarrativeContainer, MultiLineField {
	/**
     ...
     * @since 8.1.0
     */
    public Field72Z(final Narrative narrative) {
     ...
     * @return the field object to enable build pattern
     */
    public Field72Z setNarrative(String component1) {
    ...
    public static List<Field72Z> getAll(final SwiftTagListBlock block) {
        final List<Field72Z> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field72Z fromJson(final String json) {
        ...
        final Field72Z field = new Field72Z();
    ...
    @Deprecated
    @com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear.SRU2022)
    public Field72Z setNarrativeLine1(String component) {
    ...
    @Deprecated
    @com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear.SRU2022)
    public Field72Z setComponent2(String component) {
    ...
    @Deprecated
    @com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear.SRU2022)
    public Field72Z setNarrativeLine2(String component) {
    ...
    @Deprecated
    @com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear.SRU2022)
    public Field72Z setComponent3(String component) {
    ...
    @Deprecated
    @com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear.SRU2022)
    public Field72Z setNarrativeLine3(String component) {
    ...
    @Deprecated
    @com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear.SRU2022)
    public Field72Z setComponent4(String component) {
    ...
    @Deprecated
    @com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear.SRU2022)
    public Field72Z setNarrativeLine4(String component) {
    ...
    @Deprecated
    @com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear.SRU2022)
    public Field72Z setComponent5(String component) {
    ...
    @Deprecated
    @com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear.SRU2022)
    public Field72Z setNarrativeLine5(String component) {
    ...
    @Deprecated
    @com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear.SRU2022)
    public Field72Z setComponent6(String component) {
    ...
    @Deprecated
    @com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear.SRU2022)
    public Field72Z setNarrativeLine6(String component) {
