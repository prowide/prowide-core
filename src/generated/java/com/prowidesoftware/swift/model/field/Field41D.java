...
@Generated
public class Field41D extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field41D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field41D> result = new ArrayList<Field41D>(arr.length);
			for (final Tag f : arr) {
