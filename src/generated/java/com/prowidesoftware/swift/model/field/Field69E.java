...
public class Field69E extends Field implements Serializable, DateContainer, GenericField {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field69E.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field69E.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field69E> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field69E> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
