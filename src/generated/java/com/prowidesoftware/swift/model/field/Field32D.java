...
public class Field32D extends Field implements Serializable, CurrencyContainer, DateContainer, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field32D.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field32D.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field32D setComponent3(java.math.BigDecimal component3) {
     ...
     * @since 9.2.7
     */
    public Field32D setAmount(java.math.BigDecimal component3) {
        return setComponent3(component3);
    }
    ...
    public static List<Field32D> getAll(final SwiftTagListBlock block) {
        final List<Field32D> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field32D fromJson(final String json) {
        ...
        final Field32D field = new Field32D();
