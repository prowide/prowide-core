...
@Generated
public class Field90L extends Field implements Serializable, AmountContainer, com.prowidesoftware.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field90L> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field90L> result = new ArrayList<Field90L>(arr.length);
			for (final Tag f : arr) {
