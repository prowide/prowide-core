...
public class Field33D extends Field implements Serializable, CurrencyContainer, DateContainer, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field33D.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field33D.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field33D> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field33D> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
