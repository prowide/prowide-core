...
/**
 * <strong>SWIFT MT Field 49A</strong>
 * <p>
 * Model and parser for field 49A of a SWIFT MT message.
 *
 ...
 * <ul>
 * 		<li>validation pattern: <code>4!c(**)[$65z]0-50</code></li>
 * 		<li>parser pattern: <code>S[$S]0-n</code></li>
...
@Generated
public class Field49A extends Field implements Serializable, MultiLineField {
	/**
	...
	/**
	 * Constant with the field name 49A
	 */
     ...
     */
    public Field49A(final String value) {
        super(value);
    }
     ...
     * @since 7.8
     */
    public Field49A(final Tag tag) {
        this();
        if (tag == null) {
            throw new IllegalArgumentException("tag cannot be null.");
        }
        if (!StringUtils.equals(tag.getName(), "49A")) {
    ...
    public void parse(final String value) {
        ...
        if (value != null) {
            ...
            if (lines != null && lines.length > 0) {
                // component 1 contains the instruction
                setComponent1(lines[0]);
            }
            if (lines != null && lines.length > 1) {
                // component 2 contains the narrative (could be more than one line)
     ...
     * @see #typesPattern()
     * @return the static value of Field49A.COMPONENTS_PATTERN
     */
    @Override
    @Deprecated
    @ProwideDeprecated(phase2=TargetYear.SRU2022)
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field49A.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field49A.PARSER_PATTERN
     */
    @Override
     ...
     * @return the static value of Field49A.NAME
     */
    @Override
     ...
     */
    public static Field49A get(final SwiftTagListBlock block) {
    ...
    /**
     * Gets the first instance of Field49A in the given message.
     * @param msg may be empty or null
     * @return null if not found or msg is empty or null
     * @see #get(SwiftTagListBlock)
     */
    public static Field49A get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field49A in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field49A> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty())
    ...
    /**
     * Gets a list of all occurrences of the field Field49A from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field49A> getAll(final SwiftTagListBlock block) {
        if (block == null || block.isEmpty()) {
            return java.util.Collections.emptyList();
        }
        final Tag[] arr = block.getTagsByName(NAME);
        if (arr != null && arr.length > 0) {
            final List<Field49A> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
    ...
    /**
     * This method deserializes the JSON data into a Field49A object.
     * @param json JSON structure including tuples with label and value for all field components
     * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
     * @since 7.10.3
     * @see Field#fromJson(String)
     */
    public static Field49A fromJson(final String json) {
