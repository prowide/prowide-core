...
public class Field140 extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field140.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field140.PARSER_PATTERN
     */
    @Override
    ...
    /**
     * Get the Identifier (component 1) as Long
     * @return the Identifier from component 1 converted to Long or null if cannot be converted
     * @since 9.2.7
     */
    public java.lang.Long getIdentifierAsLong() {
    ...
    /**
     * Alternative method setter for field's Identifier (component 1) as as Number
     *
    ...
    /**
     * Set the Identifier (component 1).
     *
     * @param component1 the Identifier to set
     * @return the field object to enable build pattern
     */
    ...
    public static List<Field140> getAll(final SwiftTagListBlock block) {
        final List<Field140> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field140 fromJson(final String json) {
        ...
        final Field140 field = new Field140();
