...
@Generated
public class Field94F extends Field implements Serializable, BICContainer, com.prowidesoftware.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field94F> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field94F> result = new ArrayList<Field94F>(arr.length);
			for (final Tag f : arr) {
