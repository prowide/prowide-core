...
/**
 * <strong>SWIFT MT Field 34W</strong>
 * <p>
 * Model and parser for field 34W of a SWIFT MT message.
 *
...
@Generated
public class Field34W extends Field implements Serializable, AmountContainer {
	/**
	...
	/**
	 * Constant with the field name 34W
	 */
    public static final String NAME = "34W";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_34W = "34W";
     ...
     */
    public Field34W(final String value) {
        super(value);
    }
     ...
     * @since 7.8
     */
    public Field34W(final Tag tag) {
        this();
        if (tag == null) {
            throw new IllegalArgumentException("tag cannot be null.");
        }
        if (!StringUtils.equals(tag.getName(), "34W")) {
            throw new IllegalArgumentException("cannot create field 34W from tag "+tag.getName()+", tagname must match the name of the field.");
        }
        parse(tag.getValue());
    }
     ...
     * @since 7.7
     */
    public static Field34W newInstance(Field34W source) {
        Field34W cp = new Field34W();
    ...
    public String getValueDisplay(int component, Locale locale) {
        if (component < 1 || component > 2) {
            throw new IllegalArgumentException("invalid component number " + component + " for field 34W");
        }
        if (component == 1) {
     ...
     * @see #typesPattern()
     * @return the static value of Field34W.COMPONENTS_PATTERN
     */
    @Override
    @Deprecated
    @ProwideDeprecated(phase2=TargetYear.SRU2022)
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field34W.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field34W.PARSER_PATTERN
     */
    @Override
     ...
     */
    public Field34W setComponent1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field34W setCurrency(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field34W setComponent2(String component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field34W setComponent2(java.math.BigDecimal component2) {
     ...
     */
    public Field34W setComponent2(java.lang.Number component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field34W setAmount(String component2) {
     ...
     * @since 9.2.7
     */
    public Field34W setAmount(java.math.BigDecimal component2) {
        return setComponent2(component2);
    }
     ...
     * @see #setAmount(java.math.BigDecimal)
     */
    public Field34W setAmount(java.lang.Number component2) {
        return setComponent2(component2);
    }
     ...
     * @return the static value of Field34W.NAME
     */
    @Override
     ...
     */
    public static Field34W get(final SwiftTagListBlock block) {
        ...
        return new Field34W(t) ;
    }

    /**
     * Gets the first instance of Field34W in the given message.
     * @param msg may be empty or null
     * @return null if not found or msg is empty or null
     * @see #get(SwiftTagListBlock)
     */
    public static Field34W get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field34W in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field34W> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty())
    ...
    /**
     * Gets a list of all occurrences of the field Field34W from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field34W> getAll(final SwiftTagListBlock block) {
        if (block == null || block.isEmpty()) {
            return java.util.Collections.emptyList();
        }
        final Tag[] arr = block.getTagsByName(NAME);
        if (arr != null && arr.length > 0) {
            final List<Field34W> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
                result.add( new Field34W(f));
            }
            return result;
        }
        return java.util.Collections.emptyList();
    ...
    /**
     * This method deserializes the JSON data into a Field34W object.
     * @param json JSON structure including tuples with label and value for all field components
     * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
     * @since 7.10.3
     * @see Field#fromJson(String)
     */
    public static Field34W fromJson(final String json) {

        Field34W field = new Field34W();
