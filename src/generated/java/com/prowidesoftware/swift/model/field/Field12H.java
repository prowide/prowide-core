...
/**
 * <strong>SWIFT MT Field 12H</strong>
 * <p>
 * Model and parser for field 12H of a SWIFT MT message.
 *
...
@Generated
public class Field12H extends Field implements Serializable {
	/**
	...
	/**
	 * Constant with the field name 12H
	 */
     ...
     */
    public Field12H(final String value) {
        super(value);
    }
     ...
     * @since 7.8
     */
    public Field12H(final Tag tag) {
        this();
        if (tag == null) {
            throw new IllegalArgumentException("tag cannot be null.");
        }
        if (!StringUtils.equals(tag.getName(), "12H")) {
     ...
     * @see #typesPattern()
     * @return the static value of Field12H.COMPONENTS_PATTERN
     */
    @Override
    @Deprecated
    @ProwideDeprecated(phase2=TargetYear.SRU2022)
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field12H.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field12H.PARSER_PATTERN
     */
    @Override
     ...
     * @return the static value of Field12H.NAME
     */
    @Override
     ...
     */
    public static Field12H get(final SwiftTagListBlock block) {
    ...
    /**
     * Gets the first instance of Field12H in the given message.
     * @param msg may be empty or null
     * @return null if not found or msg is empty or null
     * @see #get(SwiftTagListBlock)
     */
    public static Field12H get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field12H in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field12H> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty())
    ...
    /**
     * Gets a list of all occurrences of the field Field12H from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field12H> getAll(final SwiftTagListBlock block) {
        if (block == null || block.isEmpty()) {
            return java.util.Collections.emptyList();
        }
        final Tag[] arr = block.getTagsByName(NAME);
        if (arr != null && arr.length > 0) {
            final List<Field12H> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
    ...
    /**
     * This method deserializes the JSON data into a Field12H object.
     * @param json JSON structure including tuples with label and value for all field components
     * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
     * @since 7.10.3
     * @see Field#fromJson(String)
     */
    public static Field12H fromJson(final String json) {
