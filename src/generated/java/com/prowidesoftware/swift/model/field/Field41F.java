...
/**
 * <strong>SWIFT MT Field 41F</strong>
 * <p>
 * Model and parser for field 41F of a SWIFT MT message.
 *
...
@Generated
public class Field41F extends Field implements Serializable, BICContainer {
	/**
	...
	/**
	 * Constant with the field name 41F
	 */
    public static final String NAME = "41F";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_41F = "41F";
     ...
     */
    public Field41F(final String value) {
        super(value);
    }
     ...
     * @since 7.8
     */
    public Field41F(final Tag tag) {
        this();
        if (tag == null) {
            throw new IllegalArgumentException("tag cannot be null.");
        }
        if (!StringUtils.equals(tag.getName(), "41F")) {
            throw new IllegalArgumentException("cannot create field 41F from tag "+tag.getName()+", tagname must match the name of the field.");
        }
        parse(tag.getValue());
    }
     ...
     * @since 7.7
     */
    public static Field41F newInstance(Field41F source) {
        Field41F cp = new Field41F();
     ...
     * @see #typesPattern()
     * @return the static value of Field41F.COMPONENTS_PATTERN
     */
    @Override
    @Deprecated
    @ProwideDeprecated(phase2=TargetYear.SRU2022)
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field41F.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field41F.PARSER_PATTERN
     */
    @Override
     ...
     * @return the static value of Field41F.NAME
     */
    @Override
     ...
     */
    public static Field41F get(final SwiftTagListBlock block) {
        ...
        return new Field41F(t) ;
    }

    /**
     * Gets the first instance of Field41F in the given message.
     * @param msg may be empty or null
     * @return null if not found or msg is empty or null
     * @see #get(SwiftTagListBlock)
     */
    public static Field41F get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field41F in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field41F> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty())
    ...
    /**
     * Gets a list of all occurrences of the field Field41F from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field41F> getAll(final SwiftTagListBlock block) {
        if (block == null || block.isEmpty()) {
            return java.util.Collections.emptyList();
        }
        final Tag[] arr = block.getTagsByName(NAME);
        if (arr != null && arr.length > 0) {
            final List<Field41F> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
    ...
    /**
     * This method deserializes the JSON data into a Field41F object.
     * @param json JSON structure including tuples with label and value for all field components
     * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
     * @since 7.10.3
     * @see Field#fromJson(String)
     */
    public static Field41F fromJson(final String json) {

        Field41F field = new Field41F();
