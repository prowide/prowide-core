...
@Generated
public class Field96A extends OptionAPartyField implements Serializable, BICContainer, MultiLineField {
	/**
    ...
    public Field96A(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "96A")) {
     ...
     * @return the field object to enable build pattern
     */
    public Field96A setIdentifierCode(String component3) {
     ...
     * @return the field object to enable build pattern
     */
    public Field96A setIdentifierCode(com.prowidesoftware.swift.model.BIC component3) {
        return setComponent3(component3);
    }
    ...
    public static List<Field96A> getAll(final SwiftTagListBlock block) {
        final List<Field96A> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field96A fromJson(final String json) {
        ...
        final Field96A field = new Field96A();
