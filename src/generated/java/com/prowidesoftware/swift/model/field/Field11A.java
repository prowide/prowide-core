...
public class Field11A extends Field implements Serializable, CurrencyContainer, GenericField {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field11A.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field11A.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field11A setCurrencyCode(java.util.Currency component2) {
        return setComponent2(component2);
    }
    ...
    public static List<Field11A> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field11A> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
