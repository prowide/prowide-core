 ...
 * 		<li>Component 2: Quantity: <code>BigDecimal</code></li>
...
@Generated
public class Field92N extends Field implements Serializable, MonetaryAmountContainer, GenericField {
	/**
    ...
    @Deprecated
    @ProwideDeprecated(phase3 = TargetYear.SRU2023)
	public static final String TYPES_PATTERN = "SICI";
     ...
     * @return the field object to enable build pattern
     */
    public Field92N setCurrencyCode(java.util.Currency component3) {
        return setComponent3(component3);
    }
    ...
    public static Field92N fromJson(final String json) {
        ...
        final Field92N field = new Field92N();
