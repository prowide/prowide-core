...
public class Field26H extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field26H.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field26H.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field26H> getAll(final SwiftTagListBlock block) {
        final List<Field26H> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field26H fromJson(final String json) {
        ...
        final Field26H field = new Field26H();
