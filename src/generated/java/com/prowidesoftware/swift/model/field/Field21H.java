...
/**
 * <strong>SWIFT MT Field 21H</strong>
 * <p>
 * Model and parser for field 21H of a SWIFT MT message.
 *
...
@Generated
public class Field21H extends Field implements Serializable {
	/**
	...
	/**
	 * Constant with the field name 21H
	 */
	 ...
	 */
	public Field21H(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field21H(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "21H")) {
	 ...
	 * @return the static value of Field21H.COMPONENTS_PATTERN
	 */
	@Override
     ...
     * @return the static value of Field21H.PARSER_PATTERN
     */
	@Override
	 ...
	 * @return the static value of Field21H.NAME
	 */
	@Override
	 ...
	 */
	public static Field21H get(final SwiftTagListBlock block) {
	...
	/**
	 * Gets the first instance of Field21H in the given message.
	 * @param msg may be empty or null
	 * @return null if not found or msg is empty or null
	 * @see #get(SwiftTagListBlock)
	 */
	public static Field21H get(final SwiftMessage msg) {
	...
	/**
	 * Gets a list of all occurrences of the field Field21H in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field21H> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field21H from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field21H> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field21H> result = new ArrayList<>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field21H object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field21H fromJson(final String json) {
