...
public class Field111 extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field111.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field111.PARSER_PATTERN
     */
    @Override
    ...
    /**
     * Get the Service Type Identifier (component 1) as Long
     * @return the Service Type Identifier from component 1 converted to Long or null if cannot be converted
     * @since 9.2.7
     */
    public java.lang.Long getServiceTypeIdentifierAsLong() {
    ...
    /**
     * Alternative method setter for field's Service Type Identifier (component 1) as as Number
     *
    ...
    /**
     * Set the Service Type Identifier (component 1).
     *
     * @param component1 the Service Type Identifier to set
     * @return the field object to enable build pattern
     */
    ...
    public static List<Field111> getAll(final SwiftTagListBlock block) {
        final List<Field111> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field111 fromJson(final String json) {
        ...
        final Field111 field = new Field111();

        final JsonObject jsonObject = JsonParser.parseString(json).getAsJsonObject();

        // **** COMPONENT 1 - Service Type Identifier
