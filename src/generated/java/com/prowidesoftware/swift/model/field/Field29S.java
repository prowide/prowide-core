...
/**
 * <strong>SWIFT MT Field 29S</strong>
 * <p>
...
public class Field29S extends Field implements Serializable {
	 ...
	 * @return the static value of Field29S.COMPONENTS_PATTERN
	 */
	@Override
     ...
     * @return the static value of Field29S.PARSER_PATTERN
     */
	@Override
	...
	/**
	 * Set the component2 (Party Identifier).
	...
	/**
	 * Set the Party Identifier (component2).
	...
	public static List<Field29S> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field29S> result = new ArrayList<>(arr.length);
			for (final Tag f : arr) {
