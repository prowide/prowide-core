...
/**
 * <strong>SWIFT MT Field 13E</strong>
 * <p>
 * Model and parser for field 13E of a SWIFT MT message.
 *
 ...
 * <ul>
 * 		<li>validation pattern: <code>&lt;DATE4&gt;&lt;HHMM&gt;</code></li>
 * 		<li>parser pattern: <code>&lt;DATE4&gt;&lt;HHMM&gt;</code></li>
 * 		<li>components pattern: <code>DH</code></li>
 * </ul>
 *
 * <p>
...
public class Field13E extends Field implements Serializable, DateContainer {
     ...
     * @since 9.2.7
     */
	public static final String TYPES_PATTERN = "DH";
     ...
     */
    public Field13E(final String value) {
        super(value);
    }
     ...
     * @since 7.8
     */
    public Field13E(final Tag tag) {
        this();
        if (tag == null) {
            throw new IllegalArgumentException("tag cannot be null.");
        }
        if (!StringUtils.equals(tag.getName(), "13E")) {
    ...
    public void parse(final String value) {
        ...
        if (value != null) {
            ...
            if (value.length() >= 12) {
                setComponent2(StringUtils.substring(value, 8, 12));
            }
        }
    }
     ...
     * @see #typesPattern()
     * @return the static value of Field13E.COMPONENTS_PATTERN
     */
    @Override
    @Deprecated
    @ProwideDeprecated(phase2=TargetYear.SRU2022)
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field13E.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field13E.PARSER_PATTERN
     */
    @Override
     ...
     * @return the static value of Field13E.NAME
     */
    @Override
    ...
    /**
     * Gets the first instance of Field13E in the given message.
    ...
    /**
     * Gets a list of all occurrences of the field Field13E in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field13E> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty())
    ...
    /**
     * Gets a list of all occurrences of the field Field13E from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field13E> getAll(final SwiftTagListBlock block) {
        if (block == null || block.isEmpty()) {
            return java.util.Collections.emptyList();
        }
        final Tag[] arr = block.getTagsByName(NAME);
        if (arr != null && arr.length > 0) {
            final List<Field13E> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
    ...
    /**
     * This method deserializes the JSON data into a Field13E object.
     * @param json JSON structure including tuples with label and value for all field components
     * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
     * @since 7.10.3
     * @see Field#fromJson(String)
     */
    public static Field13E fromJson(final String json) {
