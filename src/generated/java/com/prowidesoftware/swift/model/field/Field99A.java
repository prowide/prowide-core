...
@Generated
public class Field99A extends Field implements Serializable, AmountContainer, com.prowidesoftware.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field99A> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field99A> result = new ArrayList<Field99A>(arr.length);
			for (final Tag f : arr) {
