...
public class Field18D extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field18D.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field18D.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field18D setComponent1(java.lang.Long component1) {
     ...
     * @since 9.2.7
     */
    public Field18D setNumber(java.lang.Long component1) {
        return setComponent1(component1);
    }
    ...
    public static List<Field18D> getAll(final SwiftTagListBlock block) {
        final List<Field18D> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field18D fromJson(final String json) {
        ...
        final Field18D field = new Field18D();
