...
@Generated
public class Field49H extends Field implements Serializable, MultiLineField {
	/**
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field49H.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field49H.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field49H> getAll(final SwiftTagListBlock block) {
        final List<Field49H> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field49H fromJson(final String json) {
        ...
        final Field49H field = new Field49H();
