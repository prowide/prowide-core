...
public class Field30X extends Field implements Serializable, DateContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field30X.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field30X.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field30X> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field30X> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
