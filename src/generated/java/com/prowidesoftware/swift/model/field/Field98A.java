...
public class Field98A extends Field implements Serializable, DateContainer, GenericField {
     ...
     * @since 9.2.7
     */
	public static final String TYPES_PATTERN = "SD";
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field98A.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field98A.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field98A> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field98A> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
