...
public class Field50C extends Field implements Serializable, BICContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field50C.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field50C.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field50C setIdentifierCode(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field50C setIdentifierCode(com.prowidesoftware.swift.model.BIC component1) {
        return setComponent1(component1);
    }
    ...
    public static List<Field50C> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field50C> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
