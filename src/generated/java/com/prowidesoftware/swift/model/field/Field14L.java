...
public class Field14L extends Field implements Serializable {
    ...
    public Field14L(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "14L")) {
     ...
     */
    public Field14L setComponent1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field14L setConvention(String component1) {
     ...
     * @return the static value of Field14L.NAME
     */
    @Override
     ...
     */
    public static Field14L get(final SwiftTagListBlock block) {
        ...
        return new Field14L(t);
    }

    /**
     * Gets the first instance of Field14L in the given message.
     * @param msg may be empty or null
     * @return null if not found or msg is empty or null
     * @see #get(SwiftTagListBlock)
     */
    public static Field14L get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field14L in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field14L> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty()) {
    ...
    /**
     * Gets a list of all occurrences of the field Field14L from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field14L> getAll(final SwiftTagListBlock block) {
        final List<Field14L> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    /**
     * This method deserializes the JSON data into a Field14L object.
     * @param json JSON structure including tuples with label and value for all field components
     * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
     * @since 7.10.3
     * @see Field#fromJson(String)
     */
    public static Field14L fromJson(final String json) {

        final Field14L field = new Field14L();
