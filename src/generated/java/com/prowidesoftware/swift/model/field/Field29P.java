...
public class Field29P extends Field implements Serializable, BICContainer {
     ...
     * @see #typesPattern()
     * @return the static value of Field29P.COMPONENTS_PATTERN
     */
    @Override
    @Deprecated
    @ProwideDeprecated(phase2=TargetYear.SRU2022)
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field29P.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field29P.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field29P> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field29P> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
