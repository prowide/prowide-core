...
public class Field70C extends Field implements Serializable, GenericField, MultiLineField {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field70C.TYPES_PATTERN
     */
    @Override
    ...
    /**
     * Gets the Narrative as a concatenation of component 2 to component 5.
    ...
    /**
     * Gets the Narrative as a concatenation of component 2 to component 5 joined together with a copy of the
     * specified delimiter.
    ...
    public static List<Field70C> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field70C> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
