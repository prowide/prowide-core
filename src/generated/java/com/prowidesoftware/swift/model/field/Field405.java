...
public class Field405 extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field405.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field405.PARSER_PATTERN
     */
    @Override
    ...
    /**
     * Get the Line Field Number (component 2) as as Number (BigDecimal)
     *
     * The value is returned as BigDecimal to keep compatibility with previous API. You should
     * use <code>getComponent2AsLong()</code> to get the proper value.
     *
     ...
     * @since 9.2.7
     *
     * @param component2 the Long with the Line Field Number content to set
     * @return the field object to enable build pattern
     */
    public Field405 setComponent2(java.lang.Long component2) {
    ...
    /**
     * Set the Line Field Number (component 2) from a Long object.
     *
     * @see #setComponent2(java.lang.Long)
     *
     * @param component2 Long with the Line Field Number content to set
     * @return the field object to enable build pattern
     * @since 9.2.7
     */
    public Field405 setLineFieldNumber(java.lang.Long component2) {
        return setComponent2(component2);
    }
    ...
    public static List<Field405> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field405> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
