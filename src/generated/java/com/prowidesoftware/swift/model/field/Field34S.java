...
/**
 * <strong>SWIFT MT Field 34S</strong>
 * <p>
 * Model and parser for field 34S of a SWIFT MT message.
 *
...
@Generated
public class Field34S extends Field implements Serializable, AmountContainer {
	/**
	...
	/**
	 * Constant with the field name 34S
	 */
    public static final String NAME = "34S";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_34S = "34S";
     ...
     */
    public Field34S(final String value) {
        super(value);
    }
     ...
     * @since 7.8
     */
    public Field34S(final Tag tag) {
        this();
        if (tag == null) {
            throw new IllegalArgumentException("tag cannot be null.");
        }
        if (!StringUtils.equals(tag.getName(), "34S")) {
            throw new IllegalArgumentException("cannot create field 34S from tag "+tag.getName()+", tagname must match the name of the field.");
        }
        parse(tag.getValue());
    }
     ...
     * @since 7.7
     */
    public static Field34S newInstance(Field34S source) {
        Field34S cp = new Field34S();
    ...
    public String getValueDisplay(int component, Locale locale) {
        if (component < 1 || component > 2) {
            throw new IllegalArgumentException("invalid component number " + component + " for field 34S");
        }
        if (component == 1) {
     ...
     * @see #typesPattern()
     * @return the static value of Field34S.COMPONENTS_PATTERN
     */
    @Override
    @Deprecated
    @ProwideDeprecated(phase2=TargetYear.SRU2022)
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field34S.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field34S.PARSER_PATTERN
     */
    @Override
     ...
     */
    public Field34S setComponent1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field34S setCurrency(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field34S setComponent2(String component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field34S setAmount(String component2) {
     ...
     * @return the static value of Field34S.NAME
     */
    @Override
     ...
     */
    public static Field34S get(final SwiftTagListBlock block) {
        ...
        return new Field34S(t) ;
    }

    /**
     * Gets the first instance of Field34S in the given message.
     * @param msg may be empty or null
     * @return null if not found or msg is empty or null
     * @see #get(SwiftTagListBlock)
     */
    public static Field34S get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field34S in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field34S> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty())
    ...
    /**
     * Gets a list of all occurrences of the field Field34S from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field34S> getAll(final SwiftTagListBlock block) {
        if (block == null || block.isEmpty()) {
            return java.util.Collections.emptyList();
        }
        final Tag[] arr = block.getTagsByName(NAME);
        if (arr != null && arr.length > 0) {
            final List<Field34S> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
                result.add( new Field34S(f));
            }
            return result;
        }
        return java.util.Collections.emptyList();
    ...
    /**
     * This method deserializes the JSON data into a Field34S object.
     * @param json JSON structure including tuples with label and value for all field components
     * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
     * @since 7.10.3
     * @see Field#fromJson(String)
     */
    public static Field34S fromJson(final String json) {

        Field34S field = new Field34S();
