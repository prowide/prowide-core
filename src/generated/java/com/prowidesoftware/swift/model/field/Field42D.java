...
@Generated
public class Field42D extends OptionDPartyField implements Serializable, MultiLineField {
	/**
    ...
    public Field42D(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "42D")) {
    ...
    public static List<Field42D> getAll(final SwiftTagListBlock block) {
        final List<Field42D> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field42D fromJson(final String json) {
        ...
        final Field42D field = new Field42D();
