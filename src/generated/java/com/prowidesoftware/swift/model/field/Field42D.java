...
@Generated
public class Field42D extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field42D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field42D> result = new ArrayList<Field42D>(arr.length);
			for (final Tag f : arr) {
