...
@Generated
public class Field88A extends OptionAPartyField implements Serializable, BICContainer, MultiLineField {
	/**
    ...
    public Field88A(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "88A")) {
    ...
    public static Field88A fromJson(final String json) {
        ...
        final Field88A field = new Field88A();
