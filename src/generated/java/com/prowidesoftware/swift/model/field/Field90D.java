...
public class Field90D extends Field implements Serializable, CurrencyContainer, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field90D.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field90D.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field90D setComponent1(java.lang.Long component1) {
     ...
     * @since 9.2.7
     */
    public Field90D setNumber(java.lang.Long component1) {
        return setComponent1(component1);
    }
     ...
     * @return the field object to enable build pattern
     */
    public Field90D setComponent3(java.math.BigDecimal component3) {
     ...
     * @since 9.2.7
     */
    public Field90D setAmount(java.math.BigDecimal component3) {
        return setComponent3(component3);
    }
    ...
    public static List<Field90D> getAll(final SwiftTagListBlock block) {
        final List<Field90D> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field90D fromJson(final String json) {
        ...
        final Field90D field = new Field90D();
