...
@Generated
public class Field88D extends OptionDPartyField implements Serializable, MultiLineField {
	/**
    ...
    public Field88D(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "88D")) {
    ...
    public static Field88D fromJson(final String json) {
        ...
        final Field88D field = new Field88D();
