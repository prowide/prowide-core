...
public class Field31D extends Field implements Serializable, DateContainer {
     ...
     * @since 9.2.7
     */
	public static final String TYPES_PATTERN = "ES";
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field31D.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field31D.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field31D> getAll(final SwiftTagListBlock block) {
        final List<Field31D> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field31D fromJson(final String json) {
        ...
        final Field31D field = new Field31D();
