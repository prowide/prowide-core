...
/**
 * <strong>SWIFT MT Field 77U</strong>
 * <p>
...
public class Field77U extends Field implements Serializable, MultiLineField {
     ...
     * @see #typesPattern()
     * @return the static value of Field77U.COMPONENTS_PATTERN
     */
    @Override
    @Deprecated
    @ProwideDeprecated(phase2=TargetYear.SRU2022)
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field77U.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field77U.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field77U> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field77U> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
