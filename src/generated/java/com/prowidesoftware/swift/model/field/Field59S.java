...
@Generated
public class Field59S extends Field implements Serializable, MultiLineField {
	/**
	...
	/**
	 * Constant with the field name 59S.
	 */
    public static final String NAME = "59S";
    /**
     * Same as NAME, intended to be clear when using static imports.
     */
    public static final String F_59S = "59S";
     ...
     */
    public Field59S(final String value) {
        super(value);
    }
     ...
     * @since 7.8
     */
    public Field59S(final Tag tag) {
        this();
        if (tag == null) {
            throw new IllegalArgumentException("tag cannot be null.");
        }
        if (!Strings.CS.equals(tag.getName(), "59S")) {
            throw new IllegalArgumentException("cannot create field 59S from tag "+tag.getName()+", tagname must match the name of the field.");
        }
        parse(tag.getValue());
    }
     ...
     * @since 7.7
     */
    public static Field59S newInstance(Field59S source) {
        Field59S cp = new Field59S();
    ...
    public String getValueDisplay(int component, Locale locale) {
        if (component < 1 || component > 4) {
            throw new IllegalArgumentException("invalid component number " + component + " for field 59S");
        }
        if (component == 1) {
     ...
     */
    public Field59S setComponent1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field59S setNameAndAddressLine1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field59S setNameAndAddress(String value) {
        List<String> lines = SwiftParseUtils.getLines(value);
     ...
     * @return the field object to enable build pattern
     */
    public Field59S setComponent2(String component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field59S setNameAndAddressLine2(String component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field59S setComponent3(String component3) {
     ...
     * @return the field object to enable build pattern
     */
    public Field59S setNameAndAddressLine3(String component3) {
     ...
     * @return the field object to enable build pattern
     */
    public Field59S setComponent4(String component4) {
     ...
     * @return the field object to enable build pattern
     */
    public Field59S setNameAndAddressLine4(String component4) {
     ...
     * @return the static value of Field59S.NAME
     */
    @Override
     ...
     */
    public static Field59S get(final SwiftTagListBlock block) {
        ...
        return new Field59S(t);
    }

    /**
     * Gets the first instance of Field59S in the given message.
     * @param msg may be empty or null
     * @return null if not found or msg is empty or null
     * @see #get(SwiftTagListBlock)
     */
    public static Field59S get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field59S in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field59S> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty()) {
    ...
    /**
     * Gets a list of all occurrences of the field Field59S from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field59S> getAll(final SwiftTagListBlock block) {
    ...
    /**
     * This method deserializes the JSON data into a Field59S object.
     * @param json JSON structure including tuples with label and value for all field components
     * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
     * @since 7.10.3
     * @see Field#fromJson(String)
     */
    public static Field59S fromJson(final String json) {

        final Field59S field = new Field59S();
