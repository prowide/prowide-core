 ...
 * <ol>
 * 		<li>Component 1: ServiceCode: <code>String</code></li>
 * 		<li>Component 2: PaymentInformation: <code>String</code></li>
 * </ol>
 *
...
public class Field165 extends Field implements Serializable {
    ...
    public Field165(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "165")) {
    ...
    protected Map<String, Integer> getLabelMap() {
        ...
        super.labelMap.put("servicecode", 1);
        super.labelMap.put("paymentinformation", 2);
        return super.labelMap;
    }
    ...
    /**
     * Set the component 1 (Service Code).
     *
    ...
    /**
     * Set the Service Code (component 1).
     *
     * @param component1 the Service Code to set
     * @return the field object to enable build pattern
     */
    ...
    /**
     * Set the component 2 (Payment Information).
     *
    ...
    /**
     * Set the Payment Information (component 2).
     *
     * @param component2 the Payment Information to set
     * @return the field object to enable build pattern
     */
    ...
    public static List<Field165> getAll(final SwiftTagListBlock block) {
        final List<Field165> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
