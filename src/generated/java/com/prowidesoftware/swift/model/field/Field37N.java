...
@Generated
public class Field37N extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field37N> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field37N> result = new ArrayList<Field37N>(arr.length);
			for (final Tag f : arr) {
