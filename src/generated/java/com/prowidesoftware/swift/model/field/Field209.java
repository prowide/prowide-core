...
public class Field209 extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field209.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field209.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field209 setComponent1(java.lang.Long component1) {
     ...
     * @since 9.2.7
     */
    public Field209 setType(java.lang.Long component1) {
        return setComponent1(component1);
    }
    ...
    public static List<Field209> getAll(final SwiftTagListBlock block) {
        final List<Field209> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field209 fromJson(final String json) {
        ...
        final Field209 field = new Field209();
