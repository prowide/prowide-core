...
@Generated
public class Field81A extends OptionAPartyField implements Serializable, BICContainer, MultiLineField {
	/**
    ...
    public Field81A(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "81A")) {
     ...
     * @return the field object to enable build pattern
     */
    public Field81A setIdentifierCode(String component3) {
     ...
     * @return the field object to enable build pattern
     */
    public Field81A setIdentifierCode(com.prowidesoftware.swift.model.BIC component3) {
        return setComponent3(component3);
    }
    ...
    public static List<Field81A> getAll(final SwiftTagListBlock block) {
        final List<Field81A> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field81A fromJson(final String json) {
        ...
        final Field81A field = new Field81A();
