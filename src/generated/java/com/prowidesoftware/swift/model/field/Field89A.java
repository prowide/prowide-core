...
@Generated
public class Field89A extends OptionAPartyField implements Serializable, BICContainer, MultiLineField {
	/**
    ...
    public Field89A(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "89A")) {
     ...
     * @return the field object to enable build pattern
     */
    public Field89A setIdentifierCode(String component3) {
    ...
    public static List<Field89A> getAll(final SwiftTagListBlock block) {
        final List<Field89A> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field89A fromJson(final String json) {
        ...
        final Field89A field = new Field89A();
