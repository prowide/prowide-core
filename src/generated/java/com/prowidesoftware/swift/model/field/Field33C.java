...
public class Field33C extends Field implements Serializable, CurrencyContainer, DateContainer, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field33C.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field33C.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field33C setComponent3(java.math.BigDecimal component3) {
     ...
     * @since 9.2.7
     */
    public Field33C setAmount(java.math.BigDecimal component3) {
        return setComponent3(component3);
    }
    ...
    public static List<Field33C> getAll(final SwiftTagListBlock block) {
        final List<Field33C> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field33C fromJson(final String json) {
        ...
        final Field33C field = new Field33C();
