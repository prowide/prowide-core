...
public class Field151 extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field151.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field151.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field151> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field151> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
