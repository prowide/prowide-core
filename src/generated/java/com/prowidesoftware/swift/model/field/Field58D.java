...
@Generated
public class Field58D extends OptionDPartyField implements Serializable, MultiLineField {
	/**
    ...
    public Field58D(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "58D")) {
    ...
    public static Field58D fromJson(final String json) {
        ...
        final Field58D field = new Field58D();
