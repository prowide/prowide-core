...
public class Field270 extends Field implements Serializable {
     ...
     * @return the static value of Field270.PARSER_PATTERN
     */
	@Override
	...
	/**
	 * Gets the component2 (Login Block).
	...
	/**
	 * Set the component2 (Login Block).
	...
	public static List<Field270> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field270> result = new ArrayList<>(arr.length);
			for (final Tag f : arr) {
