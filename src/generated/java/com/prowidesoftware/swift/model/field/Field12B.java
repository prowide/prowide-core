 ...
 * 		<li>Component 3: InstrumentTypeCode: <code>String</code></li>
 * </ol>
 *
...
public class Field12B extends Field implements Serializable, GenericField {
    ...
    public Field12B(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "12B")) {
    ...
    protected Map<String, Integer> getLabelMap() {
        ...
        super.labelMap.put("instrumenttypecode", 3);
        // alias name
        super.labelMap.put("type", 3);
        return super.labelMap;
    }
    ...
    /**
     * Gets the component 3 (Instrument Type Code).
    ...
    /**
     * Gets the Instrument Type Code (component 3).
     * @return the Instrument Type Code from component 3
     */
    ...
    /**
     * Set the component 3 (Instrument Type Code).
     *
    ...
    /**
     * Set the Instrument Type Code (component 3).
     *
     * @param component3 the Instrument Type Code to set
     * @return the field object to enable build pattern
     */
    ...
    public static Field12B fromJson(final String json) {
        ...
        final Field12B field = new Field12B();
