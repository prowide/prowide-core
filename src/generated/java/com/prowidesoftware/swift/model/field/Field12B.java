...
public class Field12B extends Field implements Serializable, GenericField {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field12B.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field12B.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field12B> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field12B> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
