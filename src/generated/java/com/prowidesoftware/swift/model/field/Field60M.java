...
public class Field60M extends Field implements Serializable, CurrencyContainer, DateContainer, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field60M.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field60M.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field60M> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field60M> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
