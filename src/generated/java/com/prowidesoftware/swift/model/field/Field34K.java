...
/**
 * <strong>SWIFT MT Field 34K</strong>
 * <p>
...
public class Field34K extends Field implements Serializable, AmountContainer {
     ...
     * @see #typesPattern()
     * @return the static value of Field34K.COMPONENTS_PATTERN
     */
    @Override
    @Deprecated
    @ProwideDeprecated(phase2=TargetYear.SRU2022)
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field34K.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field34K.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field34K> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field34K> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
