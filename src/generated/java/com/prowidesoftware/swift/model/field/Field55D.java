...
@Generated
public class Field55D extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field55D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field55D> result = new ArrayList<Field55D>(arr.length);
			for (final Tag f : arr) {
