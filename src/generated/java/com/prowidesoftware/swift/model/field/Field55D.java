...
@Generated
public class Field55D extends OptionDPartyField implements Serializable, MultiLineField {
	/**
    ...
    public Field55D(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "55D")) {
    ...
    public static List<Field55D> getAll(final SwiftTagListBlock block) {
        final List<Field55D> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field55D fromJson(final String json) {
        ...
        final Field55D field = new Field55D();
