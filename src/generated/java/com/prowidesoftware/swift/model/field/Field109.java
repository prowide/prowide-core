...
public class Field109 extends Field implements Serializable, DateContainer {
     ...
     * @since 9.2.7
     */
	public static final String TYPES_PATTERN = "DTS";
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field109.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field109.PARSER_PATTERN
     */
    @Override
    ...
    /**
     * Gets the MIR (component 3).
     * @return the MIR from component 3
     */
    ...
    public static List<Field109> getAll(final SwiftTagListBlock block) {
        final List<Field109> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field109 fromJson(final String json) {
        ...
        final Field109 field = new Field109();
