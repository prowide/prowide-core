...
public class Field42A extends OptionAPartyField implements Serializable, BICContainer, MultiLineField {
    ...
    public Field42A(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "42A")) {
     ...
     * @return the field object to enable build pattern
     */
    public Field42A setIdentifierCode(String component3) {
     ...
     * @return the field object to enable build pattern
     */
    public Field42A setIdentifierCode(com.prowidesoftware.swift.model.BIC component3) {
        return setComponent3(component3);
    }
    ...
    public static List<Field42A> getAll(final SwiftTagListBlock block) {
        final List<Field42A> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field42A fromJson(final String json) {
        ...
        final Field42A field = new Field42A();
