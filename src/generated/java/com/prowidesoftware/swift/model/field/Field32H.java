...
public class Field32H extends Field implements Serializable, CurrencyContainer, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field32H.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field32H.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field32H setComponent3(java.math.BigDecimal component3) {
     ...
     * @since 9.2.7
     */
    public Field32H setAmount(java.math.BigDecimal component3) {
        return setComponent3(component3);
    }
    ...
    public static List<Field32H> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field32H> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
