 ...
 * 		<li>Component 2: BroadcastNumber: <code>Long</code></li>
 * </ol>
 *
...
public class Field136 extends Field implements Serializable {
    ...
    public Field136(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "136")) {
    ...
    protected Map<String, Integer> getLabelMap() {
        ...
        super.labelMap.put("broadcastindicator", 1);
        super.labelMap.put("broadcastnumber", 2);
        return super.labelMap;
    }
    ...
    public static List<Field136> getAll(final SwiftTagListBlock block) {
        final List<Field136> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field136 fromJson(final String json) {
        ...
        final Field136 field = new Field136();
