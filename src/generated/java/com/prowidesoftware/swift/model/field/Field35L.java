...
public class Field35L extends Field implements Serializable, MultiLineField {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field35L.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field35L.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field35L> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field35L> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
