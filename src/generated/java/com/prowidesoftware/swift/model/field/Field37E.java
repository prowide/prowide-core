...
public class Field37E extends Field implements Serializable, DateContainer, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field37E.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field37E.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field37E setComponent1(java.math.BigDecimal component1) {
     ...
     * @since 9.2.7
     */
    public Field37E setRate(java.math.BigDecimal component1) {
        return setComponent1(component1);
    }
     ...
     * @return the field object to enable build pattern
     */
    public Field37E setComponent4(java.lang.Long component4) {
     ...
     * @since 9.2.7
     */
    public Field37E setNumber(java.lang.Long component4) {
        return setComponent4(component4);
    }
    ...
    public static List<Field37E> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field37E> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
