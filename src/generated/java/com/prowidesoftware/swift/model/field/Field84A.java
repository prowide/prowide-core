...
@Generated
public class Field84A extends OptionAPartyField implements Serializable, BICContainer, MultiLineField {
	/**
    ...
    public Field84A(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "84A")) {
     ...
     * @return the field object to enable build pattern
     */
    public Field84A setIdentifierCode(String component3) {
     ...
     * @return the field object to enable build pattern
     */
    public Field84A setIdentifierCode(com.prowidesoftware.swift.model.BIC component3) {
        return setComponent3(component3);
    }
    ...
    public static Field84A fromJson(final String json) {
        ...
        final Field84A field = new Field84A();
