...
/**
 * <strong>SWIFT MT Field 34V</strong>
 * <p>
 * Model and parser for field 34V of a SWIFT MT message.
 *
...
@Generated
public class Field34V extends Field implements Serializable, AmountContainer {
	/**
	...
	/**
	 * Constant with the field name 34V
	 */
    public static final String NAME = "34V";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_34V = "34V";
     ...
     */
    public Field34V(final String value) {
        super(value);
    }
     ...
     * @since 7.8
     */
    public Field34V(final Tag tag) {
        this();
        if (tag == null) {
            throw new IllegalArgumentException("tag cannot be null.");
        }
        if (!StringUtils.equals(tag.getName(), "34V")) {
            throw new IllegalArgumentException("cannot create field 34V from tag "+tag.getName()+", tagname must match the name of the field.");
        }
        parse(tag.getValue());
    }
     ...
     * @since 7.7
     */
    public static Field34V newInstance(Field34V source) {
        Field34V cp = new Field34V();
    ...
    public String getValueDisplay(int component, Locale locale) {
        if (component < 1 || component > 2) {
            throw new IllegalArgumentException("invalid component number " + component + " for field 34V");
        }
        if (component == 1) {
     ...
     * @see #typesPattern()
     * @return the static value of Field34V.COMPONENTS_PATTERN
     */
    @Override
    @Deprecated
    @ProwideDeprecated(phase2=TargetYear.SRU2022)
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field34V.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field34V.PARSER_PATTERN
     */
    @Override
     ...
     */
    public Field34V setComponent1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field34V setCurrency(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field34V setComponent2(String component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field34V setComponent2(java.math.BigDecimal component2) {
     ...
     */
    public Field34V setComponent2(java.lang.Number component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field34V setAmount(String component2) {
     ...
     * @since 9.2.7
     */
    public Field34V setAmount(java.math.BigDecimal component2) {
        return setComponent2(component2);
    }
     ...
     * @see #setAmount(java.math.BigDecimal)
     */
    public Field34V setAmount(java.lang.Number component2) {
        return setComponent2(component2);
    }
     ...
     * @return the static value of Field34V.NAME
     */
    @Override
     ...
     */
    public static Field34V get(final SwiftTagListBlock block) {
        ...
        return new Field34V(t) ;
    }

    /**
     * Gets the first instance of Field34V in the given message.
     * @param msg may be empty or null
     * @return null if not found or msg is empty or null
     * @see #get(SwiftTagListBlock)
     */
    public static Field34V get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field34V in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field34V> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty())
    ...
    /**
     * Gets a list of all occurrences of the field Field34V from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field34V> getAll(final SwiftTagListBlock block) {
        if (block == null || block.isEmpty()) {
            return java.util.Collections.emptyList();
        }
        final Tag[] arr = block.getTagsByName(NAME);
        if (arr != null && arr.length > 0) {
            final List<Field34V> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
                result.add( new Field34V(f));
            }
            return result;
        }
        return java.util.Collections.emptyList();
    ...
    /**
     * This method deserializes the JSON data into a Field34V object.
     * @param json JSON structure including tuples with label and value for all field components
     * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
     * @since 7.10.3
     * @see Field#fromJson(String)
     */
    public static Field34V fromJson(final String json) {

        Field34V field = new Field34V();
