...
public class Field14E extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field14E.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field14E.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field14E> getAll(final SwiftTagListBlock block) {
        final List<Field14E> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field14E fromJson(final String json) {
        ...
        final Field14E field = new Field14E();
