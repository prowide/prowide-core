...
public class Field260 extends Field implements Serializable, DateContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field260.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field260.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field260 setComponent5(java.lang.Long component5) {
     ...
     * @since 9.2.7
     */
    public Field260 setSessionNumber(java.lang.Long component5) {
        return setComponent5(component5);
    }
    ...
    public static List<Field260> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field260> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
