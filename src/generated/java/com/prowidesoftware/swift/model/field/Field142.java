 ...
 * <ol>
 * 		<li>Component 1: StartDateTime: <code>Calendar</code></li>
 * </ol>
 *
...
@Generated
public class Field142 extends Field implements Serializable, DateContainer {
	/**
    ...
    public Field142(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "142")) {
    ...
    protected Map<String, Integer> getLabelMap() {
        ...
        super.labelMap.put("startdatetime", 1);
        return super.labelMap;
    }

    /**
     * Gets the component 1 (Start Date Time).
    ...
    /**
     * Gets the Start Date Time (component 1).
     * @return the Start Date Time from component 1
     */
    ...
    /**
     * Get the Start Date Time (component 1) as Calendar
     * @return the Start Date Time from component 1 converted to Calendar or null if cannot be converted
     */
    ...
    /**
     * Set the component 1 (Start Date Time).
     *
     ...
     *
     * @param component1 the Calendar with the Start Date Time content to set
     * @return the field object to enable build pattern
     */
    ...
    /**
     * Set the Start Date Time (component 1).
     *
     * @param component1 the Start Date Time to set
     * @return the field object to enable build pattern
     */
    ...
    /**
     * Set the Start Date Time (component 1) from a Calendar object.
     *
    ...
    public static List<Field142> getAll(final SwiftTagListBlock block) {
        final List<Field142> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field142 fromJson(final String json) {
        ...
        final Field142 field = new Field142();

        final JsonObject jsonObject = JsonParser.parseString(json).getAsJsonObject();

        // **** COMPONENT 1 - Start Date Time
