...
public class Field12 extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field12.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field12.PARSER_PATTERN
     */
    @Override
    ...
    /**
     * Alternative method setter for field's Message Type (component 1) as as Number
     *
    ...
    public static List<Field12> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field12> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
