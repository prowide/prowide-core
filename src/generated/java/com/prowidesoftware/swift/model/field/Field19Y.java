...
public class Field19Y extends Field implements Serializable, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field19Y.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field19Y.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field19Y setComponent1(java.math.BigDecimal component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field19Y setWeight(String component1) {
     ...
     * @since 9.2.7
     */
    public Field19Y setWeight(java.math.BigDecimal component1) {
        return setComponent1(component1);
    }
     ...
     * @see #setWeight(java.math.BigDecimal)
     */
    public Field19Y setWeight(java.lang.Number component1) {
        return setComponent1(component1);
    }
    ...
    public static List<Field19Y> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field19Y> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
