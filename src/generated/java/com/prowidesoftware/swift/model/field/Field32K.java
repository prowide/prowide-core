...
public class Field32K extends Field implements Serializable, CurrencyContainer, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field32K.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field32K.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field32K setDayMonth(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field32K setComponent2(java.lang.Long component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field32K setComponent5(java.math.BigDecimal component5) {
     ...
     * @since 9.2.7
     */
    public Field32K setAmount(java.math.BigDecimal component5) {
        return setComponent5(component5);
    }
    ...
    public static List<Field32K> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field32K> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
