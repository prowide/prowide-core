...
public class Field33Z extends Field implements Serializable, AmountContainer {
    ...
    public Field33Z(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "33Z")) {
     ...
     */
    public Field33Z setComponent1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field33Z setAmount(String component1) {
     ...
     * @return the static value of Field33Z.NAME
     */
    @Override
     ...
     */
    public static Field33Z get(final SwiftTagListBlock block) {
        ...
        return new Field33Z(t);
    }

    /**
     * Gets the first instance of Field33Z in the given message.
     * @param msg may be empty or null
     * @return null if not found or msg is empty or null
     * @see #get(SwiftTagListBlock)
     */
    public static Field33Z get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field33Z in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field33Z> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty()) {
    ...
    /**
     * Gets a list of all occurrences of the field Field33Z from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field33Z> getAll(final SwiftTagListBlock block) {
        final List<Field33Z> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    /**
     * This method deserializes the JSON data into a Field33Z object.
     * @param json JSON structure including tuples with label and value for all field components
     * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
     * @since 7.10.3
     * @see Field#fromJson(String)
     */
    public static Field33Z fromJson(final String json) {

        final Field33Z field = new Field33Z();
