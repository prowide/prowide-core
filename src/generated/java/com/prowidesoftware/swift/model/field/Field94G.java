...
@Generated
public class Field94G extends Field implements Serializable, GenericField, MultiLineField {
	/**
    ...
    public Field94G(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "94G")) {
    ...
    public static Field94G fromJson(final String json) {
        ...
        final Field94G field = new Field94G();
