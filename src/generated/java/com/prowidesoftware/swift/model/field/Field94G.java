...
public class Field94G extends Field implements Serializable, GenericField, MultiLineField {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field94G.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field94G.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field94G> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field94G> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
