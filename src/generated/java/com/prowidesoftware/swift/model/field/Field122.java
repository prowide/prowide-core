...
public class Field122 extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field122.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field122.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field122> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field122> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
