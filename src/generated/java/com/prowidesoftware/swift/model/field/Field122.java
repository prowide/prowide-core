...
public class Field122 extends Field implements Serializable {
	...
	*/
	...
	/**
	 * Gets the Number of Messages (component1) as Number
	 * @return the Number of Messages from component1 converted to Number or <code>null</code> if cannot be converted
	 */
   ...
   public String parserPattern() {
	...
	public static List<Field122> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field122> result = new ArrayList<Field122>(arr.length);
			for (final Tag f : arr) {
