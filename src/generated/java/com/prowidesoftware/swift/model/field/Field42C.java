...
@Generated
public class Field42C extends Field implements Serializable, MultiLineField {
	/**
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field42C.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field42C.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field42C> getAll(final SwiftTagListBlock block) {
        final List<Field42C> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field42C fromJson(final String json) {
        ...
        final Field42C field = new Field42C();
