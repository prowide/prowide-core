...
public class Field23A extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field23A.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field23A.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field23A> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field23A> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
