 ...
 * 		<li>Component 2: Location: <code>String</code></li>
...
public class Field29N extends Field implements Serializable, DateContainer {
    ...
    public Field29N(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "29N")) {
    ...
    public static List<Field29N> getAll(final SwiftTagListBlock block) {
        final List<Field29N> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field29N fromJson(final String json) {
        ...
        final Field29N field = new Field29N();
