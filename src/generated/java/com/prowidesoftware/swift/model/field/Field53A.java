...
@Generated
public class Field53A extends OptionAPartyField implements Serializable, BICContainer, MultiLineField {
	/**
    ...
    public Field53A(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "53A")) {
     ...
     * @return the field object to enable build pattern
     */
    public Field53A setIdentifierCode(String component3) {
     ...
     * @return the field object to enable build pattern
     */
    public Field53A setIdentifierCode(com.prowidesoftware.swift.model.BIC component3) {
        return setComponent3(component3);
    }
    ...
    public static Field53A fromJson(final String json) {
        ...
        final Field53A field = new Field53A();
