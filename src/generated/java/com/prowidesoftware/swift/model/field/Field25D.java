...
@Generated
public class Field25D extends Field implements Serializable, com.prowidesoftware.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field25D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field25D> result = new ArrayList<Field25D>(arr.length);
			for (final Tag f : arr) {
