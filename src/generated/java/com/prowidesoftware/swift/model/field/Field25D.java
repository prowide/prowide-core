...
public class Field25D extends Field implements Serializable, GenericField {
	...
	/**
	 * Alternative (<em>DEPRECATED</em>) constant name for field's Status Code Component number
	 * @see #STATUS_CODE
	 */
    @Deprecated
    @ProwideDeprecated(phase2=TargetYear.SRU2022)
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field25D.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field25D.PARSER_PATTERN
     */
    @Override
    ...
    /**
     * Gets the component 3 (Status Code).
    ...
    /**
     * Gets the Status Code (component 3).
     * @return the Status Code from component 3
     */
    ...
    /**
     * Set the component 3 (Status Code).
     *
    ...
    /**
     * Set the Status Code (component 3).
     *
     * @param component3 the Status Code to set
     * @return the field object to enable build pattern
     */
    ...
    /**
     * Alternative <em>DEPRECATED</em> method setter for field's Status Code
     *
    ...
    public static List<Field25D> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field25D> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
