...
@Generated
public class Field85A extends OptionAPartyField implements Serializable, BICContainer, MultiLineField {
	/**
    ...
    public Field85A(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "85A")) {
     ...
     * @return the field object to enable build pattern
     */
    public Field85A setIdentifierCode(com.prowidesoftware.swift.model.BIC component3) {
        return setComponent3(component3);
    }
    ...
    public static List<Field85A> getAll(final SwiftTagListBlock block) {
        final List<Field85A> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field85A fromJson(final String json) {
        ...
        final Field85A field = new Field85A();
