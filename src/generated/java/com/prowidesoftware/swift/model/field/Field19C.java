...
public class Field19C extends Field implements Serializable, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field19C.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field19C.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field19C> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field19C> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
