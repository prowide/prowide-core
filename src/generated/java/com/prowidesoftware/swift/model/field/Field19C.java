 ...
 * 		<li>Component 2: AdjustmentFactor: <code>BigDecimal</code></li>
 * </ol>
 *
...
public class Field19C extends Field implements Serializable, AmountContainer {
    ...
    public Field19C(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "19C")) {
    ...
    protected Map<String, Integer> getLabelMap() {
        ...
        super.labelMap.put("adjustmentfactor", 2);
        // alias name
    ...
    public static List<Field19C> getAll(final SwiftTagListBlock block) {
        final List<Field19C> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
