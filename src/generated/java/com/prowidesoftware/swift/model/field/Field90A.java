...
public class Field90A extends Field implements Serializable, AmountContainer, GenericField {
     ...
     * @return the static value of Field90A.PARSER_PATTERN
     */
	@Override
	...
	/**
	 * Get the Price (component 4) as Number
	 * @return the Price from component 4 converted to Number or null if cannot be converted
	 */
	...
	/**
	 * Set the component2 (Percentage Type Code).
   ...
   public String getConditionalQualifier() {
	...
	public static List<Field90A> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field90A> result = new ArrayList<>(arr.length);
			for (final Tag f : arr) {
