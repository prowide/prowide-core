...
@Generated
public class Field90A extends Field implements Serializable, AmountContainer, com.prowidesoftware.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field90A> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field90A> result = new ArrayList<Field90A>(arr.length);
			for (final Tag f : arr) {
