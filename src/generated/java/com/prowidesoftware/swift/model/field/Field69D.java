...
@Generated
public class Field69D extends Field implements Serializable, DateContainer, com.prowidesoftware.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field69D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field69D> result = new ArrayList<Field69D>(arr.length);
			for (final Tag f : arr) {
