...
public class Field31G extends Field implements Serializable, DateContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field31G.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field31G.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field31G> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field31G> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
