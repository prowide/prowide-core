...
public class Field120 extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field120.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field120.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field120> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field120> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
