...
public class Field32R extends Field implements Serializable, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field32R.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field32R.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field32R setComponent3(java.math.BigDecimal component3) {
     ...
     * @since 9.2.7
     */
    public Field32R setAmount(java.math.BigDecimal component3) {
        return setComponent3(component3);
    }
    ...
    public static List<Field32R> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field32R> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
