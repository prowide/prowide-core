...
@Generated
public class Field84D extends OptionDPartyField implements Serializable, MultiLineField {
	/**
    ...
    public Field84D(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "84D")) {
    ...
    public static Field84D fromJson(final String json) {
        ...
        final Field84D field = new Field84D();
