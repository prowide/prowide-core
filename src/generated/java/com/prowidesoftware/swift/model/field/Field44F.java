...
@Generated
public class Field44F extends Field implements Serializable, MultiLineField {
	/**
    ...
    public Field44F(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "44F")) {
     ...
     * @return the field object to enable build pattern
     */
    public Field44F setNarrativeLine1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field44F setNarrative(String value) {
        List<String> lines = SwiftParseUtils.getLines(value);
     ...
     * @return the field object to enable build pattern
     */
    public Field44F setComponent2(String component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field44F setNarrativeLine2(String component2) {
