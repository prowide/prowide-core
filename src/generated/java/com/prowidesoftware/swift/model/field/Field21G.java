...
public class Field21G extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field21G.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field21G.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field21G> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field21G> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
