 ...
 * 		<li>Component 2: FirstCurrencyCode: <code>Currency</code></li>
 * 		<li>Component 3: Amount1: <code>BigDecimal</code></li>
 * 		<li>Component 4: SecondCurrencyCode: <code>Currency</code></li>
 * 		<li>Component 5: Amount2: <code>BigDecimal</code></li>
 * </ol>
 *
...
@Generated
public class Field92L extends Field implements Serializable, MonetaryAmountContainer, GenericField {
	/**
    ...
    public Field92L(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "92L")) {
    ...
    public static Field92L fromJson(final String json) {
        ...
        final Field92L field = new Field92L();
