...
public class Field14G extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field14G.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field14G.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field14G> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field14G> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
