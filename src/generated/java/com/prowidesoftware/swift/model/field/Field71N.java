...
@Generated
public class Field71N extends Field implements Serializable, MultiLineField {
	/**
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field71N.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field71N.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field71N> getAll(final SwiftTagListBlock block) {
        final List<Field71N> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field71N fromJson(final String json) {
        ...
        final Field71N field = new Field71N();
