...
public class Field344 extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field344.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field344.PARSER_PATTERN
     */
    @Override
    ...
    /**
     * Get the Message Categories (component 2) as Long
     * @return the Message Categories from component 2 converted to Long or null if cannot be converted
     * @since 9.2.7
     */
    ...
    /**
     * Get the Message Categories (component 2) as as Number (BigDecimal)
     *
     * The value is returned as BigDecimal to keep compatibility with previous API. You should
     * use <code>getComponent2AsLong()</code> to get the proper value.
     *
    ...
    /**
     * Set the component 2 (Message Categories).
     *
     ...
     * @since 9.2.7
     *
     * @param component2 the Long with the Message Categories content to set
     * @return the field object to enable build pattern
     */
    public Field344 setComponent2(java.lang.Long component2) {
     ...
     *
     * @param component2 the Number with the Message Categories content to set
     * @return the field object to enable build pattern
    ...
    /**
     * Set the Message Categories (component 2).
     *
     * @param component2 the Message Categories to set
     * @return the field object to enable build pattern
     */
    ...
    /**
     * Set the Message Categories (component 2) from a Long object.
     *
     * @see #setComponent2(java.lang.Long)
     *
     * @param component2 Long with the Message Categories content to set
     * @return the field object to enable build pattern
     * @since 9.2.7
     */
    public Field344 setMessageCategories(java.lang.Long component2) {
        return setComponent2(component2);
    }
    ...
    public static List<Field344> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field344> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
    ...
    public static Field344 fromJson(final String json) {
        ...
        // **** COMPONENT 2 - Message Categories
