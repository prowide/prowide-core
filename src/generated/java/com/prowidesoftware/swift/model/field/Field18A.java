...
public class Field18A extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field18A.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field18A.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field18A setComponent1(java.lang.Long component1) {
     ...
     * @since 9.2.7
     */
    public Field18A setNumber(java.lang.Long component1) {
        return setComponent1(component1);
    }
    ...
    public static List<Field18A> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field18A> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
