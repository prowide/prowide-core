...
@Generated
public class Field94C extends Field implements Serializable, com.prowidesoftware.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field94C> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field94C> result = new ArrayList<Field94C>(arr.length);
			for (final Tag f : arr) {
