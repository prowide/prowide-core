 ...
 * 		<li>Component 2: Rate: <code>BigDecimal</code></li>
 * </ol>
 *
...
public class Field37K extends Field implements Serializable, AmountContainer {
     ...
     * @return the field object to enable build pattern
     */
    public Field37K setComponent2(java.math.BigDecimal component2) {
     ...
     * @since 9.2.7
     */
    public Field37K setRate(java.math.BigDecimal component2) {
        return setComponent2(component2);
    }
    ...
    public static List<Field37K> getAll(final SwiftTagListBlock block) {
        final List<Field37K> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field37K fromJson(final String json) {
        ...
        final Field37K field = new Field37K();
