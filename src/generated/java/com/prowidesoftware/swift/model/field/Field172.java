...
public class Field172 extends Field implements Serializable, DateContainer {
     ...
     * @since 9.2.7
     */
	public static final String TYPES_PATTERN = "JJ";
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field172.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field172.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field172> getAll(final SwiftTagListBlock block) {
        final List<Field172> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field172 fromJson(final String json) {
        ...
        final Field172 field = new Field172();
