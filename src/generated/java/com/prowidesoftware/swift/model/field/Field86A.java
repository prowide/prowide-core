...
@Generated
public class Field86A extends OptionAPartyField implements Serializable, BICContainer, MultiLineField {
	/**
    ...
    public Field86A(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "86A")) {
     ...
     * @return the field object to enable build pattern
     */
    public Field86A setIdentifierCode(String component3) {
     ...
     * @return the field object to enable build pattern
     */
    public Field86A setIdentifierCode(com.prowidesoftware.swift.model.BIC component3) {
        return setComponent3(component3);
    }
    ...
    public static Field86A fromJson(final String json) {
        ...
        final Field86A field = new Field86A();
