...
@Generated
public class Field51D extends OptionDPartyField implements Serializable, MultiLineField {
	/**
    ...
    public Field51D(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "51D")) {
    ...
    public static List<Field51D> getAll(final SwiftTagListBlock block) {
        final List<Field51D> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field51D fromJson(final String json) {
        ...
        final Field51D field = new Field51D();
