...
@Generated
public class Field51D extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field51D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field51D> result = new ArrayList<Field51D>(arr.length);
			for (final Tag f : arr) {
