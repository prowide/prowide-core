...
@Generated
public class Field36E extends Field implements Serializable, AmountContainer, com.prowidesoftware.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field36E> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field36E> result = new ArrayList<Field36E>(arr.length);
			for (final Tag f : arr) {
