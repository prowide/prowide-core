...
@Generated
public class Field42M extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field42M> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field42M> result = new ArrayList<Field42M>(arr.length);
			for (final Tag f : arr) {
