...
@Generated
public class Field42M extends Field implements Serializable, MultiLineField {
	/**
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field42M.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field42M.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field42M> getAll(final SwiftTagListBlock block) {
        final List<Field42M> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field42M fromJson(final String json) {
        ...
        final Field42M field = new Field42M();
