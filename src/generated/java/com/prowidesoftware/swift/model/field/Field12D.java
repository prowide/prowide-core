...
public class Field12D extends Field implements Serializable {
     ...
     * @return the static value of Field12D.PARSER_PATTERN
     */
	@Override
	...
	/**
	 * Gets the component1 (Option Type).
	...
	/**
	 * Set the component1 (Option Type).
	...
	public static List<Field12D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field12D> result = new ArrayList<>(arr.length);
			for (final Tag f : arr) {
