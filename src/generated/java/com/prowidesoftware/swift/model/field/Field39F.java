...
@Generated
public class Field39F extends Field implements Serializable, MultiLineField {
	/**
	...
	/**
	 * Constant with the field name 39F.
	 */
    public static final String NAME = "39F";
    /**
     * Same as NAME, intended to be clear when using static imports.
     */
    public static final String F_39F = "39F";
     ...
     */
    public Field39F(final String value) {
        super(value);
    }
     ...
     * @since 7.8
     */
    public Field39F(final Tag tag) {
        this();
        if (tag == null) {
            throw new IllegalArgumentException("tag cannot be null.");
        }
        if (!StringUtils.equals(tag.getName(), "39F")) {
            throw new IllegalArgumentException("cannot create field 39F from tag "+tag.getName()+", tagname must match the name of the field.");
        }
        parse(tag.getValue());
    }
    ...
    public String getValueDisplay(int component, Locale locale) {
        if (component < 1 || component > 12) {
            throw new IllegalArgumentException("invalid component number " + component + " for field 39F");
        }
        if (component == 1) {
     ...
     */
    public Field39F setComponent1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39F setNarrativeLine1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39F setNarrative(String value) {
        List<String> lines = SwiftParseUtils.getLines(value);
     ...
     * @return the field object to enable build pattern
     */
    public Field39F setComponent2(String component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39F setNarrativeLine2(String component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39F setComponent3(String component3) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39F setNarrativeLine3(String component3) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39F setComponent4(String component4) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39F setNarrativeLine4(String component4) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39F setComponent5(String component5) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39F setNarrativeLine5(String component5) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39F setComponent6(String component6) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39F setNarrativeLine6(String component6) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39F setComponent7(String component7) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39F setNarrativeLine7(String component7) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39F setComponent8(String component8) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39F setNarrativeLine8(String component8) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39F setComponent9(String component9) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39F setNarrativeLine9(String component9) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39F setComponent10(String component10) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39F setNarrativeLine10(String component10) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39F setComponent11(String component11) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39F setNarrativeLine11(String component11) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39F setComponent12(String component12) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39F setNarrativeLine12(String component12) {
     ...
     * @return the static value of Field39F.NAME
     */
    @Override
     ...
     */
    public static Field39F get(final SwiftTagListBlock block) {
     ...
     */
    public static Field39F get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field39F in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field39F> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty()) {
    ...
    /**
     * Gets a list of all occurrences of the field Field39F from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field39F> getAll(final SwiftTagListBlock block) {
     ...
     */
    public static Field39F fromJson(final String json) {

        final Field39F field = new Field39F();
