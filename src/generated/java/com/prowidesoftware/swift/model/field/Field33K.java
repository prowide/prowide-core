...
public class Field33K extends Field implements Serializable, CurrencyContainer, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field33K.TYPES_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field33K setComponent5(java.math.BigDecimal component5) {
     ...
     * @since 9.2.7
     */
    public Field33K setAmount(java.math.BigDecimal component5) {
        return setComponent5(component5);
    }
