...
public class Field24D extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field24D.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field24D.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field24D> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field24D> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
