...
public class Field62M extends Field implements Serializable, DateContainer, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field62M.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field62M.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field62M setComponent4(java.math.BigDecimal component4) {
     ...
     * @since 9.2.7
     */
    public Field62M setAmount(java.math.BigDecimal component4) {
        return setComponent4(component4);
    }
    ...
    public static List<Field62M> getAll(final SwiftTagListBlock block) {
        final List<Field62M> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field62M fromJson(final String json) {
        ...
        final Field62M field = new Field62M();
