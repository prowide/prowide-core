...
@Generated
public class Field71B extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field71B> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field71B> result = new ArrayList<Field71B>(arr.length);
			for (final Tag f : arr) {
