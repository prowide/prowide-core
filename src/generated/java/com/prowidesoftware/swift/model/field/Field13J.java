...
@Generated
public class Field13J extends Field implements Serializable, com.prowidesoftware.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field13J> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field13J> result = new ArrayList<Field13J>(arr.length);
			for (final Tag f : arr) {
