 ...
 * 		<li>Component 2: ExtendedNumberId: <code>String</code></li>
 * </ol>
 *
...
public class Field13J extends Field implements Serializable, GenericField {
    ...
    public Field13J(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "13J")) {
    ...
    protected Map<String, Integer> getLabelMap() {
        ...
        super.labelMap.put("extendednumberid", 2);
        // alias name
    ...
    public static Field13J fromJson(final String json) {
        ...
        final Field13J field = new Field13J();
