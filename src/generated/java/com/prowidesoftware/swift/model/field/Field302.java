 ...
 * <ol>
 * 		<li>Component 1: HolidaySuppression: <code>Boolean</code></li>
 * </ol>
 *
...
public class Field302 extends Field implements Serializable {
    ...
    public Field302(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "302")) {
    ...
    protected Map<String, Integer> getLabelMap() {
        ...
        super.labelMap.put("holidaysuppression", 1);
        return super.labelMap;
    }

    /**
     * Gets the component 1 (Holiday Suppression).
    ...
    /**
     * Gets the Holiday Suppression (component 1).
     * @return the Holiday Suppression from component 1
     */
    ...
    /**
     * Get the Holiday Suppression (component 1) as Boolean
     * @return the Holiday Suppression from component 1 converted to Boolean or null if cannot be converted
     */
    ...
    /**
     * Set the component 1 (Holiday Suppression).
     *
     ...
     *
     * @param component1 the Boolean with the Holiday Suppression content to set
     * @return the field object to enable build pattern
     */
    ...
    /**
     * Set the Holiday Suppression (component 1).
     *
     * @param component1 the Holiday Suppression to set
     * @return the field object to enable build pattern
     */
    ...
    /**
     * Set the Holiday Suppression (component 1) from a Boolean object.
     *
    ...
    public static List<Field302> getAll(final SwiftTagListBlock block) {
        final List<Field302> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field302 fromJson(final String json) {
        ...
        final Field302 field = new Field302();

        final JsonObject jsonObject = JsonParser.parseString(json).getAsJsonObject();

        // **** COMPONENT 1 - Holiday Suppression
