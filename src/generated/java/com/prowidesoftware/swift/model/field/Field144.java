...
public class Field144 extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field144.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field144.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field144> getAll(final SwiftTagListBlock block) {
        final List<Field144> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field144 fromJson(final String json) {
        ...
        final Field144 field = new Field144();
