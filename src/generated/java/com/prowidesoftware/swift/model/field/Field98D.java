...
public class Field98D extends Field implements Serializable, DateContainer {
	...
	/**
	 * Get the Decimals (component 3) as Number
	 * @return the Decimals from component 3 converted to Number or null if cannot be converted
	 */
	...
	public static List<Field98D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field98D> result = new ArrayList<>(arr.length);
			for (final Tag f : arr) {
