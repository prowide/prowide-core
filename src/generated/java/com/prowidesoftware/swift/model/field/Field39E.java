...
/**
 * <strong>SWIFT MT Field 39E</strong>
 * <p>
 * Model and parser for field 39E of a SWIFT MT message.
 *
...
public class Field39E extends Field implements Serializable, MultiLineField {
	...
	/**
	 * Constant with the field name 39E
	 */
     ...
     */
    public Field39E(final String value) {
        super(value);
    }
     ...
     * @since 7.7
     */
    public static Field39E newInstance(Field39E source) {
        Field39E cp = new Field39E();
    ...
    public String getValueDisplay(int component, Locale locale) {
        if (component < 1 || component > 12) {
            throw new IllegalArgumentException("invalid component number " + component + " for field 39E");
        }
        if (component == 1) {
     ...
     * @see #typesPattern()
     * @return the static value of Field39E.COMPONENTS_PATTERN
     */
    @Override
    @Deprecated
    @ProwideDeprecated(phase2=TargetYear.SRU2022)
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field39E.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field39E.PARSER_PATTERN
     */
    @Override
     ...
     */
    public Field39E setComponent1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39E setNarrativeLine1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39E setNarrative(String value) {
        List<String> lines = SwiftParseUtils.getLines(value);
     ...
     * @return the field object to enable build pattern
     */
    public Field39E setComponent2(String component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39E setNarrativeLine2(String component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39E setComponent3(String component3) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39E setNarrativeLine3(String component3) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39E setComponent4(String component4) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39E setNarrativeLine4(String component4) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39E setComponent5(String component5) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39E setNarrativeLine5(String component5) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39E setComponent6(String component6) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39E setNarrativeLine6(String component6) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39E setComponent7(String component7) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39E setNarrativeLine7(String component7) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39E setComponent8(String component8) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39E setNarrativeLine8(String component8) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39E setComponent9(String component9) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39E setNarrativeLine9(String component9) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39E setComponent10(String component10) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39E setNarrativeLine10(String component10) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39E setComponent11(String component11) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39E setNarrativeLine11(String component11) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39E setComponent12(String component12) {
     ...
     * @return the field object to enable build pattern
     */
    public Field39E setNarrativeLine12(String component12) {
     ...
     * @return the static value of Field39E.NAME
     */
    @Override
     ...
     */
    public static Field39E get(final SwiftTagListBlock block) {
        ...
        return new Field39E(t) ;
    }

    /**
     * Gets the first instance of Field39E in the given message.
     * @param msg may be empty or null
     * @return null if not found or msg is empty or null
     * @see #get(SwiftTagListBlock)
     */
    public static Field39E get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field39E in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field39E> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty())
    ...
    /**
     * Gets a list of all occurrences of the field Field39E from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field39E> getAll(final SwiftTagListBlock block) {
        if (block == null || block.isEmpty()) {
            return java.util.Collections.emptyList();
        }
        final Tag[] arr = block.getTagsByName(NAME);
        if (arr != null && arr.length > 0) {
            final List<Field39E> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
                result.add( new Field39E(f));
            }
            return result;
        }
        return java.util.Collections.emptyList();
    ...
    /**
     * This method deserializes the JSON data into a Field39E object.
     * @param json JSON structure including tuples with label and value for all field components
     * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
     * @since 7.10.3
     * @see Field#fromJson(String)
     */
    public static Field39E fromJson(final String json) {

        Field39E field = new Field39E();
