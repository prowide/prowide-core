...
@Generated
public class Field73A extends StructuredNarrativeField implements Serializable, NarrativeContainer, MultiLineField {
	/**
     ...
     * @since 8.1.0
     */
    public Field73A(final Narrative narrative) {
     ...
     * @return the field object to enable build pattern
     */
    public Field73A setNarrative(String component1) {
    ...
    public static List<Field73A> getAll(final SwiftTagListBlock block) {
        final List<Field73A> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field73A fromJson(final String json) {
        ...
        final Field73A field = new Field73A();
    ...
    @Deprecated
    @com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear.SRU2022)
    public Field73A setNarrativeLine1(String component) {
    ...
    @Deprecated
    @com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear.SRU2022)
    public Field73A setComponent2(String component) {
    ...
    @Deprecated
    @com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear.SRU2022)
    public Field73A setNarrativeLine2(String component) {
    ...
    @Deprecated
    @com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear.SRU2022)
    public Field73A setComponent3(String component) {
    ...
    @Deprecated
    @com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear.SRU2022)
    public Field73A setNarrativeLine3(String component) {
    ...
    @Deprecated
    @com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear.SRU2022)
    public Field73A setComponent4(String component) {
    ...
    @Deprecated
    @com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear.SRU2022)
    public Field73A setNarrativeLine4(String component) {
    ...
    @Deprecated
    @com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear.SRU2022)
    public Field73A setComponent5(String component) {
    ...
    @Deprecated
    @com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear.SRU2022)
    public Field73A setNarrativeLine5(String component) {
    ...
    @Deprecated
    @com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear.SRU2022)
    public Field73A setComponent6(String component) {
    ...
    @Deprecated
    @com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear.SRU2022)
    public Field73A setNarrativeLine6(String component) {
