...
public class Field37J extends Field implements Serializable, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field37J.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field37J.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field37J setComponent1(java.math.BigDecimal component1) {
     ...
     * @since 9.2.7
     */
    public Field37J setRate(java.math.BigDecimal component1) {
        return setComponent1(component1);
    }
    ...
    public static List<Field37J> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field37J> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
