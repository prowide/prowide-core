...
public class Field17C extends Field implements Serializable {
    ...
    public Field17C(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "17C")) {
    ...
    protected Map<String, Integer> getLabelMap() {
        ...
        super.labelMap.put("indicator", 1);
        return super.labelMap;
    }
     ...
     */
    public Field17C setComponent1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field17C setIndicator(String component1) {
     ...
     * @return the static value of Field17C.NAME
     */
    @Override
     ...
     */
    public static Field17C get(final SwiftTagListBlock block) {
        ...
        return new Field17C(t);
    }

    /**
     * Gets the first instance of Field17C in the given message.
     * @param msg may be empty or null
     * @return null if not found or msg is empty or null
     * @see #get(SwiftTagListBlock)
     */
    public static Field17C get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field17C in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field17C> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty()) {
    ...
    /**
     * Gets a list of all occurrences of the field Field17C from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field17C> getAll(final SwiftTagListBlock block) {
        final List<Field17C> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    /**
     * This method deserializes the JSON data into a Field17C object.
     * @param json JSON structure including tuples with label and value for all field components
     * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
     * @since 7.10.3
     * @see Field#fromJson(String)
     */
    public static Field17C fromJson(final String json) {

        final Field17C field = new Field17C();
