...
public class Field48 extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field48.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field48.PARSER_PATTERN
     */
    @Override
    ...
    /**
     * Get the Days (component 1) as Long
     * @return the Days from component 1 converted to Long or null if cannot be converted
     * @since 9.2.7
     */
    public java.lang.Long getDaysAsLong() {
        return getComponent1AsLong();
    }

    /**
     * Get the Days (component 1) as as Number (BigDecimal)
     *
     * The value is returned as BigDecimal to keep compatibility with previous API. You should
     * use <code>getComponent1AsLong()</code> to get the proper value.
     *
     ...
     * @since 9.2.7
     *
     * @param component1 the Long with the Days content to set
     * @return the field object to enable build pattern
     */
    public Field48 setComponent1(java.lang.Long component1) {
        setComponent(1, SwiftFormatUtils.getLong(component1));
        return this;
    }

    /**
     * Alternative method setter for field's Days (component 1) as as Number
     *
     * This method supports java constant value boxing for simpler coding styles (ex: 10 becomes an Integer)
     *
     * @param component1 the Number with the Days content to set
     * @return the field object to enable build pattern
    ...
    /**
     * Set the Days (component 1) from a Long object.
     *
     * @see #setComponent1(java.lang.Long)
     *
     * @param component1 Long with the Days content to set
     * @return the field object to enable build pattern
     * @since 9.2.7
     */
    public Field48 setDays(java.lang.Long component1) {
        return setComponent1(component1);
    }
    ...
    public static List<Field48> getAll(final SwiftTagListBlock block) {
        final List<Field48> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
