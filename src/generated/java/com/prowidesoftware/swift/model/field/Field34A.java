...
public class Field34A extends Field implements Serializable, CurrencyContainer, DateContainer, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field34A.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field34A.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field34A setComponent3(java.math.BigDecimal component3) {
     ...
     * @since 9.2.7
     */
    public Field34A setAmount(java.math.BigDecimal component3) {
        return setComponent3(component3);
    }
    ...
    public static List<Field34A> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field34A> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
