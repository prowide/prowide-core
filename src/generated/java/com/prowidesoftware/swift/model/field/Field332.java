...
public class Field332 extends Field implements Serializable {
	...
	*/
	...
	/**
	 * Gets the Total Messages Sent (component1) as Number
	...
	/**
	 * Gets the Total Messages Received (component2) as Number
   ...
   public String parserPattern() {
	...
	public static List<Field332> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field332> result = new ArrayList<Field332>(arr.length);
			for (final Tag f : arr) {
