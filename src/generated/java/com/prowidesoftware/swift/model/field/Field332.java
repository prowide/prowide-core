 ...
 * <ol>
 * 		<li>Component 1: TotalMessagesSent: <code>Long</code></li>
 * 		<li>Component 2: TotalMessagesReceived: <code>Long</code></li>
 * </ol>
 *
...
public class Field332 extends Field implements Serializable {
    ...
    protected Map<String, Integer> getLabelMap() {
        ...
        super.labelMap.put("totalmessagessent", 1);
        super.labelMap.put("totalmessagesreceived", 2);
        return super.labelMap;
    }
    ...
    /**
     * Get the Total Messages Sent (component 1) as Long
     * @return the Total Messages Sent from component 1 converted to Long or null if cannot be converted
     * @since 9.2.7
     */
    ...
    /**
     * Get the Total Messages Received (component 2) as Long
     * @return the Total Messages Received from component 2 converted to Long or null if cannot be converted
     * @since 9.2.7
     */
     ...
     * @since 9.2.7
     *
     * @param component1 the Long with the Total Messages Sent content to set
     * @return the field object to enable build pattern
     */
    public Field332 setComponent1(java.lang.Long component1) {
        setComponent(1, SwiftFormatUtils.getLong(component1));
        return this;
    }

    /**
     * Alternative method setter for field's Total Messages Sent (component 1) as as Number
     *
     * This method supports java constant value boxing for simpler coding styles (ex: 10 becomes an Integer)
     *
     * @param component1 the Number with the Total Messages Sent content to set
     * @return the field object to enable build pattern
    ...
    /**
     * Set the Total Messages Sent (component 1).
     *
     * @param component1 the Total Messages Sent to set
     * @return the field object to enable build pattern
     */
    ...
    /**
     * Set the Total Messages Sent (component 1) from a Long object.
     *
     * @see #setComponent1(java.lang.Long)
     *
     * @param component1 Long with the Total Messages Sent content to set
     * @return the field object to enable build pattern
     * @since 9.2.7
     */
    public Field332 setTotalMessagesSent(java.lang.Long component1) {
        return setComponent1(component1);
    }
    ...
    /**
     * Set the component 2 (Total Messages Received).
     *
     ...
     * @since 9.2.7
     *
     * @param component2 the Long with the Total Messages Received content to set
     * @return the field object to enable build pattern
     */
    public Field332 setComponent2(java.lang.Long component2) {
        setComponent(2, SwiftFormatUtils.getLong(component2));
        return this;
    }

    /**
     * Alternative method setter for field's Total Messages Received (component 2) as as Number
     *
     * This method supports java constant value boxing for simpler coding styles (ex: 10 becomes an Integer)
     *
     * @param component2 the Number with the Total Messages Received content to set
     * @return the field object to enable build pattern
    ...
    /**
     * Set the Total Messages Received (component 2).
     *
     * @param component2 the Total Messages Received to set
     * @return the field object to enable build pattern
     */
    ...
    /**
     * Set the Total Messages Received (component 2) from a Long object.
     *
     * @see #setComponent2(java.lang.Long)
     *
     * @param component2 Long with the Total Messages Received content to set
     * @return the field object to enable build pattern
     * @since 9.2.7
     */
    public Field332 setTotalMessagesReceived(java.lang.Long component2) {
        return setComponent2(component2);
    }
