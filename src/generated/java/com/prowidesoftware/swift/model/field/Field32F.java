...
public class Field32F extends Field implements Serializable, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field32F.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field32F.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field32F setComponent2(java.math.BigDecimal component2) {
     ...
     * @since 9.2.7
     */
    public Field32F setAmount(java.math.BigDecimal component2) {
        return setComponent2(component2);
    }
    ...
    public static List<Field32F> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field32F> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
