...
/**
 * <strong>SWIFT MT Field 29F</strong>
 * <p>
 * Model and parser for field 29F of a SWIFT MT message.
 *
...
@Generated
public class Field29F extends Field implements Serializable, MultiLineField {
	/**
     ...
     */
    public Field29F(final String value) {
        super(value);
    }
     ...
     * @since 7.8
     */
    public Field29F(final Tag tag) {
        this();
        if (tag == null) {
            throw new IllegalArgumentException("tag cannot be null.");
        }
        if (!StringUtils.equals(tag.getName(), "29F")) {
            throw new IllegalArgumentException("cannot create field 29F from tag "+tag.getName()+", tagname must match the name of the field.");
        }
        parse(tag.getValue());
    }
     ...
     * @since 7.7
     */
    public static Field29F newInstance(Field29F source) {
        Field29F cp = new Field29F();
    ...
    public String getValueDisplay(int component, Locale locale) {
        if (component < 1 || component > 4) {
            throw new IllegalArgumentException("invalid component number " + component + " for field 29F");
        }
        if (component == 1) {
     ...
     * @see #typesPattern()
     * @return the static value of Field29F.COMPONENTS_PATTERN
     */
    @Override
    @Deprecated
    @ProwideDeprecated(phase2=TargetYear.SRU2022)
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field29F.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field29F.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field29F setNarrativeLine1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field29F setNarrative(String value) {
        List<String> lines = SwiftParseUtils.getLines(value);
     ...
     * @return the field object to enable build pattern
     */
    public Field29F setNarrativeLine2(String component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field29F setNarrativeLine3(String component3) {
     ...
     * @return the field object to enable build pattern
     */
    public Field29F setNarrativeLine4(String component4) {
     ...
     * @return the static value of Field29F.NAME
     */
    @Override
    ...
    public static Field29F get(final SwiftTagListBlock block) {
        ...
        return new Field29F(t) ;
    }

    /**
     * Gets the first instance of Field29F in the given message.
    ...
    /**
     * Gets a list of all occurrences of the field Field29F in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field29F> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty())
    ...
    /**
     * Gets a list of all occurrences of the field Field29F from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field29F> getAll(final SwiftTagListBlock block) {
        if (block == null || block.isEmpty()) {
            return java.util.Collections.emptyList();
        }
        final Tag[] arr = block.getTagsByName(NAME);
        if (arr != null && arr.length > 0) {
            final List<Field29F> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
                result.add( new Field29F(f));
            }
            return result;
        }
        return java.util.Collections.emptyList();
    ...
    /**
     * This method deserializes the JSON data into a Field29F object.
     * @param json JSON structure including tuples with label and value for all field components
     * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
     * @since 7.10.3
     * @see Field#fromJson(String)
     */
    public static Field29F fromJson(final String json) {

        Field29F field = new Field29F();
