...
@Generated
public class Field57A extends OptionAPartyField implements Serializable, BICContainer, MultiLineField {
	/**
    ...
    public Field57A(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "57A")) {
     ...
     * @return the field object to enable build pattern
     */
    public Field57A setIdentifierCode(String component3) {
     ...
     * @return the field object to enable build pattern
     */
    public Field57A setIdentifierCode(com.prowidesoftware.swift.model.BIC component3) {
        return setComponent3(component3);
    }
    ...
    public static Field57A fromJson(final String json) {
        ...
        final Field57A field = new Field57A();
