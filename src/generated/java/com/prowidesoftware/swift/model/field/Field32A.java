   ...
   public String parserPattern() {
	...
	public static List<Field32A> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field32A> result = new ArrayList<>(arr.length);
			for (final Tag f : arr) {
	...
	public Double getAmountDouble() {
	    com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "getAmountDouble()", "Use use getAmountBigDecimal() instead.");
