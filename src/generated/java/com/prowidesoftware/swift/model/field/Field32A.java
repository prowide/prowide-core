...
@Generated
public class Field32A extends Field implements Serializable, MonetaryAmountContainer, DateContainer {
	/**
    ...
    public Field32A(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "32A")) {
    ...
    public static Field32A fromJson(final String json) {
        ...
        final Field32A field = new Field32A();
