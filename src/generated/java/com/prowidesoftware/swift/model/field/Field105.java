...
public class Field105 extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field105.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field105.PARSER_PATTERN
     */
    @Override
    ...
    /**
     * Get the Delivery Monitoring (component 1) as Long
     * @return the Delivery Monitoring from component 1 converted to Long or null if cannot be converted
     * @since 9.2.7
     */
    public java.lang.Long getDeliveryMonitoringAsLong() {
    ...
    /**
     * Set the component 1 (Delivery Monitoring).
     *
    ...
    /**
     * Alternative method setter for field's Delivery Monitoring (component 1) as as Number
     *
    ...
    /**
     * Set the Delivery Monitoring (component 1).
     *
     * @param component1 the Delivery Monitoring to set
     * @return the field object to enable build pattern
     */
    ...
    public static List<Field105> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field105> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
