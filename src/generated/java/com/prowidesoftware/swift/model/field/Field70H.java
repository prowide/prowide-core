...
/**
 * <strong>SWIFT MT Field 70H</strong>
 * <p>
 * Model and parser for field 70H of a SWIFT MT message.
 *
 ...
 * <ul>
 * 		<li>validation pattern: <code>:4!c//2500z</code></li>
...
@Generated
public class Field70H extends Field implements Serializable, GenericField {
	/**
	...
	/**
	 * Constant with the field name 70H
	 */
     ...
     */
    public Field70H(final String value) {
        super(value);
    }
     ...
     * @since 7.8
     */
    public Field70H(final Tag tag) {
        this();
        if (tag == null) {
            throw new IllegalArgumentException("tag cannot be null.");
        }
        if (!StringUtils.equals(tag.getName(), "70H")) {
     ...
     * @see #typesPattern()
     * @return the static value of Field70H.COMPONENTS_PATTERN
     */
    @Override
    @Deprecated
    @ProwideDeprecated(phase2=TargetYear.SRU2022)
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field70H.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field70H.PARSER_PATTERN
     */
    @Override
     ...
     * @return the static value of Field70H.NAME
     */
    @Override
     ...
     */
    public static Field70H get(final SwiftTagListBlock block) {
    ...
    /**
     * Gets the first instance of Field70H in the given message.
     * @param msg may be empty or null
     * @return null if not found or msg is empty or null
     * @see #get(SwiftTagListBlock)
     */
    public static Field70H get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field70H in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field70H> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty())
    ...
    /**
     * Gets a list of all occurrences of the field Field70H from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field70H> getAll(final SwiftTagListBlock block) {
        if (block == null || block.isEmpty()) {
            return java.util.Collections.emptyList();
        }
        final Tag[] arr = block.getTagsByName(NAME);
        if (arr != null && arr.length > 0) {
            final List<Field70H> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
    ...
    /**
     * This method deserializes the JSON data into a Field70H object.
     * @param json JSON structure including tuples with label and value for all field components
     * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
     * @since 7.10.3
     * @see Field#fromJson(String)
     */
    public static Field70H fromJson(final String json) {
