...
public class Field97B extends Field implements Serializable, GenericField {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field97B.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field97B.PARSER_PATTERN
     */
    @Override
    ...
    /**
     * Set the component 3 (Account Type Code).
     *
    ...
    /**
     * Set the Account Type Code (component 3).
     *
     * @param component3 the Account Type Code to set
     * @return the field object to enable build pattern
     */
    ...
    /**
     * Set the component 4 (Account Number).
     *
    ...
    /**
     * Set the Account Number (component 4).
     *
     * @param component4 the Account Number to set
     * @return the field object to enable build pattern
     */
    ...
    public static List<Field97B> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field97B> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
