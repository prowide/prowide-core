...
@Generated
public class Field54B extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field54B> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field54B> result = new ArrayList<>(arr.length);
			for (final Tag f : arr) {
	...
	@ProwideDeprecated(phase3=TargetYear._2019)
	public String getDC() {
	    com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "getDC()", "Use use getDCMark() instead.");
		return getDCMark();
	}
	...
	public void setDC(final String DC) {
	    com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "setDC(String)", "Use use setDCMark(String) instead.");
		setDCMark(DC);
	}
