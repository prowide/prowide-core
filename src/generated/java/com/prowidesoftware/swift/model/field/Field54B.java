...
@Generated
public class Field54B extends OptionBPartyField implements Serializable, MultiLineField {
	/**
    ...
    public Field54B(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "54B")) {
    ...
    public static List<Field54B> getAll(final SwiftTagListBlock block) {
        final List<Field54B> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field54B fromJson(final String json) {
        ...
        final Field54B field = new Field54B();
