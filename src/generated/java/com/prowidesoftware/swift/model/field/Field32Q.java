 ...
 * <ol>
 * 		<li>Component 1: Currency1: <code>Currency</code></li>
 * 		<li>Component 2: Currency2: <code>Currency</code></li>
 * </ol>
 *
...
public class Field32Q extends Field implements Serializable, CurrencyContainer {
    ...
    public Field32Q(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "32Q")) {
    ...
    protected Map<String, Integer> getLabelMap() {
        ...
        super.labelMap.put("currency1", 1);
        super.labelMap.put("currency2", 2);
        return super.labelMap;
    }
