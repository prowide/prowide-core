...
public class Field256 extends Field implements Serializable, DateContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field256.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field256.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field256 setComponent1(com.prowidesoftware.swift.model.LogicalTerminalAddress component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field256 setLTAddress(com.prowidesoftware.swift.model.LogicalTerminalAddress component1) {
        return setComponent1(component1);
    }
     ...
     * @since 9.2.7
     *
     * @param component2 the Long with the Session Number content to set
     * @return the field object to enable build pattern
     */
    public Field256 setComponent2(java.lang.Long component2) {
    ...
    /**
     * Set the Session Number (component 2) from a Long object.
     *
     * @see #setComponent2(java.lang.Long)
     *
     * @param component2 Long with the Session Number content to set
     * @return the field object to enable build pattern
     * @since 9.2.7
     */
    public Field256 setSessionNumber(java.lang.Long component2) {
        return setComponent2(component2);
    }
     ...
     * @since 9.2.7
     *
     * @param component3 the Long with the Message Category content to set
     * @return the field object to enable build pattern
     */
    public Field256 setComponent3(java.lang.Long component3) {
     ...
     * @return the field object to enable build pattern
     * @see #setMessageCategory(java.lang.Long)
     */
    ...
    /**
     * Set the Message Category (component 3) from a Long object.
     *
     * @see #setComponent3(java.lang.Long)
     *
     * @param component3 Long with the Message Category content to set
     * @return the field object to enable build pattern
     * @since 9.2.7
     */
    public Field256 setMessageCategory(java.lang.Long component3) {
        return setComponent3(component3);
    }
    ...
    public static List<Field256> getAll(final SwiftTagListBlock block) {
        final List<Field256> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field256 fromJson(final String json) {
        ...
        final Field256 field = new Field256();
