...
public class Field256 extends Field implements Serializable, DateContainer {
	...
	/**
	 * Get the Session Number (component 2) as Number
	 * @return the Session Number from component 2 converted to Number or null if cannot be converted
	 */
	...
	/**
	 * Get the Message Category (component 3) as Number
	 * @return the Message Category from component 3 converted to Number or null if cannot be converted
	 */
	...
	/**
	 * Set the component3 (Message Category).
