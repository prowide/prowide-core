...
public class Field30F extends Field implements Serializable, DateContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field30F.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field30F.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field30F> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field30F> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
