...
@Generated
public class Field91D extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field91D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field91D> result = new ArrayList<Field91D>(arr.length);
			for (final Tag f : arr) {
