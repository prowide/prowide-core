...
@Generated
public class Field91D extends OptionDPartyField implements Serializable, MultiLineField {
	/**
    ...
    public Field91D(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "91D")) {
    ...
    public static Field91D fromJson(final String json) {
        ...
        final Field91D field = new Field91D();
