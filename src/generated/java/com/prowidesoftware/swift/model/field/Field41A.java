...
@Generated
public class Field41A extends Field implements Serializable, BICContainer, MultiLineField {
	/**
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field41A.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field41A.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field41A> getAll(final SwiftTagListBlock block) {
        final List<Field41A> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field41A fromJson(final String json) {
        ...
        final Field41A field = new Field41A();
