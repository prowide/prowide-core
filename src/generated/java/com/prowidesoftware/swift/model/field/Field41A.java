...
@Generated
public class Field41A extends Field implements Serializable, BICContainer, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
	...
	*/
	...
	/**
	 * Gets the BIC (component1) as BIC
   ...
   public String parserPattern() {
	...
	public static List<Field41A> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field41A> result = new ArrayList<Field41A>(arr.length);
			for (final Tag f : arr) {
