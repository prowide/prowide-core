 ...
 * 		<li>Component 3: SubbalanceType: <code>String</code></li>
 * </ol>
 *
...
public class Field93A extends Field implements Serializable, GenericField {
    ...
    public Field93A(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "93A")) {
    ...
    protected Map<String, Integer> getLabelMap() {
        ...
        super.labelMap.put("subbalancetype", 3);
        // alias name
    ...
    public static Field93A fromJson(final String json) {
        ...
        final Field93A field = new Field93A();
