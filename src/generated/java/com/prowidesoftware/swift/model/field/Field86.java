...
@Generated
public class Field86 extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field86> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field86> result = new ArrayList<Field86>(arr.length);
			for (final Tag f : arr) {
