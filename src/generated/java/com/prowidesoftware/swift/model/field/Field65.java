...
public class Field65 extends Field implements Serializable, DateContainer, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field65.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field65.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field65 setComponent4(java.math.BigDecimal component4) {
     ...
     * @since 9.2.7
     */
    public Field65 setAmount(java.math.BigDecimal component4) {
        return setComponent4(component4);
    }
    ...
    public static List<Field65> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field65> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
