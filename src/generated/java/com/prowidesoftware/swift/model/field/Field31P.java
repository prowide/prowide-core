...
public class Field31P extends Field implements Serializable, DateContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field31P.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field31P.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field31P> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field31P> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
