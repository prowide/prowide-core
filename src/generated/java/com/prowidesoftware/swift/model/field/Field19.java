...
public class Field19 extends Field implements Serializable, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field19.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field19.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field19 setComponent1(java.math.BigDecimal component1) {
     ...
     * @since 9.2.7
     */
    public Field19 setAmount(java.math.BigDecimal component1) {
        return setComponent1(component1);
    }
    ...
    public static List<Field19> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field19> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
