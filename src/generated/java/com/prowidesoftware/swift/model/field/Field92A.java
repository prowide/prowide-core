...
@Generated
public class Field92A extends Field implements Serializable, AmountContainer, com.prowidesoftware.swift.model.field.GenericField {
	/**
	...
	*/
	...
	/**
	 * Gets the Rate Amount (component3) as Number
	 * @return the Rate Amount from component3 converted to Number or <code>null</code> if cannot be converted
	 */
   ...
   public String parserPattern() {
	...
	public static List<Field92A> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field92A> result = new ArrayList<Field92A>(arr.length);
			for (final Tag f : arr) {
