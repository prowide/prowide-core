...
public class Field37D extends Field implements Serializable, DateContainer, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field37D.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field37D.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field37D setComponent1(java.math.BigDecimal component1) {
     ...
     * @since 9.2.7
     */
    public Field37D setRate(java.math.BigDecimal component1) {
        return setComponent1(component1);
    }
     ...
     * @return the field object to enable build pattern
     */
    public Field37D setEndDate(String component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field37D setEndDate(java.util.Calendar component2) {
        return setComponent2(component2);
    }
     ...
     * @return the field object to enable build pattern
     */
    public Field37D setComponent4(java.lang.Long component4) {
     ...
     * @return the field object to enable build pattern
     */
    public Field37D setNumber(String component4) {
     ...
     * @since 9.2.7
     */
    public Field37D setNumber(java.lang.Long component4) {
        return setComponent4(component4);
    }
    ...
    public static List<Field37D> getAll(final SwiftTagListBlock block) {
        final List<Field37D> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field37D fromJson(final String json) {
        ...
        final Field37D field = new Field37D();
