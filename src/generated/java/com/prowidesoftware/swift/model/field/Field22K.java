...
public class Field22K extends Field implements Serializable {
     ...
     * @return the static value of Field22K.PARSER_PATTERN
     */
	@Override
	...
	/**
	 * Gets the component1 (Type Of Event).
	...
	/**
	 * Set the component1 (Type Of Event).
	...
	public static List<Field22K> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field22K> result = new ArrayList<>(arr.length);
			for (final Tag f : arr) {
