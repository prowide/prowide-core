...
/**
 * <strong>SWIFT MT Field 12R</strong>
 * <p>
...
public class Field12R extends Field implements Serializable {
    ...
    public Field12R(final Tag tag) {
        ...
        if (!StringUtils.equals(tag.getName(), "12R")) {
            throw new IllegalArgumentException("cannot create field 12R from tag "+tag.getName()+", tagname must match the name of the field.");
        }
        parse(tag.getValue());
    }
     ...
     * @see #typesPattern()
     * @return the static value of Field12R.COMPONENTS_PATTERN
     */
    @Override
    @Deprecated
    @ProwideDeprecated(phase2=TargetYear.SRU2022)
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field12R.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field12R.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field12R> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field12R> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
