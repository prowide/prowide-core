...
public class Field29Q extends Field implements Serializable {
    ...
    public Field29Q(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "29Q")) {
     ...
     * @return the static value of Field29Q.NAME
     */
    @Override
     ...
     */
    public static Field29Q get(final SwiftTagListBlock block) {
        ...
        return new Field29Q(t);
    }

    /**
     * Gets the first instance of Field29Q in the given message.
     * @param msg may be empty or null
     * @return null if not found or msg is empty or null
     * @see #get(SwiftTagListBlock)
     */
    public static Field29Q get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field29Q in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field29Q> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty()) {
     ...
     */
    public static List<Field29Q> getAll(final SwiftTagListBlock block) {
    ...
    /**
     * This method deserializes the JSON data into a Field29Q object.
