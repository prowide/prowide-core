...
public class Field28C extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field28C.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field28C.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field28C setComponent1(java.lang.Long component1) {
     ...
     * @since 9.2.7
     */
    public Field28C setStatementNumber(java.lang.Long component1) {
        return setComponent1(component1);
    }
     ...
     * @return the field object to enable build pattern
     */
    public Field28C setComponent2(java.lang.Long component2) {
     ...
     * @since 9.2.7
     */
    public Field28C setSequenceNumber(java.lang.Long component2) {
        return setComponent2(component2);
    }
    ...
    public static List<Field28C> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field28C> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
