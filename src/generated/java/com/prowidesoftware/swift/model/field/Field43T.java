...
public class Field43T extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field43T.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field43T.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field43T> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field43T> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
