...
public class Field22J extends Field implements Serializable {
     ...
     * @return the static value of Field22J.PARSER_PATTERN
     */
	@Override
	...
	/**
	 * Gets the component1 (Type Of Barrier).
	...
	/**
	 * Set the component1 (Type Of Barrier).
	...
	public static List<Field22J> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field22J> result = new ArrayList<>(arr.length);
			for (final Tag f : arr) {
