...
public class Field38E extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field38E.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field38E.PARSER_PATTERN
     */
    @Override
    ...
    /**
     * Gets the Period (component 2).
     * @return the Period from component 2
     */
     ...
     * @return the field object to enable build pattern
     */
    public Field38E setComponent1(java.lang.Long component1) {
     ...
     * @since 9.2.7
     */
    public Field38E setNumber(java.lang.Long component1) {
        return setComponent1(component1);
    }
    ...
    public static List<Field38E> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field38E> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
