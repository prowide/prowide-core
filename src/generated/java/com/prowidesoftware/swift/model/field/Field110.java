...
public class Field110 extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field110.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field110.PARSER_PATTERN
     */
    @Override
    ...
    /**
     * Gets the component 1 (Window Size).
    ...
    /**
     * Get the Window Size (component 1) as Long
     * @return the Window Size from component 1 converted to Long or null if cannot be converted
     * @since 9.2.7
     */
    public java.lang.Long getWindowSizeAsLong() {
    ...
    /**
     * Alternative method setter for field's Window Size (component 1) as as Number
     *
    ...
    /**
     * Set the Window Size (component 1).
     *
     * @param component1 the Window Size to set
     * @return the field object to enable build pattern
     */
    ...
    public static List<Field110> getAll(final SwiftTagListBlock block) {
        final List<Field110> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field110 fromJson(final String json) {
        ...
        final Field110 field = new Field110();

        final JsonObject jsonObject = JsonParser.parseString(json).getAsJsonObject();

        // **** COMPONENT 1 - Window Size
