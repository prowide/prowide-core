...
public class Field28 extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field28.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field28.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field28> getAll(final SwiftTagListBlock block) {
        final List<Field28> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field28 fromJson(final String json) {
        ...
        final Field28 field = new Field28();
