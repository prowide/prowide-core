...
@Generated
public class Field44A extends Field implements Serializable, MultiLineField {
	/**
    ...
    public Field44A(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "44A")) {
     ...
     * @return the field object to enable build pattern
     */
    public Field44A setNarrativeLine1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field44A setNarrative(String value) {
        List<String> lines = SwiftParseUtils.getLines(value);
     ...
     * @return the field object to enable build pattern
     */
    public Field44A setComponent2(String component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field44A setNarrativeLine2(String component2) {
    ...
    public static List<Field44A> getAll(final SwiftTagListBlock block) {
        final List<Field44A> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field44A fromJson(final String json) {
        ...
        final Field44A field = new Field44A();
