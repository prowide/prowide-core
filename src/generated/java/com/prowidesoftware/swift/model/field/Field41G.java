...
/**
 * <strong>SWIFT MT Field 41G</strong>
 * <p>
 * Model and parser for field 41G of a SWIFT MT message.
 *
...
@Generated
public class Field41G extends Field implements Serializable, MultiLineField {
	/**
	...
	/**
	 * Constant with the field name 41G
	 */
    public static final String NAME = "41G";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_41G = "41G";
     ...
     */
    public Field41G(final String value) {
        super(value);
    }
     ...
     * @since 7.8
     */
    public Field41G(final Tag tag) {
        this();
        if (tag == null) {
            throw new IllegalArgumentException("tag cannot be null.");
        }
        if (!StringUtils.equals(tag.getName(), "41G")) {
            throw new IllegalArgumentException("cannot create field 41G from tag "+tag.getName()+", tagname must match the name of the field.");
        }
        parse(tag.getValue());
    }
     ...
     * @since 7.7
     */
    public static Field41G newInstance(Field41G source) {
        Field41G cp = new Field41G();
    ...
    public String getValueDisplay(int component, Locale locale) {
        if (component < 1 || component > 4) {
            throw new IllegalArgumentException("invalid component number " + component + " for field 41G");
        }
        if (component == 1) {
     ...
     * @see #typesPattern()
     * @return the static value of Field41G.COMPONENTS_PATTERN
     */
    @Override
    @Deprecated
    @ProwideDeprecated(phase2=TargetYear.SRU2022)
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field41G.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field41G.PARSER_PATTERN
     */
    @Override
     ...
     */
    public Field41G setComponent1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field41G setNameAndAddressLine1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field41G setNameAndAddress(String value) {
        List<String> lines = SwiftParseUtils.getLines(value);
     ...
     * @return the field object to enable build pattern
     */
    public Field41G setComponent2(String component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field41G setNameAndAddressLine2(String component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field41G setComponent3(String component3) {
     ...
     * @return the field object to enable build pattern
     */
    public Field41G setNameAndAddressLine3(String component3) {
     ...
     * @return the field object to enable build pattern
     */
    public Field41G setComponent4(String component4) {
     ...
     * @return the field object to enable build pattern
     */
    public Field41G setNameAndAddressLine4(String component4) {
     ...
     * @return the static value of Field41G.NAME
     */
    @Override
     ...
     */
    public static Field41G get(final SwiftTagListBlock block) {
        ...
        return new Field41G(t) ;
    }

    /**
     * Gets the first instance of Field41G in the given message.
     * @param msg may be empty or null
     * @return null if not found or msg is empty or null
     * @see #get(SwiftTagListBlock)
     */
    public static Field41G get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field41G in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field41G> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty())
    ...
    /**
     * Gets a list of all occurrences of the field Field41G from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field41G> getAll(final SwiftTagListBlock block) {
        if (block == null || block.isEmpty()) {
            return java.util.Collections.emptyList();
        }
        final Tag[] arr = block.getTagsByName(NAME);
        if (arr != null && arr.length > 0) {
            final List<Field41G> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
                result.add( new Field41G(f));
            }
            return result;
        }
        return java.util.Collections.emptyList();
    ...
    /**
     * This method deserializes the JSON data into a Field41G object.
     * @param json JSON structure including tuples with label and value for all field components
     * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
     * @since 7.10.3
     * @see Field#fromJson(String)
     */
    public static Field41G fromJson(final String json) {

        Field41G field = new Field41G();
