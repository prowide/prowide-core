...
public class Field27 extends Field implements Serializable {
	...
	/**
     * Alternative constant name for field's Number Component number.
     * @see #NUMBER
     */
	...
	/**
     * Alternative constant name for field's Total Component number.
     * @see #TOTAL
     */
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field27.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field27.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field27 setComponent1(java.lang.Long component1) {
     ...
     * @since 9.2.7
     */
    public Field27 setNumber(java.lang.Long component1) {
        return setComponent1(component1);
    }
     ...
     * @return the field object to enable build pattern
     */
    public Field27 setComponent2(java.lang.Long component2) {
     ...
     * @since 9.2.7
     */
    public Field27 setTotal(java.lang.Long component2) {
        return setComponent2(component2);
    }
    ...
    public static List<Field27> getAll(final SwiftTagListBlock block) {
        final List<Field27> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field27 fromJson(final String json) {
        ...
        final Field27 field = new Field27();
