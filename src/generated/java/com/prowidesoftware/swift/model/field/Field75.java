...
@Generated
public class Field75 extends Field implements Serializable, MultiLineField {
	/**
     ...
     * @return the static value of Field75.PARSER_PATTERN
     */
	@Override
	...
	public static List<Field75> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field75> result = new ArrayList<>(arr.length);
			for (final Tag f : arr) {
