...
public class Field37H extends Field implements Serializable, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field37H.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field37H.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field37H> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field37H> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
