 ...
 * 		<li>Component 3: Rate: <code>BigDecimal</code></li>
 * </ol>
 *
...
public class Field37H extends Field implements Serializable, AmountContainer {
     ...
     * @return the field object to enable build pattern
     */
    public Field37H setComponent3(java.math.BigDecimal component3) {
        setComponent(3, SwiftFormatUtils.getBigDecimal(component3));
        return this;
    }
    /**
     * Alternative method setter for field's Rate (component 3) as Number
     *
     ...
     * @since 9.2.7
     */
    public Field37H setRate(java.math.BigDecimal component3) {
        return setComponent3(component3);
    }
