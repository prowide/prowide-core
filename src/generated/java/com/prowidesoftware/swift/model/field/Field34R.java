...
public class Field34R extends Field implements Serializable, CurrencyContainer, DateContainer, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field34R.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field34R.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field34R setComponent3(java.math.BigDecimal component3) {
     ...
     * @since 9.2.7
     */
    public Field34R setAmount(java.math.BigDecimal component3) {
        return setComponent3(component3);
    }
    ...
    public static List<Field34R> getAll(final SwiftTagListBlock block) {
        final List<Field34R> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field34R fromJson(final String json) {
        ...
        final Field34R field = new Field34R();
