...
@Generated
public class Field50 extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field50> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field50> result = new ArrayList<Field50>(arr.length);
			for (final Tag f : arr) {
