...
public class Field30Z extends Field implements Serializable, DateContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field30Z.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field30Z.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field30Z> getAll(final SwiftTagListBlock block) {
        final List<Field30Z> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field30Z fromJson(final String json) {
        ...
        final Field30Z field = new Field30Z();
