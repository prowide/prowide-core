 ...
 * <ol>
 * 		<li>Component 1: Tolerance1: <code>Long</code></li>
 * 		<li>Component 2: Tolerance2: <code>Long</code></li>
 * </ol>
 *
...
public class Field39A extends Field implements Serializable {
    ...
    public Field39A(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "39A")) {
    ...
    protected Map<String, Integer> getLabelMap() {
        ...
        super.labelMap.put("tolerance1", 1);
        super.labelMap.put("tolerance2", 2);
        return super.labelMap;
    }
    ...
    public static Field39A fromJson(final String json) {
        ...
        final Field39A field = new Field39A();
