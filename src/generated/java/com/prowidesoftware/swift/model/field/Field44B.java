...
@Generated
public class Field44B extends Field implements Serializable, MultiLineField {
	/**
    ...
    public Field44B(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "44B")) {
     ...
     * @return the field object to enable build pattern
     */
    public Field44B setNarrativeLine1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field44B setNarrative(String value) {
        List<String> lines = SwiftParseUtils.getLines(value);
     ...
     * @return the field object to enable build pattern
     */
    public Field44B setComponent2(String component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field44B setNarrativeLine2(String component2) {
    ...
    public static List<Field44B> getAll(final SwiftTagListBlock block) {
        final List<Field44B> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field44B fromJson(final String json) {
        ...
        final Field44B field = new Field44B();
