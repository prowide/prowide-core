...
@Generated
public class Field50A extends Field implements Serializable, BICContainer, MultiLineField {
	/**
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field50A.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field50A.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field50A setIdentifierCode(com.prowidesoftware.swift.model.BIC component2) {
        return setComponent2(component2);
    }
    ...
    public static List<Field50A> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field50A> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
