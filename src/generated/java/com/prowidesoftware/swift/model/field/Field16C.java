...
public class Field16C extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field16C.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field16C.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field16C> getAll(final SwiftTagListBlock block) {
        final List<Field16C> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field16C fromJson(final String json) {
        ...
        final Field16C field = new Field16C();
