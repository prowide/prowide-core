...
@Generated
public class Field82D extends OptionDPartyField implements Serializable, MultiLineField {
	/**
    ...
    public Field82D(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "82D")) {
    ...
    public static Field82D fromJson(final String json) {
        ...
        final Field82D field = new Field82D();
