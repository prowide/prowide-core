...
public class Field129 extends Field implements Serializable {
	...
	*/
	...
	/**
	 * Gets the Section (component1) as Number
	...
	/**
	 * Gets the Total (component2) as Number
   ...
   public String parserPattern() {
	...
	public static List<Field129> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field129> result = new ArrayList<Field129>(arr.length);
			for (final Tag f : arr) {
