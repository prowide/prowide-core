 ...
 * <ol>
 * 		<li>Component 1: Section: <code>Long</code></li>
...
public class Field129 extends Field implements Serializable {
    ...
    public Field129(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "129")) {
    ...
    protected Map<String, Integer> getLabelMap() {
        ...
        super.labelMap.put("section", 1);
        super.labelMap.put("total", 2);
        return super.labelMap;
    }

    /**
     * Gets the component 1 (Section).
    ...
    /**
     * Get the Section (component 1) as Long
     * @return the Section from component 1 converted to Long or null if cannot be converted
     * @since 9.2.7
     */
    ...
    public static List<Field129> getAll(final SwiftTagListBlock block) {
        final List<Field129> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field129 fromJson(final String json) {
        ...
        final Field129 field = new Field129();
