...
public class Field334 extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field334.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field334.PARSER_PATTERN
     */
    @Override
    ...
    /**
     * Set the component 2 (Delta Time).
     *
     ...
     *
     * @param component2 the Calendar with the Delta Time content to set
     * @return the field object to enable build pattern
     */
    ...
    /**
     * Set the Delta Time (component 2).
     *
     * @param component2 the Delta Time to set
     * @return the field object to enable build pattern
     */
    ...
    /**
     * Set the Delta Time (component 2) from a Calendar object.
     *
    ...
    public static List<Field334> getAll(final SwiftTagListBlock block) {
        final List<Field334> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field334 fromJson(final String json) {
        ...
        final Field334 field = new Field334();
