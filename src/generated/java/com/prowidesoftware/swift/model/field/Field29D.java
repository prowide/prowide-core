...
/**
 * <strong>SWIFT MT Field 29D</strong>
 * <p>
 * Model and parser for field 29D of a SWIFT MT message.
 *
...
public class Field29D extends Field implements Serializable, MultiLineField {
     ...
     */
    public Field29D(final String value) {
        super(value);
    }
     ...
     * @since 7.7
     */
    public static Field29D newInstance(Field29D source) {
        Field29D cp = new Field29D();
     ...
     * @see #typesPattern()
     * @return the static value of Field29D.COMPONENTS_PATTERN
     */
    @Override
    @Deprecated
    @ProwideDeprecated(phase2=TargetYear.SRU2022)
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field29D.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field29D.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field29D setNarrativeLine1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field29D setNarrative(String value) {
        List<String> lines = SwiftParseUtils.getLines(value);
     ...
     * @return the field object to enable build pattern
     */
    public Field29D setNarrativeLine2(String component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field29D setNarrativeLine3(String component3) {
     ...
     * @return the field object to enable build pattern
     */
    public Field29D setNarrativeLine4(String component4) {
    ...
    public static Field29D get(final SwiftTagListBlock block) {
        ...
        return new Field29D(t) ;
    }

    /**
     * Gets the first instance of Field29D in the given message.
    ...
    /**
     * Gets a list of all occurrences of the field Field29D in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field29D> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty())
    ...
    /**
     * Gets a list of all occurrences of the field Field29D from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field29D> getAll(final SwiftTagListBlock block) {
        if (block == null || block.isEmpty()) {
            return java.util.Collections.emptyList();
        }
        final Tag[] arr = block.getTagsByName(NAME);
        if (arr != null && arr.length > 0) {
            final List<Field29D> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
    ...
    /**
     * This method deserializes the JSON data into a Field29D object.
     * @param json JSON structure including tuples with label and value for all field components
     * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
     * @since 7.10.3
     * @see Field#fromJson(String)
     */
    public static Field29D fromJson(final String json) {

        Field29D field = new Field29D();
