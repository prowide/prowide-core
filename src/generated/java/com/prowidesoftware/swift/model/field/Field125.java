...
public class Field125 extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field125.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field125.PARSER_PATTERN
     */
    @Override
    ...
    /**
     * Get the Category (component 1) as Long
     * @return the Category from component 1 converted to Long or null if cannot be converted
     * @since 9.2.7
     */
    public java.lang.Long getCategoryAsLong() {
    ...
    /**
     * Alternative method setter for field's Category (component 1) as as Number
     *
    ...
    public static List<Field125> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field125> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
