 ...
 * <ol>
 * 		<li>Component 1: StartMOR: <code>MOR</code></li>
 * 		<li>Component 2: EndMOR: <code>MOR</code></li>
...
public class Field254 extends Field implements Serializable {
    ...
    public Field254(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "254")) {
    ...
    protected Map<String, Integer> getLabelMap() {
        ...
        super.labelMap.put("startmor", 1);
        super.labelMap.put("endmor", 2);
     ...
     *
     * @param component1 the MOR with the Start MOR content to set
     * @return the field object to enable build pattern
     */
    ...
    /**
     * Set the Start MOR (component 1) from a MOR object.
     *
     ...
     *
     * @param component2 the MOR with the End MOR content to set
     * @return the field object to enable build pattern
     */
    ...
    /**
     * Set the End MOR (component 2) from a MOR object.
     *
    ...
    public static List<Field254> getAll(final SwiftTagListBlock block) {
        final List<Field254> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field254 fromJson(final String json) {
        ...
        final Field254 field = new Field254();

        final JsonObject jsonObject = JsonParser.parseString(json).getAsJsonObject();

        // **** COMPONENT 1 - Start MOR
