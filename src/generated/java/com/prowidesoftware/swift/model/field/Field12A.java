...
public class Field12A extends Field implements Serializable, GenericField {
     ...
     * @return the static value of Field12A.PARSER_PATTERN
     */
	@Override
	...
	/**
	 * Gets the component3 (Instrument Code).
	...
	/**
	 * Set the component3 (Instrument Code).
   ...
   public String getConditionalQualifier() {
	...
	public static List<Field12A> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field12A> result = new ArrayList<>(arr.length);
			for (final Tag f : arr) {
