 ...
 * 		<li>Component 3: InstrumentCodeOrDescription: <code>String</code></li>
 * </ol>
 *
...
public class Field12A extends Field implements Serializable, GenericField {
    ...
    public Field12A(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "12A")) {
    ...
    protected Map<String, Integer> getLabelMap() {
        ...
        super.labelMap.put("instrumentcodeordescription", 3);
        // alias name
        super.labelMap.put("instrumentcode", 3);
        return super.labelMap;
    }
