...
@Generated
public class Field12A extends Field implements Serializable, com.prowidesoftware.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field12A> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field12A> result = new ArrayList<Field12A>(arr.length);
			for (final Tag f : arr) {
