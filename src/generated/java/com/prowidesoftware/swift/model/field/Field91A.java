...
@Generated
public class Field91A extends OptionAPartyField implements Serializable, BICContainer, MultiLineField {
	/**
     ...
     * @return the field object to enable build pattern
     */
    public Field91A setIdentifierCode(String component3) {
     ...
     * @return the field object to enable build pattern
     */
    public Field91A setIdentifierCode(com.prowidesoftware.swift.model.BIC component3) {
        return setComponent3(component3);
    }
    ...
    public static List<Field91A> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field91A> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
