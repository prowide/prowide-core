...
public class Field37C extends Field implements Serializable, DateContainer, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field37C.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field37C.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field37C setComponent1(java.math.BigDecimal component1) {
     ...
     * @since 9.2.7
     */
    public Field37C setRate(java.math.BigDecimal component1) {
        return setComponent1(component1);
    }
    ...
    public static Field37C fromJson(final String json) {
        ...
        final Field37C field = new Field37C();
