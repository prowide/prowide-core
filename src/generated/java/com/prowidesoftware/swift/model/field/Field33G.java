 ...
 * 		<li>Component 2: Price: <code>BigDecimal</code></li>
...
@Generated
public class Field33G extends Field implements Serializable, MonetaryAmountContainer {
	/**
    ...
    public Field33G(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "33G")) {
    ...
    public static List<Field33G> getAll(final SwiftTagListBlock block) {
        final List<Field33G> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field33G fromJson(final String json) {
        ...
        final Field33G field = new Field33G();
