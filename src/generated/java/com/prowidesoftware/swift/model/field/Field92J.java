...
@Generated
public class Field92J extends Field implements Serializable, MonetaryAmountContainer, GenericField {
	/**
    ...
    public Field92J(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "92J")) {
    ...
    protected Map<String, Integer> getLabelMap() {
        ...
        super.labelMap.put("ratetypecode", 3);
        // alias name
        super.labelMap.put("code", 3);
        super.labelMap.put("currencycode", 4);
        // alias name
        super.labelMap.put("currency", 4);
        super.labelMap.put("amount", 5);
        super.labelMap.put("ratestatus", 6);
        return super.labelMap;
    }
