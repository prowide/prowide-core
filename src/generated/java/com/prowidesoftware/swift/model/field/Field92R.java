...
@Generated
public class Field92R extends Field implements Serializable, AmountContainer, com.prowidesoftware.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field92R> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field92R> result = new ArrayList<Field92R>(arr.length);
			for (final Tag f : arr) {
