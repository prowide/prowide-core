...
public class Field97C extends Field implements Serializable, GenericField {
	...
	/**
	 * Component number for the Account Code subfield
	 */
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field97C.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field97C.PARSER_PATTERN
     */
    @Override
    ...
    /**
     * Gets the component 2 (Account Code).
    ...
    /**
     * Gets the Account Code (component 2).
     * @return the Account Code from component 2
     */
    ...
    /**
     * Set the component 2 (Account Code).
     *
    ...
    /**
     * Set the Account Code (component 2).
     *
     * @param component2 the Account Code to set
     * @return the field object to enable build pattern
     */
    public Field97C setAccountCode(String component2) {
    ...
    public static List<Field97C> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field97C> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
    ...
    public static Field97C fromJson(final String json) {
        ...
        if (jsonObject.get("accountCode") != null) {
            field.setComponent2(jsonObject.get("accountCode").getAsString());
        }
