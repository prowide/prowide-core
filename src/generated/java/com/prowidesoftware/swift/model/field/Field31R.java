...
public class Field31R extends Field implements Serializable, DateContainer {
    ...
    public Field31R(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "31R")) {
    ...
    public static Field31R fromJson(final String json) {
        ...
        final Field31R field = new Field31R();
...
// According to latest SCORE specification, there  are 2 formats for this field:
// a new one (6!n) in message 765, and the old format (6!n[/6!n])) in message 784
// Both are correct in their own context. That is – 31R in MT 798<784> has a
// different significance from field 31R in the MT 765.
