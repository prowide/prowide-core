...
public class Field31R extends Field implements Serializable, DateContainer {
	...
	/**
	 * Set the Date 1 (component1) from a Calendar object.
	...
	/**
	 * Set the Date 2 (component2) from a Calendar object.
	...
	public static List<Field31R> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field31R> result = new ArrayList<>(arr.length);
			for (final Tag f : arr) {
