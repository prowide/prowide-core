...
public class Field32U extends Field implements Serializable, CurrencyContainer, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field32U.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field32U.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field32U> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field32U> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
