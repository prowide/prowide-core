...
@Generated
public class Field32U extends Field implements Serializable, MonetaryAmountContainer {
	/**
    ...
    public Field32U(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "32U")) {
    ...
    public static Field32U fromJson(final String json) {
        ...
        final Field32U field = new Field32U();
