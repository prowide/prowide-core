...
@Generated
public class Field85D extends OptionDPartyField implements Serializable, MultiLineField {
	/**
    ...
    public Field85D(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "85D")) {
    ...
    public static List<Field85D> getAll(final SwiftTagListBlock block) {
        final List<Field85D> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field85D fromJson(final String json) {
        ...
        final Field85D field = new Field85D();
