...
public class Field30T extends Field implements Serializable, DateContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field30T.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field30T.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field30T> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field30T> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
