...
@Generated
public class Field92P extends Field implements Serializable, AmountContainer, com.prowidesoftware.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field92P> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field92P> result = new ArrayList<Field92P>(arr.length);
			for (final Tag f : arr) {
