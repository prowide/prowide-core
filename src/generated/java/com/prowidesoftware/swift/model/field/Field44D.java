...
@Generated
public class Field44D extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field44D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field44D> result = new ArrayList<Field44D>(arr.length);
			for (final Tag f : arr) {
