...
@Generated
public class Field44D extends Field implements Serializable, MultiLineField {
	/**
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field44D.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field44D.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field44D> getAll(final SwiftTagListBlock block) {
        final List<Field44D> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field44D fromJson(final String json) {
        ...
        final Field44D field = new Field44D();
