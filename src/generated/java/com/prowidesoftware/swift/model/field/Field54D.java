...
@Generated
public class Field54D extends OptionDPartyField implements Serializable, MultiLineField {
	/**
    ...
    public Field54D(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "54D")) {
    ...
    public static List<Field54D> getAll(final SwiftTagListBlock block) {
        final List<Field54D> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field54D fromJson(final String json) {
        ...
        final Field54D field = new Field54D();
