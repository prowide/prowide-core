...
public class Field29W extends Field implements Serializable {
    ...
    public Field29W(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "29W")) {
     ...
     * @return the static value of Field29W.NAME
     */
    @Override
     ...
     */
    public static Field29W get(final SwiftTagListBlock block) {
        ...
        return new Field29W(t);
    }

    /**
     * Gets the first instance of Field29W in the given message.
     * @param msg may be empty or null
     * @return null if not found or msg is empty or null
     * @see #get(SwiftTagListBlock)
     */
    public static Field29W get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field29W in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field29W> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty()) {
    ...
    /**
     * Gets a list of all occurrences of the field Field29W from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field29W> getAll(final SwiftTagListBlock block) {
    ...
    /**
     * This method deserializes the JSON data into a Field29W object.
