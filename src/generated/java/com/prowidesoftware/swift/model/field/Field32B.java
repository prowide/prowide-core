...
public class Field32B extends Field implements Serializable, CurrencyContainer, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field32B.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field32B.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field32B setComponent2(java.math.BigDecimal component2) {
     ...
     * @since 9.2.7
     */
    public Field32B setAmount(java.math.BigDecimal component2) {
        return setComponent2(component2);
    }
    ...
    public static List<Field32B> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field32B> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
