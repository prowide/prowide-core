...
@Generated
public class Field29A extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field29A> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field29A> result = new ArrayList<Field29A>(arr.length);
			for (final Tag f : arr) {
