...
@Generated
public class Field29A extends Field implements Serializable, MultiLineField {
	/**
     ...
     * @return the static value of Field29A.PARSER_PATTERN
     */
	@Override
	...
	public static List<Field29A> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field29A> result = new ArrayList<>(arr.length);
			for (final Tag f : arr) {
