...
@Generated
public class Field37B extends Field implements Serializable, AmountContainer, DateContainer {
	/**
     ...
     * @return the field object to enable build pattern
     */
    public Field37B setComponent1(java.math.BigDecimal component1) {
     ...
     * @since 9.2.7
     */
    public Field37B setRate(java.math.BigDecimal component1) {
        return setComponent1(component1);
    }
     ...
     * @return the field object to enable build pattern
     */
    public Field37B setEndDate(String component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field37B setEndDate(java.util.Calendar component2) {
        return setComponent2(component2);
    }
     ...
     * @return the field object to enable build pattern
     */
    public Field37B setPeriod(String component3) {
     ...
     * @return the field object to enable build pattern
     */
    public Field37B setComponent4(java.lang.Long component4) {
     ...
     * @return the field object to enable build pattern
     */
    public Field37B setNumber(String component4) {
     ...
     * @since 9.2.7
     */
    public Field37B setNumber(java.lang.Long component4) {
        return setComponent4(component4);
    }
     ...
     * @see #setNumber(java.lang.Long)
     */
    public Field37B setNumber(java.lang.Number component4) {
        return setComponent4(component4);
    }
    ...
    @Deprecated
    @ProwideDeprecated(phase3 = TargetYear.SRU2023)
    public Field37B setNumberofDaysMonths(java.lang.Long component4) {
        return setNumber(component4);
    }
    ...
    public static List<Field37B> getAll(final SwiftTagListBlock block) {
        final List<Field37B> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field37B fromJson(final String json) {
        ...
        final Field37B field = new Field37B();
