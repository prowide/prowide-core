...
public class Field253 extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field253.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field253.PARSER_PATTERN
     */
    @Override
     ...
     *
     * @param component1 the MOR with the MOR content to set
     * @return the field object to enable build pattern
     */
    ...
    /**
     * Set the MOR (component 1) from a MOR object.
     *
    ...
    public static List<Field253> getAll(final SwiftTagListBlock block) {
        final List<Field253> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field253 fromJson(final String json) {
        ...
        final Field253 field = new Field253();
