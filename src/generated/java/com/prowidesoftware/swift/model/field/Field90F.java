...
public class Field90F extends Field implements Serializable, CurrencyContainer, AmountContainer, GenericField {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field90F.TYPES_PATTERN
     */
    @Override
    ...
    /**
     * Get the Quantity (component 6) as as Number (BigDecimal)
     *
     * The value is returned as BigDecimal to keep compatibility with previous API. You should
     * use <code>getComponent6AsBigDecimal()</code> to get the proper value.
     *
     ...
     * @return the field object to enable build pattern
     */
    public Field90F setComponent4(java.math.BigDecimal component4) {
     ...
     * @since 9.2.7
     */
    public Field90F setAmount(java.math.BigDecimal component4) {
        return setComponent4(component4);
    }
     ...
     * @since 9.2.7
     *
     * @param component6 the BigDecimal with the Quantity content to set
     * @return the field object to enable build pattern
     */
    public Field90F setComponent6(java.math.BigDecimal component6) {
        setComponent(6, SwiftFormatUtils.getBigDecimal(component6));
        return this;
    }
    /**
     * Alternative method setter for field's Quantity (component 6) as as Number
     *
     * This method supports java constant value boxing for simpler coding styles (ex: 10.0 becomes an Float)
     *
    ...
    /**
     * Set the Quantity (component 6) from a BigDecimal object.
     *
     * @see #setComponent6(java.math.BigDecimal)
     *
     * @param component6 BigDecimal with the Quantity content to set
     * @return the field object to enable build pattern
     * @since 9.2.7
     */
    public Field90F setQuantity(java.math.BigDecimal component6) {
        return setComponent6(component6);
    }
