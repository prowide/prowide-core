...
@Generated
public class Field90F extends Field implements Serializable, CurrencyContainer, AmountContainer, com.prowidesoftware.swift.model.field.GenericField {
	/**
	...
	*/
	...
	/**
	 * Gets the Quantity (component6) as Number
	 * @return the Quantity from component6 converted to Number or <code>null</code> if cannot be converted
	 */
   ...
   public String parserPattern() {
	...
	public static List<Field90F> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field90F> result = new ArrayList<Field90F>(arr.length);
			for (final Tag f : arr) {
