...
@Generated
public class Field99B extends Field implements Serializable, com.prowidesoftware.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field99B> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field99B> result = new ArrayList<Field99B>(arr.length);
			for (final Tag f : arr) {
