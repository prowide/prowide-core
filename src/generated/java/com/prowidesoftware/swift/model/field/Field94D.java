 ...
 * 		<li>Component 3: Place: <code>String</code></li>
 * </ol>
 *
...
public class Field94D extends Field implements Serializable, GenericField {
    ...
    public Field94D(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "94D")) {
    ...
    /**
     * Gets the Place (component 3).
     * @return the Place from component 3
     */
