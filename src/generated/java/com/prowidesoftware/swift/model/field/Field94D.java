...
public class Field94D extends Field implements Serializable, GenericField {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field94D.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field94D.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field94D> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field94D> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
