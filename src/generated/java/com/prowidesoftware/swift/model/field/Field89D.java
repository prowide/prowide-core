...
@Generated
public class Field89D extends OptionDPartyField implements Serializable, MultiLineField {
	/**
    ...
    public Field89D(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "89D")) {
    ...
    public static List<Field89D> getAll(final SwiftTagListBlock block) {
        final List<Field89D> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field89D fromJson(final String json) {
        ...
        final Field89D field = new Field89D();
