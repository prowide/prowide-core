...
@Generated
public class Field89D extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field89D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field89D> result = new ArrayList<Field89D>(arr.length);
			for (final Tag f : arr) {
