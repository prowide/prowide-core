...
public class Field33B extends Field implements Serializable, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field33B.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field33B.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field33B setComponent2(java.math.BigDecimal component2) {
     ...
     * @since 9.2.7
     */
    public Field33B setAmount(java.math.BigDecimal component2) {
        return setComponent2(component2);
    }
    ...
    public static List<Field33B> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field33B> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
