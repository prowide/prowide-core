...
public class Field35H extends Field implements Serializable, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field35H.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field35H.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field35H> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field35H> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
