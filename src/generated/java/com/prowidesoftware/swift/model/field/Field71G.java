...
public class Field71G extends Field implements Serializable, CurrencyContainer, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field71G.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field71G.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field71G setComponent2(java.math.BigDecimal component2) {
     ...
     * @since 9.2.7
     */
    public Field71G setAmount(java.math.BigDecimal component2) {
        return setComponent2(component2);
    }
    ...
    public static List<Field71G> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field71G> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
