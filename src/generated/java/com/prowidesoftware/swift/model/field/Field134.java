...
@Generated
public class Field134 extends Field implements Serializable, BICContainer, MultiLineField {
	/**
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field134.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field134.PARSER_PATTERN
     */
    @Override
    ...
    /**
     * Set the component 2 (Broadcast Requester Name).
     *
    ...
    /**
     * Set the Broadcast Requester Name (component 2).
     *
     * @param component2 the Broadcast Requester Name to set
     * @return the field object to enable build pattern
     */
    ...
    /**
     * Set the component 3 (Broadcast Requester City).
     *
    ...
    /**
     * Set the Broadcast Requester City (component 3).
     *
     * @param component3 the Broadcast Requester City to set
     * @return the field object to enable build pattern
     */
    ...
    public static List<Field134> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field134> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
