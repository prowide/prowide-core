...
public class Field18B extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field18B.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field18B.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field18B setComponent1(java.lang.Long component1) {
     ...
     * @since 9.2.7
     */
    public Field18B setNumber(java.lang.Long component1) {
        return setComponent1(component1);
    }
    ...
    public static List<Field18B> getAll(final SwiftTagListBlock block) {
        final List<Field18B> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field18B fromJson(final String json) {
        ...
        final Field18B field = new Field18B();
