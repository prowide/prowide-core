...
@Generated
public class Field95R extends Field implements Serializable, com.prowidesoftware.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field95R> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field95R> result = new ArrayList<Field95R>(arr.length);
			for (final Tag f : arr) {
