...
@Generated
public class Field42P extends Field implements Serializable, MultiLineField {
	/**
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field42P.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field42P.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field42P> getAll(final SwiftTagListBlock block) {
        final List<Field42P> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field42P fromJson(final String json) {
        ...
        final Field42P field = new Field42P();
