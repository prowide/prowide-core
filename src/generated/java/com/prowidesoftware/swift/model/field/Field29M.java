...
public class Field29M extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field29M.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field29M.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field29M> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field29M> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
