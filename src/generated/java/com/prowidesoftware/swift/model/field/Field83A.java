...
public class Field83A extends OptionAPartyField implements Serializable, BICContainer, MultiLineField {
    ...
    public Field83A(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "83A")) {
     ...
     * @return the field object to enable build pattern
     */
    public Field83A setIdentifierCode(String component3) {
     ...
     * @return the field object to enable build pattern
     */
    public Field83A setIdentifierCode(com.prowidesoftware.swift.model.BIC component3) {
        return setComponent3(component3);
    }
    ...
    public static Field83A fromJson(final String json) {
        ...
        final Field83A field = new Field83A();
