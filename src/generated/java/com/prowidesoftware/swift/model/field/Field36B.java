...
public class Field36B extends Field implements Serializable, AmountContainer, GenericField {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field36B.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field36B.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field36B setComponent3(java.math.BigDecimal component3) {
     ...
     * @since 9.2.7
     */
    public Field36B setQuantity(java.math.BigDecimal component3) {
        return setComponent3(component3);
    }
    ...
    public static List<Field36B> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field36B> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
