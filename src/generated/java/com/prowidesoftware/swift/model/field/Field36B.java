...
@Generated
public class Field36B extends Field implements Serializable, AmountContainer, com.prowidesoftware.swift.model.field.GenericField {
	/**
	...
	*/
	...
	/**
	 * Gets the Quantity (component3) as Number
   ...
   public String parserPattern() {
	...
	public static List<Field36B> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field36B> result = new ArrayList<Field36B>(arr.length);
			for (final Tag f : arr) {
