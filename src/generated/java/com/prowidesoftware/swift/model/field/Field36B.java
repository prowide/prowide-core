...
public class Field36B extends Field implements Serializable, AmountContainer, GenericField {
	...
	/**
	 * Get the Quantity (component 3) as Number
	 * @return the Quantity from component 3 converted to Number or null if cannot be converted
	 */
