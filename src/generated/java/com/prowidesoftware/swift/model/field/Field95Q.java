...
@Generated
public class Field95Q extends OptionQPartyField implements Serializable, GenericField, MultiLineField {
	/**
    ...
    public Field95Q(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "95Q")) {
    ...
    public static Field95Q fromJson(final String json) {
        ...
        final Field95Q field = new Field95Q();
