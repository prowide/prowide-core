...
@Generated
public class Field173 extends Field implements Serializable, DateContainer {
	/**
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field173.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field173.PARSER_PATTERN
     */
    @Override
     ...
     *
     * @param component1 the Calendar with the Day Time content to set
     * @return the field object to enable build pattern
     */
    ...
    /**
     * Set the Day Time (component 1) from a Calendar object.
     *
    ...
    public static List<Field173> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field173> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
