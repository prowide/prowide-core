 ...
 * 		<li>Component 2: LogoutBlock: <code>String</code></li>
 * </ol>
 *
...
@Generated
public class Field271 extends Field implements Serializable, DateContainer {
	/**
    ...
    public Field271(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "271")) {
    ...
    protected Map<String, Integer> getLabelMap() {
        ...
        super.labelMap.put("logoutblock", 2);
        return super.labelMap;
    }
    ...
    /**
     * Gets the component 2 (Logout Block).
    ...
    /**
     * Gets the Logout Block (component 2).
     * @return the Logout Block from component 2
     */
    ...
    /**
     * Set the component 2 (Logout Block).
     *
    ...
    /**
     * Set the Logout Block (component 2).
     *
     * @param component2 the Logout Block to set
     * @return the field object to enable build pattern
     */
    ...
    public static List<Field271> getAll(final SwiftTagListBlock block) {
        final List<Field271> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field271 fromJson(final String json) {
        ...
        final Field271 field = new Field271();
