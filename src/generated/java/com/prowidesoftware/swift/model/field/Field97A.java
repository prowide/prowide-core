 ...
 * 		<li>Component 2: AccountNumber: <code>String</code></li>
 * </ol>
 *
...
public class Field97A extends Field implements Serializable, GenericField {
    ...
    public Field97A(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "97A")) {
    ...
    protected Map<String, Integer> getLabelMap() {
        ...
        super.labelMap.put("accountnumber", 2);
        // alias name
    ...
    public static Field97A fromJson(final String json) {
        ...
        final Field97A field = new Field97A();
