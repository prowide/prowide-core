...
/**
 * <strong>SWIFT MT Field 27A</strong>
 * <p>
 * Model and parser for field 27A of a SWIFT MT message.
 *
...
public class Field27A extends Field implements Serializable {
     ...
     */
    public Field27A(final String value) {
        super(value);
    }
     ...
     * @see #typesPattern()
     * @return the static value of Field27A.COMPONENTS_PATTERN
     */
    @Override
    @Deprecated
    @ProwideDeprecated(phase2=TargetYear.SRU2022)
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field27A.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field27A.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field27A setComponent1(java.lang.Long component1) {
     ...
     * @since 9.2.7
     */
    public Field27A setNumber(java.lang.Long component1) {
        return setComponent1(component1);
    }
     ...
     * @see #setNumber(java.lang.Long)
     */
    public Field27A setNumber(java.lang.Number component1) {
        return setComponent1(component1);
    }
     ...
     * @return the field object to enable build pattern
     */
    public Field27A setComponent2(java.lang.Long component2) {
     ...
     * @since 9.2.7
     */
    public Field27A setTotal(java.lang.Long component2) {
        return setComponent2(component2);
    }
    ...
    /**
     * Gets the first instance of Field27A in the given message.
    ...
    /**
     * Gets a list of all occurrences of the field Field27A in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field27A> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty())
    ...
    /**
     * Gets a list of all occurrences of the field Field27A from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field27A> getAll(final SwiftTagListBlock block) {
        if (block == null || block.isEmpty()) {
            return java.util.Collections.emptyList();
        }
        final Tag[] arr = block.getTagsByName(NAME);
        if (arr != null && arr.length > 0) {
            final List<Field27A> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
    ...
    /**
     * This method deserializes the JSON data into a Field27A object.
     * @param json JSON structure including tuples with label and value for all field components
     * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
     * @since 7.10.3
     * @see Field#fromJson(String)
     */
    public static Field27A fromJson(final String json) {
