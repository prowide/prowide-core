...
public class Field34J extends Field implements Serializable, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field34J.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field34J.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field34J setComponent3(java.math.BigDecimal component3) {
     ...
     * @since 9.2.7
     */
    public Field34J setAmount(java.math.BigDecimal component3) {
        return setComponent3(component3);
    }
    ...
    public static List<Field34J> getAll(final SwiftTagListBlock block) {
        final List<Field34J> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field34J fromJson(final String json) {
        ...
        final Field34J field = new Field34J();
