 ...
 * <ol>
 * 		<li>Component 1: Portfolio: <code>String</code></li>
 * </ol>
 *
...
public class Field22Q extends Field implements Serializable {
    ...
    public Field22Q(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "22Q")) {
    ...
    protected Map<String, Integer> getLabelMap() {
        ...
        super.labelMap.put("portfolio", 1);
        // alias name
    ...
    public static List<Field22Q> getAll(final SwiftTagListBlock block) {
        final List<Field22Q> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
