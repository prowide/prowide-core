...
public class Field22Q extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field22Q.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field22Q.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field22Q> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field22Q> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
