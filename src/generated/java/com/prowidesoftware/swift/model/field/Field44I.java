 ...
 * <ul>
 * 		<li>validation pattern: <code>3!a[$70z]0-2</code></li>
...
@Generated
public class Field44I extends Field implements Serializable, MultiLineField {
	/**
	...
	/**
	 * Constant with the field name 44I.
	 */
    public static final String NAME = "44I";
    /**
     ...
     */
    public Field44I(final String value) {
        super(value);
    }
     ...
     * @since 7.8
     */
    public Field44I(final Tag tag) {
        this();
        if (tag == null) {
            throw new IllegalArgumentException("tag cannot be null.");
        }
        if (!Strings.CS.equals(tag.getName(), "44I")) {
            throw new IllegalArgumentException("cannot create field 44I from tag "+tag.getName()+", tagname must match the name of the field.");
        }
        parse(tag.getValue());
    }
     ...
     * @since 7.7
     */
    public static Field44I newInstance(Field44I source) {
        Field44I cp = new Field44I();
    ...
    public String getValueDisplay(int component, Locale locale) {
        if (component < 1 || component > 3) {
            throw new IllegalArgumentException("invalid component number " + component + " for field 44I");
        }
        if (component == 1) {
    ...
    /**
     * Gets the Narrative as a concatenation of component 2 to component 3.
    ...
    /**
     * Gets the Narrative as a concatenation of component 2 to component 3 joined together with a copy of the
     * specified delimiter.
     ...
     * @return the field object to enable build pattern
     */
    public Field44I setComponent2(String component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field44I setNarrativeLine1(String component2) {
        return setComponent2(component2);
    }

    /**
     * Set the Narrative splitting the parameter lines into components 2 to 3.
     *
     ...
     * @return the field object to enable build pattern
     */
    public Field44I setNarrative(String value) {
        List<String> lines = SwiftParseUtils.getLines(value);
     ...
     * @return the field object to enable build pattern
     */
    public Field44I setComponent3(String component3) {
     ...
     * @return the field object to enable build pattern
     */
    public Field44I setNarrativeLine2(String component3) {
     ...
     * @return the static value of Field44I.NAME
     */
    @Override
     ...
     */
    public static Field44I get(final SwiftTagListBlock block) {
        ...
        return new Field44I(t);
    }

    /**
     * Gets the first instance of Field44I in the given message.
     * @param msg may be empty or null
     * @return null if not found or msg is empty or null
     * @see #get(SwiftTagListBlock)
     */
    public static Field44I get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field44I in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field44I> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty()) {
    ...
    /**
     * Gets a list of all occurrences of the field Field44I from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field44I> getAll(final SwiftTagListBlock block) {
        final List<Field44I> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    /**
     * This method deserializes the JSON data into a Field44I object.
     * @param json JSON structure including tuples with label and value for all field components
     * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
     * @since 7.10.3
     * @see Field#fromJson(String)
     */
    public static Field44I fromJson(final String json) {

        final Field44I field = new Field44I();
