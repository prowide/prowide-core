...
public class Field14Q extends Field implements Serializable {
    ...
    public Field14Q(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "14Q")) {
     ...
     * @return the static value of Field14Q.NAME
     */
    @Override
     ...
     */
    public static Field14Q get(final SwiftTagListBlock block) {
        ...
        return new Field14Q(t);
    }

    /**
     * Gets the first instance of Field14Q in the given message.
     * @param msg may be empty or null
     * @return null if not found or msg is empty or null
     * @see #get(SwiftTagListBlock)
     */
    public static Field14Q get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field14Q in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field14Q> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty()) {
     ...
     */
    public static List<Field14Q> getAll(final SwiftTagListBlock block) {
        final List<Field14Q> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    /**
     * This method deserializes the JSON data into a Field14Q object.
