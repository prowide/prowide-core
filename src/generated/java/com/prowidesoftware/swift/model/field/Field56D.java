...
@Generated
public class Field56D extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field56D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field56D> result = new ArrayList<Field56D>(arr.length);
			for (final Tag f : arr) {
