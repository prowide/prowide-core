...
public class Field18C extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field18C.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field18C.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field18C> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field18C> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
