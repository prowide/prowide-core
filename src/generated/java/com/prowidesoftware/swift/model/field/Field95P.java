...
@Generated
public class Field95P extends Field implements Serializable, BICContainer, com.prowidesoftware.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field95P> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field95P> result = new ArrayList<Field95P>(arr.length);
			for (final Tag f : arr) {
