...
@Generated
public class Field96D extends OptionDPartyField implements Serializable, MultiLineField {
	/**
    ...
    public Field96D(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "96D")) {
    ...
    public static List<Field96D> getAll(final SwiftTagListBlock block) {
        final List<Field96D> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field96D fromJson(final String json) {
        ...
        final Field96D field = new Field96D();
