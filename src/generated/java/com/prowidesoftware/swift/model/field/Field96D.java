...
@Generated
public class Field96D extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field96D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field96D> result = new ArrayList<Field96D>(arr.length);
			for (final Tag f : arr) {
