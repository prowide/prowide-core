...
public class Field14C extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field14C.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field14C.PARSER_PATTERN
     */
    @Override
    ...
    /**
     * Get the Year (component 1) as Long
     * @return the Year from component 1 converted to Long or null if cannot be converted
     * @since 9.2.7
     */
    public java.lang.Long getYearAsLong() {
    ...
    /**
     * Alternative method setter for field's Year (component 1) as as Number
     *
    ...
    public static List<Field14C> getAll(final SwiftTagListBlock block) {
        final List<Field14C> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field14C fromJson(final String json) {
        ...
        final Field14C field = new Field14C();
