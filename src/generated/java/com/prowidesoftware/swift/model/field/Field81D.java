...
@Generated
public class Field81D extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field81D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field81D> result = new ArrayList<Field81D>(arr.length);
			for (final Tag f : arr) {
