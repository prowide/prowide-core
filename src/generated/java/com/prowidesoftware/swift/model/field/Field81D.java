...
@Generated
public class Field81D extends OptionDPartyField implements Serializable, MultiLineField {
	/**
    ...
    public Field81D(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "81D")) {
    ...
    public static List<Field81D> getAll(final SwiftTagListBlock block) {
        final List<Field81D> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field81D fromJson(final String json) {
        ...
        final Field81D field = new Field81D();
