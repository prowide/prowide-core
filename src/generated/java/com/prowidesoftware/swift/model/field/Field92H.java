...
@Generated
public class Field92H extends Field implements Serializable, CurrencyContainer, AmountContainer, GenericField {
	/**
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field92H.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field92H.PARSER_PATTERN
     */
    @Override
    ...
    /**
     * Set the component 4 (Rate Status).
     *
    ...
    /**
     * Set the Rate Status (component 4).
     *
     * @param component4 the Rate Status to set
     * @return the field object to enable build pattern
     */
    ...
    public static List<Field92H> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field92H> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
