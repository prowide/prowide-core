 ...
 * 		<li>Component 4: RateStatus: <code>String</code></li>
 * </ol>
 *
...
@Generated
public class Field92H extends Field implements Serializable, MonetaryAmountContainer, GenericField {
	/**
    ...
    public Field92H(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "92H")) {
    ...
    protected Map<String, Integer> getLabelMap() {
        ...
        super.labelMap.put("ratestatus", 4);
        return super.labelMap;
    }
    ...
    public static Field92H fromJson(final String json) {
        ...
        final Field92H field = new Field92H();
