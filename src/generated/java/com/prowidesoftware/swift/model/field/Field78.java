...
@Generated
public class Field78 extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field78> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field78> result = new ArrayList<Field78>(arr.length);
			for (final Tag f : arr) {
