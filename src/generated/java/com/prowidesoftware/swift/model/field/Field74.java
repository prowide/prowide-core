...
@Generated
public class Field74 extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field74> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field74> result = new ArrayList<Field74>(arr.length);
			for (final Tag f : arr) {
