...
public class Field14K extends Field implements Serializable {
    ...
    public Field14K(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "14K")) {
     ...
     */
    public Field14K setComponent1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field14K setConvention(String component1) {
     ...
     * @return the static value of Field14K.NAME
     */
    @Override
     ...
     */
    public static Field14K get(final SwiftTagListBlock block) {
        ...
        return new Field14K(t);
    }

    /**
     * Gets the first instance of Field14K in the given message.
     * @param msg may be empty or null
     * @return null if not found or msg is empty or null
     * @see #get(SwiftTagListBlock)
     */
    public static Field14K get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field14K in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field14K> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty()) {
    ...
    /**
     * Gets a list of all occurrences of the field Field14K from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field14K> getAll(final SwiftTagListBlock block) {
        final List<Field14K> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    /**
     * This method deserializes the JSON data into a Field14K object.
     * @param json JSON structure including tuples with label and value for all field components
     * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
     * @since 7.10.3
     * @see Field#fromJson(String)
     */
    public static Field14K fromJson(final String json) {

        final Field14K field = new Field14K();
