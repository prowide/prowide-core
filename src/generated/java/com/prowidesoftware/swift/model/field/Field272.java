 ...
 * 		<li>Component 2: Abort: <code>String</code></li>
 * </ol>
 *
...
@Generated
public class Field272 extends Field implements Serializable, DateContainer {
	/**
    ...
    public Field272(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "272")) {
    ...
    public static Field272 fromJson(final String json) {
        ...
        final Field272 field = new Field272();
