...
/**
 * <strong>SWIFT MT Field 29U</strong>
 * <p>
 * Model and parser for field 29U of a SWIFT MT message.
 *
...
public class Field29U extends Field implements Serializable, BICContainer {
	...
	/**
	 * Constant with the field name 29U
	 */
    public static final String NAME = "29U";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_29U = "29U";
     ...
     */
    public Field29U(final String value) {
        super(value);
    }
     ...
     * @since 7.8
     */
    public Field29U(final Tag tag) {
        this();
        if (tag == null) {
            throw new IllegalArgumentException("tag cannot be null.");
        }
        if (!StringUtils.equals(tag.getName(), "29U")) {
            throw new IllegalArgumentException("cannot create field 29U from tag "+tag.getName()+", tagname must match the name of the field.");
        }
        parse(tag.getValue());
    }
     ...
     * @since 7.7
     */
    public static Field29U newInstance(Field29U source) {
        Field29U cp = new Field29U();
    ...
    public String getValueDisplay(int component, Locale locale) {
        if (component < 1 || component > 1) {
            throw new IllegalArgumentException("invalid component number " + component + " for field 29U");
        }
        if (component == 1) {
     ...
     * @see #typesPattern()
     * @return the static value of Field29U.COMPONENTS_PATTERN
     */
    @Override
    @Deprecated
    @ProwideDeprecated(phase2=TargetYear.SRU2022)
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field29U.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field29U.PARSER_PATTERN
     */
    @Override
     ...
     */
    public Field29U setComponent1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field29U setComponent1(com.prowidesoftware.swift.model.BIC component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field29U setIdentifierCode(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field29U setIdentifierCode(com.prowidesoftware.swift.model.BIC component1) {
        return setComponent1(component1);
    }
     ...
     * @return the static value of Field29U.NAME
     */
    @Override
     ...
     */
    public static Field29U get(final SwiftTagListBlock block) {
        ...
        return new Field29U(t) ;
    }

    /**
     * Gets the first instance of Field29U in the given message.
     * @param msg may be empty or null
     * @return null if not found or msg is empty or null
     * @see #get(SwiftTagListBlock)
     */
    public static Field29U get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field29U in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field29U> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty())
    ...
    /**
     * Gets a list of all occurrences of the field Field29U from the given block
     * an empty list is returned if none found.
     *
    ...
    /**
     * This method deserializes the JSON data into a Field29U object.
     * @param json JSON structure including tuples with label and value for all field components
     * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
     * @since 7.10.3
     * @see Field#fromJson(String)
     */
    public static Field29U fromJson(final String json) {

        Field29U field = new Field29U();
