 ...
 * 		<li>Component 3: Currency: <code>Currency</code></li>
...
@Generated
public class Field60F extends Field implements Serializable, MonetaryAmountContainer, DateContainer {
	/**
     ...
     * @return the field object to enable build pattern
     */
    public Field60F setComponent4(java.math.BigDecimal component4) {
     ...
     * @since 9.2.7
     */
    public Field60F setAmount(java.math.BigDecimal component4) {
        return setComponent4(component4);
    }
    ...
    public static List<Field60F> getAll(final SwiftTagListBlock block) {
        final List<Field60F> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
