...
public class Field60F extends Field implements Serializable, CurrencyContainer, DateContainer, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field60F.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field60F.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field60F> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field60F> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
