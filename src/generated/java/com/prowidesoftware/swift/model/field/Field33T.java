...
public class Field33T extends Field implements Serializable, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field33T.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field33T.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field33T setPrice(String component2) {
    ...
    public static List<Field33T> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field33T> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
