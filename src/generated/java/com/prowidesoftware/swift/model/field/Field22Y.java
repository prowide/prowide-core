...
public class Field22Y extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field22Y.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field22Y.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field22Y> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field22Y> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
