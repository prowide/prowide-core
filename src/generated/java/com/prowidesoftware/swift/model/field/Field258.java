...
public class Field258 extends Field implements Serializable, DateContainer {
     ...
     * @since 9.2.7
     */
	public static final String TYPES_PATTERN = "ZNMEHH";
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field258.TYPES_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field258 setComponent2(java.lang.Long component2) {
     ...
     * @since 9.2.7
     */
    public Field258 setSessionNumber(java.lang.Long component2) {
        return setComponent2(component2);
    }
    ...
    public static List<Field258> getAll(final SwiftTagListBlock block) {
        final List<Field258> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field258 fromJson(final String json) {
        ...
        final Field258 field = new Field258();
