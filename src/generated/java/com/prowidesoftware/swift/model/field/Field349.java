...
public class Field349 extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field349.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field349.PARSER_PATTERN
     */
    @Override
    ...
    /**
     * Gets the component 1 (Combined Criteria).
    ...
    /**
     * Get the Combined Criteria (component 1) as Long
     * @return the Combined Criteria from component 1 converted to Long or null if cannot be converted
     * @since 9.2.7
     */
    public java.lang.Long getCombinedCriteriaAsLong() {
        return getComponent1AsLong();
    }

    /**
     * Get the Combined Criteria (component 1) as as Number (BigDecimal)
     *
     * The value is returned as BigDecimal to keep compatibility with previous API. You should
     * use <code>getComponent1AsLong()</code> to get the proper value.
     *
     * @return the component 1 converted to Number (BigDecimal) or null if cannot be converted
     * @see #getCombinedCriteriaAsLong()
     */
    @Deprecated
    @ProwideDeprecated(phase2=TargetYear.SRU2022)
     ...
     * @since 9.2.7
     *
     * @param component1 the Long with the Combined Criteria content to set
     * @return the field object to enable build pattern
     */
    public Field349 setComponent1(java.lang.Long component1) {
        setComponent(1, SwiftFormatUtils.getLong(component1));
        return this;
    }

    /**
     * Alternative method setter for field's Combined Criteria (component 1) as as Number
     *
     * This method supports java constant value boxing for simpler coding styles (ex: 10 becomes an Integer)
     *
     * @param component1 the Number with the Combined Criteria content to set
     * @return the field object to enable build pattern
    ...
    /**
     * Set the Combined Criteria (component 1).
     *
     * @param component1 the Combined Criteria to set
     * @return the field object to enable build pattern
     */
    ...
    /**
     * Set the Combined Criteria (component 1) from a Long object.
     *
     * @see #setComponent1(java.lang.Long)
     *
     * @param component1 Long with the Combined Criteria content to set
     * @return the field object to enable build pattern
     * @since 9.2.7
     */
    public Field349 setCombinedCriteria(java.lang.Long component1) {
        return setComponent1(component1);
    }
    ...
    public static List<Field349> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field349> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
