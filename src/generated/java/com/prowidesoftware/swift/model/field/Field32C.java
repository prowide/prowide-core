...
public class Field32C extends Field implements Serializable, CurrencyContainer, DateContainer, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field32C.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field32C.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field32C setComponent3(java.math.BigDecimal component3) {
     ...
     * @since 9.2.7
     */
    public Field32C setAmount(java.math.BigDecimal component3) {
        return setComponent3(component3);
    }
    ...
    public static List<Field32C> getAll(final SwiftTagListBlock block) {
        final List<Field32C> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field32C fromJson(final String json) {
        ...
        final Field32C field = new Field32C();
