 ...
 * 		<li>Component 2: NumberId: <code>String</code></li>
 * </ol>
 *
...
public class Field13A extends Field implements Serializable, GenericField {
    ...
    public Field13A(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "13A")) {
    ...
    protected Map<String, Integer> getLabelMap() {
        ...
        super.labelMap.put("numberid", 2);
        // alias name
        super.labelMap.put("numberidentification", 2);
        return super.labelMap;
    }
    ...
    public static Field13A fromJson(final String json) {
        ...
        final Field13A field = new Field13A();
