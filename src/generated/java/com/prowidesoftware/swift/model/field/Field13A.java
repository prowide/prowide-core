...
@Generated
public class Field13A extends Field implements Serializable, com.prowidesoftware.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field13A> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field13A> result = new ArrayList<Field13A>(arr.length);
			for (final Tag f : arr) {
