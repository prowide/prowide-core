...
public class Field13A extends Field implements Serializable, GenericField {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field13A.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field13A.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field13A> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field13A> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
