...
/**
 * <strong>SWIFT MT Field 34T</strong>
 * <p>
 * Model and parser for field 34T of a SWIFT MT message.
 *
...
@Generated
public class Field34T extends Field implements Serializable, AmountContainer {
	/**
	...
	/**
	 * Constant with the field name 34T
	 */
    public static final String NAME = "34T";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_34T = "34T";
     ...
     */
    public Field34T(final String value) {
        super(value);
    }
     ...
     * @since 7.8
     */
    public Field34T(final Tag tag) {
        this();
        if (tag == null) {
            throw new IllegalArgumentException("tag cannot be null.");
        }
        if (!StringUtils.equals(tag.getName(), "34T")) {
            throw new IllegalArgumentException("cannot create field 34T from tag "+tag.getName()+", tagname must match the name of the field.");
        }
        parse(tag.getValue());
    }
     ...
     * @since 7.7
     */
    public static Field34T newInstance(Field34T source) {
        Field34T cp = new Field34T();
    ...
    public String getValueDisplay(int component, Locale locale) {
        if (component < 1 || component > 2) {
            throw new IllegalArgumentException("invalid component number " + component + " for field 34T");
        }
        if (component == 1) {
     ...
     * @see #typesPattern()
     * @return the static value of Field34T.COMPONENTS_PATTERN
     */
    @Override
    @Deprecated
    @ProwideDeprecated(phase2=TargetYear.SRU2022)
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field34T.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field34T.PARSER_PATTERN
     */
    @Override
     ...
     */
    public Field34T setComponent1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field34T setCurrency(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field34T setComponent2(String component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field34T setAmount(String component2) {
     ...
     * @return the static value of Field34T.NAME
     */
    @Override
     ...
     */
    public static Field34T get(final SwiftTagListBlock block) {
        ...
        return new Field34T(t) ;
    }

    /**
     * Gets the first instance of Field34T in the given message.
     * @param msg may be empty or null
     * @return null if not found or msg is empty or null
     * @see #get(SwiftTagListBlock)
     */
    public static Field34T get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field34T in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field34T> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty())
    ...
    /**
     * Gets a list of all occurrences of the field Field34T from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field34T> getAll(final SwiftTagListBlock block) {
        if (block == null || block.isEmpty()) {
            return java.util.Collections.emptyList();
        }
        final Tag[] arr = block.getTagsByName(NAME);
        if (arr != null && arr.length > 0) {
            final List<Field34T> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
                result.add( new Field34T(f));
            }
            return result;
        }
        return java.util.Collections.emptyList();
    ...
    /**
     * This method deserializes the JSON data into a Field34T object.
     * @param json JSON structure including tuples with label and value for all field components
     * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
     * @since 7.10.3
     * @see Field#fromJson(String)
     */
    public static Field34T fromJson(final String json) {

        Field34T field = new Field34T();
