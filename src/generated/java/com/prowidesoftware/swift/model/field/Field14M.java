 ...
 * <ol>
 * 		<li>Component 1: Type: <code>String</code></li>
 * </ol>
 *
...
public class Field14M extends Field implements Serializable {
    ...
    public Field14M(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "14M")) {
     ...
     */
    public Field14M setComponent1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field14M setType(String component1) {
     ...
     * @return the static value of Field14M.NAME
     */
    @Override
     ...
     */
    public static Field14M get(final SwiftTagListBlock block) {
        ...
        return new Field14M(t);
    }

    /**
     * Gets the first instance of Field14M in the given message.
     * @param msg may be empty or null
     * @return null if not found or msg is empty or null
     * @see #get(SwiftTagListBlock)
     */
    public static Field14M get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field14M in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field14M> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty()) {
    ...
    /**
     * Gets a list of all occurrences of the field Field14M from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field14M> getAll(final SwiftTagListBlock block) {
        final List<Field14M> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    /**
     * This method deserializes the JSON data into a Field14M object.
     * @param json JSON structure including tuples with label and value for all field components
     * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
     * @since 7.10.3
     * @see Field#fromJson(String)
     */
    public static Field14M fromJson(final String json) {

        final Field14M field = new Field14M();
