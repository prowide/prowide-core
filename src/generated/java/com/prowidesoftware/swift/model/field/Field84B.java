...
@Generated
public class Field84B extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field84B> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field84B> result = new ArrayList<Field84B>(arr.length);
			for (final Tag f : arr) {
