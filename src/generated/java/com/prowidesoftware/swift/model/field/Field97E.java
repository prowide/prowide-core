 ...
 * 		<li>Component 2: InternationalBankAccountNumber: <code>String</code></li>
 * </ol>
 *
...
public class Field97E extends Field implements Serializable, GenericField {
    ...
    public Field97E(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "97E")) {
    ...
    protected Map<String, Integer> getLabelMap() {
        ...
        super.labelMap.put("internationalbankaccountnumber", 2);
        // alias name
    ...
    public static Field97E fromJson(final String json) {
        ...
        final Field97E field = new Field97E();
