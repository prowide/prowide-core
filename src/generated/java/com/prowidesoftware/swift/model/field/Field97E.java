...
@Generated
public class Field97E extends Field implements Serializable, com.prowidesoftware.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field97E> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field97E> result = new ArrayList<Field97E>(arr.length);
			for (final Tag f : arr) {
