...
@Generated
public class Field90C extends Field implements Serializable, MonetaryAmountContainer {
	/**
    ...
    public Field90C(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "90C")) {
    ...
    public static Field90C fromJson(final String json) {
        ...
        final Field90C field = new Field90C();
