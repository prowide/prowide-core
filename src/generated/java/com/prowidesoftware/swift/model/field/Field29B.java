...
@Generated
public class Field29B extends Field implements Serializable, MultiLineField {
	/**
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field29B.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field29B.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field29B> getAll(final SwiftTagListBlock block) {
        final List<Field29B> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field29B fromJson(final String json) {
        ...
        final Field29B field = new Field29B();
