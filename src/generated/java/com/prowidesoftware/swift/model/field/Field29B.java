...
@Generated
public class Field29B extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field29B> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field29B> result = new ArrayList<Field29B>(arr.length);
			for (final Tag f : arr) {
