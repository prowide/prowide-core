...
public class Field171 extends Field implements Serializable, DateContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field171.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field171.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field171> getAll(final SwiftTagListBlock block) {
        final List<Field171> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field171 fromJson(final String json) {
        ...
        final Field171 field = new Field171();
