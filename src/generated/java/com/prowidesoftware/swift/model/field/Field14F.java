...
public class Field14F extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field14F.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field14F.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field14F> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field14F> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
