...
public class Field23G extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field23G.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field23G.PARSER_PATTERN
     */
    @Override
    ...
    /**
     * Set the component 2 (Subfunction).
     *
    ...
    /**
     * Set the Subfunction (component 2).
     *
     * @param component2 the Subfunction to set
     * @return the field object to enable build pattern
     */
    ...
    public static List<Field23G> getAll(final SwiftTagListBlock block) {
        final List<Field23G> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field23G fromJson(final String json) {
        ...
        final Field23G field = new Field23G();
