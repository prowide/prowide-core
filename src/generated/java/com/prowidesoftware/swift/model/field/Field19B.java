...
public class Field19B extends Field implements Serializable, CurrencyContainer, AmountContainer, GenericField {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field19B.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field19B.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field19B setCurrencyCode(String component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field19B setCurrencyCode(java.util.Currency component2) {
        return setComponent2(component2);
    }
     ...
     * @return the field object to enable build pattern
     */
    public Field19B setComponent3(java.math.BigDecimal component3) {
     ...
     * @since 9.2.7
     */
    public Field19B setAmount(java.math.BigDecimal component3) {
        return setComponent3(component3);
    }
    ...
    public static List<Field19B> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field19B> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
