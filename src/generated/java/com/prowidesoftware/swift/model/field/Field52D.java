...
@Generated
public class Field52D extends OptionDPartyField implements Serializable, MultiLineField {
	/**
    ...
    public Field52D(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "52D")) {
    ...
    public static Field52D fromJson(final String json) {
        ...
        final Field52D field = new Field52D();
