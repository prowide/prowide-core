...
@Generated
public class Field80C extends Field implements Serializable, MultiLineField {
	/**
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field80C.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field80C.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field80C> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field80C> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
