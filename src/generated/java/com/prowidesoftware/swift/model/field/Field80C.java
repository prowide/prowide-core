...
@Generated
public class Field80C extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field80C> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field80C> result = new ArrayList<Field80C>(arr.length);
			for (final Tag f : arr) {
