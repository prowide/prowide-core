 ...
 * 		<li>Component 4: Price: <code>BigDecimal</code></li>
 * </ol>
 *
...
@Generated
public class Field90B extends Field implements Serializable, MonetaryAmountContainer, GenericField {
	/**
    ...
    public Field90B(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "90B")) {
    ...
    public static Field90B fromJson(final String json) {
        ...
        final Field90B field = new Field90B();
