...
public class Field451 extends Field implements Serializable {
	...
	/**
	 * Get the Accept Reject Option (component 1) as Number
	 * @return the Accept Reject Option from component 1 converted to Number or null if cannot be converted
	 */
	...
	/**
	 * Set the component1 (Accept Reject Option).
	...
	public static List<Field451> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field451> result = new ArrayList<>(arr.length);
			for (final Tag f : arr) {
