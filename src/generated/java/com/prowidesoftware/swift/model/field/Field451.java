...
public class Field451 extends Field implements Serializable {
	...
	*/
	...
	/**
	 * Gets the Accept Reject Option (component1) as Number
	 * @return the Accept Reject Option from component1 converted to Number or <code>null</code> if cannot be converted
	 */
   ...
   public String parserPattern() {
	...
	public static List<Field451> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field451> result = new ArrayList<Field451>(arr.length);
			for (final Tag f : arr) {
