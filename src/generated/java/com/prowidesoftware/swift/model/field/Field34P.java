...
public class Field34P extends Field implements Serializable, CurrencyContainer, DateContainer, AmountContainer {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field34P.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field34P.PARSER_PATTERN
     */
    @Override
     ...
     * @return the field object to enable build pattern
     */
    public Field34P setComponent3(java.math.BigDecimal component3) {
     ...
     * @since 9.2.7
     */
    public Field34P setAmount(java.math.BigDecimal component3) {
        return setComponent3(component3);
    }
    ...
    public static List<Field34P> getAll(final SwiftTagListBlock block) {
        final List<Field34P> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field34P fromJson(final String json) {
        ...
        final Field34P field = new Field34P();
