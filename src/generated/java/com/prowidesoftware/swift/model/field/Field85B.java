...
@Generated
public class Field85B extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field85B> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field85B> result = new ArrayList<Field85B>(arr.length);
			for (final Tag f : arr) {
