...
public class Field22S extends Field implements Serializable {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field22S.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field22S.PARSER_PATTERN
     */
    @Override
    ...
    public static List<Field22S> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field22S> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
