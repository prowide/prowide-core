 ...
 * <ol>
 * 		<li>Component 1: SideIndicator: <code>String</code></li>
 * 		<li>Component 2: Identification: <code>String</code></li>
 * </ol>
 *
...
public class Field22S extends Field implements Serializable {
    ...
    public Field22S(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "22S")) {
    ...
    protected Map<String, Integer> getLabelMap() {
        ...
        super.labelMap.put("sideindicator", 1);
        super.labelMap.put("identification", 2);
        return super.labelMap;
    }
    ...
    /**
     * Set the component 1 (Side Indicator).
     *
    ...
    /**
     * Set the Side Indicator (component 1).
     *
     * @param component1 the Side Indicator to set
     * @return the field object to enable build pattern
     */
    ...
    /**
     * Set the component 2 (Identification).
     *
    ...
    /**
     * Set the Identification (component 2).
     *
     * @param component2 the Identification to set
     * @return the field object to enable build pattern
     */
    ...
    public static Field22S fromJson(final String json) {
        ...
        final Field22S field = new Field22S();

        final JsonObject jsonObject = JsonParser.parseString(json).getAsJsonObject();

        // **** COMPONENT 1 - Side Indicator
