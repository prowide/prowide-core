...
public class Field92D extends Field implements Serializable, AmountContainer, GenericField {
     ...
     * @since 9.2.7
     * @see #TYPES_PATTERN
     * @return the static value of Field92D.TYPES_PATTERN
     */
    @Override
     ...
     * @return the static value of Field92D.PARSER_PATTERN
     */
    @Override
    ...
    /**
     * Get the Quantity1 (component 2) as BigDecimal
     * @return the Quantity1 from component 2 converted to BigDecimal or null if cannot be converted
     * @since 9.2.7
     */
    ...
    /**
     * Get the Quantity1 (component 2) as as Number (BigDecimal)
     *
     * The value is returned as BigDecimal to keep compatibility with previous API. You should
     * use <code>getComponent2AsBigDecimal()</code> to get the proper value.
     *
     * @return the component 2 converted to Number (BigDecimal) or null if cannot be converted
     * @see #getQuantity1AsBigDecimal()
     */
    @Deprecated
    @ProwideDeprecated(phase2=TargetYear.SRU2022)
    ...
    /**
     * Get the Quantity2 (component 3) as BigDecimal
     * @return the Quantity2 from component 3 converted to BigDecimal or null if cannot be converted
     * @since 9.2.7
     */
    ...
    /**
     * Get the Quantity2 (component 3) as as Number (BigDecimal)
     *
     * The value is returned as BigDecimal to keep compatibility with previous API. You should
     * use <code>getComponent3AsBigDecimal()</code> to get the proper value.
     *
     * @return the component 3 converted to Number (BigDecimal) or null if cannot be converted
     * @see #getQuantity2AsBigDecimal()
     */
    @Deprecated
    @ProwideDeprecated(phase2=TargetYear.SRU2022)
     ...
     * @since 9.2.7
     *
     * @param component2 the BigDecimal with the Quantity1 content to set
     * @return the field object to enable build pattern
     */
    public Field92D setComponent2(java.math.BigDecimal component2) {
     ...
     *
     * @param component2 the Number with the Quantity1 content to set
     * @return the field object to enable build pattern
     * @see #setQuantity1(java.math.BigDecimal)
     */
    ...
    /**
     * Set the Quantity1 (component 2) from a BigDecimal object.
     *
     * @see #setComponent2(java.math.BigDecimal)
     *
     * @param component2 BigDecimal with the Quantity1 content to set
     * @return the field object to enable build pattern
     * @since 9.2.7
     */
    public Field92D setQuantity1(java.math.BigDecimal component2) {
        return setComponent2(component2);
    }
     ...
     * @since 9.2.7
     *
     * @param component3 the BigDecimal with the Quantity2 content to set
     * @return the field object to enable build pattern
     */
    public Field92D setComponent3(java.math.BigDecimal component3) {
     ...
     * This method supports java constant value boxing for simpler coding styles (ex: 10.0 becomes an Float)
     *
     * @param component3 the Number with the Quantity2 content to set
     * @return the field object to enable build pattern
     * @see #setQuantity2(java.math.BigDecimal)
     */
    ...
    /**
     * Set the Quantity2 (component 3) from a BigDecimal object.
     *
     * @see #setComponent3(java.math.BigDecimal)
     *
     * @param component3 BigDecimal with the Quantity2 content to set
     * @return the field object to enable build pattern
     * @since 9.2.7
     */
    public Field92D setQuantity2(java.math.BigDecimal component3) {
        return setComponent3(component3);
    }
    ...
    public static List<Field92D> getAll(final SwiftTagListBlock block) {
        ...
        if (arr != null && arr.length > 0) {
            final List<Field92D> result = new ArrayList<>(arr.length);
            for (final Tag f : arr) {
