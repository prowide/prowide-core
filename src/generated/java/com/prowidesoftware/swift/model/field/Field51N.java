...
@Generated
public class Field51N extends Field implements Serializable, MultiLineField {
	/**
	...
	/**
	 * Constant with the field name 51N.
	 */
    public static final String NAME = "51N";
    /**
     * Same as NAME, intended to be clear when using static imports.
     */
    public static final String F_51N = "51N";
     ...
     */
    public Field51N(final String value) {
        super(value);
    }
     ...
     * @since 7.8
     */
    public Field51N(final Tag tag) {
        this();
        if (tag == null) {
            throw new IllegalArgumentException("tag cannot be null.");
        }
        if (!Strings.CS.equals(tag.getName(), "51N")) {
            throw new IllegalArgumentException("cannot create field 51N from tag "+tag.getName()+", tagname must match the name of the field.");
        }
        parse(tag.getValue());
    }
     ...
     * @since 7.7
     */
    public static Field51N newInstance(Field51N source) {
        Field51N cp = new Field51N();
    ...
    public String getValueDisplay(int component, Locale locale) {
        if (component < 1 || component > 4) {
            throw new IllegalArgumentException("invalid component number " + component + " for field 51N");
        }
        if (component == 1) {
     ...
     */
    public Field51N setComponent1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field51N setNameAndAddressLine1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field51N setNameAndAddress(String value) {
        List<String> lines = SwiftParseUtils.getLines(value);
     ...
     * @return the field object to enable build pattern
     */
    public Field51N setComponent2(String component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field51N setNameAndAddressLine2(String component2) {
     ...
     * @return the field object to enable build pattern
     */
    public Field51N setComponent3(String component3) {
     ...
     * @return the field object to enable build pattern
     */
    public Field51N setNameAndAddressLine3(String component3) {
     ...
     * @return the field object to enable build pattern
     */
    public Field51N setComponent4(String component4) {
     ...
     * @return the field object to enable build pattern
     */
    public Field51N setNameAndAddressLine4(String component4) {
     ...
     * @return the static value of Field51N.NAME
     */
    @Override
     ...
     */
    public static Field51N get(final SwiftTagListBlock block) {
        ...
        return new Field51N(t);
    }

    /**
     * Gets the first instance of Field51N in the given message.
     * @param msg may be empty or null
     * @return null if not found or msg is empty or null
     * @see #get(SwiftTagListBlock)
     */
    public static Field51N get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field51N in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field51N> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty()) {
    ...
    /**
     * Gets a list of all occurrences of the field Field51N from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field51N> getAll(final SwiftTagListBlock block) {
    ...
    /**
     * This method deserializes the JSON data into a Field51N object.
     * @param json JSON structure including tuples with label and value for all field components
     * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
     * @since 7.10.3
     * @see Field#fromJson(String)
     */
    public static Field51N fromJson(final String json) {

        final Field51N field = new Field51N();
