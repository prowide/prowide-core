...
public class Field281 extends Field implements Serializable {
	...
	*/
	...
	/**
	 * Gets the Output Time (component1) as Calendar
	...
	/**
	 * Gets the MOR (component2) as MOR
   ...
   public String parserPattern() {
	...
	public static List<Field281> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field281> result = new ArrayList<Field281>(arr.length);
			for (final Tag f : arr) {
