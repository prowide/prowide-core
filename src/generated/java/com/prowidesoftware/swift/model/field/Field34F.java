 ...
 * 		<li>Component 2: DCMark: <code>String</code></li>
...
@Generated
public class Field34F extends Field implements Serializable, MonetaryAmountContainer {
	/**
    ...
    /**
     * Gets the D/C Mark (component 2).
     * @return the D/C Mark from component 2
     */
     ...
     * @return the field object to enable build pattern
     */
    public Field34F setComponent3(java.math.BigDecimal component3) {
     ...
     * @since 9.2.7
     */
    public Field34F setAmount(java.math.BigDecimal component3) {
        return setComponent3(component3);
    }
    ...
    public static Field34F fromJson(final String json) {
        ...
        final Field34F field = new Field34F();
