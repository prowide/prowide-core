...
public class Field92B extends Field implements Serializable, CurrencyContainer, AmountContainer, GenericField {
	...
	/**
	 * Get the Rate (component 4) as Number
	 * @return the Rate from component 4 converted to Number or null if cannot be converted
	 */
	...
	/**
	 * Set the component2 (First Currency Code).
	...
	/**
	 * Set the component3 (Second Currency Code).
