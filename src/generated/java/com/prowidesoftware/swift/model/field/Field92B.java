 ...
 * 		<li>Component 3: SecondCurrencyCode: <code>Currency</code></li>
 * 		<li>Component 4: Rate: <code>BigDecimal</code></li>
 * </ol>
 *
...
@Generated
public class Field92B extends Field implements Serializable, MonetaryAmountContainer, GenericField {
	/**
    ...
    public Field92B(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "92B")) {
    ...
    protected Map<String, Integer> getLabelMap() {
        ...
        super.labelMap.put("secondcurrencycode", 3);
        super.labelMap.put("rate", 4);
        return super.labelMap;
    }
