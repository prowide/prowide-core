...
@Generated
public class Field57D extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field57D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field57D> result = new ArrayList<Field57D>(arr.length);
			for (final Tag f : arr) {
