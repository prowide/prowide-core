...
@Generated
public class Field57D extends OptionDPartyField implements Serializable, MultiLineField {
	/**
    ...
    public Field57D(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "57D")) {
    ...
    public static Field57D fromJson(final String json) {
        ...
        final Field57D field = new Field57D();
