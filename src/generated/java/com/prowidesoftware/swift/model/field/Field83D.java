...
@Generated
public class Field83D extends OptionDPartyField implements Serializable, MultiLineField {
	/**
    ...
    public Field83D(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "83D")) {
    ...
    public static List<Field83D> getAll(final SwiftTagListBlock block) {
        final List<Field83D> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    public static Field83D fromJson(final String json) {
        ...
        final Field83D field = new Field83D();
