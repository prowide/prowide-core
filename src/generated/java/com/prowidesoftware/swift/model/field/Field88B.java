...
@Generated
public class Field88B extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field88B> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field88B> result = new ArrayList<Field88B>(arr.length);
			for (final Tag f : arr) {
