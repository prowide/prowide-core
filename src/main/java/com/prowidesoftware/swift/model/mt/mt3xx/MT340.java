...
/**
 * <h1>MT 340 - Forward Rate Agreement Confirmation</h1>
 * <h3>SWIFT MT340 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
<li class="sequence">
...
// end qualifiers constants	
	...
	*/
	...
	public MT340(final int messageType, final String sender, final String receiver) {
		super(340, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT340(int, String, String)", "Use the constructor MT340(sender, receiver) instead.");
	}
