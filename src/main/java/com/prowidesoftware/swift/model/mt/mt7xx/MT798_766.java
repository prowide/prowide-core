...
/**
 * <h1>MT 798_766 - Advice of Reduction or Release Index</h1>
 * <h3>SWIFT MT798_766 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	...
	* @deprecated Use instead <code>new MT798_766(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2018)
	public MT798_766(final int messageType, final String sender, final String receiver) {
		super(798, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT798_766(int, String, String)", "Use the constructor MT798_766(sender, receiver) instead.");
	}
    ...
    private void sanityCheck(final SwiftMessage param) {
    	if (param.isServiceMessage()) {
			log.warning("Creating an MT798_766 object from FIN content with a Service Message. Check if the MT798_766 you are intended to read is prepended with and ACK.");
		} else if (!StringUtils.equals(param.getType(), getMessageType())) {
			log.warning("Creating an MT798_766 object from FIN content with message type "+param.getType());
		}
    }
