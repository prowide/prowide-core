...
/**
 * <h1>MT 420 - Tracer</h1>
 * <h3>SWIFT MT420 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
<li class="sequence">
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT420 content, the parameter can not be <code>null</code>
	 * @see #MT420(String)
	 */
	...
	*/
	...
	public MT420(final int messageType, final String sender, final String receiver) {
		super(420, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT420(int, String, String)", "Use the constructor MT420(sender, receiver) instead.");
	}
