...
/**
 * <h1>MT 998 - Proprietary Message</h1>
 * <h3>SWIFT MT998 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT998 content, the parameter can not be <code>null</code>
	 * @see #MT998(String)
	 */
	...
	*/
	...
	public MT998(final int messageType, final String sender, final String receiver) {
		super(998, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT998(int, String, String)", "Use the constructor MT998(sender, receiver) instead.");
	}
