...
/**
 * <h1>MT 691 - Request for Payment of Charges, Interest and Other Expenses</h1>
 * <h3>SWIFT MT691 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT691 content, the parameter can not be <code>null</code>
	 * @see #MT691(String)
	 */
	...
	*/
	...
	public MT691(final int messageType, final String sender, final String receiver) {
		super(691, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT691(int, String, String)", "Use the constructor MT691(sender, receiver) instead.");
	}
