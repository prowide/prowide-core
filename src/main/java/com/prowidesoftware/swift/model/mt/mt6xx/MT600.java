...
Letter options: A,D,J<br/></div><div class="field"><em>Field 30</em>
Letter options: null<br/></div><div class="field"><em>Field 26</em>
Letter options: C<br/></div><div class="field"><em>Field 26</em>
Letter options: H<br/></div><div class="field"><em>Field 33</em>
Letter options: G<br/></div><div class="field"><em>Field 26</em>
...
Letter options: F<br/></div><div class="field"><em>Field 86</em>
Letter options: A,B,D<br/></div><div class="field"><em>Field 87</em>
Letter options: A,B,D<br/></div><div class="field"><em>Field 34</em>
Letter options: P<br/></div><div class="field"><em>Field 53</em>
Letter options: A,B,D<br/></div><div class="field"><em>Field 56</em>
Letter options: A,B,D<br/></div><div class="field"><em>Field 57</em>
Letter options: A,B,D<br/></div></blockquote>
<div class="sequence">
<em>Sequence C</em><br/>
<div class="field"><em>Field 15</em>
...
Letter options: A,B,D<br/></div><div class="field"><em>Field 87</em>
Letter options: A,B,D<br/></div><div class="field"><em>Field 34</em>
Letter options: R<br/></div><div class="field"><em>Field 56</em>
Letter options: A,B,D<br/></div><div class="field"><em>Field 57</em>
Letter options: A,B,D<br/></div></blockquote>
<div class="sequence">
<em>Sequence D</em><br/>
...
// begin qualifiers constants	
	...
	* @deprecated use instead com.prowidesoftware.swift.SchemeConstantsS.SEE72
	* @see com.prowidesoftware.swift.SchemeConstantsS#SEE72
	*/
	@Deprecated
	@com.prowidesoftware.deprecation.ProwideDeprecated(phase2=com.prowidesoftware.deprecation.TargetYear._2017)
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT600 content, the parameter can not be <code>null</code>
	 * @see #MT600(String)
	 */
	...
	* Use instead <code>new MT600(sender, receiver)</code>
	...
	*/
	...
	public Field33G getField33G() {
		...
		if (_m.getBlock4() == null) {
			...
			final Tag t = _m.getBlock4().getTagByName("33G");
			if (t == null) {
	...
	public Field34G getField34G() {
		...
		if (_m.getBlock4() == null) {
			...
			final Tag t = _m.getBlock4().getTagByName("34G");
			if (t == null) {
	...
	public List<Field56B> getField56B() {
		...
		if (_m.getBlock4() == null) {
			...
			final Tag[] tags = _m.getBlock4().getTagsByName("56B");
