...
/**
 * <h1>MT 986 - Status Report</h1>
 * <h3>SWIFT MT986 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	...
	*/
	...
	public MT986(final int messageType, final String sender, final String receiver) {
		super(986, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT986(int, String, String)", "Use the constructor MT986(sender, receiver) instead.");
	}
