...
/**
 * <h1>MT 422 - Advice of Fate and Request for Instructions</h1>
 * <h3>SWIFT MT422 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
<li class="sequence">
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT422 content, the parameter can not be <code>null</code>
	 * @see #MT422(String)
	 */
	...
	*/
	...
	public MT422(final int messageType, final String sender, final String receiver) {
		super(422, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT422(int, String, String)", "Use the constructor MT422(sender, receiver) instead.");
	}
...
// BaseSequenceCodeGenerator [seq=A]
	/**
	* Class for Sequence "A" of MT 422
	*/
