...
/**
 * <h1>MT 698 - Proprietary Message</h1>
 * <h3>SWIFT MT698 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT698 content, the parameter can not be <code>null</code>
	 * @see #MT698(String)
	 */
	...
	*/
	...
	public MT698(final int messageType, final String sender, final String receiver) {
		super(698, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT698(int, String, String)", "Use the constructor MT698(sender, receiver) instead.");
	}
