...
/**
 * <h1>MT 649 - General Syndicated Facility Message</h1>
 * <h3>SWIFT MT649 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
public class MT649 extends AbstractMT implements Serializable {
	...
	private static final transient java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT649.class.getName());
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT649 content, the parameter can not be <code>null</code>
	 * @see #MT649(String)
	 */
	...
	/**
	 * Creates and initializes a new MT649 input message setting TEST BICS as sender and receiver.<br />
	...
	/**
	 * Creates and initializes a new MT649 input message from sender to receiver.<br />
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.7
	 */
	public MT649(final String sender, final String receiver) {
	...
	* 
	* @see #MT649(String, String)
	* @deprecated Use instead <code>new MT649(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2018)
	public MT649(final int messageType, final String sender, final String receiver) {
		super(649, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT649(int, String, String)", "Use the constructor MT649(sender, receiver) instead.");
	}
	
	/**
	 * Creates a new MT649 by parsing a String with the message content in its swift FIN format.<br />
	...
	/**
	 * Creates a new MT649 by parsing a String with the message content in its swift FIN format.<br />
	 * If the fin parameter cannot be parsed, the returned MT649 will have its internal message object
	 * initialized (blocks will be created) but empty.<br />
	 * If the string contains multiple messages, only the first one will be parsed. 
	 *
	 * @param fin a string with the MT message in its FIN swift format. <em>fin may be <code>null</code> in which case this method returns null</em>
	 * @return a new instance of MT649 or null if fin is null 
	 * @since 7.7
	 */
	public static MT649 parse(final String fin) {
		if (fin == null) {
			return null;
		}
    ...
    /**
	 * Creates a new MT649 by parsing a input stream with the message content in its swift FIN format, using "UTF-8" as encoding.<br />
	 ...
	 * @since 7.7
	 */
	public MT649(final InputStream stream) throws IOException {
	 ...
	 *
	 * @param stream an input stream in UTF-8 encoding with the MT message in its FIN swift format.
	 * @return a new instance of MT649 or null if stream is null or the message cannot be parsed 
	 * @since 7.7
	 */
	public static MT649 parse(final InputStream stream) throws IOException {
		if (stream == null) {
			return null;
		}
    ...
    /**
	 * Creates a new MT649 by parsing a file with the message content in its swift FIN format.<br />
	 ...
	 * @since 7.7
	 */
	public MT649(final File file) throws IOException {
	 ...
	 *
	 * @param file a file with the MT message in its FIN swift format.
	 * @return a new instance of MT649 or null if; file is null, does not exist, can't be read, is not a file or the message cannot be parsed
	 * @since 7.7
	 */
	public static MT649 parse(final File file) throws IOException {
		if (file == null) {
			return null;
		}
	 ...
	 */
	@Override
	public MT649 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT649 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT649 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
