...
/**
 * <h1>MT 802 - T/C Settlement Advice</h1>
 * <h3>SWIFT MT802 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT802 content, the parameter can not be <code>null</code>
	 * @see #MT802(String)
	 */
	...
	*/
	...
	public MT802(final int messageType, final String sender, final String receiver) {
		super(802, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT802(int, String, String)", "Use the constructor MT802(sender, receiver) instead.");
	}
