...
/**
 * <h1>MT 037 - Time Zone Status Request</h1>
 * <h3>SWIFT MT037 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT037 content, the parameter can not be <code>null</code>
	 * @see #MT037(String)
	 */
	...
	*/
	...
	public MT037(final int messageType, final String sender, final String receiver) {
		super(37, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT037(int, String, String)", "Use the constructor MT037(sender, receiver) instead.");
	}
