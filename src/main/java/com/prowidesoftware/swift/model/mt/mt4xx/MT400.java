...
/**
 * <h1>MT 400 - Advice of Payment</h1>
 * <h3>SWIFT MT400 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	...
	*/
	...
	public MT400(final int messageType, final String sender, final String receiver) {
		super(400, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT400(int, String, String)", "Use the constructor MT400(sender, receiver) instead.");
	}
