...
Letter options: A,B,K<br/></div><div class="field"><em>Field 33</em>
...
Letter options: null<br/></div><div class="field"><em>Field 73</em>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT400 content, the parameter can not be <code>null</code>
	 * @see #MT400(String)
	 */
	...
	* Use instead <code>new MT400(sender, receiver)</code>
	...
	*/
	...
	public Field32K getField32K() {
		...
		if (_m.getBlock4() == null) {
			...
			final Tag t = _m.getBlock4().getTagByName("32K");
			if (t == null) {
