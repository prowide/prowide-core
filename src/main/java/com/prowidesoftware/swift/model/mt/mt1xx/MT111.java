...
/**
 * <h1>MT 111 - Request for Stop Payment of a Cheque</h1>
 * <h3>SWIFT MT111 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT111 content, the parameter can not be <code>null</code>
	 * @see #MT111(String)
	 */
	...
	*/
	...
	public MT111(final int messageType, final String sender, final String receiver) {
		super(111, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT111(int, String, String)", "Use the constructor MT111(sender, receiver) instead.");
	}
