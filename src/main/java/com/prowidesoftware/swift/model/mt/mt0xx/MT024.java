...
/**
 * <h1>MT 024 - Bulk Retrieval Request</h1>
 * <h3>SWIFT MT024 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT024 content, the parameter can not be <code>null</code>
	 * @see #MT024(String)
	 */
	...
	*/
	...
	public MT024(final int messageType, final String sender, final String receiver) {
		super(24, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT024(int, String, String)", "Use the constructor MT024(sender, receiver) instead.");
	}
