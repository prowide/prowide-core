...
Letter options: C<br/></div><div class="field"><em>Field 52</em>
Letter options: A,D<br/></div><div class="field"><em>Field 32</em>
...
// end qualifiers constants	
	...
	* Use instead <code>new MT742(sender, receiver)</code>
	...
	*/
	...
	public Field34A getField34A() {
		...
		if (_m.getBlock4() == null) {
			...
			final Tag t = _m.getBlock4().getTagByName("34A");
			if (t == null) {
