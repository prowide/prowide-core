...
/**
 * <h1>MT 742 - Reimbursement Claim</h1>
 * <h3>SWIFT MT742 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT742 content, the parameter can not be <code>null</code>
	 * @see #MT742(String)
	 */
	...
	*/
	...
	public MT742(final int messageType, final String sender, final String receiver) {
		super(742, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT742(int, String, String)", "Use the constructor MT742(sender, receiver) instead.");
	}
