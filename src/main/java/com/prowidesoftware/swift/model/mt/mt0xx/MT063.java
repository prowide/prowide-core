...
/**
 * <h1>MT 063 - Non-Banking Days List Report</h1>
 * <h3>SWIFT MT063 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT063 content, the parameter can not be <code>null</code>
	 * @see #MT063(String)
	 */
	...
	*/
	...
	public MT063(final int messageType, final String sender, final String receiver) {
		super(63, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT063(int, String, String)", "Use the constructor MT063(sender, receiver) instead.");
	}
	 ...
	 * 
	 * @return a Field172 object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	 ...
	 * 
	 * @return a Field340 object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
