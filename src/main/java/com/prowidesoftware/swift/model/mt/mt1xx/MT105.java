...
/**
 * <h1>MT 105 - EDIFACT Envelope</h1>
 * <h3>SWIFT MT105 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT105 content, the parameter can not be <code>null</code>
	 * @see #MT105(String)
	 */
	...
	*/
	...
	public MT105(final int messageType, final String sender, final String receiver) {
		super(105, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT105(int, String, String)", "Use the constructor MT105(sender, receiver) instead.");
	}
