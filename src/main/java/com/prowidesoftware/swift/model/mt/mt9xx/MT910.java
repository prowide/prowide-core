...
/**
 * <h1>MT 910 - Confirmation of Credit</h1>
 * <h3>SWIFT MT910 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT910 content, the parameter can not be <code>null</code>
	 * @see #MT910(String)
	 */
	...
	*/
	...
	public MT910(final int messageType, final String sender, final String receiver) {
		super(910, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT910(int, String, String)", "Use the constructor MT910(sender, receiver) instead.");
	}
