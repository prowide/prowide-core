...
/**
 * <h1>MT 798 - Proprietary Message</h1>
 * <h3>SWIFT MT798 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT798 content, the parameter can not be <code>null</code>
	 * @see #MT798(String)
	 */
	...
	*/
	...
	public MT798(final int messageType, final String sender, final String receiver) {
		super(798, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT798(int, String, String)", "Use the constructor MT798(sender, receiver) instead.");
	}
