...
/**
 * <h1>MT 398 - Proprietary Message</h1>
 * <h3>SWIFT MT398 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	...
	*/
	...
	public MT398(final int messageType, final String sender, final String receiver) {
		super(398, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT398(int, String, String)", "Use the constructor MT398(sender, receiver) instead.");
	}
