...
/**
 * <h1>MT 067 - Delivery Instructions Redefinition Report</h1>
 * <h3>SWIFT MT067 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT067 content, the parameter can not be <code>null</code>
	 * @see #MT067(String)
	 */
	...
	*/
	...
	public MT067(final int messageType, final String sender, final String receiver) {
		super(67, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT067(int, String, String)", "Use the constructor MT067(sender, receiver) instead.");
	}
