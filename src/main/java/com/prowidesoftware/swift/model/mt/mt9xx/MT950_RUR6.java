...
/**
 * <h1>MT 950_RUR6 - Statement Message</h1>
 * <h3>SWIFT MT950_RUR6 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT950_RUR6 content, the parameter can not be <code>null</code>
	...
	public static MT950_RUR6 parse(MtSwiftMessage m) {
		...
		return new MT950_RUR6(m.message());
	}
	...
	*/
	...
	public MT950_RUR6(final int messageType, final String sender, final String receiver) {
		super(950, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT950_RUR6(int, String, String)", "Use the constructor MT950_RUR6(sender, receiver) instead.");
	}
