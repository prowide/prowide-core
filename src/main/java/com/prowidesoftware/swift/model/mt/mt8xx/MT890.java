...
/**
 * <h1>MT 890 - Advice of Charges, Interest and Other Adjustments</h1>
 * <h3>SWIFT MT890 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT890 content, the parameter can not be <code>null</code>
	 * @see #MT890(String)
	 */
	...
	*/
	...
	public MT890(final int messageType, final String sender, final String receiver) {
		super(890, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT890(int, String, String)", "Use the constructor MT890(sender, receiver) instead.");
	}
