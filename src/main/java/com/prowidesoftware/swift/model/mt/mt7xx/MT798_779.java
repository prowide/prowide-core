...
Letter options: C<br/></div><div class="field"><em>Field 39</em>
Letter options: D<br/></div><div class="field"><em>Field 49</em>
Letter options: J<br/></div><div class="field"><em>Field 78</em>
Letter options: B<br/></div><div class="field"><em>Field 29</em>
...
// end qualifiers constants	
	...
	* Use instead <code>new MT798_779(sender, receiver)</code>
	...
	*/
	...
	public Field39D getField39D() {
		...
		if (_m.getBlock4() == null) {
			...
			final Tag t = _m.getBlock4().getTagByName("39D");
			if (t == null) {
	...
	public Field49J getField49J() {
		...
		if (_m.getBlock4() == null) {
			...
			final Tag t = _m.getBlock4().getTagByName("49J");
			if (t == null) {
