...
Letter options: P<br/></div><div class="field"><em>Field 31</em>
Letter options: F<br/></div><div class="field"><em>Field 32</em>
Letter options: P<br/></div><div class="field"><em>Field 33</em>
Letter options: P,R<br/></div><div class="field"><em>Field 71</em>
...
<em>Sequence C</em><br/>
<div class="field"><em>Field 26</em>
Letter options: N<br/></div><div class="field"><em>Field 32</em>
Letter options: E<br/></div><div class="field"><em>Field 31</em>
Letter options: F<br/></div><div class="field"><em>Field 31</em>
Letter options: R<br/></div><div class="field"><em>Field 32</em>
...
// end qualifiers constants	
	...
	* Use instead <code>new MT643(sender, receiver)</code>
	...
	*/
	...
	public List<Field26P> getField26P() {
		...
		if (_m.getBlock4() == null) {
			...
			final Tag[] tags = _m.getBlock4().getTagsByName("26P");
	...
	public List<Field32P> getField32P() {
		...
		if (_m.getBlock4() == null) {
			...
			final Tag[] tags = _m.getBlock4().getTagsByName("32P");
	...
	public List<Field33P> getField33P() {
		...
		if (_m.getBlock4() == null) {
			...
			final Tag[] tags = _m.getBlock4().getTagsByName("33P");
	...
	public List<Field33R> getField33R() {
		...
		if (_m.getBlock4() == null) {
			...
			final Tag[] tags = _m.getBlock4().getTagsByName("33R");
	...
	public List<Field34P> getField34P() {
		...
		if (_m.getBlock4() == null) {
			...
			final Tag[] tags = _m.getBlock4().getTagsByName("34P");
	...
	public List<Field34R> getField34R() {
		...
		if (_m.getBlock4() == null) {
			...
			final Tag[] tags = _m.getBlock4().getTagsByName("34R");
	...
	public List<Field26N> getField26N() {
		...
		if (_m.getBlock4() == null) {
			...
			final Tag[] tags = _m.getBlock4().getTagsByName("26N");
	...
	public List<Field32E> getField32E() {
		...
		if (_m.getBlock4() == null) {
			...
			final Tag[] tags = _m.getBlock4().getTagsByName("32E");
	...
	public List<Field31R> getField31R() {
		...
		if (_m.getBlock4() == null) {
			...
			final Tag[] tags = _m.getBlock4().getTagsByName("31R");
