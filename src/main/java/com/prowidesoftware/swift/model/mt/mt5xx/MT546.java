...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT546 content, the parameter can not be <code>null</code>
	 * @see #MT546(String)
	 */
	...
	* Use instead <code>new MT546(sender, receiver)</code>
