...
/**
 * <h1>MT 546 - Deliver Free Confirmation</h1>
 * <h3>SWIFT MT546 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
<li class="sequence">
...
// end qualifiers constants	
	...
	*/
	...
	public MT546(final int messageType, final String sender, final String receiver) {
		super(546, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT546(int, String, String)", "Use the constructor MT546(sender, receiver) instead.");
	}
