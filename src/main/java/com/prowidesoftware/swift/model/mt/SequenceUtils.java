...
public class SequenceUtils {
    ...
    public static List<MT535.SequenceB1b1> resolveMT535GetSequenceB1b1List_sru2022(final MT535 mt) {
    ...
    public static List<MT535.SequenceB1c> resolveMT535GetSequenceB1cList_sru2022(final MT535 mt) {
        final List<MT535.SequenceB1c> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceB1List(), MT535.SequenceB1c.START_END_16RS)) {
    ...
    public static List<MT536.SequenceA1> resolveMT536GetSequenceA1List_sru2022(final MT536 mt) {
        final List<MT536.SequenceA1> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceA(), MT536.SequenceA1.START_END_16RS)) {
    ...
    public static List<MT536.SequenceB1a1> resolveMT536GetSequenceB1a1List_sru2022(final MT536 mt) {
        final List<MT536.SequenceB1a1> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceB1aList(), MT536.SequenceB1a1.START_END_16RS)) {
    ...
    public static List<MT537.SequenceA1> resolveMT537GetSequenceA1List_sru2022(final MT537 mt) {
        final List<MT537.SequenceA1> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceA(), MT537.SequenceA1.START_END_16RS)) {
    ...
    public static List<MT537.SequenceB> resolveMT537GetSequenceBList_sru2022(final MT537 mt) {
        return resolveMT537GetSequenceBList_sru2022(mt.getSwiftMessage().getBlock4());
    }

    /**
     * Custom heuristic to deal with B delimiter "STAT" overlapping C3 and D1a1B1a delimiters
     */
    public static List<MT537.SequenceB> resolveMT537GetSequenceBList_sru2022(final SwiftTagListBlock mt /* block 4 */) {
    ...
    public static List<MT537.SequenceB1> resolveMT537GetSequenceB1List_sru2022(final MT537 mt) {
    ...
    public static List<MT537.SequenceB2> resolveMT537GetSequenceB2List_sru2022(final MT537 mt) {
        final List<MT537.SequenceB2> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceBList(), MT537.SequenceB2.START_END_16RS)) {
    ...
    public static List<MT537.SequenceB2a> resolveMT537GetSequenceB2aList_sru2022(final MT537 mt) {
        final List<MT537.SequenceB2a> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceB2List(), MT537.SequenceB2a.START_END_16RS)) {
    ...
    public static List<MT537.SequenceB2b> resolveMT537GetSequenceB2bList_sru2022(final MT537 mt) {
        final List<MT537.SequenceB2b> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceB2List(), MT537.SequenceB2b.START_END_16RS)) {
    ...
    public static List<MT537.SequenceB2b1> resolveMT537GetSequenceB2b1List_sru2022(final MT537 mt) {
        final List<MT537.SequenceB2b1> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceB2bList(), MT537.SequenceB2b1.START_END_16RS)) {
    ...
    public static List<MT537.SequenceC1> resolveMT537GetSequenceC1List_sru2022(final MT537 mt) {
        final List<MT537.SequenceC1> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceCList(), MT537.SequenceC1.START_END_16RS)) {
    ...
    public static List<MT537.SequenceC2> resolveMT537GetSequenceC2List_sru2022(final MT537 mt) {
        final List<MT537.SequenceC2> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceCList(), MT537.SequenceC2.START_END_16RS)) {
    ...
    public static List<MT537.SequenceC2a> resolveMT537GetSequenceC2aList_sru2022(final MT537 mt) {
        final List<MT537.SequenceC2a> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceC2List(), MT537.SequenceC2a.START_END_16RS)) {
    ...
    public static List<MT537.SequenceC3> resolveMT537GetSequenceC3List_sru2022(final MT537 mt) {
        final List<MT537.SequenceC3> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceCList(), MT537.SequenceC3.START_END_16RS)) {
    ...
    public static List<MT537.SequenceC3a> resolveMT537GetSequenceC3aList_sru2022(final MT537 mt) {
        final List<MT537.SequenceC3a> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceC3List(), MT537.SequenceC3a.START_END_16RS)) {
     ...
     */
    public static List<MT537.SequenceD1a1B1> resolveMT537GetSequenceD1a1B1List_sru2022(final MT537 mt) {
     ...
     * So we call a special method to resolve this situation until we find a better approach.
     */
    public static List<MT537.SequenceD1a1B1a> resolveMT537GetSequenceD1a1B1aList_sru2022(final MT537 mt) {
        final List<MT537.SequenceD1a1B1a> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceD1a1B1List(), MT537.SequenceD1a1B1a.START_END_16RS)) {
     ...
     * So we call a special method to resolve this situation until we find a better approach.
     */
    public static List<MT537.SequenceD1a1B1a1> resolveMT537GetSequenceD1a1B1a1List_sru2022(final MT537 mt) {
        final List<MT537.SequenceD1a1B1a1> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceD1a1B1aList(), MT537.SequenceD1a1B1a1.START_END_16RS)) {
    ...
    public static List<MT538.SequenceA1> resolveMT538GetSequenceA1List_sru2022(final MT538 mt) {
        final List<MT538.SequenceA1> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceA(), MT538.SequenceA1.START_END_16RS)) {
    ...
    public static List<MT538.SequenceB2a1> resolveMT538GetSequenceB2a1List_sru2022(final MT538 mt) {
        final List<MT538.SequenceB2a1> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceB2aList(), MT538.SequenceB2a1.START_END_16RS)) {
    ...
    public static List<MT548.SequenceA2> resolveMT548GetSequenceA2List_sru2022(final MT548 mt) {
        final List<MT548.SequenceA2> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceA(), MT548.SequenceA2.START_END_16RS)) {
    ...
    public static List<MT548.SequenceA2a> resolveMT548GetSequenceA2aList_sru2022(final MT548 mt) {
        final List<MT548.SequenceA2a> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceA2List(), MT548.SequenceA2a.START_END_16RS)) {
     ...
     * So we call a special method to resolve this situation until we find a better approach.
     */
    public static List<MT548.SequenceC1a1B1a> resolveMT548GetSequenceC1a1B1aList_sru2022(final MT548 mt) {
        final List<MT548.SequenceC1a1B1a> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceC1a1B1List(), MT548.SequenceC1a1B1a.START_END_16RS)) {
     ...
     * So we call a special method to resolve this situation until we find a better approach.
     */
    public static List<MT548.SequenceC1a1B1a1> resolveMT548GetSequenceC1a1B1a1List_sru2022(final MT548 mt) {
        final List<MT548.SequenceC1a1B1a1> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceC1a1B1aList(), MT548.SequenceC1a1B1a1.START_END_16RS)) {
    ...
    public static MT564.SequenceB1 resolveMT564GetSequenceB1_sru2022(final MT564 mt) {
        Objects.requireNonNull(mt);
    ...
    public static List<MT564.SequenceE1a> resolveMT564GetSequenceE1aList_sru2022(final MT564 mt) {
        final List<MT564.SequenceE1a> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceE1List(), MT564.SequenceE1a.START_END_16RS)) {
    ...
    public static List<MT566.SequenceD1a> resolveMT566GetSequenceD1aList_sru2022(final MT566 mt) {
    ...
    public static List<MT575.SequenceA1> resolveMT575GetSequenceA1List_sru2022(final MT575 mt) {
        final List<MT575.SequenceA1> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceA(), MT575.SequenceA1.START_END_16RS)) {
    ...
    public static List<MT575.SequenceB1a1> resolveMT575GetSequenceB1a1List_sru2022(final MT575 mt) {
        final List<MT575.SequenceB1a1> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceB1aList(), MT575.SequenceB1a1.START_END_16RS)) {
    ...
    public static List<MT575.SequenceB1a4> resolveMT575GetSequenceB1a4List_sru2022(final MT575 mt) {
        final List<MT575.SequenceB1a4> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceB1aList(), MT575.SequenceB1a4.START_END_16RS)) {
    ...
    public static List<MT575.SequenceC1> resolveMT575GetSequenceC1List_sru2022(final MT575 mt) {
        final List<MT575.SequenceC1> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceCList(), MT575.SequenceC1.START_END_16RS)) {
    ...
    public static List<MT575.SequenceC2a> resolveMT575GetSequenceC2aList_sru2022(final MT575 mt) {
        final List<MT575.SequenceC2a> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceC2List(), MT575.SequenceC2a.START_END_16RS)) {
    ...
    public static List<MT576.SequenceA1> resolveMT576GetSequenceA1List_sru2022(final MT576 mt) {
        final List<MT576.SequenceA1> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceA(), MT576.SequenceA1.START_END_16RS)) {
    ...
    public static List<MT576.SequenceB2a> resolveMT576GetSequenceB2aList_sru2022(final MT576 mt) {
        final List<MT576.SequenceB2a> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceB2List(), MT576.SequenceB2a.START_END_16RS)) {
    ...
    public static List<MT586.SequenceA1> resolveMT586GetSequenceA1List_sru2022(final MT586 mt) {
        final List<MT586.SequenceA1> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceA(), MT586.SequenceA1.START_END_16RS)) {
    ...
    public static List<MT586.SequenceB1> resolveMT586GetSequenceB1List_sru2022(final MT586 mt) {
    ...
    public static List<MT670.SequenceB2> resolveMT670GetSequenceB2List_sru2022(final MT670 mt) {
        final List<MT670.SequenceB2> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceBList(), MT670.SequenceB2.START_END_16RS)) {
    ...
    public static MT670.SequenceC resolveMT670GetSequenceC_sru2022(final MT670 mt) {
        Objects.requireNonNull(mt);
    ...
    public static List<MT671.SequenceB2> resolveMT671GetSequenceB2List_sru2022(final MT671 mt) {
        final List<MT671.SequenceB2> result = new ArrayList<>();
        for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt.getSequenceBList(), MT671.SequenceB2.START_END_16RS)) {
    ...
    public static MT671.SequenceC resolveMT671GetSequenceC_sru2022(final MT671 mt) {
        Objects.requireNonNull(mt);
    ...
    public static List<MT537.SequenceB> resolveMT537GetSequenceBList_sru2023(final MT537 mt) {
        return resolveMT537GetSequenceBList_sru2023(mt.getSwiftMessage().getBlock4());
    }

    /**
     * Custom heuristic to deal with B delimiter "STAT" overlapping C3 and D1a1B1a delimiters
     */
    public static List<MT537.SequenceB> resolveMT537GetSequenceBList_sru2023(final SwiftTagListBlock mt /* block 4 */) {
        Objects.requireNonNull(mt);
        final List<SequenceB> result = new ArrayList<>();
