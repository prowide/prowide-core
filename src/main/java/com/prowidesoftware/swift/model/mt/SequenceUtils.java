...
public class SequenceUtils {
	...
	public static List<MT537.SequenceD1a1B1> resolveMT537GetSequenceD1a1B1List_sru2020(final MT537 mt) {
		...
		for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt, join(mt.getSequenceD1a1BList()), MT537.SequenceD1a1B1.START_END_16RS)) {
	...
	public static List<MT537.SequenceD1a1B1a> resolveMT537GetSequenceD1a1B1aList_sru2020(final MT537 mt) {
		...
		for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt, join(mt.getSequenceD1a1B1List()), MT537.SequenceD1a1B1a.START_END_16RS)) {
	...
	public static List<MT537.SequenceD1a1B1a1> resolveMT537GetSequenceD1a1B1a1List_sru2020(final MT537 mt) {
		...
		for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt, join(mt.getSequenceD1a1B1aList()), MT537.SequenceD1a1B1a1.START_END_16RS)) {
	...
	public static List<MT548.SequenceC1a1B1a> resolveMT548GetSequenceC1a1B1aList_sru2020(final MT548 mt) {
		...
		for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt, join(mt.getSequenceC1a1B1List()), MT548.SequenceC1a1B1a.START_END_16RS)) {
	...
	public static List<MT548.SequenceC1a1B1a1> resolveMT548GetSequenceC1a1B1a1List_sru2020(final MT548 mt) {
		...
		for (final SwiftTagListBlock seq : resolveNotUniqueSeparator(mt, join(mt.getSequenceC1a1B1aList()), MT548.SequenceC1a1B1a1.START_END_16RS)) {
