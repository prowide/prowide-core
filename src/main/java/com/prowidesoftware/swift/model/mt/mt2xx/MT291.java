...
/**
 * <h1>MT 291 - Request for Payment of Charges, Interest and Other Expenses</h1>
 * <h3>SWIFT MT291 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT291 content, the parameter can not be <code>null</code>
	 * @see #MT291(String)
	 */
	...
	*/
	...
	public MT291(final int messageType, final String sender, final String receiver) {
		super(291, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT291(int, String, String)", "Use the constructor MT291(sender, receiver) instead.");
	}
