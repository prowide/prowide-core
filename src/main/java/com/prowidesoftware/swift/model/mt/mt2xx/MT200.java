...
/**
 * <h1>MT 200 - Financial Institution Transfer for its Own Account</h1>
 * <h3>SWIFT MT200 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT200 content, the parameter can not be <code>null</code>
	 * @see #MT200(String)
	 */
	...
	*/
	...
	public MT200(final int messageType, final String sender, final String receiver) {
		super(200, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT200(int, String, String)", "Use the constructor MT200(sender, receiver) instead.");
	}
