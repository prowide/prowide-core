...
/**
 * <h1>MT 202_RUR6 - General Financial Institution Transfer</h1>
 * <h3>SWIFT MT202_RUR6 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT202_RUR6 content, the parameter can not be <code>null</code>
	...
	public static MT202_RUR6 parse(MtSwiftMessage m) {
		...
		return new MT202_RUR6(m.message());
	}
	...
	*/
	...
	public MT202_RUR6(final int messageType, final String sender, final String receiver) {
		super(202, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT202_RUR6(int, String, String)", "Use the constructor MT202_RUR6(sender, receiver) instead.");
	}
