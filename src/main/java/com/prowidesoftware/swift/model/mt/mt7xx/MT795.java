...
/**
 * <h1>MT 795 - Queries</h1>
 * <h3>SWIFT MT795 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT795 content, the parameter can not be <code>null</code>
	 * @see #MT795(String)
	 */
	...
	*/
	...
	public MT795(final int messageType, final String sender, final String receiver) {
		super(795, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT795(int, String, String)", "Use the constructor MT795(sender, receiver) instead.");
	}
