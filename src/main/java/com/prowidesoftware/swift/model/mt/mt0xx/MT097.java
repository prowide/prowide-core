...
/**
 * <h1>MT 097 - FINCopy Message Authorisation/Refusal Notification</h1>
 * <h3>SWIFT MT097 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT097 content, the parameter can not be <code>null</code>
	 * @see #MT097(String)
	 */
	...
	*/
	...
	public MT097(final int messageType, final String sender, final String receiver) {
		super(97, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT097(int, String, String)", "Use the constructor MT097(sender, receiver) instead.");
	}
	 ...
	 * 
	 * @return a Field109 object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	 ...
	 * 
	 * @return a Field451 object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	 ...
	 * 
	 * @return a Field115 object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	 ...
	 * 
	 * @return a Field165 object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	 ...
	 * 
	 * @return a Field433 object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	...
	/**
	 * Iterates through block4 fields and return the first one whose name matches 434, 
	 * or <code>null</code> if none is found.<br />
	 * The first occurrence of field 434 at MT097 is expected to be the only one.
	 * 
	 * @return a Field434 object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	public Field434 getField434() {
		final Tag t = tag("434");
		if (t != null) {
			return new Field434(t.getValue());
		} else {
			return null;
		}
	}
	 ...
	 * 
	 * @return a Field422 object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	 ...
	 * 
	 * @return a Field425 object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
