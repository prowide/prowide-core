...
/**
 * <h1>MT 768 - Acknowledgement of a Guarantee / Standby Message</h1>
 * <h3>SWIFT MT768 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	...
	*/
	...
	public MT768(final int messageType, final String sender, final String receiver) {
		super(768, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT768(int, String, String)", "Use the constructor MT768(sender, receiver) instead.");
	}
