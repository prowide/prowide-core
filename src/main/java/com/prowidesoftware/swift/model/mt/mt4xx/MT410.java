...
/**
 * <h1>MT 410 - Acknowledgement</h1>
 * <h3>SWIFT MT410 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
<li class="sequence">
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT410 content, the parameter can not be <code>null</code>
	 * @see #MT410(String)
	 */
	...
	*/
	...
	public MT410(final int messageType, final String sender, final String receiver) {
		super(410, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT410(int, String, String)", "Use the constructor MT410(sender, receiver) instead.");
	}
...
// BaseSequenceCodeGenerator [seq=A]
	/**
	* Class for Sequence "A" of MT 410
	*/
