...
/**
 * <h1>MT 042 - Cut-off Times List Request</h1>
 * <h3>SWIFT MT042 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT042 content, the parameter can not be <code>null</code>
	 * @see #MT042(String)
	 */
	...
	*/
	...
	public MT042(final int messageType, final String sender, final String receiver) {
		super(42, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT042(int, String, String)", "Use the constructor MT042(sender, receiver) instead.");
	}
	 ...
	 * 
	 * @return a Field304 object or <code>null</code> if the field is not found
