...
/**
 * <h1>MT 191 - Request for Payment of Charges, Interest and Other Expenses</h1>
 * <h3>SWIFT MT191 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT191 content, the parameter can not be <code>null</code>
	 * @see #MT191(String)
	 */
	...
	*/
	...
	public MT191(final int messageType, final String sender, final String receiver) {
		super(191, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT191(int, String, String)", "Use the constructor MT191(sender, receiver) instead.");
	}
