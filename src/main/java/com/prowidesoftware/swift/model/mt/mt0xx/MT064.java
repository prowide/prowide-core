...
/**
 * <h1>MT 064 - Undelivered Report Rules Change Report</h1>
 * <h3>SWIFT MT064 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT064 content, the parameter can not be <code>null</code>
	 * @see #MT064(String)
	 */
	...
	*/
	...
	public MT064(final int messageType, final String sender, final String receiver) {
		super(64, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT064(int, String, String)", "Use the constructor MT064(sender, receiver) instead.");
	}
	 ...
	 * 
	 * @return a Field302 object or <code>null</code> if the field is not found
	 ...
	 * 
	 * @return a Field341 object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
