...
/**
 * <h1>MT 798_794 - Request for Settlement of Charges Index</h1>
 * <h3>SWIFT MT798_794 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
<li class="field">Field 21 P (M)</li>
<li class="field">Field 20  (M)</li>
...
public class MT798_794 extends AbstractMT implements Serializable {
	...
	private static final transient java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT798_794.class.getName());
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT798_794 content, the parameter can not be <code>null</code>
	 * @see #MT798_794(String)
	 */
	 ...
	 * @since 7.7
	 */
	public static MT798_794 parse(MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT798_794(m.message());
	}
	
	/**
	 * Creates and initializes a new MT798_794 input message setting TEST BICS as sender and receiver.<br />
	...
	/**
	 * Creates and initializes a new MT798_794 input message from sender to receiver.<br />
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.7
	 */
	public MT798_794(final String sender, final String receiver) {
	...
	* 
	* @see #MT798_794(String, String)
	* @deprecated Use instead <code>new MT798_794(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2018)
	public MT798_794(final int messageType, final String sender, final String receiver) {
		super(798, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT798_794(int, String, String)", "Use the constructor MT798_794(sender, receiver) instead.");
	}
	
	/**
	 * Creates a new MT798_794 by parsing a String with the message content in its swift FIN format.<br />
	 ...
	 * @since 7.7
	 */
	public MT798_794(final String fin) {
		super();
		if (fin != null) {
    ...
    private void sanityCheck(final SwiftMessage param) {
    	if (param.isServiceMessage()) {
			log.warning("Creating an MT798_794 object from FIN content with a Service Message. Check if the MT798_794 you are intended to read is prepended with and ACK.");
		} else if (!StringUtils.equals(param.getType(), getMessageType())) {
			log.warning("Creating an MT798_794 object from FIN content with message type "+param.getType());
		}
    }
	
	/**
	 * Creates a new MT798_794 by parsing a String with the message content in its swift FIN format.<br />
	 * If the fin parameter cannot be parsed, the returned MT798_794 will have its internal message object
	 * initialized (blocks will be created) but empty.<br />
	 * If the string contains multiple messages, only the first one will be parsed. 
	 *
	 * @param fin a string with the MT message in its FIN swift format. <em>fin may be <code>null</code> in which case this method returns null</em>
	 * @return a new instance of MT798_794 or null if fin is null 
	 * @since 7.7
	 */
	public static MT798_794 parse(final String fin) {
		if (fin == null) {
			return null;
		}
		return new MT798_794(fin);
    }
    
    /**
	 * Creates a new MT798_794 by parsing a input stream with the message content in its swift FIN format, using "UTF-8" as encoding.<br />
	 ...
	 * @since 7.7
	 */
	public MT798_794(final InputStream stream) throws IOException {
	 ...
	 *
	 * @param stream an input stream in UTF-8 encoding with the MT message in its FIN swift format.
	 * @return a new instance of MT798_794 or null if stream is null or the message cannot be parsed 
	 * @since 7.7
	 */
	public static MT798_794 parse(final InputStream stream) throws IOException {
		if (stream == null) {
			return null;
		}
		return new MT798_794(stream);
    }
    
    /**
	 * Creates a new MT798_794 by parsing a file with the message content in its swift FIN format.<br />
	 ...
	 * @since 7.7
	 */
	public MT798_794(final File file) throws IOException {
	 ...
	 *
	 * @param file a file with the MT message in its FIN swift format.
	 * @return a new instance of MT798_794 or null if; file is null, does not exist, can't be read, is not a file or the message cannot be parsed
	 * @since 7.7
	 */
	public static MT798_794 parse(final File file) throws IOException {
		if (file == null) {
			return null;
		}
		return new MT798_794(file);
    }
	 ...
	 */
	@Override
	public MT798_794 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT798_794 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT798_794 append(final Field ... fields) {
		super.append(fields);
		return this;
	}
