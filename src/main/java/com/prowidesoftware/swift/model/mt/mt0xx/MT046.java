...
/**
 * <h1>MT 046 - Undelivered Message Report Request</h1>
 * <h3>SWIFT MT046 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT046 content, the parameter can not be <code>null</code>
	 * @see #MT046(String)
	 */
	...
	*/
	...
	public MT046(final int messageType, final String sender, final String receiver) {
		super(46, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT046(int, String, String)", "Use the constructor MT046(sender, receiver) instead.");
	}
	 ...
	 * 
	 * @return a Field303 object or <code>null</code> if the field is not found
