...
/**
 * <h1>MT 792 - Request for Cancellation</h1>
 * <h3>SWIFT MT792 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT792 content, the parameter can not be <code>null</code>
	 * @see #MT792(String)
	 */
	...
	*/
	...
	public MT792(final int messageType, final String sender, final String receiver) {
		super(792, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT792(int, String, String)", "Use the constructor MT792(sender, receiver) instead.");
	}
