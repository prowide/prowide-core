...
/**
 * <h1>MT 721 - Transfer of a Documentary Credit</h1>
 * <h3>SWIFT MT721 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	...
	*/
	...
	public MT721(final int messageType, final String sender, final String receiver) {
		super(721, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT721(int, String, String)", "Use the constructor MT721(sender, receiver) instead.");
	}
