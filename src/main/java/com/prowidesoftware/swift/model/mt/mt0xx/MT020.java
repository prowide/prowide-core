...
/**
 * <h1>MT 020 - Retrieval Request</h1>
 * <h3>SWIFT MT020 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT020 content, the parameter can not be <code>null</code>
	 * @see #MT020(String)
	 */
	...
	*/
	...
	public MT020(final int messageType, final String sender, final String receiver) {
		super(20, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT020(int, String, String)", "Use the constructor MT020(sender, receiver) instead.");
	}
