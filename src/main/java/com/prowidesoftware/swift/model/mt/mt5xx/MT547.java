...
/**
 * <h1>MT 547 - Deliver Against Payment Confirmation</h1>
 * <h3>SWIFT MT547 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
<li class="sequence">
...
Fieldset 98
 (M) (repetitive)<ul><li>FieldsetItem 98 A,B,C (M)</li><li>FieldsetItem 98 A,B,C,E (O)</li><li>FieldsetItem 98 A,B,C (M)</li></ul></li><li class="field">Field 90 A,B (O)</li>
...
// end qualifiers constants	
	...
	*/
	...
	public MT547(final int messageType, final String sender, final String receiver) {
		super(547, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT547(int, String, String)", "Use the constructor MT547(sender, receiver) instead.");
	}
