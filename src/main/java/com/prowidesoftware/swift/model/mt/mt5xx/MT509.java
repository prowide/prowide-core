...
/**
 * <h1>MT 509 - Trade Status Message</h1>
 * <h3>SWIFT MT509 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
<li class="sequence">
...
// end qualifiers constants	
	...
	*/
	...
	public MT509(final int messageType, final String sender, final String receiver) {
		super(509, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT509(int, String, String)", "Use the constructor MT509(sender, receiver) instead.");
	}
