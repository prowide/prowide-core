...
/**
 * <h1>MT 940 - Customer Statement Message</h1>
 * <h3>SWIFT MT940 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
<li class="field">Field 60 F,M (O)</li>
<li class="sequence">
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT940 content, the parameter can not be <code>null</code>
	 * @see #MT940(String)
	 */
	...
	*/
	...
	public MT940(final int messageType, final String sender, final String receiver) {
		super(940, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT940(int, String, String)", "Use the constructor MT940(sender, receiver) instead.");
	}
