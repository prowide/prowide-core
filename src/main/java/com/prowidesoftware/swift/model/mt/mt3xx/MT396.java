...
/**
 * <h1>MT 396 - Answers</h1>
 * <h3>SWIFT MT396 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT396 content, the parameter can not be <code>null</code>
	 * @see #MT396(String)
	 */
	...
	*/
	...
	public MT396(final int messageType, final String sender, final String receiver) {
		super(396, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT396(int, String, String)", "Use the constructor MT396(sender, receiver) instead.");
	}
