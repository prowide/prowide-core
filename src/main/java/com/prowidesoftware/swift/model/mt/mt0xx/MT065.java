...
/**
 * <h1>MT 065 - Time Change Report for Daily Check Report</h1>
 * <h3>SWIFT MT065 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT065 content, the parameter can not be <code>null</code>
	 * @see #MT065(String)
	 */
	...
	*/
	...
	public MT065(final int messageType, final String sender, final String receiver) {
		super(65, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT065(int, String, String)", "Use the constructor MT065(sender, receiver) instead.");
	}
