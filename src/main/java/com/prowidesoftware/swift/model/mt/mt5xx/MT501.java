...
Letter options: B<br/></div><div class="field"><em>Field 95</em>
...
// end qualifiers constants	
	...
	* Use instead <code>new MT501(sender, receiver)</code>
	...
	*/
	...
	public Field93B getField93B() {
		...
		if (_m.getBlock4() == null) {
			...
			final Tag t = _m.getBlock4().getTagByName("93B");
			if (t == null) {
	...
	public Field70C getField70C() {
		...
		if (_m.getBlock4() == null) {
			...
			final Tag t = _m.getBlock4().getTagByName("70C");
			if (t == null) {
