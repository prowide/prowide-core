...
/**
 * <h1>MT 514 - Trade Allocation Instruction</h1>
 * <h3>SWIFT MT514 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
<li class="sequence">
...
<li class="fieldset">
Fieldset 22
 (M) (repetitive)<ul><li>FieldsetItem 22 H (M)</li><li>FieldsetItem 22 F (O) (repetitive)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O)</li></ul></li><li class="field">Field 11 A (O)</li>
<li class="sequence">
...
// begin qualifiers constants	
	...
	* @deprecated use instead com.prowidesoftware.swift.SchemeConstantsA.ALLO
	* @see com.prowidesoftware.swift.SchemeConstantsA#ALLO
	*/
	@Deprecated
	@com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2018)
	...
	* @deprecated use instead com.prowidesoftware.swift.SchemeConstantsS.SEBL
	* @see com.prowidesoftware.swift.SchemeConstantsS#SEBL
	*/
	@Deprecated
	@com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2018)
	...
	* @deprecated use instead com.prowidesoftware.swift.SchemeConstantsT.TOAL
	* @see com.prowidesoftware.swift.SchemeConstantsT#TOAL
	*/
	@Deprecated
	@com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2018)
	...
	* @deprecated use instead com.prowidesoftware.swift.SchemeConstantsT.TQBT
	* @see com.prowidesoftware.swift.SchemeConstantsT#TQBT
	*/
	@Deprecated
	@com.prowidesoftware.deprecation.ProwideDeprecated(phase3=com.prowidesoftware.deprecation.TargetYear._2018)
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT514 content, the parameter can not be <code>null</code>
	 * @see #MT514(String)
	 */
	...
	*/
	...
	public MT514(final int messageType, final String sender, final String receiver) {
		super(514, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT514(int, String, String)", "Use the constructor MT514(sender, receiver) instead.");
	}
