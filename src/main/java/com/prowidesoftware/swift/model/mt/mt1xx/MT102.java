...
/**
 * MT 102<br />
 * Multiple Customer Credit Transfer<br />
 <h1>MT102 Format</h1>
 <pre>
...
Letter options: A,B,C<br/></div><div class="field"><em>Field 26</em>
...
Letter options: A,F,K<br/></div><div class="field"><em>Field 52</em>
Letter options: A,B,C<br/></div><div class="field"><em>Field 57</em>
Letter options: A,C<br/></div><div class="field"><em>Field 59</em>
...
Letter options: A<br/></div><div class="field"><em>Field 19</em>
Letter options: null<br/></div><div class="field"><em>Field 71</em>
Letter options: G<br/></div><div class="field"><em>Field 13</em>
Letter options: C<br/></div><div class="field"><em>Field 53</em>
Letter options: A,C<br/></div><div class="field"><em>Field 54</em>
...
// end qualifiers constants	
	...
	* Use instead <code>new MT102(sender, receiver)</code>
	...
	*/
	...
	public List<Field52B> getField52B() {
		...
		if (_m.getBlock4() == null) {
			...
			final Tag[] tags = _m.getBlock4().getTagsByName("52B");
	...
	public List<Field59F> getField59F() {
		...
		if (_m.getBlock4() == null) {
			...
			final Tag[] tags = _m.getBlock4().getTagsByName("59F");
