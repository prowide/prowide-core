...
/**
 * <h1>MT 910_RUR6 - Confirmation of Credit</h1>
 * <h3>SWIFT MT910_RUR6 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	...
	*/
	...
	public MT910_RUR6(final int messageType, final String sender, final String receiver) {
		super(910, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT910_RUR6(int, String, String)", "Use the constructor MT910_RUR6(sender, receiver) instead.");
	}
