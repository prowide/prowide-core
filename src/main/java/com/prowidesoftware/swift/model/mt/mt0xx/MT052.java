...
/**
 * <h1>MT 052 - Delivery Subset Status Report</h1>
 * <h3>SWIFT MT052 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT052 content, the parameter can not be <code>null</code>
	 * @see #MT052(String)
	 */
	...
	*/
	...
	public MT052(final int messageType, final String sender, final String receiver) {
		super(52, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT052(int, String, String)", "Use the constructor MT052(sender, receiver) instead.");
	}
	...
	public List<Field336> getField336() {
		...
		for (int i=0; i<tags.length; i++) {
			result.add(new Field336(tags[i].getValue()));
		}
		return result;
	}
