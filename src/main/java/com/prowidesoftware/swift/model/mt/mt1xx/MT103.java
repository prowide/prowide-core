...
/**
 * <h1>MT 103 - Single Customer Credit Transfer</h1>
 * <h3>SWIFT MT103 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	...
	*/
	...
	public MT103(final int messageType, final String sender, final String receiver) {
		super(103, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT103(int, String, String)", "Use the constructor MT103(sender, receiver) instead.");
	}
