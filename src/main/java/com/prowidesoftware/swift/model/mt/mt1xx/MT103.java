...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT103 content, the parameter can not be <code>null</code>
	 * @see #MT103(String)
	 */
	...
	* Use instead <code>new MT103(sender, receiver)</code>
