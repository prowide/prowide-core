...
/**
 * <h1>MT 071 - Undelivered SSI Update Notification Report</h1>
 * <h3>SWIFT MT071 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT071 content, the parameter can not be <code>null</code>
	 * @see #MT071(String)
	 */
	...
	*/
	...
	public MT071(final int messageType, final String sender, final String receiver) {
		super(71, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT071(int, String, String)", "Use the constructor MT071(sender, receiver) instead.");
	}
	 ...
	 * 
	 * @return a Field209 object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	 ...
	 * 
	 * @return a Field313 object or <code>null</code> if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	...
	public List<Field102> getField102() {
		...
		for (int i=0; i<tags.length; i++) {
			result.add(new Field102(tags[i].getValue()));
		}
		return result;
	}
