...
/**
 * <h1>MT 604 - Commodity Transfer/ Delivery Order</h1>
 * <h3>SWIFT MT604 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT604 content, the parameter can not be <code>null</code>
	 * @see #MT604(String)
	 */
	...
	*/
	...
	public MT604(final int messageType, final String sender, final String receiver) {
		super(604, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT604(int, String, String)", "Use the constructor MT604(sender, receiver) instead.");
	}
