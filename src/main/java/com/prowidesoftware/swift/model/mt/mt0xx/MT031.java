...
/**
 * <h1>MT 031 - Session History Request</h1>
 * <h3>SWIFT MT031 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT031 content, the parameter can not be <code>null</code>
	 * @see #MT031(String)
	 */
	...
	*/
	...
	public MT031(final int messageType, final String sender, final String receiver) {
		super(31, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT031(int, String, String)", "Use the constructor MT031(sender, receiver) instead.");
	}
