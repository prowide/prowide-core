...
<blockquote><ul><it><em>FieldsetItem 20 D</em><br/>
</it><it><em>FieldsetItem 20 D</em><br/>
</it><it><em>FieldsetItem 20 D</em><br/>
...
Letter options: A,C<br/></div><div class="field"><em>Field 35</em>
...
<blockquote><ul><it><em>FieldsetItem 95 P,R,U</em><br/>
...
</it><it><em>FieldsetItem 94 G</em><br/>
</it><it><em>FieldsetItem 94 D</em><br/>
</it></ul></blockquote></div><div class="fieldset">
<em>Fieldset 13</em><br/>
...
Letter options: U<br/></div><div class="fieldset">
<em>Fieldset 98</em><br/>
...
// begin qualifiers constants	
	...
	* @deprecated use instead com.prowidesoftware.swift.SchemeConstantsA.ADMT
	* @see com.prowidesoftware.swift.SchemeConstantsA#ADMT
	*/
	@Deprecated
	@com.prowidesoftware.deprecation.ProwideDeprecated(phase2=com.prowidesoftware.deprecation.TargetYear._2017)
	...
	* @deprecated use instead com.prowidesoftware.swift.SchemeConstantsN.NEWA
	* @see com.prowidesoftware.swift.SchemeConstantsN#NEWA
	*/
	@Deprecated
	@com.prowidesoftware.deprecation.ProwideDeprecated(phase2=com.prowidesoftware.deprecation.TargetYear._2017)
	...
	* @deprecated use instead com.prowidesoftware.swift.SchemeConstantsR.RMOD
	* @see com.prowidesoftware.swift.SchemeConstantsR#RMOD
	*/
	@Deprecated
	@com.prowidesoftware.deprecation.ProwideDeprecated(phase2=com.prowidesoftware.deprecation.TargetYear._2017)
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT519 content, the parameter can not be <code>null</code>
	 * @see #MT519(String)
	 */
	...
	* Use instead <code>new MT519(sender, receiver)</code>
	...
	*/
	...
	public List<Field20D> getField20D() {
		...
		if (_m.getBlock4() == null) {
			...
			final Tag[] tags = _m.getBlock4().getTagsByName("20D");
	...
	public List<Field95U> getField95U() {
		...
		if (_m.getBlock4() == null) {
			...
			final Tag[] tags = _m.getBlock4().getTagsByName("95U");
