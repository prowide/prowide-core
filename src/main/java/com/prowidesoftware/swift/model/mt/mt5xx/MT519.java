...
/**
 * <h1>MT 519 - Modification of Client Details</h1>
 * <h3>SWIFT MT519 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
<li class="sequence">
...
// end qualifiers constants	
	...
	*/
	...
	public MT519(final int messageType, final String sender, final String receiver) {
		super(519, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT519(int, String, String)", "Use the constructor MT519(sender, receiver) instead.");
	}
