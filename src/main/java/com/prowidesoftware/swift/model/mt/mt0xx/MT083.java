...
/**
 * <h1>MT 083 - Undelivered Message Report at Cut-off Time</h1>
 * <h3>SWIFT MT083 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT083 content, the parameter can not be <code>null</code>
	 * @see #MT083(String)
	 */
	...
	*/
	...
	public MT083(final int messageType, final String sender, final String receiver) {
		super(83, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT083(int, String, String)", "Use the constructor MT083(sender, receiver) instead.");
	}
