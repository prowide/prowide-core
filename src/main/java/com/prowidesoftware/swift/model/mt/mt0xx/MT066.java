...
/**
 * <h1>MT 066 - Solicited Undelivered Message Report</h1>
 * <h3>SWIFT MT066 (ISO 15022) message structure:</h3>
 *
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT066 content, the parameter can not be <code>null</code>
	 * @see #MT066(String)
	 */
	...
	*/
	...
	public MT066(final int messageType, final String sender, final String receiver) {
		super(66, sender, receiver);
		com.prowidesoftware.deprecation.DeprecationUtils.phase2(getClass(), "MT066(int, String, String)", "Use the constructor MT066(sender, receiver) instead.");
	}
