...
@Generated
public class Field99C extends Field implements Serializable, com.prowidesoftware.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field99C> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field99C> result = new ArrayList<Field99C>(arr.length);
			for (final Tag f : arr) {
