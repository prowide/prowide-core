...
@Generated
public class Field77D extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field77D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field77D> result = new ArrayList<Field77D>(arr.length);
			for (final Tag f : arr) {
