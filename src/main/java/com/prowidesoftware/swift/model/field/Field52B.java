...
@Generated
public class Field52B extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field52B> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field52B> result = new ArrayList<Field52B>(arr.length);
			for (final Tag f : arr) {
