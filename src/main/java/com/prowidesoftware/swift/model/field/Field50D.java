...
@Generated
public class Field50D extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field50D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field50D> result = new ArrayList<Field50D>(arr.length);
			for (final Tag f : arr) {
