...
@Generated
public class Field87B extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field87B> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field87B> result = new ArrayList<Field87B>(arr.length);
			for (final Tag f : arr) {
