...
public class Field32P extends Field implements Serializable, CurrencyContainer, DateContainer, AmountContainer {
	 ...
	 */
	public Field32P(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field32P(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "32P")) {
			throw new IllegalArgumentException("cannot create field 32P from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field32P newInstance(Field32P source) {
		Field32P cp = new Field32P();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field32P.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field32P.COMPONENTS_PATTERN
	 */
	@Override
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 32P");
		}
		if (locale == null) {
