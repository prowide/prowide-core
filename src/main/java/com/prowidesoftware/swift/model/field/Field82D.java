...
@Generated
public class Field82D extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field82D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field82D> result = new ArrayList<Field82D>(arr.length);
			for (final Tag f : arr) {
