...
public class Field71J extends Field implements Serializable, CurrencyContainer, AmountContainer {
	 ...
	 */
	public Field71J(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field71J(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "71J")) {
			throw new IllegalArgumentException("cannot create field 71J from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field71J newInstance(Field71J source) {
		Field71J cp = new Field71J();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field71J.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field71J.COMPONENTS_PATTERN
	 */
	@Override
