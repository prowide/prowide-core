...
public class Field71K extends Field implements Serializable, CurrencyContainer, AmountContainer {
	 ...
	 */
	public Field71K(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field71K(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "71K")) {
			throw new IllegalArgumentException("cannot create field 71K from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field71K newInstance(Field71K source) {
		Field71K cp = new Field71K();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field71K.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field71K.COMPONENTS_PATTERN
	 */
	@Override
