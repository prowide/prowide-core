...
@Generated
public class Field53D extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field53D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field53D> result = new ArrayList<Field53D>(arr.length);
			for (final Tag f : arr) {
