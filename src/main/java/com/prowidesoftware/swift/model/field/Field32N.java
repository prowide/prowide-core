...
public class Field32N extends Field implements Serializable, CurrencyContainer, DateContainer, AmountContainer {
	 ...
	 */
	public Field32N(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field32N(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "32N")) {
			throw new IllegalArgumentException("cannot create field 32N from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field32N newInstance(Field32N source) {
		Field32N cp = new Field32N();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field32N.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field32N.COMPONENTS_PATTERN
	 */
	@Override
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 4) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 32N");
		}
		if (locale == null) {
