...
public class Field60B extends Field implements Serializable, DateContainer, AmountContainer {
	 ...
	 */
	public Field60B(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field60B(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "60B")) {
			throw new IllegalArgumentException("cannot create field 60B from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field60B newInstance(Field60B source) {
		Field60B cp = new Field60B();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field60B.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field60B.COMPONENTS_PATTERN
	 */
	@Override
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 4) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 60B");
		}
		if (locale == null) {
