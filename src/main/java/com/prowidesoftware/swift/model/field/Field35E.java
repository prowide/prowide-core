...
@Generated
public class Field35E extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field35E> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field35E> result = new ArrayList<Field35E>(arr.length);
			for (final Tag f : arr) {
