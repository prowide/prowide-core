...
@Generated
public class Field77B extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field77B> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field77B> result = new ArrayList<Field77B>(arr.length);
			for (final Tag f : arr) {
