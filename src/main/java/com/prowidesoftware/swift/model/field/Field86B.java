...
@Generated
public class Field86B extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field86B> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field86B> result = new ArrayList<Field86B>(arr.length);
			for (final Tag f : arr) {
