...
public class Field31H extends Field implements Serializable, DateContainer {
	 ...
	 */
	public Field31H(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field31H(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "31H")) {
			throw new IllegalArgumentException("cannot create field 31H from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field31H newInstance(Field31H source) {
		Field31H cp = new Field31H();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field31H.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field31H.COMPONENTS_PATTERN
	 */
	@Override
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 31H");
		}
		if (locale == null) {
