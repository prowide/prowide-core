...
@Generated
public class Field50K extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field50K> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field50K> result = new ArrayList<Field50K>(arr.length);
			for (final Tag f : arr) {
