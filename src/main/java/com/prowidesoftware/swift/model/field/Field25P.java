...
@Generated
public class Field25P extends Field implements Serializable, BICContainer, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	/**
	 * Get a list of all occurrences of the field Field25P in the given message
	...
	/**
	 * Get a list of all occurrences of the field Field25P from the given block
	 * an empty list is returned if none found.
	 *
