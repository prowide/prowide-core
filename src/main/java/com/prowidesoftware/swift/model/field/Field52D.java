...
@Generated
public class Field52D extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field52D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field52D> result = new ArrayList<Field52D>(arr.length);
			for (final Tag f : arr) {
