...
public class Field34N extends Field implements Serializable, CurrencyContainer, DateContainer, AmountContainer {
	 ...
	 */
	public Field34N(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field34N(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "34N")) {
			throw new IllegalArgumentException("cannot create field 34N from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field34N newInstance(Field34N source) {
		Field34N cp = new Field34N();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field34N.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field34N.COMPONENTS_PATTERN
	 */
	@Override
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 4) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 34N");
		}
		if (locale == null) {
