...
@Generated
public class Field72C extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field72C(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field72C(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "72C")) {
			throw new IllegalArgumentException("cannot create field 72C from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field72C newInstance(Field72C source) {
		Field72C cp = new Field72C();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field72C.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field72C.COMPONENTS_PATTERN
	 */
	@Override
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 35) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 72C");
		}
		if (locale == null) {
