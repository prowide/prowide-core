...
@Generated
public class Field94D extends Field implements Serializable, com.prowidesoftware.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field94D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field94D> result = new ArrayList<Field94D>(arr.length);
			for (final Tag f : arr) {
