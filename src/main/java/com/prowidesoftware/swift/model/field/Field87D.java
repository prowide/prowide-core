...
@Generated
public class Field87D extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field87D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field87D> result = new ArrayList<Field87D>(arr.length);
			for (final Tag f : arr) {
