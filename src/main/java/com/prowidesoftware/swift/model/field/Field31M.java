 ...
 * SWIFT MT Field 31M.
 * <p>
 * Model and parser for field 31M of a SWIFT MT message.
 *
...
public class Field31M extends Field implements Serializable, DateContainer {
     ...
     */
    public static final String F_31M = "31M";
     ...
     */
    public Field31M(final String value) {
        super(value);
    }
     ...
     * @since 7.7
     */
    public static Field31M newInstance(Field31M source) {
        Field31M cp = new Field31M();
     ...
     */
    public Field31M setComponent1(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field31M setComponent1(java.util.Calendar component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field31M setDate(String component1) {
     ...
     * @return the field object to enable build pattern
     */
    public Field31M setDate(java.util.Calendar component1) {
        return setComponent1(component1);
    }
     ...
     * @return the static value of Field31M.NAME
     */
    @Override
     ...
     */
    public static Field31M get(final SwiftTagListBlock block) {
        ...
        return new Field31M(t);
    }

    /**
     * Gets the first instance of Field31M in the given message.
     * @param msg may be empty or null
     * @return null if not found or msg is empty or null
     * @see #get(SwiftTagListBlock)
     */
    public static Field31M get(final SwiftMessage msg) {
    ...
    /**
     * Gets a list of all occurrences of the field Field31M in the given message
     * an empty list is returned if none found.
     * @param msg may be empty or null in which case an empty list is returned
     * @see #getAll(SwiftTagListBlock)
     */
    public static List<Field31M> getAll(final SwiftMessage msg) {
        if (msg == null || msg.getBlock4() == null || msg.getBlock4().isEmpty()) {
    ...
    /**
     * Gets a list of all occurrences of the field Field31M from the given block
     * an empty list is returned if none found.
     *
     * @param block may be empty or null in which case an empty list is returned
     */
    public static List<Field31M> getAll(final SwiftTagListBlock block) {
        final List<Field31M> result = new ArrayList<>();
        if (block == null || block.isEmpty()) {
            return result;
        }
    ...
    /**
     * This method deserializes the JSON data into a Field31M object.
     * @param json JSON structure including tuples with label and value for all field components
     * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
     * @since 7.10.3
     * @see Field#fromJson(String)
     */
    public static Field31M fromJson(final String json) {

        final Field31M field = new Field31M();
