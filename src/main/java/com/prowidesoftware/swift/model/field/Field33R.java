...
public class Field33R extends Field implements Serializable, CurrencyContainer, DateContainer, AmountContainer {
	 ...
	 */
	public Field33R(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field33R(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "33R")) {
			throw new IllegalArgumentException("cannot create field 33R from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field33R newInstance(Field33R source) {
		Field33R cp = new Field33R();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field33R.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field33R.COMPONENTS_PATTERN
	 */
	@Override
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 33R");
		}
		if (locale == null) {
