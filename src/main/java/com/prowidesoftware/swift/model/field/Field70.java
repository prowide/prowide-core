...
@Generated
public class Field70 extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field70> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field70> result = new ArrayList<Field70>(arr.length);
			for (final Tag f : arr) {
