...
public class Field60A extends Field implements Serializable, DateContainer, AmountContainer {
	 ...
	 */
	public Field60A(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field60A(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "60A")) {
			throw new IllegalArgumentException("cannot create field 60A from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field60A newInstance(Field60A source) {
		Field60A cp = new Field60A();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field60A.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field60A.COMPONENTS_PATTERN
	 */
	@Override
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 4) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 60A");
		}
		if (locale == null) {
