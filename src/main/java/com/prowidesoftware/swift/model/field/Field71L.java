...
public class Field71L extends Field implements Serializable, CurrencyContainer, AmountContainer {
	 ...
	 */
	public Field71L(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field71L(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "71L")) {
			throw new IllegalArgumentException("cannot create field 71L from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field71L newInstance(Field71L source) {
		Field71L cp = new Field71L();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field71L.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field71L.COMPONENTS_PATTERN
	 */
	@Override
