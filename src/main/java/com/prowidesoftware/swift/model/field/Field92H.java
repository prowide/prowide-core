 ...
 * Field 92H<br /><br />
 *
 * validation pattern: :4!c//&lt;CUR&gt;&lt;AMOUNT&gt;15/4!c<br />
 * parser pattern: :S//SN/S<br />
 * components pattern: SCNS<br />
 *
...
@Generated
public class Field92H extends Field implements Serializable, CurrencyContainer, AmountContainer, com.prowidesoftware.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	/**
	 * Get a list of all occurrences of the field Field92H in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static java.util.List<Field92H> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return java.util.Collections.emptyList();
	...
	/**
	 * Get a list of all occurrences of the field Field92H from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static java.util.List<Field92H> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field92H> result = new java.util.ArrayList<Field92H>(arr.length);
			for (final Tag f : arr) {
