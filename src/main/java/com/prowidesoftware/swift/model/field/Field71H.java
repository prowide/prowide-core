...
public class Field71H extends Field implements Serializable, CurrencyContainer, AmountContainer {
	 ...
	 */
	public Field71H(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field71H(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "71H")) {
			throw new IllegalArgumentException("cannot create field 71H from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field71H newInstance(Field71H source) {
		Field71H cp = new Field71H();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field71H.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field71H.COMPONENTS_PATTERN
	 */
	@Override
