...
public class Field30Z extends Field implements Serializable, DateContainer {
   ...
   public String parserPattern() {
	 ...
	 */ 
	public static java.util.List<Field30Z> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	 ...
	 */ 
	public static java.util.List<Field30Z> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length>0) {
			final java.util.ArrayList<Field30Z> result = new java.util.ArrayList<Field30Z>(arr.length);
			for (final Tag f : arr) {
