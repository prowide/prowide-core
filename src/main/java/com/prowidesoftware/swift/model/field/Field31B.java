...
@Generated
public class Field31B extends Field implements Serializable, DateContainer, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field31B(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field31B(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "31B")) {
			throw new IllegalArgumentException("cannot create field 31B from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field31B newInstance(Field31B source) {
		Field31B cp = new Field31B();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field31B.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field31B.COMPONENTS_PATTERN
	 */
	@Override
