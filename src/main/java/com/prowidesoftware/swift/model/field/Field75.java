...
@Generated
public class Field75 extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field75> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field75> result = new ArrayList<Field75>(arr.length);
			for (final Tag f : arr) {
