...
@Generated
public class Field97B extends Field implements Serializable, com.prowidesoftware.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field97B> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field97B> result = new ArrayList<Field97B>(arr.length);
			for (final Tag f : arr) {
