...
@Generated
public class Field94L extends Field implements Serializable, com.prowidesoftware.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	/**
	 * Get a list of all occurrences of the field Field94L in the given message
	...
	/**
	 * Get a list of all occurrences of the field Field94L from the given block
	 * an empty list is returned if none found.
	 *
