...
@Generated
public class Field92E extends Field implements Serializable, AmountContainer, com.prowidesoftware.swift.model.field.GenericField {
	/**
	 ...
	 */
	public Field92E(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field92E(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "92E")) {
			throw new IllegalArgumentException("cannot create field 92E from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field92E newInstance(Field92E source) {
		Field92E cp = new Field92E();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field92E.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field92E.COMPONENTS_PATTERN
	 */
	@Override
	...
	public final String validatorPattern() {
		return ":4!c/[8c]/4!c/[<N>]<AMOUNT>15[/4!c]";
	}
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 6) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 92E");
		}
		if (locale == null) {
