...
@Generated
public class Field76 extends Field implements Serializable, com.prowidesoftware.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field76> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field76> result = new ArrayList<Field76>(arr.length);
			for (final Tag f : arr) {
