...
public class Field39P extends Field implements Serializable, CurrencyContainer, AmountContainer {
	 ...
	 */
	public Field39P(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field39P(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "39P")) {
			throw new IllegalArgumentException("cannot create field 39P from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field39P newInstance(Field39P source) {
		Field39P cp = new Field39P();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field39P.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field39P.COMPONENTS_PATTERN
	 */
	@Override
