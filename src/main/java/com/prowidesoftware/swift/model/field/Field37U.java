...
public class Field37U extends Field implements Serializable, AmountContainer {
    ...
    public Field37U() {
        super(1);
        DeprecationUtils.phase3(Field37U.class, null, "this field has been removed from the standard since SRU2025");
    }
    ...
    public Field37U(final Tag tag) {
        ...
        if (!Strings.CS.equals(tag.getName(), "37U")) {
            throw new IllegalArgumentException("cannot create field 37U from tag " + tag.getName()
