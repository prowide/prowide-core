...
public class Field33N extends Field implements Serializable, CurrencyContainer, DateContainer, AmountContainer {
	 ...
	 */
	public Field33N(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field33N(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "33N")) {
			throw new IllegalArgumentException("cannot create field 33N from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field33N newInstance(Field33N source) {
		Field33N cp = new Field33N();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field33N.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field33N.COMPONENTS_PATTERN
	 */
	@Override
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 4) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 33N");
		}
		if (locale == null) {
