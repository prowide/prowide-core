...
@Generated
public class Field11A extends Field implements Serializable, CurrencyContainer, com.prowidesoftware.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field11A> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length>0) {
			final ArrayList<Field11A> result = new ArrayList<Field11A>(arr.length);
			for (final Tag f : arr) {
